...
public class ChunkCopyBehaviour {
    ...
    static final class AnonymousClass1 implements ChunkPredicate {
        ...
        final /* synthetic */ ImageInfo f3652a;
        ...
        public boolean a(PngChunk pngChunk) {
            if (pngChunk.b) {
                if (pngChunk.f3667a.equals("PLTE")) {
                    if (this.f3652a.g && ChunkCopyBehaviour.b(this.b, 1)) {
                        return true;
                    }
                    return !this.f3652a.f && ChunkCopyBehaviour.b(this.b, 8);
                }
                return false;
            }
            ...
            if (pngChunk.f3667a.equals("tRNS") && ChunkCopyBehaviour.b(this.b, 64)) {
                return true;
            }
            if (pngChunk.f3667a.equals("pHYs") && ChunkCopyBehaviour.b(this.b, 16)) {
                return true;
            }
            if (z && ChunkCopyBehaviour.b(this.b, 32)) {
                return true;
            }
            if (!ChunkCopyBehaviour.b(this.b, 256) || ChunkHelper.a(pngChunk) || z || pngChunk.f3667a.equals("hIST") || pngChunk.f3667a.equals("tIME")) {
