...
public class FiltersPerformance {
    ...
    public static final double[] f3677a = {0.73d, 1.03d, 0.97d, 1.11d, 1.22d};
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f3678a[FilterType.FILTER_PAETH.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f3678a[FilterType.FILTER_SUB.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f3678a[FilterType.FILTER_UP.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f3678a[FilterType.FILTER_AVERAGE.ordinal()] = 5;
