...
/* loaded from: source-3503164-dex2jar.jar:okhttp3/ConnectionPool.class */
public final class ConnectionPool {
    ...
    public Socket deduplicate(Address address, StreamAllocation streamAllocation) {
        for (RealConnection realConnection : this.connections) {
            if (realConnection.a(address, null) && realConnection.b() && realConnection != streamAllocation.c()) {
