...
/* loaded from: source-9557208-dex2jar.jar:android/hardware/display/IDisplayManagerCallback.class */
public interface IDisplayManagerCallback extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/hardware/display/IDisplayManagerCallback$Stub.class */
    public static abstract class Stub extends Binder implements IDisplayManagerCallback {
        ...
        static final int TRANSACTION_onDisplayEvent_0 = 1;

        /* loaded from: source-9557208-dex2jar.jar:android/hardware/display/IDisplayManagerCallback$Stub$Proxy.class */
        ...
        public static IDisplayManagerCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IDisplayManagerCallback)) ? new Proxy(iBinder) : (IDisplayManagerCallback) queryLocalInterface;
        }
