...
/* loaded from: source-9557208-dex2jar.jar:android/hardware/ICameraServiceListener.class */
public interface ICameraServiceListener extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/hardware/ICameraServiceListener$Stub.class */
    public static abstract class Stub extends Binder implements ICameraServiceListener {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/hardware/ICameraServiceListener$Stub$Proxy.class */
        ...
        public static ICameraServiceListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ICameraServiceListener)) ? new Proxy(iBinder) : (ICameraServiceListener) queryLocalInterface;
        }
