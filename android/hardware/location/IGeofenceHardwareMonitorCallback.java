...
/* loaded from: source-9557208-dex2jar.jar:android/hardware/location/IGeofenceHardwareMonitorCallback.class */
public interface IGeofenceHardwareMonitorCallback extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/hardware/location/IGeofenceHardwareMonitorCallback$Stub.class */
    public static abstract class Stub extends Binder implements IGeofenceHardwareMonitorCallback {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/hardware/location/IGeofenceHardwareMonitorCallback$Stub$Proxy.class */
            ...
            public void onMonitoringSystemChange(GeofenceHardwareMonitorEvent geofenceHardwareMonitorEvent) throws RemoteException {
                ...
                try {
                    ...
                    if (geofenceHardwareMonitorEvent != null) {
                        obtain.writeInt(1);
                        geofenceHardwareMonitorEvent.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
        ...
        public static IGeofenceHardwareMonitorCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IGeofenceHardwareMonitorCallback)) ? new Proxy(iBinder) : (IGeofenceHardwareMonitorCallback) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    onMonitoringSystemChange(parcel.readInt() != 0 ? GeofenceHardwareMonitorEvent.CREATOR.createFromParcel(parcel) : null);
                    return true;
