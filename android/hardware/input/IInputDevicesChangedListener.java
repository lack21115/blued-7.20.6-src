...
/* loaded from: source-9557208-dex2jar.jar:android/hardware/input/IInputDevicesChangedListener.class */
public interface IInputDevicesChangedListener extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/hardware/input/IInputDevicesChangedListener$Stub.class */
    public static abstract class Stub extends Binder implements IInputDevicesChangedListener {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/hardware/input/IInputDevicesChangedListener$Stub$Proxy.class */
        ...
        public static IInputDevicesChangedListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IInputDevicesChangedListener)) ? new Proxy(iBinder) : (IInputDevicesChangedListener) queryLocalInterface;
        }
