...
/* loaded from: source-9557208-dex2jar.jar:android/app/IActivityManager.class */
public interface IActivityManager extends IInterface {
    ...
    public static final int GET_CALLING_PACKAGE_FOR_BROADCAST_TRANSACTION = 245;
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/app/IActivityManager$ContentProviderHolder.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/app/IActivityManager$WaitResult.class */
    ...
    String getCallingPackageForBroadcast(boolean z) throws RemoteException;
    ...
    ActivityManager.StackInfo getStackInfo(int i) throws RemoteException;
    ...
    ActivityManager.TaskThumbnail getTaskThumbnail(int i) throws RemoteException;

    List<ActivityManager.RunningTaskInfo> getTasks(int i, int i2) throws RemoteException;
    ...
    boolean handleApplicationWtf(IBinder iBinder, String str, boolean z, ApplicationErrorReport.CrashInfo crashInfo) throws RemoteException;
