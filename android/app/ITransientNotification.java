...
/* loaded from: source-9557208-dex2jar.jar:android/app/ITransientNotification.class */
public interface ITransientNotification extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/app/ITransientNotification$Stub.class */
    public static abstract class Stub extends Binder implements ITransientNotification {
        ...
        public static ITransientNotification asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ITransientNotification)) ? new Proxy(iBinder) : (ITransientNotification) queryLocalInterface;
        }
