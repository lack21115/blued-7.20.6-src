...
/* loaded from: source-9557208-dex2jar.jar:android/app/IAppTask.class */
public interface IAppTask extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/app/IAppTask$Stub.class */
    public static abstract class Stub extends Binder implements IAppTask {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/app/IAppTask$Stub$Proxy.class */
        private static class Proxy implements IAppTask {
            ...
            public ActivityManager.RecentTaskInfo getTaskInfo() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    ActivityManager.RecentTaskInfo createFromParcel = obtain2.readInt() != 0 ? ActivityManager.RecentTaskInfo.CREATOR.createFromParcel(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static IAppTask asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IAppTask)) ? new Proxy(iBinder) : (IAppTask) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 4:
                    parcel.enforceInterface(DESCRIPTOR);
                    int startActivity = startActivity(parcel.readStrongBinder(), parcel.readString(), parcel.readInt() != 0 ? Intent.CREATOR.createFromParcel(parcel) : null, parcel.readString(), parcel.readInt() != 0 ? Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
