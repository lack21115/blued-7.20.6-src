...
/* loaded from: source-9557208-dex2jar.jar:android/media/IMediaRouterClient.class */
public interface IMediaRouterClient extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/media/IMediaRouterClient$Stub.class */
    public static abstract class Stub extends Binder implements IMediaRouterClient {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/media/IMediaRouterClient$Stub$Proxy.class */
        ...
        public static IMediaRouterClient asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMediaRouterClient)) ? new Proxy(iBinder) : (IMediaRouterClient) queryLocalInterface;
        }
