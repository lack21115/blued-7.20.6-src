...
/* loaded from: source-9557208-dex2jar.jar:android/media/session/ISession.class */
public interface ISession extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/media/session/ISession$Stub.class */
    public static abstract class Stub extends Binder implements ISession {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/media/session/ISession$Stub$Proxy.class */
        private static class Proxy implements ISession {
            ...
            @Override // android.media.session.ISession
            public void playItemResponse(boolean z) throws RemoteException {
                int i = 0;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            @Override // android.media.session.ISession
            public void updateFolderInfoBrowsedPlayer(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.media.session.ISession
            public void updateNowPlayingEntries(long[] jArr) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 15:
                    parcel.enforceInterface(DESCRIPTOR);
                    updateNowPlayingEntries(parcel.createLongArray());
                    parcel2.writeNoException();
                    return true;
                case 16:
                    parcel.enforceInterface(DESCRIPTOR);
                    updateFolderInfoBrowsedPlayer(parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 17:
                    parcel.enforceInterface(DESCRIPTOR);
