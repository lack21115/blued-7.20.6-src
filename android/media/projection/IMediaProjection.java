...
/* loaded from: source-9557208-dex2jar.jar:android/media/projection/IMediaProjection.class */
public interface IMediaProjection extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/media/projection/IMediaProjection$Stub.class */
    public static abstract class Stub extends Binder implements IMediaProjection {
        ...
        static final int TRANSACTION_start_0 = 1;
        static final int TRANSACTION_stop = 2;
        static final int TRANSACTION_unregisterCallback = 8;

        /* loaded from: source-9557208-dex2jar.jar:android/media/projection/IMediaProjection$Stub$Proxy.class */
        private static class Proxy implements IMediaProjection {
            ...
            public void registerCallback(IMediaProjectionCallback iMediaProjectionCallback) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeStrongBinder(iMediaProjectionCallback != null ? iMediaProjectionCallback.asBinder() : null);
        ...
        public static IMediaProjection asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMediaProjection)) ? new Proxy(iBinder) : (IMediaProjection) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 6:
                    parcel.enforceInterface(DESCRIPTOR);
                    int applyVirtualDisplayFlags = applyVirtualDisplayFlags(parcel.readInt());
                    parcel2.writeNoException();
