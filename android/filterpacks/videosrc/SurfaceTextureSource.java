...
/* loaded from: source-9557208-dex2jar.jar:android/filterpacks/videosrc/SurfaceTextureSource.class */
public class SurfaceTextureSource extends Filter {
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/filterpacks/videosrc/SurfaceTextureSource$SurfaceTextureSourceListener.class */
    ...
    public void process(FilterContext filterContext) {
        ...
        if (this.mWaitForNewFrame || this.mFirstFrame) {
            ...
            } else if (!this.mNewFrameAvailable.block(this.mWaitTimeout)) {
