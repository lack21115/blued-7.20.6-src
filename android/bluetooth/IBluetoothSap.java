...
/* loaded from: source-9557208-dex2jar.jar:android/bluetooth/IBluetoothSap.class */
public interface IBluetoothSap extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/bluetooth/IBluetoothSap$Stub.class */
    public static abstract class Stub extends Binder implements IBluetoothSap {
        ...
        static final int TRANSACTION_disconnect_0 = 1;
        static final int TRANSACTION_getConnectedDevices_2 = 3;
        ...
        public static IBluetoothSap asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IBluetoothSap)) ? new Proxy(iBinder) : (IBluetoothSap) queryLocalInterface;
        }
