...
/* loaded from: source-9557208-dex2jar.jar:android/bluetooth/IBluetoothCallback.class */
public interface IBluetoothCallback extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/bluetooth/IBluetoothCallback$Stub.class */
    public static abstract class Stub extends Binder implements IBluetoothCallback {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/bluetooth/IBluetoothCallback$Stub$Proxy.class */
        ...
        public static IBluetoothCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IBluetoothCallback)) ? new Proxy(iBinder) : (IBluetoothCallback) queryLocalInterface;
        }
