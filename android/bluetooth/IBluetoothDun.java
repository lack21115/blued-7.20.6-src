...
/* loaded from: source-9557208-dex2jar.jar:android/bluetooth/IBluetoothDun.class */
public interface IBluetoothDun extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/bluetooth/IBluetoothDun$Stub.class */
    public static abstract class Stub extends Binder implements IBluetoothDun {
        ...
        public static IBluetoothDun asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IBluetoothDun)) ? new Proxy(iBinder) : (IBluetoothDun) queryLocalInterface;
        }
