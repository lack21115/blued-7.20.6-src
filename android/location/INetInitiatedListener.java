...
/* loaded from: source-9557208-dex2jar.jar:android/location/INetInitiatedListener.class */
public interface INetInitiatedListener extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/location/INetInitiatedListener$Stub.class */
    public static abstract class Stub extends Binder implements INetInitiatedListener {
        ...
        static final int TRANSACTION_sendNiResponse_0 = 1;

        /* loaded from: source-9557208-dex2jar.jar:android/location/INetInitiatedListener$Stub$Proxy.class */
        ...
        public static INetInitiatedListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof INetInitiatedListener)) ? new Proxy(iBinder) : (INetInitiatedListener) queryLocalInterface;
        }
