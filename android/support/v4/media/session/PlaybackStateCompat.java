...
/* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat.class */
public final class PlaybackStateCompat implements Parcelable {
    ...
    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$Actions.class */
    public @interface Actions {
    }

    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$Builder.class */
    ...
    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$CustomAction.class */
    public static final class CustomAction implements Parcelable {
        ...
        /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$CustomAction$Builder.class */
        public static final class Builder {
            private final String mAction;
            private Bundle mExtras;
            private final int mIcon;
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$ErrorCode.class */
    public @interface ErrorCode {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$MediaKeyAction.class */
    public @interface MediaKeyAction {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$RepeatMode.class */
    public @interface RepeatMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$ShuffleMode.class */
    public @interface ShuffleMode {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8756600-dex2jar.jar:android/support/v4/media/session/PlaybackStateCompat$State.class */
