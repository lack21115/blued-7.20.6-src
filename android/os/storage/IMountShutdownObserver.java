...
/* loaded from: source-9557208-dex2jar.jar:android/os/storage/IMountShutdownObserver.class */
public interface IMountShutdownObserver extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/os/storage/IMountShutdownObserver$Stub.class */
    public static abstract class Stub extends Binder implements IMountShutdownObserver {
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/os/storage/IMountShutdownObserver$Stub$Proxy.class */
        ...
        public static IMountShutdownObserver asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMountShutdownObserver)) ? new Proxy(iBinder) : (IMountShutdownObserver) queryLocalInterface;
        }
