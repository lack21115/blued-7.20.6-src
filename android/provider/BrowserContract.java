...
/* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract.class */
public class BrowserContract {
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$Accounts.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$BaseSyncColumns.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$Bookmarks.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$ChromeSyncColumns.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$Combined.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$CommonColumns.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$History.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$HistoryColumns.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$ImageColumns.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$ImageMappingColumns.class */
    interface ImageMappingColumns {
        public static final String IMAGE_ID = "image_id";
        public static final String URL = "url";
    }

    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$ImageMappings.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$Images.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$Searches.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$Settings.class */
    public static final class Settings {
        ...
        public static boolean isSyncEnabled(Context context) {
            ...
            Cursor cursor = null;
            try {
                Cursor query = context.getContentResolver().query(CONTENT_URI, new String[]{"value"}, "key=?", new String[]{KEY_SYNC_ENABLED}, null);
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$SyncColumns.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/BrowserContract$SyncState.class */
