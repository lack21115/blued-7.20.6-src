...
/* loaded from: source-9557208-dex2jar.jar:android/provider/ThemesContract.class */
public class ThemesContract {
    public static final String AUTHORITY = "com.mokee.themes";
    public static final Uri AUTHORITY_URI = Uri.parse("content://com.mokee.themes");

    /* loaded from: source-9557208-dex2jar.jar:android/provider/ThemesContract$Intent.class */
    public static class Intent {
        public static final String ACTION_THEME_INSTALLED = "themescontract.intent.action.THEME_INSTALLED";
        public static final String ACTION_THEME_REMOVED = "themescontract.intent.action.THEME_REMOVED";
        public static final String ACTION_THEME_UPDATED = "themescontract.intent.action.THEME_UPDATED";
        public static final String URI_SCHEME_PACKAGE = "package";
    }

    /* loaded from: source-9557208-dex2jar.jar:android/provider/ThemesContract$MixnMatchColumns.class */
    public static class MixnMatchColumns {
        ...
        public static String componentToImageColName(String str) {
            if (str.equals(KEY_HOMESCREEN)) {
                return ThemesColumns.HOMESCREEN_URI;
            }
            if (str.equals(KEY_LOCKSCREEN)) {
                return ThemesColumns.LOCKSCREEN_URI;
            }
            if (str.equals(KEY_BOOT_ANIM)) {
                return ThemesColumns.BOOT_ANIM_URI;
            }
            if (str.equals(KEY_FONT)) {
                return ThemesColumns.FONT_URI;
            }
            if (str.equals(KEY_ICONS)) {
            ...
            if (str.equals(KEY_OVERLAYS)) {
                return ThemesColumns.OVERLAYS_URI;
            }
            if (str.equals(KEY_STATUS_BAR)) {
                throw new IllegalArgumentException("Status bar mixnmatch component does not have a related column");
            }
            ...
            if (str.equals(KEY_LIVE_LOCK_SCREEN)) {
                throw new IllegalArgumentException("Live lock screen mixnmatch component does not have a related column");
            }
            return null;
        }

        public static String componentToMixNMatchKey(String str) {
            if (str.equals(ThemesColumns.MODIFIES_LAUNCHER)) {
                return KEY_HOMESCREEN;
            }
            if (str.equals(ThemesColumns.MODIFIES_ICONS)) {
                return KEY_ICONS;
            }
            if (str.equals(ThemesColumns.MODIFIES_LOCKSCREEN)) {
                return KEY_LOCKSCREEN;
            }
            if (str.equals(ThemesColumns.MODIFIES_FONTS)) {
                return KEY_FONT;
            }
            if (str.equals(ThemesColumns.MODIFIES_BOOT_ANIM)) {
                return KEY_BOOT_ANIM;
            }
            if (str.equals(ThemesColumns.MODIFIES_ALARMS)) {
                return KEY_ALARM;
            }
            if (str.equals(ThemesColumns.MODIFIES_NOTIFICATIONS)) {
                return KEY_NOTIFICATIONS;
            }
            if (str.equals(ThemesColumns.MODIFIES_RINGTONES)) {
                return KEY_RINGTONE;
            }
            if (str.equals(ThemesColumns.MODIFIES_OVERLAYS)) {
                return KEY_OVERLAYS;
            }
            if (str.equals(ThemesColumns.MODIFIES_STATUS_BAR)) {
                return KEY_STATUS_BAR;
            }
            if (str.equals(ThemesColumns.MODIFIES_NAVIGATION_BAR)) {
                return KEY_NAVIGATION_BAR;
            }
            if (str.equals(ThemesColumns.MODIFIES_LIVE_LOCK_SCREEN)) {
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/ThemesContract$PreviewColumns.class */
    ...
    /* loaded from: source-9557208-dex2jar.jar:android/provider/ThemesContract$ThemesColumns.class */
    public static class ThemesColumns {
        public static final String AUTHOR = "author";
        public static final String BOOT_ANIM_URI = "bootanim_uri";
        public static final Uri CONTENT_URI = Uri.withAppendedPath(ThemesContract.AUTHORITY_URI, Context.THEME_SERVICE);
        ...
        /* loaded from: source-9557208-dex2jar.jar:android/provider/ThemesContract$ThemesColumns$InstallState.class */
