...
/* loaded from: source-9557208-dex2jar.jar:android/view/IWindowSessionCallback.class */
public interface IWindowSessionCallback extends IInterface {

    /* loaded from: source-9557208-dex2jar.jar:android/view/IWindowSessionCallback$Stub.class */
    public static abstract class Stub extends Binder implements IWindowSessionCallback {
        ...
        static final int TRANSACTION_onAnimatorScaleChanged_0 = 1;

        /* JADX INFO: Access modifiers changed from: private */
        /* loaded from: source-9557208-dex2jar.jar:android/view/IWindowSessionCallback$Stub$Proxy.class */
        ...
        public static IWindowSessionCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IWindowSessionCallback)) ? new Proxy(iBinder) : (IWindowSessionCallback) queryLocalInterface;
        }
