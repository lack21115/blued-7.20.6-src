...
@Metadata
/* loaded from: source-3503164-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__ReduceKt$first$$inlined$collectWhile$2.class */
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function2 f43240a;
    final /* synthetic */ Ref.ObjectRef b;

    @Metadata
    @DebugMetadata(b = "Reduce.kt", c = {144}, d = "emit", e = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2")
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2$1  reason: invalid class name */
    /* loaded from: source-3503164-dex2jar.jar:kotlinx/coroutines/flow/FlowKt__ReduceKt$first$$inlined$collectWhile$2$1.class */
