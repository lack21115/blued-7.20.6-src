...
/* loaded from: source-8303388-dex2jar.jar:com/qiniu/android/dns/http/CloudflareHttpsDns.class */
    ...
    */
    private static java.lang.String getStringResponse(java.net.HttpURLConnection r5) throws java.io.IOException {
        ...
        L87:
            ...
            goto L20
        */
        throw new UnsupportedOperationException("Method not decompiled: com.qiniu.android.dns.http.CloudflareHttpsDns.getStringResponse(java.net.HttpURLConnection):java.lang.String");
    }

    @Override // com.qiniu.android.dns.IResolver
    public Record[] resolve(Domain domain, NetworkInfo networkInfo) throws IOException {
        JSONArray jSONArray;
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL("https://cloudflare-dns.com/dns-query?type=A&name=" + domain.domain).openConnection();
