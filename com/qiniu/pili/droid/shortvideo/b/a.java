...
public class a {
    ...
    */
    protected void a(com.qiniu.pili.droid.shortvideo.b.a.C0572a r6, byte[] r7) {
        /*
    ...
    protected void b(int i) {
        ...
        Bitmap bitmap;
        Bitmap bitmap2;
        C0572a c0572a = this.w.get(i);
        int i5 = i - 1;
        C0572a c0572a2 = i5 >= 0 ? this.w.get(i5) : null;
        int[] iArr = this.u;
        int i6 = 0;
        if (c0572a2 != null && c0572a2.g > 0) {
            if (c0572a2.g == 1 && (bitmap2 = this.z) != null) {
                int i7 = this.b;
                bitmap2.getPixels(iArr, 0, i7, 0, 0, i7, this.f13837c);
            }
            if (c0572a2.g == 2) {
                int i8 = !c0572a.f ? this.j : 0;
                int i9 = 0;
                while (true) {
                    int i10 = i9;
                    if (i10 >= c0572a2.d) {
                    ...
                    int i11 = ((c0572a2.b + i10) * this.b) + c0572a2.f13838a;
                    int i12 = c0572a2.f13839c;
                    int i13 = i11;
                    while (true) {
                        int i14 = i13;
                        if (i14 < i12 + i11) {
            ...
            if (c0572a2.g == 3 && (bitmap = this.y) != null) {
                int i15 = this.b;
                bitmap.getPixels(iArr, 0, i15, 0, 0, i15, this.f13837c);
            }
        }
        a(c0572a, this.t);
        int i16 = 8;
        ...
        while (i6 < c0572a.d) {
            ...
            if (i21 < this.f13837c) {
                int i22 = i21 * this.b;
                int i23 = c0572a.f13838a + i22;
                int i24 = c0572a.f13839c + i23;
                int i25 = this.b;
                int i26 = i24;
                if (i22 + i25 < i24) {
                    i26 = i22 + i25;
                }
                int i27 = c0572a.f13839c * i6;
                while (true) {
                    int i28 = i27;
                    if (i23 < i26) {
        ...
        int[] iArr2 = this.v;
        int i30 = this.b;
        bitmap3.getPixels(iArr2, 0, i30, 0, 0, i30, this.f13837c);
        Bitmap bitmap4 = this.y;
        int[] iArr3 = this.v;
        int i31 = this.b;
        bitmap4.setPixels(iArr3, 0, i31, 0, 0, i31, this.f13837c);
        Bitmap bitmap5 = this.z;
        int i32 = this.b;
        bitmap5.setPixels(iArr, 0, i32, 0, 0, i32, this.f13837c);
    }
    ...
    protected void n() {
        ...
        this.z = Bitmap.createBitmap(this.b, this.f13837c, Bitmap.Config.ARGB_8888);
    }
