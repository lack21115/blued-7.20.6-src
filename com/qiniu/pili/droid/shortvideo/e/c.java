...
public class c {
    ...
    private List<PLMixAudioFile> f13960a = new LinkedList();

    public PLMixAudioFile a() {
        if (this.f13960a.size() <= 0) {
            return null;
        }
        return this.f13960a.get(0);
    }
    ...
    public void a(int i) {
        ...
        while (true) {
            int i3 = i2;
            if (i3 >= this.f13960a.size()) {
                return;
            }
            PLMixAudioFile pLMixAudioFile = this.f13960a.get(i3);
    ...
    public void a(long j) {
        ...
        while (true) {
            int i2 = i;
            if (i2 >= this.f13960a.size()) {
                return;
            }
            PLMixAudioFile pLMixAudioFile = this.f13960a.get(i2);
    ...
    public void a(long j, boolean z) {
        ...
        while (true) {
            int i2 = i;
            if (i2 >= this.f13960a.size() || (a2 = (pLMixAudioFile = this.f13960a.get(i2)).a()) == null) {
                return;
            }
    ...
    public void a(PLMixAudioFile pLMixAudioFile) {
        this.f13960a.add(pLMixAudioFile);
    }
    ...
    public void b(PLMixAudioFile pLMixAudioFile) {
        if (!this.f13960a.contains(pLMixAudioFile)) {
            e.q.e("MultiMixAudioPlayer", "can not find the mix audio file!");
            return;
        }
        this.f13960a.remove(pLMixAudioFile);
    ...
    public void c(PLMixAudioFile pLMixAudioFile) {
        if (this.f13960a.size() <= 0) {
            ...
            this.f13960a.set(0, pLMixAudioFile);
        }
    }
    ...
    public void d() {
        ...
        while (true) {
            ...
            if (this.f13960a.get(i2).a() != null) {
                this.f13960a.get(i2).a().e();
            }
            i = i2 + 1;
        }
    }
