...
public class AspectFrameLayout extends FrameLayout {
    ...
    public double f14159a;
    public SHOW_MODE b;

    /* renamed from: c  reason: collision with root package name */
    public Point f14160c;
    public int d;
    public int e;
    public Rect f;
    public int g;
    ...
    public void onMeasure(int i, int i2) {
        ...
        double d3;
        double d4;
        e.f1313c.b("AspectFrameLayout", "onMeasure target=" + this.f14159a + " width=[" + View.MeasureSpec.toString(i) + "] height=[" + View.MeasureSpec.toString(i2) + "],x:" + this.f14160c.x + ",y:" + this.f14160c.y);
        getWindowVisibleDisplayFrame(this.f);
        if (this.e == 0 && this.d == 0) {
            this.e = getRootView().getWidth();
            this.d = getRootView().getHeight();
        }
        Point point = this.f14160c;
        if (point.x > point.y) {
            int i6 = this.e;
            int i7 = this.d;
            i3 = i6;
        ...
        if (i3 - (rect.bottom - rect.top) > i3 / 4) {
            e.f1313c.c("AspectFrameLayout", "soft keyboard show");
            super.onMeasure(this.g, this.h);
            return;
        }
        e.f1313c.c("AspectFrameLayout", "soft keyboard hide");
        if (this.f14159a > 0.0d) {
            ...
            double d5 = i10;
            double d6 = i11;
            double d7 = (this.f14159a / (d5 / d6)) - 1.0d;
            if (Math.abs(d7) < 0.01d) {
                e.f1313c.b("AspectFrameLayout", "aspect ratio is good (target=" + this.f14159a + ", view=" + i10 + "x" + i11 + ")");
            } else {
                if (this.b == SHOW_MODE.REAL) {
                    if (d7 > 0.0d) {
                        i11 = (int) (d5 / this.f14159a);
                    } else {
                        i10 = (int) (d6 * this.f14159a);
                    }
                    i4 = i10 + paddingLeft;
                    i5 = i11 + paddingTop;
                } else {
                    Point point2 = this.f14160c;
                    int i12 = point2.x;
                    int i13 = point2.y;
                    if (i12 > i13) {
                        if (i10 == i12) {
                ...
                e.f1313c.b("AspectFrameLayout", "new size=" + i4 + "x" + i5 + " + padding " + paddingLeft + "x" + paddingTop);
    ...
    public void setAspectRatio(double d) {
        ...
        e eVar = e.f1313c;
        eVar.c("AspectFrameLayout", "Setting aspect ratio to " + d + " (was " + this.f14159a + ")");
        if (this.f14159a != d) {
            this.f14159a = d;
            if (getHandler() != null) {
