...
public class e {
    ...
    protected HashMap<String, com.zk_oaction.adengine.lk_sdkwrapper.a> f28278a = new HashMap<>();
    private Context b;
    ...
    class a implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ com.zk_oaction.adengine.lk_sdkwrapper.a f28279a;
        ...
        public void run() {
            try {
                if (this.f28279a == null || e.this.b == null) {
                    return;
                }
                this.f28279a.a(this.b, this.f28280c);
                HashMap<String, com.zk_oaction.adengine.lk_sdkwrapper.a> hashMap = e.this.f28278a;
                if (hashMap != null) {
                    hashMap.put(this.f28279a.e(), this.f28279a);
                }
                if (this.d) {
                    this.f28279a.c();
                }
    ...
    public View a(String str, int i, int i2, boolean z, HashMap<ZkViewSDK.KEY, Object> hashMap, ZkViewSDK.a aVar, int i3, Map map, int i4) {
        ...
        a2.a(i, i2);
        HashMap<String, com.zk_oaction.adengine.lk_sdkwrapper.a> hashMap2 = this.f28278a;
        if (hashMap2 != null) {
            ...
            if (view != null) {
                try {
                    if (view instanceof com.zk_oaction.adengine.lk_sdkwrapper.a) {
                        ...
                        HashMap<String, com.zk_oaction.adengine.lk_sdkwrapper.a> hashMap = this.f28278a;
                        if (hashMap != null && hashMap.containsKey(((com.zk_oaction.adengine.lk_sdkwrapper.a) view).e())) {
                            this.f28278a.remove(((com.zk_oaction.adengine.lk_sdkwrapper.a) view).e());
                        }
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
