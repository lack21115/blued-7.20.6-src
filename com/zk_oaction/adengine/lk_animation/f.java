...
public class f extends b {
    ...
    private com.zk_oaction.adengine.lk_sdk.interfaces.b f41896a;

    /* renamed from: c  reason: collision with root package name */
    private long f41897c;
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        com.zk_oaction.adengine.lk_expression.a f41898a;
    ...
    public void a(long j) {
        ...
        while (true) {
            ...
            long j3 = aVar.f41899c;
            int i3 = (j > j3 ? 1 : (j == j3 ? 0 : -1));
            if (i3 <= 0) {
                if (i3 == 0) {
                    if (Float.valueOf(aVar.f41898a.a()).equals(Float.valueOf(this.d)) && Float.valueOf(aVar.b.a()).equals(Float.valueOf(this.e))) {
                        return;
                    }
                    this.f41896a.h(aVar.f41898a.a(), aVar.b.a());
                    this.d = aVar.f41898a.a();
                    this.e = aVar.b.a();
                    return;
                }
                float f3 = ((float) (j - j2)) / ((float) (j3 - j2));
                float a2 = ((aVar.f41898a.a() - f) * f3) + f;
                float a3 = ((aVar.b.a() - f2) * f3) + f2;
                if (Float.valueOf(a2).equals(Float.valueOf(this.d)) && Float.valueOf(a3).equals(Float.valueOf(this.e))) {
                    return;
                }
                this.f41896a.h(a2, a3);
                this.d = a2;
                this.e = a3;
                return;
            }
        ...
        while (true) {
            try {
                ...
                if (next != 2) {
                    ...
                    com.zk_oaction.adengine.lk_expression.a aVar = new com.zk_oaction.adengine.lk_expression.a(this.f41896a.b(), null, xmlPullParser.getAttributeValue(null, IAdInterListener.AdReqParam.WIDTH), 0.0f, null, true);
                    com.zk_oaction.adengine.lk_expression.a aVar2 = new com.zk_oaction.adengine.lk_expression.a(this.f41896a.b(), null, xmlPullParser.getAttributeValue(null, "h"), 0.0f, null, true);
                    long parseLong = Long.parseLong(xmlPullParser.getAttributeValue(null, "time"));
                    if (parseLong > this.f41897c) {
                        this.f41897c = parseLong;
                    }
