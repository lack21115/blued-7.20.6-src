...
public class a {
    ...
    private static float[] f41925a = {0.0f, 0.0f};
    private float[] b;
    ...
    class HandlerC1104a extends Handler {
        ...
        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ float f41928c;
        final /* synthetic */ float d;
        final /* synthetic */ b e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        HandlerC1104a(Looper looper, long j, float f, float f2, float f3, b bVar) {
            super(looper);
            this.f41927a = j;
            this.b = f;
            this.f41928c = f2;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:17:0x013e, code lost:
            if (r7.f.f41926c < r7.f.b.length) goto L27;
         */
        ...
        */
        public void handleMessage(android.os.Message r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.zk_oaction.adengine.lk_sdk.a.HandlerC1104a.handleMessage(android.os.Message):void");
        }
    }
    ...
    public void a(float f, float f2, float f3, b bVar, float[] fArr) {
        ...
        this.f = 0.036f;
        this.g = 6.0E-4f;
        HandlerC1104a handlerC1104a = new HandlerC1104a(Looper.getMainLooper(), SystemClock.uptimeMillis(), f3, f, f2, bVar);
        this.h = handlerC1104a;
        handlerC1104a.sendEmptyMessageDelayed(0, 16L);
    }
}
