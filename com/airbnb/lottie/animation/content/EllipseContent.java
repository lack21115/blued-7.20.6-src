...
public class EllipseContent implements KeyPathElementContent, PathContent, BaseKeyframeAnimation.AnimationListener {
    ...
    private final LottieDrawable f4275c;
    ...
    public Path e() {
        ...
        if (this.f.d()) {
            float f5 = -f2;
            this.f4274a.moveTo(0.0f, f5);
            float f6 = 0.0f - f3;
            float f7 = -f;
            float f8 = 0.0f - f4;
            this.f4274a.cubicTo(f6, f5, f7, f8, f7, 0.0f);
            float f9 = f4 + 0.0f;
            this.f4274a.cubicTo(f7, f9, f6, f2, 0.0f, f2);
            float f10 = f3 + 0.0f;
            this.f4274a.cubicTo(f10, f2, f, f9, f, 0.0f);
            this.f4274a.cubicTo(f, f8, f10, f5, 0.0f, f5);
        } else {
            float f11 = -f2;
            this.f4274a.moveTo(0.0f, f11);
            float f12 = f3 + 0.0f;
            float f13 = 0.0f - f4;
            this.f4274a.cubicTo(f12, f11, f, f13, f, 0.0f);
            float f14 = f4 + 0.0f;
            this.f4274a.cubicTo(f, f14, f12, f2, 0.0f, f2);
            float f15 = 0.0f - f3;
            float f16 = -f;
            this.f4274a.cubicTo(f15, f2, f16, f14, f16, 0.0f);
            this.f4274a.cubicTo(f16, f13, f15, f11, 0.0f, f11);
        }
        PointF g2 = this.e.g();
        this.f4274a.offset(g2.x, g2.y);
        this.f4274a.close();
        this.g.a(this.f4274a);
        this.h = true;
        return this.f4274a;
    }
}
