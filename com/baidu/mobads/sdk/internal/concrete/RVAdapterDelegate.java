...
public class RVAdapterDelegate extends RecyclerView.Adapter<RVViewHolderDelegate> implements a {
    ...
    public RVAdapterDelegate(IAdInterListener iAdInterListener) {
        this.f9390a = b.a(iAdInterListener, this);
        registerAdapterDataObserver(new ViewPager2.DataSetChangeObserver() { // from class: com.baidu.mobads.sdk.internal.concrete.RVAdapterDelegate.1
            ...
            public void onChanged() {
                RVAdapterDelegate.this.f9390a.a("onChanged");
            }
        });
    }
    ...
    public int getCode() {
        return this.f9390a.getCode();
    }

    @Override // com.baidu.mobads.sdk.api.IOAdEvent
    public Map<String, Object> getData() {
        return this.f9390a.getData();
    }

    @Override // com.baidu.mobads.sdk.internal.a.a
    public IAdInterListener getDelegator() {
        return this.f9390a.getDelegator();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        Object a2 = this.f9390a.a("getItemCount", new Object[0]);
    ...
    public long getItemId(int i) {
        Object a2 = this.f9390a.a("getItemId", Integer.valueOf(i));
        return a2 instanceof Integer ? ((Integer) a2).intValue() : super.getItemId(i);
    }

    @Override // com.baidu.mobads.sdk.api.IOAdEvent
    public String getMessage() {
        return this.f9390a.getMessage();
    }

    @Override // com.baidu.mobads.sdk.api.IOAdEvent
    public Object getTarget() {
        return this.f9390a.getTarget();
    }

    @Override // com.baidu.mobads.sdk.api.IOAdEvent
    public String getType() {
        return this.f9390a.getType();
    }
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        this.f9390a.a("onAttachedToRecyclerView", recyclerView);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(RVViewHolderDelegate rVViewHolderDelegate, int i) {
        this.f9390a.a("onBindViewHolder", rVViewHolderDelegate.getDelegator(), Integer.valueOf(i));
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public RVViewHolderDelegate onCreateViewHolder(ViewGroup viewGroup, int i) {
        Object a2 = this.f9390a.a("onCreateViewHolder", viewGroup, Integer.valueOf(i));
        return a2 instanceof RVViewHolderDelegate ? (RVViewHolderDelegate) a2 : new RVViewHolderDelegate(this.f9390a.getDelegator(), viewGroup) { // from class: com.baidu.mobads.sdk.internal.concrete.RVAdapterDelegate.2
        };
    }
    ...
    public void onDetachedFromRecyclerView(RecyclerView recyclerView) {
        ...
        this.f9390a.a("onDetachedFromRecyclerView", recyclerView);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public boolean onFailedToRecycleView(RVViewHolderDelegate rVViewHolderDelegate) {
        Object a2 = this.f9390a.a("onFailedToRecycleView", rVViewHolderDelegate.getDelegator());
    ...
    public void onViewAttachedToWindow(RVViewHolderDelegate rVViewHolderDelegate) {
        ...
        this.f9390a.a("onViewAttachedToWindow", rVViewHolderDelegate.getDelegator());
    }
    ...
    public void onViewDetachedFromWindow(RVViewHolderDelegate rVViewHolderDelegate) {
        ...
        this.f9390a.a("onViewDetachedFromWindow", rVViewHolderDelegate.getDelegator());
    }
    ...
    public void onViewRecycled(RVViewHolderDelegate rVViewHolderDelegate) {
        ...
        this.f9390a.a("onViewRecycled", rVViewHolderDelegate.getDelegator());
    }

    @Override // com.baidu.mobads.sdk.api.IOAdEvent
    public void setTarget(Object obj) {
        this.f9390a.setTarget(obj);
    }
}
