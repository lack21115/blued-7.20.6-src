...
public class cy implements t {
    ...
    public JSONObject a() {
        ...
        String h = this.f9407a.h("get_cuid");
        String h2 = this.f9407a.h("get_imei");
        String h3 = this.f9407a.h("get_oaid");
        try {
    ...
    public void a(long j) {
        ...
        cpuNovelListener = this.f9407a.H;
        if (cpuNovelListener != null) {
            cpuNovelListener2 = this.f9407a.H;
    ...
    public void a(ViewGroup viewGroup) {
        ...
        hashMap.put("novel_activity", this.f9407a.g());
        hashMap.put("interstitial_container", viewGroup);
        hashMap.put(com.anythink.expressad.foundation.g.a.aj, Integer.valueOf(this.f9407a.D));
        hashMap.put("channelId", Integer.valueOf(this.f9407a.E));
        hashMap.put("novel_id", this.f9407a.F);
        this.f9407a.a(cv.r, hashMap);
    }
    ...
    public void a(ViewGroup viewGroup, int i) {
        ...
        hashMap.put("novel_activity", this.f9407a.g());
        hashMap.put("interstitial_container", viewGroup);
        hashMap.put("isnight", Boolean.valueOf(this.f9407a.h()));
        hashMap.put(com.anythink.expressad.foundation.g.a.aj, Integer.valueOf(this.f9407a.D));
        hashMap.put("channelId", Integer.valueOf(this.f9407a.E));
        hashMap.put("novel_id", this.f9407a.F);
        hashMap.put("count_down", Integer.valueOf(i));
        this.f9407a.a(cv.x, hashMap);
    }
    ...
    public void a(boolean z) {
        ...
        softReference = this.f9407a.I;
        if (softReference != null) {
            softReference2 = this.f9407a.I;
            RelativeLayout relativeLayout = (RelativeLayout) softReference2.get();
            if (relativeLayout != null) {
                HashMap<String, Object> hashMap = new HashMap<>();
                hashMap.put("novel_activity", (Activity) this.f9407a.h);
                hashMap.put("interstitial_container", null);
                hashMap.put("banner_container", relativeLayout);
                hashMap.put(com.anythink.expressad.foundation.g.a.aj, Integer.valueOf(this.f9407a.D));
                hashMap.put("channelId", Integer.valueOf(this.f9407a.E));
                hashMap.put("novel_id", this.f9407a.F);
                hashMap.put("isnight", Boolean.valueOf(this.f9407a.w()));
                this.f9407a.a(cv.w, hashMap);
            }
        }
    }
