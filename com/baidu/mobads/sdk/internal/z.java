...
public class z {
    ...
    private static final String f9474a = "LoadRemoteDex";
    private static z i;
    ...
    private void h() {
        ...
        if (this.b != null) {
            k();
        } else if (f.f9427a == null) {
            this.h.a(f9474a, "BaiduXAdSDKContext.mApkLoader == null,not load apk");
        } else {
            this.h.a(f9474a, "start load apk");
            try {
                f.f9427a.a(new ab(this));
            } catch (Throwable th2) {
                th2.printStackTrace();
            }
        }
    ...
    public void a(Context context, a aVar) {
        if (context == null) {
            this.h.c(f9474a, "init Context is null,error");
            return;
        }
    ...
    public String d() {
        if (this.b != null) {
            return BridgeUtil.UNDERLINE_STR + this.b.getRemoteVersion();
        }
        return "";
    }
