...
/* loaded from: source-8457232-dex2jar.jar:com/ss/android/socialbase/downloader/db/DownloadDBHelper.class */
public class DownloadDBHelper extends SQLiteOpenHelper {
    private static volatile DownloadDBHelper instance;
    private boolean tempDirSetted;

    private DownloadDBHelper() {
        super(DownloadComponentManager.getAppContext(), DBDefinition.DATABASE_NAME, null, 15);
