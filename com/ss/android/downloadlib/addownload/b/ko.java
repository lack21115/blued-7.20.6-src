...
/* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadlib/addownload/b/ko.class */
public class ko implements hj {
    ...
    public boolean mb(com.ss.android.downloadad.api.mb.ox oxVar, int i, b bVar) {
        ...
        return je.mb(oxVar, ww.mb((Context) null).ox(oxVar.mb()), i, bVar);
    }
}
