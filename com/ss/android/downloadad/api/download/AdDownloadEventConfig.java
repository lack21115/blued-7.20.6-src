...
/* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/download/AdDownloadEventConfig.class */
public class AdDownloadEventConfig implements DownloadEventConfig {
    ...
    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/download/AdDownloadEventConfig$Builder.class */
    ...
    public static AdDownloadEventConfig fromJson(JSONObject jSONObject) {
        ...
        try {
            ...
            x.m().mb(e, "AdDownloadEventConfig fromJson");
        }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            x.m().mb(e, "AdDownloadEventConfig toJson");
            return jSONObject;
        }
    }
}
