...
/* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants.class */
public interface AdBaseConstants extends BaseConstants {
    ...
    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants$DownloadConfigureName.class */
    public @interface DownloadConfigureName {
        public static final String PANGOLIN = "pangolin";
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants$DownloadMode.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants$DownloadScene.class */
    public @interface DownloadScene {
        public static final int DETAIL = 1;
        public static final int NORMAL = 0;
    }

    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants$FunnelType.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants$LinkMode.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants$ModelType.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8457232-dex2jar.jar:com/ss/android/downloadad/api/constant/AdBaseConstants$OpenAppScene.class */
