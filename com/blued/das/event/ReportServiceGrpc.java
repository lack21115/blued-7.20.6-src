...
/* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc.class */
public final class ReportServiceGrpc {
    private static final int METHODID_BATCH_REPORT = 0;
    public static final String SERVICE_NAME = "com.blued.das.event.ReportService";
    ...
    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$MethodHandlers.class */
    ...
    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$ReportServiceBaseDescriptorSupplier.class */
    ...
    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$ReportServiceBlockingStub.class */
    public static final class ReportServiceBlockingStub extends AbstractBlockingStub<ReportServiceBlockingStub> {
        ...
        /* renamed from: build */
        public ReportServiceBlockingStub m2195build(Channel channel, CallOptions callOptions) {
            return new ReportServiceBlockingStub(channel, callOptions);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$ReportServiceFileDescriptorSupplier.class */
    ...
    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$ReportServiceFutureStub.class */
    public static final class ReportServiceFutureStub extends AbstractFutureStub<ReportServiceFutureStub> {
        ...
        public ListenableFuture<CustomEventProtos.Response> batchReport(CustomEventProtos.Requests requests) {
            return ClientCalls.futureUnaryCall(getChannel().newCall(ReportServiceGrpc.getBatchReportMethod(), getCallOptions()), requests);
        }

        /* JADX INFO: Access modifiers changed from: protected */
        /* renamed from: build */
        public ReportServiceFutureStub m2196build(Channel channel, CallOptions callOptions) {
            return new ReportServiceFutureStub(channel, callOptions);
        }
    }

    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$ReportServiceImplBase.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$ReportServiceMethodDescriptorSupplier.class */
    ...
    /* loaded from: source-7206380-dex2jar.jar:com/blued/das/event/ReportServiceGrpc$ReportServiceStub.class */
    public static final class ReportServiceStub extends AbstractAsyncStub<ReportServiceStub> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        /* renamed from: build */
        public ReportServiceStub m2197build(Channel channel, CallOptions callOptions) {
    ...
    public static MethodDescriptor<CustomEventProtos.Requests, CustomEventProtos.Response> getBatchReportMethod() {
        MethodDescriptor<CustomEventProtos.Requests, CustomEventProtos.Response> methodDescriptor;
        MethodDescriptor<CustomEventProtos.Requests, CustomEventProtos.Response> methodDescriptor2 = getBatchReportMethod;
        if (methodDescriptor2 == null) {
            synchronized (ReportServiceGrpc.class) {
                try {
                    MethodDescriptor<CustomEventProtos.Requests, CustomEventProtos.Response> methodDescriptor3 = getBatchReportMethod;
    ...
    public static ReportServiceBlockingStub newBlockingStub(Channel channel) {
        return ReportServiceBlockingStub.newStub(new AbstractStub.StubFactory<ReportServiceBlockingStub>() { // from class: com.blued.das.event.ReportServiceGrpc.2
            /* renamed from: newStub */
            public ReportServiceBlockingStub m2193newStub(Channel channel2, CallOptions callOptions) {
    ...
    public static ReportServiceFutureStub newFutureStub(Channel channel) {
        return ReportServiceFutureStub.newStub(new AbstractStub.StubFactory<ReportServiceFutureStub>() { // from class: com.blued.das.event.ReportServiceGrpc.3
            /* renamed from: newStub */
            public ReportServiceFutureStub m2194newStub(Channel channel2, CallOptions callOptions) {
    ...
    public static ReportServiceStub newStub(Channel channel) {
        return ReportServiceStub.newStub(new AbstractStub.StubFactory<ReportServiceStub>() { // from class: com.blued.das.event.ReportServiceGrpc.1
            /* renamed from: newStub */
            public ReportServiceStub m2192newStub(Channel channel2, CallOptions callOptions) {
