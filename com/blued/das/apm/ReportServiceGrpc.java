...
public final class ReportServiceGrpc {
    ...
    public static final class ReportServiceBlockingStub extends AbstractBlockingStub<ReportServiceBlockingStub> {
        ...
        /* renamed from: build */
        public ReportServiceBlockingStub m2095build(Channel channel, CallOptions callOptions) {
    ...
    public static final class ReportServiceFutureStub extends AbstractFutureStub<ReportServiceFutureStub> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        /* renamed from: build */
        public ReportServiceFutureStub m2096build(Channel channel, CallOptions callOptions) {
    ...
    public static final class ReportServiceStub extends AbstractAsyncStub<ReportServiceStub> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        /* renamed from: build */
        public ReportServiceStub m2097build(Channel channel, CallOptions callOptions) {
    ...
    public static ReportServiceBlockingStub newBlockingStub(Channel channel) {
        return ReportServiceBlockingStub.newStub(new AbstractStub.StubFactory<ReportServiceBlockingStub>() { // from class: com.blued.das.apm.ReportServiceGrpc.2
            /* renamed from: newStub */
            public ReportServiceBlockingStub m2093newStub(Channel channel2, CallOptions callOptions) {
    ...
    public static ReportServiceFutureStub newFutureStub(Channel channel) {
        return ReportServiceFutureStub.newStub(new AbstractStub.StubFactory<ReportServiceFutureStub>() { // from class: com.blued.das.apm.ReportServiceGrpc.3
            /* renamed from: newStub */
            public ReportServiceFutureStub m2094newStub(Channel channel2, CallOptions callOptions) {
    ...
    public static ReportServiceStub newStub(Channel channel) {
        return ReportServiceStub.newStub(new AbstractStub.StubFactory<ReportServiceStub>() { // from class: com.blued.das.apm.ReportServiceGrpc.1
            /* renamed from: newStub */
            public ReportServiceStub m2092newStub(Channel channel2, CallOptions callOptions) {
