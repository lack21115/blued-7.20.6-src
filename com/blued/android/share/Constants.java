...
/* loaded from: source-5382004-dex2jar.jar:com/blued/android/share/Constants.class */
public class Constants {
    public static String BLUED_FEED = "blued_feed";
    public static String BLUED_GROUP_AND_PEOPLE = "group_and_people";
    ...
    public static String REPOST_FEED = "repost_feed";
