...
public class ResizeLinearLayout extends KeyboardListenLinearLayout implements BluedSkinSupportable {
    ...
    public final boolean fitSystemWindows(Rect rect) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.f11032a[0] = rect.left;
            this.f11032a[1] = rect.top;
            this.f11032a[2] = rect.right;
            rect.left = 0;
            rect.top = 0;
            rect.right = 0;
        }
    ...
    public final WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            this.f11032a[0] = windowInsets.getSystemWindowInsetLeft();
            this.f11032a[1] = windowInsets.getSystemWindowInsetTop();
            this.f11032a[2] = windowInsets.getSystemWindowInsetRight();
