...
public class NoDataAndLoadFailView extends LinearLayout {
    ...
    private void a(AttributeSet attributeSet) {
        View inflate = LayoutInflater.from(this.a).inflate(R.layout.item_ll_nodata, this);
        this.b = inflate;
        inflate.setVisibility(8);
        LinearLayout linearLayout = (LinearLayout) this.b.findViewById(R.id.ll_main);
        this.c = linearLayout;
        linearLayout.setBackgroundColor(BluedSkinUtils.a(this.a, R.color.syc_b));
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = this.a.obtainStyledAttributes(attributeSet, R.styleable.NoDataAndLoadFailView);
            ...
            int resourceId2 = obtainStyledAttributes.getResourceId(R.styleable.NoDataAndLoadFailView_img_width, DensityUtils.a(this.a, 160.0f));
            int resourceId3 = obtainStyledAttributes.getResourceId(R.styleable.NoDataAndLoadFailView_img_height, DensityUtils.a(this.a, 160.0f));
    ...
    public void a() {
        ...
        this.e.setTextColor(BluedSkinUtils.a(this.a, this.t));
        if (this.r) {
            int i = this.o;
            if (i > 0) {
                this.g.setText(i);
    ...
    public void b() {
        ...
        this.e.setTextColor(BluedSkinUtils.a(this.a, this.u));
        if (this.q) {
            int i = this.p;
            if (i > 0) {
                this.g.setText(i);
    ...
    public void setBackgroundColorRes(int i) {
        this.b.findViewById(R.id.ll_main).setBackgroundColor(BluedSkinUtils.a(this.a, i));
    }
    ...
    public void setNoDataImg(int i) {
        this.j = i;
        this.d.setImageDrawable(BluedSkinUtils.b(this.a, i));
    }
