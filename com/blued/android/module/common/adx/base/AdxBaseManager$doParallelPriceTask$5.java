...
@Metadata
@DebugMetadata(b = "AdxBaseManager.kt", c = {1018, 1407}, d = "invokeSuspend", e = "com.blued.android.module.common.adx.base.AdxBaseManager$doParallelPriceTask$5")
...
final class AdxBaseManager$doParallelPriceTask$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ List<BluedADExtra> f10504c;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AdxBaseManager$doParallelPriceTask$5) create(coroutineScope, continuation)).invokeSuspend(Unit.f42314a);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AdxBaseManager$doParallelPriceTask$5(this.b, this.f10504c, this.d, this.e, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.a(obj);
            this.f10503a = 1;
            Object a3 = this.b.a(this.f10504c, this);
            obj = a3;
            if (a3 == a2) {
                return a2;
            }
        ...
        Flow a4 = FlowKt.a(FlowKt.a(FlowKt.a((Function2) new AdxBaseManager$doParallelPriceTask$5$invokeSuspend$$inlined$transform$1((Flow) obj, null)), Dispatchers.b()));
        final AdxBaseManager adxBaseManager = this.b;
        final List<BluedADExtra> list = this.d;
        final CoroutineScope coroutineScope = this.e;
        this.f10503a = 2;
        if (a4.a(new FlowCollector<ADEvent>() { // from class: com.blued.android.module.common.adx.base.AdxBaseManager$doParallelPriceTask$5$invokeSuspend$$inlined$collect$1
