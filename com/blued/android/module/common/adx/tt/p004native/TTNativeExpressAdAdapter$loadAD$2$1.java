...
final class TTNativeExpressAdAdapter$loadAD$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ CancellableContinuation<ADEvent> f10597c;
    ...
    public TTNativeExpressAdAdapter$loadAD$2$1(TTNativeExpressAdAdapter tTNativeExpressAdAdapter, CancellableContinuation<? super ADEvent> cancellableContinuation, Continuation<? super TTNativeExpressAdAdapter$loadAD$2$1> continuation) {
        ...
        this.f10597c = cancellableContinuation;
    }

    @Override // kotlin.jvm.functions.Function2
    /* renamed from: a */
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((TTNativeExpressAdAdapter$loadAD$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f42314a);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TTNativeExpressAdAdapter$loadAD$2$1(this.b, this.f10597c, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.f10596a == 0) {
            ...
            final CancellableContinuation<ADEvent> cancellableContinuation = this.f10597c;
