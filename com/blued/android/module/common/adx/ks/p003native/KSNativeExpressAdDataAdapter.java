...
public final class KSNativeExpressAdDataAdapter extends NativeExpressADView implements ADEventListener {
    ...
    public static final void d(KSNativeExpressAdDataAdapter this$0) {
        ...
        if (layoutParams == null) {
            layoutParams2 = new ViewGroup.LayoutParams(this$0.a.getWidth(), this$0.a.getHeight());
        }
        if (view != null) {
    ...
    public void render() {
        ...
        if (aDListener != null) {
            aDListener.onADEvent(new ADEvent(109, this.c));
        }
