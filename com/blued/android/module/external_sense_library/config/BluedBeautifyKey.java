...
public interface BluedBeautifyKey {
    ...
    public enum KEY implements BluedBeautifyKey {
        ...
        ST_BEAUTIFY_3D_NARROW_NOSE_RATIO(11, 306),
        ST_BEAUTIFY_3D_NOSE_LENGTH_RATIO(12, 307),
        ST_BEAUTIFY_3D_CHIN_LENGTH_RATIO(13, 303),
        ST_BEAUTIFY_3D_MOUTH_SIZE_RATIO(14, 309),
        ST_BEAUTIFY_3D_PHILTRUM_LENGTH_RATIO(15, 310),
        ...
        ST_BEAUTIFY_3D_PROFILE_RHINOPLASTY_RATIO(21, 308),
