...
public class LiveViewerListView extends FrameLayout {
    ...
    public /* synthetic */ boolean a(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            return false;
        } else if (action == 1 && Math.abs(motionEvent.getX() - this.a) < 10.0f) {
            LiveOnlineUserDialogFragment.a.a(this.g);
            return true;
        } else {
            return false;
        }
    ...
    private void d() {
        ...
        this.d = inflate;
        RecyclerView findViewById = inflate.findViewById(R.id.live_viewer_listview);
        this.e = findViewById;
        findViewById.setLayoutManager(new LinearLayoutManager(this.b, 0, false));
    ...
    public void a(FragmentManager fragmentManager, boolean z) {
        ...
        this.e.setOnTouchListener(new View.OnTouchListener() { // from class: com.blued.android.module.live_china.view.-$$Lambda$LiveViewerListView$O3pcSE8Aw-aIE5it3lIsy9VbO-Y
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                boolean a;
                a = LiveViewerListView.this.a(view, motionEvent);
                return a;
            }
        });
    }
