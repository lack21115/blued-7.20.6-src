...
/* loaded from: source-5961304-dex2jar.jar:com/blued/android/module/live_china/view/WaveLoadingView.class */
public class WaveLoadingView extends View {

    /* renamed from: a  reason: collision with root package name */
    private static final int f15302a = Color.parseColor("#212121");
    private static final int b = Color.parseColor("#00000000");

    /* renamed from: c  reason: collision with root package name */
    private static final int f15303c = Color.parseColor("#212121");
    ...
    /* loaded from: source-5961304-dex2jar.jar:com/blued/android/module/live_china/view/WaveLoadingView$ShapeType.class */
    ...
    /* loaded from: source-5961304-dex2jar.jar:com/blued/android/module/live_china/view/WaveLoadingView$TriangleDirection.class */
    ...
    private void a(Context context, AttributeSet attributeSet, int i) {
        ...
        this.k = obtainStyledAttributes.getColor(R.styleable.WaveLoadingView_wlv_waveColor, f15302a);
        ...
        this.B.setColor(obtainStyledAttributes.getColor(R.styleable.WaveLoadingView_wlv_borderColor, f15302a));
        Paint paint4 = new Paint();
        this.C = paint4;
        paint4.setColor(obtainStyledAttributes.getColor(R.styleable.WaveLoadingView_wlv_titleTopColor, f15303c));
        ...
        this.E = paint6;
        paint6.setColor(obtainStyledAttributes.getColor(R.styleable.WaveLoadingView_wlv_titleCenterColor, f15303c));
        ...
        this.D = paint8;
        paint8.setColor(obtainStyledAttributes.getColor(R.styleable.WaveLoadingView_wlv_titleBottomColor, f15303c));
