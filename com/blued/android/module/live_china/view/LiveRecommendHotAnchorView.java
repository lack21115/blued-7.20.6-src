...
public final class LiveRecommendHotAnchorView extends FrameLayout {
    ...
    public LiveRecommendHotAnchorView(Context context, AttributeSet attributeSet, int i) {
        ...
        Intrinsics.e(context, "context");
        this.f14904a = LazyKt.a(new Function0<LayoutLiveHotRedBinding>() { // from class: com.blued.android.module.live_china.view.LiveRecommendHotAnchorView$binding$2
            ...
            public final LayoutLiveHotRedBinding invoke() {
                LayoutLiveHotRedBinding a2 = LayoutLiveHotRedBinding.a(LayoutInflater.from(LiveRecommendHotAnchorView.this.getContext()), LiveRecommendHotAnchorView.this, true);
    ...
    public final void a(int i) {
        ...
        if (i2 == 0) {
            ...
            ImageView flipperNext = binding.f12095a;
            Intrinsics.c(flipperNext, "flipperNext");
            a(flipperNext, 0.0f, 1.0f);
            ImageView flipperNext2 = binding.f12095a;
            ...
            binding.f12095a.setElevation(0.0f);
            ...
            ImageView flipperNext3 = binding.f12095a;
            ...
            a(flipperPre3);
            binding.f12095a.setElevation(10.0f);
            ...
            a(flipperShow4);
            ImageView flipperNext4 = binding.f12095a;
            ...
            binding.f12095a.setElevation(1.0f);
    ...
    public final LayoutLiveHotRedBinding getBinding() {
        return (LayoutLiveHotRedBinding) this.f14904a.getValue();
    }
