...
public final class LiveConstellationHonourKingView extends FrameLayout {
    ...
    public LiveConstellationHonourKingView(Context context, AttributeSet attributeSet, int i) {
        ...
        Intrinsics.e(context, "context");
        this.a = LazyKt.a(new Function0<LiveConstellationHonourKingViewBinding>() { // from class: com.blued.android.module.live_china.view.LiveConstellationHonourKingView$binding$2
            ...
            public final LiveConstellationHonourKingViewBinding invoke() {
                LiveConstellationHonourKingViewBinding a = LiveConstellationHonourKingViewBinding.a(LayoutInflater.from(LiveConstellationHonourKingView.this.getContext()), LiveConstellationHonourKingView.this, true);
    ...
    public final LiveConstellationHonourKingViewBinding getBinding() {
        return (LiveConstellationHonourKingViewBinding) this.a.getValue();
    }
    ...
    public final void setData(GiftConstellationHonourTopModel topModel) {
        ...
        ImageLoader.a((IRequestHost) null, topModel.getAnchor_avatar()).b(R.drawable.user_bg_round).c().a(getBinding().a);
        ...
        ImageLoader.a((IRequestHost) null, topModel.getAvatar()).b(R.drawable.user_bg_round).c().a(getBinding().c);
    }
}
