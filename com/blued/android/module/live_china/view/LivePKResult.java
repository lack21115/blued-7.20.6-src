...
public class LivePKResult extends FrameLayout implements View.OnClickListener {
    ...
    public LivePKResult(Context context, AttributeSet attributeSet) {
        ...
        this.e = new Runnable() { // from class: com.blued.android.module.live_china.view.LivePKResult.1
            ...
            public void run() {
                ...
                LivePKResult.this.f14795c.setAlpha(0.0f);
                ...
                LivePKResult.this.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.blued.android.module.live_china.view.LivePKResult.1.1
                    ...
                    public void onGlobalLayout() {
                        ...
                        int width = ((ViewGroup) LivePKResult.this.f14795c.getParent()).getWidth();
                        int height = ((ViewGroup) LivePKResult.this.f14795c.getParent()).getHeight();
                        int width2 = LivePKResult.this.f14795c.getWidth();
                        int height2 = LivePKResult.this.f14795c.getHeight();
                        float f = (width - width2) / 2;
                        LivePKResult.this.f14795c.setX(f);
                        float f2 = (height - height2) / 2;
                        LivePKResult.this.f14795c.setY(f2);
                        LivePKResult.this.d.setX(f);
                        LivePKResult.this.d.setY(f2);
                        LivePKResult.this.f14795c.setAlpha(1.0f);
                        LivePKResult.this.d.setAlpha(1.0f);
                        Log.i("xpm", "getX:" + LivePKResult.this.f14795c.getX() + "  getY:" + LivePKResult.this.f14795c.getY());
                        Log.i("xpm", "parentWidth:" + width + "  parentHeight:" + height);
                        if (LivePKResult.this.k == 0) {
                            LivePKResult.this.f14795c.setImageResource(R.drawable.live_pk_tie);
                            LivePKResult.this.d.setImageResource(R.drawable.live_pk_tie);
                        } else if (LivePKResult.this.k == LiveRoomManager.a().f()) {
                            LivePKResult.this.f14795c.setImageResource(R.drawable.live_pk_winner);
                            LivePKResult.this.d.setImageResource(R.drawable.live_pk_loser);
                        } else {
                            LivePKResult.this.f14795c.setImageResource(R.drawable.live_pk_loser);
    ...
    private void b() {
        ...
        this.f14794a = (ImageView) findViewById(R.id.iv_pk_left_bg);
        this.b = (ImageView) findViewById(R.id.iv_pk_right_bg);
        this.f14795c = (ImageView) findViewById(R.id.live_pk_my_result_icon);
    ...
    public void c() {
        this.f14795c.setScaleX(1.0f);
        this.f14795c.setScaleY(1.0f);
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.blued.android.module.live_china.view.LivePKResult.2
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                LivePKResult.this.f14795c.setScaleX(floatValue);
                LivePKResult.this.f14795c.setScaleY(floatValue);
    ...
    public void d() {
        ...
        if (j == 0) {
            ...
            this.f14794a.setImageResource(R.drawable.live_pk_winner_anim_bg);
            this.b.setVisibility(8);
            a(this.f14794a);
        } else {
            this.f14794a.setVisibility(8);
    ...
    public void e() {
        ...
        this.f14794a.setVisibility(8);
        this.b.setVisibility(8);
        final int width = ((ViewGroup) this.f14795c.getParent()).getWidth();
        final int height = ((ViewGroup) this.f14795c.getParent()).getHeight();
        final int x = (int) this.f14795c.getX();
        final int y = (int) this.f14795c.getY();
        final int x2 = (int) this.d.getX();
        final int y2 = (int) this.d.getY();
        final int a2 = DensityUtils.a(getContext(), 55.0f);
        final int a3 = DensityUtils.a(getContext(), 55.0f);
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.blued.android.module.live_china.view.LivePKResult.6
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                LivePKResult.this.f14795c.setX(x + ((DensityUtils.a(LivePKResult.this.getContext(), 10.0f) - x) * floatValue));
                ImageView imageView = LivePKResult.this.f14795c;
                int i5 = y;
                imageView.setY(i5 + ((((height - i3) - a3) - i5) * floatValue));
                LivePKResult.this.d.setX(x2 + ((((width - DensityUtils.a(LivePKResult.this.getContext(), 10.0f)) - a2) - x2) * floatValue));
                ImageView imageView2 = LivePKResult.this.d;
                int i6 = y2;
                imageView2.setY(i6 + ((((height - i4) - a3) - i6) * floatValue));
                float f = 1.5f - (floatValue * 0.5f);
                LivePKResult.this.f14795c.setScaleX(f);
                LivePKResult.this.f14795c.setScaleY(f);
