...
public class PkDaredFogView extends FrameLayout {
    ...
    public void c() {
        ...
        this.c.animate().alpha(0.0f).setDuration(200L).setStartDelay(0L).setInterpolator(accelerateInterpolator);
        this.a.animate().translationX(-this.a.getWidth()).setDuration(400L).setStartDelay(200L).setInterpolator(accelerateInterpolator);
    ...
    public /* synthetic */ void d() {
        ...
        this.c.animate().alpha(1.0f).setDuration(200L).setStartDelay(520L).setInterpolator(decelerateInterpolator);
        this.a.animate().translationX(0.0f).setDuration(600L).setStartDelay(200L).setInterpolator(decelerateInterpolator);
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [com.blued.android.module.live_china.view.pkdared.PkDaredFogView$1] */
    public void a(int i) {
        ...
        this.d = new CountDownTimer(i * 1000, 1000L) { // from class: com.blued.android.module.live_china.view.pkdared.PkDaredFogView.1
            ...
            public void onTick(long j) {
                PkDaredFogView.this.c.setText(String.format(PkDaredFogView.this.getContext().getResources().getString(R.string.live_pk_dared_fog_hide), Long.valueOf(Math.round(j / 1000.0d))));
            }
        }.start();
        setAlpha(0.0f);
        setVisibility(0);
    ...
    protected void a(Context context) {
        ...
        this.a = findViewById(R.id.iv_fog_left);
        this.b = findViewById(R.id.iv_fog_right);
        this.c = (TextView) findViewById(R.id.tv_fog_time);
    }
