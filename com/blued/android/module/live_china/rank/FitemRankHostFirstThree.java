...
public final class FitemRankHostFirstThree extends FreedomItem {
    ...
    public static final class ConstField {
        public static final ConstField a = new ConstField();
        private static String b = "https://web.bldimg.com/image-manager/1689832311_97803.webp";
        private static String c = "https://web.bldimg.com/image-manager/1689735948_31980.webp";
    ...
    public FitemRankHostFirstThree(ArrayList<RankAllDataModel> modelList, String str, int i) {
        ...
        this.f = Intrinsics.a((Object) this.c, (Object) "union");
    }
    ...
    private final void a(final Context context, BaseViewHolder baseViewHolder, final RankAllDataModel rankAllDataModel) {
        ...
        if (rankAllDataModel == null || rankAllDataModel.isFake()) {
            baseViewHolder.c(R.id.iv_first_one_avatar, this.e ? R.drawable.live_rank_union_defalut : R.drawable.live_rank_hour_default_avatar).a(R.id.iv_first_one_avatar_frame, ConstField.a.f()).a(R.id.iv_first_one_top, !this.f ? ConstField.a.b() : ConstField.a.c()).a(R.id.tv_first_one_name, R.string.live_rank_vacancy).a(R.id.tv_first_one_desc, "--").a(R.id.tv_first_one_name, true);
            baseViewHolder.a(R.id.ll_first_one_avatars_root).setVisibility(4);
            return;
        }
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.a = rankAllDataModel.getTop();
        boolean z = rankAllDataModel.is_hide() == 1;
        String name = z ? Intrinsics.a((Object) "fans", (Object) this.c) ? "用户暂时神隐" : "主播想静静" : rankAllDataModel.getName();
        if (z) {
            a = "火力值MAX";
        } else if (this.e) {
            a = Intrinsics.a("活跃值", (Object) Long.valueOf(rankAllDataModel.getScore()));
        } else {
            a = "领先" + ((Object) DistanceUtils.a(Long.valueOf(rankAllDataModel.getDiff_score()))) + "火力值";
        }
        String f = ConstField.a.f();
        if (this.e) {
            ...
            baseViewHolder.a(R.id.iv_first_one_avatar, !z ? rankAllDataModel.getAvatar() : ConstField.a.a(), R.drawable.live_rank_hour_default_avatar, true).a(R.id.iv_first_one_avatar_frame, f).a(R.id.tv_first_one_name, (CharSequence) name);
        }
        baseViewHolder.a(R.id.iv_first_one_top, !this.f ? ConstField.a.b() : ConstField.a.c()).a(R.id.tv_first_one_name, true).a(R.id.tv_first_one_desc, (CharSequence) a).a(R.id.iv_first_one_avatar0, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 1 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i()).a(R.id.iv_first_one_avatar1, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 2 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i()).a(R.id.iv_first_one_avatar2, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 3 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i());
        if (rankAllDataModel.getLid() <= 0 || z) {
            ...
            View a2 = baseViewHolder.a(R.id.iv_first_one_live_icon);
            if (a2 == null) {
                throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
            }
            g.a((ImageView) a2);
        }
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 1) {
            baseViewHolder.a(R.id.rl_first_living0).setVisibility(8);
        } else {
            baseViewHolder.a(R.id.rl_first_living0).setVisibility(0);
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).is_hide() != 0 || z) {
                ...
                View a3 = baseViewHolder.a(R.id.iv_first_one_bonus0);
                if (a3 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g2.a((ImageView) a3);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 2) {
            baseViewHolder.a(R.id.rl_first_living1).setVisibility(8);
        } else {
            baseViewHolder.a(R.id.rl_first_living1).setVisibility(0);
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).is_hide() != 0 || z) {
                ...
                View a4 = baseViewHolder.a(R.id.iv_first_one_bonus1);
                if (a4 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g3.a((ImageView) a4);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 3) {
            baseViewHolder.a(R.id.rl_first_living2).setVisibility(8);
        } else {
            baseViewHolder.a(R.id.rl_first_living2).setVisibility(0);
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).is_hide() != 0 || z) {
                ...
                View a5 = baseViewHolder.a(R.id.iv_first_one_bonus2);
                if (a5 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g4.a((ImageView) a5);
    ...
    public static final void a(Ref.ObjectRef top, FitemRankHostFirstThree this$0, Context context, boolean z, View view) {
        ...
        Intrinsics.e(this$0, "this$0");
        Intrinsics.e(context, "$context");
        if (top.a == 0 || ((ArrayList) top.a).size() < 1) {
            return;
        }
        this$0.a(context, ((RankTopDataModel) ((ArrayList) top.a).get(0)).is_hide() == 1, ((RankTopDataModel) ((ArrayList) top.a).get(0)).getLid(), String.valueOf(((RankTopDataModel) ((ArrayList) top.a).get(0)).getUid()), "", ((RankTopDataModel) ((ArrayList) top.a).get(0)).getAvatar(), z);
    }
    ...
    private final void b(final Context context, BaseViewHolder baseViewHolder, final RankAllDataModel rankAllDataModel) {
        String a;
        if (rankAllDataModel == null || rankAllDataModel.isFake()) {
            baseViewHolder.c(R.id.iv_first_two_avatar, this.e ? R.drawable.live_rank_union_defalut : R.drawable.live_rank_hour_default_avatar).a(R.id.iv_first_two_avatar_frame, ConstField.a.g()).a(R.id.iv_first_two_top, ConstField.a.d()).a(R.id.tv_first_two_name, R.string.live_rank_vacancy).a(R.id.tv_first_two_desc, "--").a(R.id.tv_first_two_name, true);
        ...
        if (z) {
            ...
            a = "距前一名" + ((Object) DistanceUtils.a(Long.valueOf(rankAllDataModel.getDiff_score()))) + "火力值";
        }
        String g = ConstField.a.g();
        if (this.e) {
            ...
            baseViewHolder.a(R.id.iv_first_two_avatar, !z ? rankAllDataModel.getAvatar() : ConstField.a.a(), R.drawable.live_rank_hour_default_avatar, true).a(R.id.iv_first_two_avatar_frame, g, true, -1).a(R.id.tv_first_two_name, (CharSequence) name);
        }
        baseViewHolder.a(R.id.iv_first_two_top, ConstField.a.d()).a(R.id.tv_first_two_desc, (CharSequence) a).a(R.id.tv_first_two_name, true).a(R.id.iv_first_two_avatar0, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 1 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i()).a(R.id.iv_first_two_avatar1, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 2 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i()).a(R.id.iv_first_two_avatar2, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 3 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i());
        if (rankAllDataModel.getLid() <= 0 || z) {
            ...
            View a2 = baseViewHolder.a(R.id.iv_first_two_live_icon);
            if (a2 == null) {
                throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
            }
            g2.a((ImageView) a2);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 1) {
            ...
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).is_hide() != 0 || z) {
                ...
                View a3 = baseViewHolder.a(R.id.iv_first_two_bonus0);
                if (a3 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g3.a((ImageView) a3);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 2) {
            ...
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).is_hide() != 0 || z) {
                ...
                View a4 = baseViewHolder.a(R.id.iv_first_two_bonus1);
                if (a4 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g4.a((ImageView) a4);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 3) {
            ...
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).is_hide() != 0 || z) {
                ...
                View a5 = baseViewHolder.a(R.id.iv_first_two_bonus2);
                if (a5 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g5.a((ImageView) a5);
    ...
    public static final void b(Ref.ObjectRef top, FitemRankHostFirstThree this$0, Context context, boolean z, View view) {
        ...
        Intrinsics.e(this$0, "this$0");
        Intrinsics.e(context, "$context");
        if (top.a == 0 || ((ArrayList) top.a).size() < 2) {
            return;
        }
        this$0.a(context, ((RankTopDataModel) ((ArrayList) top.a).get(1)).is_hide() == 1, ((RankTopDataModel) ((ArrayList) top.a).get(1)).getLid(), String.valueOf(((RankTopDataModel) ((ArrayList) top.a).get(1)).getUid()), "", ((RankTopDataModel) ((ArrayList) top.a).get(1)).getAvatar(), z);
    }
    ...
    private final void c(final Context context, BaseViewHolder baseViewHolder, final RankAllDataModel rankAllDataModel) {
        String a;
        if (rankAllDataModel == null || rankAllDataModel.isFake()) {
            baseViewHolder.c(R.id.iv_first_three_avatar, this.e ? R.drawable.live_rank_union_defalut : R.drawable.live_rank_hour_default_avatar).a(R.id.iv_first_three_avatar_frame, ConstField.a.h()).a(R.id.iv_first_three_top, ConstField.a.e()).a(R.id.tv_first_three_name, R.string.live_rank_vacancy).a(R.id.tv_first_three_desc, "--").a(R.id.tv_first_three_name, true);
        ...
        if (this.e) {
            ...
            baseViewHolder.a(R.id.iv_first_three_avatar, !z ? rankAllDataModel.getAvatar() : ConstField.a.a(), R.drawable.live_rank_hour_default_avatar, true).a(R.id.iv_first_three_avatar_frame, h, true, -1).a(R.id.tv_first_three_name, (CharSequence) name);
        }
        baseViewHolder.a(R.id.iv_first_three_top, ConstField.a.e()).a(R.id.tv_first_three_name, true).a(R.id.tv_first_three_desc, (CharSequence) a).a(R.id.tv_first_three_name, true).a(R.id.iv_first_three_avatar0, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 1 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i()).a(R.id.iv_first_three_avatar1, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 2 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i()).a(R.id.iv_first_three_avatar2, (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 3 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).is_hide() != 0 || z) ? ConstField.a.a() : ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).getAvatar(), R.drawable.live_rank_hour_default_avatar, true, 1.0f, -1, ConstField.a.i());
        if (rankAllDataModel.getLid() <= 0 || z) {
            ...
            View a2 = baseViewHolder.a(R.id.iv_first_three_live_icon);
            if (a2 == null) {
                throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
            }
            g.a((ImageView) a2);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 1) {
            ...
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(0)).is_hide() != 0 || z) {
                ...
                View a3 = baseViewHolder.a(R.id.iv_first_three_bonus0);
                if (a3 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g2.a((ImageView) a3);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 2) {
            ...
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(1)).is_hide() != 0 || z) {
                ...
                View a4 = baseViewHolder.a(R.id.iv_first_three_bonus1);
                if (a4 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g3.a((ImageView) a4);
        ...
        if (objectRef.a == 0 || ((ArrayList) objectRef.a).size() < 3) {
            ...
            if (((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).getLid() == 0 || ((RankTopDataModel) ((ArrayList) objectRef.a).get(2)).is_hide() != 0 || z) {
                ...
                View a5 = baseViewHolder.a(R.id.iv_first_three_bonus2);
                if (a5 == null) {
                    throw new NullPointerException("null cannot be cast to non-null type android.widget.ImageView");
                }
                g4.a((ImageView) a5);
    ...
    public static final void c(Ref.ObjectRef top, FitemRankHostFirstThree this$0, Context context, boolean z, View view) {
        ...
        Intrinsics.e(this$0, "this$0");
        Intrinsics.e(context, "$context");
        if (top.a == 0 || ((ArrayList) top.a).size() < 3) {
            return;
        }
        this$0.a(context, ((RankTopDataModel) ((ArrayList) top.a).get(2)).is_hide() == 1, ((RankTopDataModel) ((ArrayList) top.a).get(2)).getLid(), String.valueOf(((RankTopDataModel) ((ArrayList) top.a).get(2)).getUid()), "", ((RankTopDataModel) ((ArrayList) top.a).get(2)).getAvatar(), z);
    }
