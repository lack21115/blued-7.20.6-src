...
public class CommonShowBottomWindow {
    public static ActionSheet a(FragmentActivity fragmentActivity, String[] strArr, String str, ActionSheet.ActionSheetListener actionSheetListener) {
        return ActionSheet.a((Context) fragmentActivity, fragmentActivity.getFragmentManager()).a(fragmentActivity.getResources().getString(R.string.biao_v4_cancel)).a(strArr).b(str).a(true).a(actionSheetListener).b();
    }
}
