...
public class LiveFansRecordMemberFragment extends MvpFragment<LiveFansRecordMemberPresent> implements View.OnClickListener {
    ...
    private void c() {
        this.a = this.i.findViewById(R.id.rl_list_title);
        ...
        j().a(this.o);
        this.b.c(false);
        this.b.a(new SimpleMultiPurposeListener() { // from class: com.blued.android.module.live_china.fragment.LiveFansRecordMemberFragment.1
        ...
        liveFansRecordMemberAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() { // from class: com.blued.android.module.live_china.fragment.LiveFansRecordMemberFragment.3
            public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                if (LiveFansRecordMemberFragment.this.getParentFragment() instanceof LiveFansRecordDialogFragment) {
                    LiveFansRecordMemberFragment.this.getParentFragment().dismiss();
                }
                LiveFansMemberModel a = LiveFansRecordMemberFragment.this.m.a(i2);
                if (a != null) {
                    if (LiveFansRecordMemberFragment.this.o == 0) {
                        EventTrackLive.a(LiveProtos.Event.FANS_CLUB_PAGE_ACTIVE_LIST_USER_CLICK, String.valueOf(LiveFansRecordMemberFragment.this.p), a.uid);
                    } else if (LiveFansRecordMemberFragment.this.o == 1) {
                        EventTrackLive.a(LiveProtos.Event.FANS_CLUB_PAGE_TODAY_LIST_USER_CLICK, String.valueOf(LiveFansRecordMemberFragment.this.p), a.uid);
                    } else if (LiveFansRecordMemberFragment.this.o == 2) {
                        EventTrackLive.a(LiveProtos.Event.FANS_CLUB_PAGE_ALL_LIST_USER_CLICK, String.valueOf(LiveFansRecordMemberFragment.this.p), a.uid);
                    }
