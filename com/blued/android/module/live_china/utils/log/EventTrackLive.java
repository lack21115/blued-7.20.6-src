...
public class EventTrackLive {
    ...
    public static void a(LiveProtos.Event event, String str, String str2, String str3, String str4) {
        if (event != null) {
            EventTrackUtils.a(LiveProtos.LiveProto.newBuilder().setEvent(event).setTargetUid(a(str2)).setLiveId(a(str)).setId(a(str3)).setGoodsId(a(str4)).build());
        }
    }

    public static void a(LiveProtos.Event event, String str, String str2, String str3, boolean z, boolean z2) {
        if (event != null) {
            EventTrackUtils.a(LiveProtos.LiveProto.newBuilder().setEvent(event).setTargetUid(a(str2)).setLiveId(a(str)).setType(a(str3)).setIsTrue(z).setIsSuccess(z2).build());
        }
    }

    public static void b(LiveProtos.Event event, String str, String str2, String str3) {
        if (event != null) {
            EventTrackUtils.a(LiveProtos.LiveProto.newBuilder().setEvent(event).setTargetUid(a(str2)).setLiveId(a(str)).setId(a(str3)).build());
        }
    }

    public static void c(LiveProtos.Event event, String str, String str2, String str3) {
        if (event != null) {
            EventTrackUtils.a(LiveProtos.LiveProto.newBuilder().setEvent(event).setTargetUid(a(str2)).setLiveId(a(str)).setType(a(str3)).build());
        }
    }
}
