...
public class LiveFansPrivilegeAdapater extends BaseQuickAdapter<LiveFansPrivilegeModel, BaseViewHolder> {
    ...
    public List<LiveFansPrivilegeModel> a() {
        ...
        LiveFansPrivilegeModel liveFansPrivilegeModel = new LiveFansPrivilegeModel(this.a.getString(R.string.live_fans_privilege_one), this.a.getString(R.string.live_fans_privilege_one_tip), R.drawable.live_privilege_one);
        ...
        LiveFansPrivilegeModel liveFansPrivilegeModel4 = new LiveFansPrivilegeModel(this.a.getString(R.string.live_fans_privilege_four), String.format(this.a.getString(R.string.live_fans_privilege_open_level), 6), R.drawable.live_privilege_four);
        LiveFansPrivilegeModel liveFansPrivilegeModel5 = new LiveFansPrivilegeModel(this.a.getString(R.string.live_fans_privilege_five), String.format(this.a.getString(R.string.live_fans_privilege_open_level), 16), R.drawable.live_privilege_five);
        LiveFansPrivilegeModel liveFansPrivilegeModel6 = new LiveFansPrivilegeModel(this.a.getString(R.string.live_fans_privilege_six), String.format(this.a.getString(R.string.live_fans_privilege_open_level), 26), R.drawable.live_privilege_six);
    ...
    public void convert(BaseViewHolder baseViewHolder, LiveFansPrivilegeModel liveFansPrivilegeModel) {
        if (this.b == 0) {
            baseViewHolder.getView(R.id.fl_view).setPadding(0, 0, 0, DensityUtils.a(this.a, 20.0f));
        } else {
            baseViewHolder.getView(R.id.fl_view).setPadding(0, 0, 0, DensityUtils.a(this.a, 10.0f));
        }
