...
public final class LiveMultiConnectionItemViewBinding implements ViewBinding {
    ...
    public final ShapeFrameLayout f12287a;
    public final ShapeFrameLayout b;

    /* renamed from: c  reason: collision with root package name */
    public final ImageView f12288c;
                            ...
                            if (imageView4 != null) {
                                ...
                                if (imageView5 != null) {
                                    ...
                                    if (imageView6 != null) {
                                        ...
                                        if (imageView7 != null) {
                                            CardView cardView = (CardView) view.findViewById(R.id.sl_pk_stream);
                                            if (cardView != null) {
                                                                    ...
                                                                    if (textView2 != null) {
                                                                        ...
                                                                        if (textView3 != null) {
                                                                            ...
                                                                            if (textView4 != null) {
                                                                                ...
                                                                                if (textView5 != null) {
                                                                                    return new LiveMultiConnectionItemViewBinding((FrameLayout) view, shapeFrameLayout, shapeFrameLayout2, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, cardView, shapeLinearLayout, shapeLinearLayout2, shapeTextView, shapeFrameLayout3, textView, textView2, textView3, textView4, textView5);
                                                                                }
                                                                                str = "tvPlusRightCopy";
                                                                            } else {
                                                                                str = "tvPlusRight";
