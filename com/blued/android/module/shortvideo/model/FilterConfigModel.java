    ...
    public List<FilterItem> getFilters() {
        ...
        if (this.mFilterNameMap.size() <= 0) {
            ...
            while (true) {
                ...
                if (next != null) {
                    int i2 = AnonymousClass1.a[next.ordinal()];
                    char c = i2 != 1 ? i2 != 2 ? i2 != 3 ? i2 != 4 ? (char) 4 : (char) 3 : (char) 2 : (char) 1 : (char) 0;
                    filterItemArr[c] = new FilterItem(next, this.mFilterIconRsIds[c], this.mFilterShowNameRsIds[c]);
                }
            }
            for (i = 0; i < 5; i++) {
