...
public class StvRoundImageView extends AppCompatImageView {
    ...
    private void a(Context context, AttributeSet attributeSet, int i) {
        ...
        this.b = i2;
        this.f15939c = obtainStyledAttributes.hasValue(R.styleable.StvRoundImageView_stv_round_v_radius) ? obtainStyledAttributes.getDimensionPixelSize(R.styleable.StvRoundImageView_stv_round_v_radius, this.f15939c) : this.f15939c;
    ...
    public void onDraw(Canvas canvas) {
        ...
        int i = this.b;
        if (i == 1) {
            this.f15938a.setShader(new BitmapShader(a(drawable), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP));
            canvas.drawCircle(getWidth() / 2, getHeight() / 2, getWidth() / 2, this.f15938a);
        } else if (i == 2) {
            this.f15938a.setShader(new BitmapShader(a(drawable), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP));
            RectF rectF = new RectF(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getHeight() - getPaddingBottom());
            int i2 = this.f15939c;
            canvas.drawRoundRect(rectF, i2, i2, this.f15938a);
        } else {
            if (imageMatrix != null) {
                canvas.concat(imageMatrix);
            }
