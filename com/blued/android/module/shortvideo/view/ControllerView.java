...
public class ControllerView extends FrameLayout implements View.OnClickListener, EventObserver, ReturnObserver {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                a[EventType.VALUE.RECOVER_SHINE_V.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                a[EventType.VALUE.SHINE_RECORD.ordinal()] = 4;
            ...
            try {
                a[EventType.VALUE.CONCAT_SECTION_FINISH.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                a[EventType.VALUE.SHINE_ENDRECORD.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                a[EventType.VALUE.DELECT_LAST_SECOTION.ordinal()] = 8;
