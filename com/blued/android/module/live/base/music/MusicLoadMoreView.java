...
public class MusicLoadMoreView extends InternalClassics implements RefreshFooter {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f11433a[RefreshState.PullUpToLoad.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f11433a[RefreshState.Loading.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f11433a[RefreshState.LoadReleased.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f11433a[RefreshState.ReleaseToLoad.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f11433a[RefreshState.Refreshing.ordinal()] = 6;
    ...
    public void a(RefreshLayout refreshLayout, RefreshState refreshState, RefreshState refreshState2) {
        ...
        switch (AnonymousClass1.f11433a[refreshState2.ordinal()]) {
            case 1:
                this.b.setVisibility(0);
                break;
            case 2:
