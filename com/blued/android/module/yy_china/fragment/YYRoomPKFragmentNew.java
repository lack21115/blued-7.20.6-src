...
public final class YYRoomPKFragmentNew extends YYRoomPKFragment {
    ...
    public final class PKAdapterNew extends FragmentPagerAdapter {
        final /* synthetic */ YYRoomPKFragmentNew a;
    ...
    public void g() {
        ...
        PagerAdapter pKAdapterNew = new PKAdapterNew(this);
        FragmentYyRoomPkLayoutBinding f = f();
        ViewPager viewPager = f == null ? null : f.c;
        if (viewPager != null) {
        ...
        if (f2 != null && (tabPageIndicatorWithDot = f2.d) != null) {
            ...
            tabPageIndicatorWithDot.setViewPager(f3 == null ? null : f3.c);
        }
        FragmentYyRoomPkLayoutBinding f4 = f();
        ViewPager viewPager2 = f4 == null ? null : f4.c;
        if (viewPager2 != null) {
            viewPager2.setCurrentItem(0);
        }
        FragmentYyRoomPkLayoutBinding f5 = f();
        ViewPager viewPager3 = f5 == null ? null : f5.c;
        if (viewPager3 != null) {
