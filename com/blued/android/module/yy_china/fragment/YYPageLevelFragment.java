...
public class YYPageLevelFragment extends BaseFragment {
    ...
    private FragmentPageLevelLayoutBinding f17367a;
    private Ada b;

    /* renamed from: c  reason: collision with root package name */
    private int f17368c = 1;
    ...
    public static final class Ada extends BaseQuickAdapter<YyPkRecordListModel, BaseViewHolder> {
        ...
        /* renamed from: a  reason: collision with root package name */
        private SimpleDateFormat f17369a;

        public Ada() {
            super(R.layout.item_page_level, new ArrayList());
            this.f17369a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        }
        ...
        public void convert(BaseViewHolder baseViewHolder, YyPkRecordListModel yyPkRecordListModel) {
            ...
            Intrinsics.a(view);
            ItemPageLevelBinding a2 = ItemPageLevelBinding.a(view);
            Intrinsics.c(a2, "bind(helper?.itemView!!)");
            a2.f16638a.setText(yyPkRecordListModel == null ? null : yyPkRecordListModel.getName());
            TextView textView = a2.f16639c;
            SimpleDateFormat simpleDateFormat = this.f17369a;
            ...
            a2.b.setText(yyPkRecordListModel.getScore());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void a(YyPkLevelListModel yyPkLevelListModel) {
        FragmentPageLevelLayoutBinding fragmentPageLevelLayoutBinding = this.f17367a;
        ...
        FragmentPageLevelLayoutBinding fragmentPageLevelLayoutBinding2 = this.f17367a;
        ...
        FragmentPageLevelLayoutBinding fragmentPageLevelLayoutBinding3 = this.f17367a;
        ...
        FragmentPageLevelLayoutBinding fragmentPageLevelLayoutBinding4 = this.f17367a;
        ...
        FragmentPageLevelLayoutBinding fragmentPageLevelLayoutBinding5 = this.f17367a;
        ...
        ImageLoader.a(getFragmentActive(), yyPkLevelListModel.getLevel_img()).a(new CustomTarget<Drawable>() { // from class: com.blued.android.module.yy_china.fragment.YYPageLevelFragment$refreshPKLevelUI$1
            ...
            public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                ...
                fragmentPageLevelLayoutBinding6 = YYPageLevelFragment.this.f17367a;
                if (fragmentPageLevelLayoutBinding6 == null || (constraintLayout = fragmentPageLevelLayoutBinding6.f16483a) == null) {
                    return;
                }
        ...
        if (fragmentPageLevelLayoutBinding != null && (smartRefreshLayout2 = fragmentPageLevelLayoutBinding.g) != null) {
            smartRefreshLayout2.a(new OnRefreshLoadMoreListener() { // from class: com.blued.android.module.yy_china.fragment.YYPageLevelFragment$initView$1
                ...
                public void onRefresh(RefreshLayout refreshLayout) {
                    Intrinsics.e(refreshLayout, "refreshLayout");
                    YYPageLevelFragment.this.f17368c = 1;
                    YYPageLevelFragment.this.d();
                }
            });
        }
    ...
    public void d() {
        ...
        YYRoomHttpUtils.c(b.room_id, String.valueOf(this.f17368c), (BluedUIHttpResponse) e(), getFragmentActive());
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.f17367a = FragmentPageLevelLayoutBinding.a(getLayoutInflater(), viewGroup, true);
        f();
        FragmentPageLevelLayoutBinding fragmentPageLevelLayoutBinding = this.f17367a;
