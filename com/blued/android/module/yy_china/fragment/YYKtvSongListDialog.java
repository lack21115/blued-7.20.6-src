...
public final class YYKtvSongListDialog extends BaseFullScreenDialog {
    private FragmentYyKtvSongListBinding a;
    ...
    public final class SongAdapter extends BaseQuickAdapter<YYKtvOrderedMusicModel, BaseViewHolder> {
        final /* synthetic */ YYKtvSongListDialog a;
        ...
        private final void a() {
            ...
            final YYKtvSongListDialog yYKtvSongListDialog = this.a;
            String str = b.room_id;
            final ActivityFragmentActive a = yYKtvSongListDialog.a();
            YYRoomHttpUtils.v(str, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntityA<YYKtvOrderedMusicModel>>(a) { // from class: com.blued.android.module.yy_china.fragment.YYKtvSongListDialog$SongAdapter$toWinSinger$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(a);
                }
        ...
        public void convert(BaseViewHolder baseViewHolder, final YYKtvOrderedMusicModel yYKtvOrderedMusicModel) {
            ...
            ShapeableImageView view = baseViewHolder == null ? null : baseViewHolder.getView(R.id.iv_singer_header);
            ...
            ImageLoader.a(yYKtvSongListDialog.a(), yYKtvOrderedMusicModel.avatar).b(R.drawable.user_bg_round).a((ImageView) view);
            if (textView3 != null) {
            ...
            if (imageView != null) {
                imageView.setOnClickListener(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.fragment.-$$Lambda$YYKtvSongListDialog$SongAdapter$9wNtN9PbMEU2hSH3lk4BhQ8ux8o
                    ...
                    public final void onClick(View view2) {
                        YYKtvSongListDialog.SongAdapter.a(YYKtvSongListDialog.SongAdapter.this, yYKtvOrderedMusicModel, view2);
                    }
                });
            }
            if (shapeTextView == null) {
            ...
            shapeTextView.setOnClickListener(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.fragment.-$$Lambda$YYKtvSongListDialog$SongAdapter$r1Ndcc3XmwZ1SpVD7hgyVEas4tI
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    YYKtvSongListDialog.SongAdapter.a(YYKtvSongListDialog.this, yYKtvOrderedMusicModel, view2);
                }
            });
        }
    }
    ...
    private final void f() {
        ...
        FragmentYyKtvSongListBinding fragmentYyKtvSongListBinding = this.a;
        ...
        FragmentYyKtvSongListBinding fragmentYyKtvSongListBinding2 = this.a;
        RecyclerView recyclerView2 = fragmentYyKtvSongListBinding2 == null ? null : fragmentYyKtvSongListBinding2.b;
        if (recyclerView2 != null) {
            recyclerView2.setAdapter(this.b);
        }
        FragmentYyKtvSongListBinding fragmentYyKtvSongListBinding3 = this.a;
        if (fragmentYyKtvSongListBinding3 == null || (view = fragmentYyKtvSongListBinding3.a) == null) {
            return;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.a = FragmentYyKtvSongListBinding.a(inflate);
        f();
        return inflate;
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        YYRoomHttpUtils.j(str, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntityA<YYKtvOrderedMusicModel>>(a) { // from class: com.blued.android.module.yy_china.fragment.YYKtvSongListDialog$onViewCreated$1$1
            /* JADX INFO: Access modifiers changed from: protected */
            /* JADX WARN: Code restructure failed: missing block: B:11:0x0017, code lost:
                r0 = r3.a.b;
             */
