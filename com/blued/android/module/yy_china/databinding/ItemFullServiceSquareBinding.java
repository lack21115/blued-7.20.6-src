                                ...
                                if (yYLivingStreamView2 != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (shapeTextView != null) {
                                            return new ItemFullServiceSquareBinding((FrameLayout) view, findViewById, imageView, imageView2, imageView3, imageView4, yYLivingStreamView, yYLivingStreamView2, textView, shapeTextView);
                                        }
                                        str = "tvBgAllgift";
                                    } else {
                                        str = "tvAllgiftInfo";
