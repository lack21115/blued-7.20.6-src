                                ...
                                if (findViewById3 != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (textView4 != null) {
                                                return new DialogYyMatchingLayoutBinding((FrameLayout) view, textView, findViewById, hollowView, hollowView2, imageView, findViewById2, findViewById3, textView2, textView3, textView4);
                                            }
                                            str = "tvPlayerRight";
                                        } else {
                                            str = "tvPlayerLeft";
