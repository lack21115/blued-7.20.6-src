...
public final class ItemYyRelationRankTopBinding implements ViewBinding {
    ...
    public final YYLivingStreamView k;
    public final YYLivingStreamView l;
    public final YYLivingStreamView m;
    ...
    private ItemYyRelationRankTopBinding(ConstraintLayout constraintLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, ShapeableImageView shapeableImageView, ShapeableImageView shapeableImageView2, ShapeableImageView shapeableImageView3, ShapeableImageView shapeableImageView4, ShapeableImageView shapeableImageView5, ShapeableImageView shapeableImageView6, YYLivingStreamView yYLivingStreamView, YYLivingStreamView yYLivingStreamView2, YYLivingStreamView yYLivingStreamView3, YYLivingStreamView yYLivingStreamView4, YYLivingStreamView yYLivingStreamView5, YYLivingStreamView yYLivingStreamView6, Group group, Group group2, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8) {
        ...
        this.j = yYLivingStreamView;
        this.k = yYLivingStreamView2;
        this.l = yYLivingStreamView3;
        this.m = yYLivingStreamView4;
        this.n = yYLivingStreamView5;
        this.o = yYLivingStreamView6;
        this.p = group;
        this.q = group2;
        this.r = textView;
        this.s = textView2;
    ...
    public static ItemYyRelationRankTopBinding a(View view) {
        String str;
        ImageView imageView = (ImageView) view.findViewById(R.id.bg_top_1);
        if (imageView != null) {
            ImageView imageView2 = (ImageView) view.findViewById(R.id.bg_top_2);
            if (imageView2 != null) {
                                        ...
                                        if (findViewById6 != null) {
                                            ...
                                            if (yYLivingStreamView != null) {
                                                ...
                                                if (yYLivingStreamView2 != null) {
                                                    YYLivingStreamView yYLivingStreamView3 = (YYLivingStreamView) view.findViewById(R.id.live_top_2_1);
                                                    if (yYLivingStreamView3 != null) {
                                                        YYLivingStreamView yYLivingStreamView4 = (YYLivingStreamView) view.findViewById(R.id.live_top_2_2);
                                                        if (yYLivingStreamView4 != null) {
                                                            YYLivingStreamView yYLivingStreamView5 = (YYLivingStreamView) view.findViewById(R.id.live_top_3_1);
                                                                    ...
                                                                    if (findViewById7 != null) {
                                                                        ...
                                                                        if (findViewById8 != null) {
                                                                            ...
                                                                            if (textView != null) {
                                                                                ...
                                                                                if (textView2 != null) {
                                                                                    TextView textView3 = (TextView) view.findViewById(R.id.tv_top_2_type_name);
                                                                                    if (textView3 != null) {
                                                                                        TextView textView4 = (TextView) view.findViewById(R.id.tv_top_2_type_value);
                                                                                        if (textView4 != null) {
                                                                                            TextView textView5 = (TextView) view.findViewById(R.id.tv_top_2_value_title);
                                                                                            if (textView5 != null) {
                                                                                                TextView textView6 = (TextView) view.findViewById(R.id.tv_top_3_type_name);
                                                                                                if (textView6 != null) {
                                                                                                    TextView textView7 = (TextView) view.findViewById(R.id.tv_top_3_type_value);
                                                                                                    if (textView7 != null) {
