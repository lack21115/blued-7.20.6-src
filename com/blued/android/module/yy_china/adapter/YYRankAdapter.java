...
public class YYRankAdapter extends BaseMultiItemQuickAdapter<YYRankModel, BaseViewHolder> {
    ...
    private void a(YYRankModel yYRankModel, TextView textView, ImageView imageView) {
        ...
        YYRoomInfoManager.e().b(this.f16212a, imageView, yYRankModel.uid, yYRankModel.avatar);
    }

    private void a(BaseViewHolder baseViewHolder, List<YYRankModel> list) {
        ConstraintLayout constraintLayout = (ConstraintLayout) baseViewHolder.getView(R.id.ll_no1_view);
        ...
        ConstraintLayout constraintLayout2 = (ConstraintLayout) baseViewHolder.getView(R.id.ll_no2_view);
        ...
        ConstraintLayout constraintLayout3 = (ConstraintLayout) baseViewHolder.getView(R.id.ll_no3_view);
