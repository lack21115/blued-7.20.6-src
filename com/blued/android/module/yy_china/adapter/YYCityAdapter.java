...
public final class YYCityAdapter extends BaseQuickAdapter<YYRomanticCityModel, BaseViewHolder> {
    ...
    public void convert(BaseViewHolder baseViewHolder, YYRomanticCityModel yYRomanticCityModel) {
        ...
        ShapeableImageView view = baseViewHolder == null ? null : baseViewHolder.getView(R.id.img_user_head);
        ...
        ImageLoader.a(a(), yYRomanticCityModel.getSend_user_avatar()).b(R.drawable.user_bg_round).a((ImageView) view);
    }
}
