...
public class YYConnectingGameAdapter extends BaseConnectingAdapter<YYSeatMemberModel, BaseViewHolder> implements SeatChangedObserver {
    ...
    public void a(View view, YYSeatMemberModel yYSeatMemberModel, int i) {
        ...
        textView3.setText(a2 > 0.0d ? CommonStringUtils.b(a2) : "");
        ...
        yYBaseUserHeadView.a(yYSeatMemberModel, this.f16169a.getFragmentActive());
    }

    @Override // com.blued.android.module.yy_china.observer.SeatChangedObserver
    public void a(final int i, final int i2) {
        this.f16169a.postSafeRunOnUiThread(new Runnable() { // from class: com.blued.android.module.yy_china.adapter.YYConnectingGameAdapter.2
            ...
            public void run() {
                ...
                if (yYBaseUserHeadView != null) {
                    yYBaseUserHeadView.a(yYSeatMemberModel, YYConnectingGameAdapter.this.f16169a.getFragmentActive());
                }
            }
        });
    }
    ...
    public void a(int i, String str, String str2, YYImModel yYImModel) {
        ...
        yYBaseUserHeadView.a(this.f16169a.getFragmentActive(), str, str2, yYImModel);
    }
    ...
    public void b(final List<YYSeatMemberModel> list) {
        this.f16169a.postSafeRunOnUiThread(new Runnable() { // from class: com.blued.android.module.yy_china.adapter.YYConnectingGameAdapter.1
            @Override // java.lang.Runnable
            public void run() {
                if (list == null) {
                    return;
