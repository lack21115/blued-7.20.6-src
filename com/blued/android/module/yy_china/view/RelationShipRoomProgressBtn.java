...
public final class RelationShipRoomProgressBtn extends View {
    ...
    public final void a(IRequestHost re, String img, int i, int i2, String color1, String color2, String color3) {
        ...
        this.d = i;
        this.e = i2;
        this.a.setColor(Color.parseColor(color1));
        this.f = color2;
        this.g = color3;
        invalidate();
        ImageLoader.a(re, img).a((Target) new SimpleTarget<Drawable>() { // from class: com.blued.android.module.yy_china.view.RelationShipRoomProgressBtn$setDa$1
            /* renamed from: a */
            public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                Intrinsics.e(resource, "resource");
                if (resource instanceof BitmapDrawable) {
                    RelationShipRoomProgressBtn.this.c = ((BitmapDrawable) resource).getBitmap();
    ...
    public void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.d >= 0) {
            float measuredHeight = (getMeasuredHeight() - (2 * this.a.getStrokeWidth())) * 0.8f;
            ...
            RectF rectF = new RectF(this.a.getStrokeWidth() + 0.0f, this.a.getStrokeWidth() + 0.0f, getMeasuredHeight() - this.a.getStrokeWidth(), getMeasuredHeight() - this.a.getStrokeWidth());
            if (canvas != null) {
