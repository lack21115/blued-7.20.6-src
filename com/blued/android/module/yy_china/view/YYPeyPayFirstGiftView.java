...
public class YYPeyPayFirstGiftView extends CommonDialogFragment implements View.OnClickListener {
    ...
    public void a(View view) {
        DialogPrePayFirstgiftBinding a = DialogPrePayFirstgiftBinding.a(view);
        this.b = a;
        ...
        if (yYPerFirstGiftModel2 != null && yYPerFirstGiftModel2.getGift_list() != null && this.c != null) {
            if (this.d.getGift_list().size() > 0) {
                GiftListDTOModel giftListDTOModel = this.d.getGift_list().get(0);
                ImageLoader.a(this.c.getFragmentActive(), giftListDTOModel.getPic()).a(this.b.a);
            ...
            if (this.d.getGift_list().size() > 1) {
                ...
                ImageLoader.a(this.c.getFragmentActive(), giftListDTOModel2.getPic()).a(this.b.b);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() != R.id.tv_pre_pay || this.c == null || (onClickListener = this.e) == null) {
            return;
        }
