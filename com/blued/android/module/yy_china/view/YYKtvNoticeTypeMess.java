...
public final class YYKtvNoticeTypeMess extends BaseFullScreenDialog {
    ...
    private ViewKtvNoticeTypeMessBinding f18277a;
    private boolean b;

    /* renamed from: c  reason: collision with root package name */
    private BaseYYStudioFragment f18278c;
    private String d = "";
    private String e = "";
    ...
    public static final void b(YYKtvNoticeTypeMess this$0, View view) {
        Intrinsics.e(this$0, "this$0");
        BaseYYStudioFragment baseYYStudioFragment = this$0.f18278c;
    ...
    private final void i() {
        if (this.b) {
            ...
            ShapeTextView shapeTextView = f().f16866c;
            Context context2 = getContext();
            shapeTextView.setText(context2 == null ? null : context2.getString(R.string.yy_ktv_notice_type_btn_send_gift));
            f().f16866c.setOnClickListener(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.view.-$$Lambda$YYKtvNoticeTypeMess$IMc6Bv8AiURUChJQj9KMxJVhals
            ...
            ShapeTextView shapeTextView2 = f().f16866c;
            Context context4 = getContext();
            shapeTextView2.setText(context4 == null ? null : context4.getString(R.string.yy_ktv_notice_type_btn_up_mic));
            f().f16866c.setOnClickListener(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.view.-$$Lambda$YYKtvNoticeTypeMess$yUUI7NQ5FCFgSF5SBe35LdqeKYI
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public final ViewKtvNoticeTypeMessBinding f() {
        ViewKtvNoticeTypeMessBinding viewKtvNoticeTypeMessBinding = this.f18277a;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.f18277a = ViewKtvNoticeTypeMessBinding.a(inflater.inflate(R.layout.view_ktv_notice_type_mess, viewGroup, true));
        f().f16865a.setOnClickListener(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.view.-$$Lambda$YYKtvNoticeTypeMess$UsaJU05_H2DM6liA4xvk3qzkZnw
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
