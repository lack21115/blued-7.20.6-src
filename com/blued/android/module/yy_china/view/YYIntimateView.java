...
public class YYIntimateView extends FrameLayout {
    ...
    private void a() {
        ...
        this.a = (LiveAnimationView) findViewById(R.id.apng_animation_layout);
    }

    public void a(final BaseYYStudioFragment baseYYStudioFragment, final String str) {
        this.a.postDelayed(new Runnable() { // from class: com.blued.android.module.yy_china.view.YYIntimateView.1
            @Override // java.lang.Runnable
            public void run() {
                YYIntimateView.this.a.a(baseYYStudioFragment.getFragmentActive(), "", "", str, "", LiveAnimationViewFactory.ScaleType.FIT_BOTTOM, new AnimationListenerAdapter() { // from class: com.blued.android.module.yy_china.view.YYIntimateView.1.1
