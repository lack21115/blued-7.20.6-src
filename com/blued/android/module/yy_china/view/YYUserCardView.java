...
public abstract class YYUserCardView extends RelativeLayout implements View.OnClickListener, FollowStatusObserver {
    private final DialogUserCardLayoutBinding a;
    ...
    public YYUserCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        Intrinsics.e(context, "context");
        DialogUserCardLayoutBinding a = DialogUserCardLayoutBinding.a(LayoutInflater.from(getContext()), this, true);
        Intrinsics.c(a, "inflate(LayoutInflater.from(context), this, true)");
        this.a = a;
        this.c = new int[]{R.color.color_897369, R.color.color_747FB3, R.color.color_5D7D98, R.color.color_4B78B2, R.color.color_6340C1, R.color.color_8C40C1};
        ...
        ShapeLinearLayout shapeLinearLayout = this.a.E;
        Intrinsics.c(shapeLinearLayout, "binding.llInfo");
        a(shapeLinearLayout);
        YYUserCardView yYUserCardView = this;
        this.a.z.setOnClickListener(yYUserCardView);
        this.a.P.setOnClickListener(yYUserCardView);
        this.a.b.setOnClickListener(yYUserCardView);
        this.a.y.setOnClickListener(yYUserCardView);
        this.a.c.setOnClickListener(yYUserCardView);
        this.a.ac.setOnClickListener(yYUserCardView);
        this.a.J.setOnClickListener(yYUserCardView);
        this.a.L.setOnClickListener(yYUserCardView);
        this.a.K.setOnClickListener(yYUserCardView);
        this.a.H.setOnClickListener(yYUserCardView);
        this.a.M.setOnClickListener(yYUserCardView);
        this.a.I.setOnClickListener(yYUserCardView);
        this.a.N.setOnClickListener(yYUserCardView);
        ...
        if (yYGiftGottenModel != null && !yYGiftGottenModel.goods.isEmpty()) {
            ...
            while (true) {
                ...
                if (i2 == 0) {
                    ...
                    e.a(baseYYStudioFragment == null ? null : baseYYStudioFragment.getFragmentActive(), (ImageView) this.a.p, yYGiftWallModel.sponsor.get(0).getUid(), yYGiftWallModel.sponsor.get(0).getAvatar());
                    this.a.l.setBackgroundResource(R.drawable.shape_raduis_8dp_52b0ff);
                    BaseYYStudioFragment baseYYStudioFragment2 = this.i;
                    ImageLoader.a(baseYYStudioFragment2 == null ? null : baseYYStudioFragment2.getFragmentActive(), yYGiftWallModel.images_static).a(this.a.l);
                }
                if (i2 == 1) {
                    this.a.q.setVisibility(0);
                    YYRoomInfoManager e2 = YYRoomInfoManager.e();
                    BaseYYStudioFragment baseYYStudioFragment3 = this.i;
                    e2.a(baseYYStudioFragment3 == null ? null : baseYYStudioFragment3.getFragmentActive(), (ImageView) this.a.q, yYGiftWallModel.sponsor.get(0).getUid(), yYGiftWallModel.sponsor.get(0).getAvatar());
                    this.a.m.setBackgroundResource(R.drawable.shape_raduis_8dp_52b0ff);
                    BaseYYStudioFragment baseYYStudioFragment4 = this.i;
                    ImageLoader.a(baseYYStudioFragment4 == null ? null : baseYYStudioFragment4.getFragmentActive(), yYGiftWallModel.images_static).a(this.a.m);
                }
                if (i2 == 2) {
                    this.a.r.setVisibility(0);
                    YYRoomInfoManager e3 = YYRoomInfoManager.e();
                    BaseYYStudioFragment baseYYStudioFragment5 = this.i;
                    e3.a(baseYYStudioFragment5 == null ? null : baseYYStudioFragment5.getFragmentActive(), (ImageView) this.a.r, yYGiftWallModel.sponsor.get(0).getUid(), yYGiftWallModel.sponsor.get(0).getAvatar());
                    this.a.n.setBackgroundResource(R.drawable.shape_raduis_8dp_52b0ff);
                    BaseYYStudioFragment baseYYStudioFragment6 = this.i;
                    ImageLoader.a(baseYYStudioFragment6 == null ? null : baseYYStudioFragment6.getFragmentActive(), yYGiftWallModel.images_static).a(this.a.n);
                }
                i = i2 + 1;
            }
        } else {
            this.a.R.setText("点亮0个礼物");
        }
        if (yYGiftGottenModel == null || (skinDTO = yYGiftGottenModel.f56skin) == null) {
            return;
        }
        BaseYYStudioFragment fragment = getFragment();
        ImageLoader.a(fragment == null ? null : fragment.getFragmentActive(), skinDTO.getProfile()).a((Target) new SimpleTarget<Drawable>() { // from class: com.blued.android.module.yy_china.view.YYUserCardView$refreshGiftWall$1$1
            /* renamed from: a */
    ...
    public static final void a(final YYUserCardView this$0, View view) {
        ...
        BluedUIHttpResponse<BluedEntityA<Object>> bluedUIHttpResponse = new BluedUIHttpResponse<BluedEntityA<Object>>(fragmentActive) { // from class: com.blued.android.module.yy_china.view.YYUserCardView$forcedOut$1$1
            ...
            public void onUIUpdate(BluedEntityA<Object> bluedEntityA) {
                ...
                yYAudioConfig.c = userModel2 == null ? null : userModel2.getUid();
    ...
    private final void a(String str) {
        this.a.P.setText(UserRelationshipUtils.a(getContext(), str));
        String str2 = str;
    ...
    private final void b(YYUserInfo yYUserInfo) {
        ...
        if (yYUserInfo.wealth_level >= 3) {
            this.a.W.setText(new YYTextSpanComputer.Builder().a(this.a.W.getText().toString(), getContext().getResources().getColor(R.color.color_7BCBFF), getContext().getResources().getColor(R.color.color_DE7BFF)).c().a());
        }
    }
    ...
    public final void c() {
        ...
        BaseYYStudioFragment fragment = getFragment();
        ImageLoader.a(fragment == null ? null : fragment.getFragmentActive(), userAuctionModel.getRelation_bg()).a((Target) new SimpleTarget<Drawable>() { // from class: com.blued.android.module.yy_china.view.YYUserCardView$noticRation$1$1
            /* renamed from: a */
            public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                Intrinsics.e(resource, "resource");
        ...
        ImageLoader.a(fragmentActive, avatar).c().b(R.drawable.user_bg_round).a((ImageView) getBinding().j);
        BaseYYStudioFragment fragment3 = getFragment();
        ImageLoader.a(fragment3 == null ? null : fragment3.getFragmentActive(), userAuctionModel.getAuction_avatar()).c().b(R.drawable.user_bg_round).a((ImageView) getBinding().k);
        BaseYYStudioFragment fragment4 = getFragment();
        ImageLoader.a(fragment4 == null ? null : fragment4.getFragmentActive(), userAuctionModel.getBg_image()).a((Target) new SimpleTarget<Drawable>() { // from class: com.blued.android.module.yy_china.view.YYUserCardView$noticRation$1$2
            /* renamed from: a */
            public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                Intrinsics.e(resource, "resource");
    ...
    public final void d() {
        ...
        if (uid_profile != null) {
            if (YYRoomInfoManager.e().J() && !YYRoomInfoManager.e().g(uid_profile.getUid())) {
                ...
                BaseYYStudioFragment fragment = getFragment();
                ImageLoader.a(fragment == null ? null : fragment.getFragmentActive(), uid_profile.getAvatar()).c().b(R.drawable.user_bg_round).a(100).a((ImageView) getBinding().B);
            } else {
                BaseYYStudioFragment fragment2 = getFragment();
                ImageLoader.a(fragment2 == null ? null : fragment2.getFragmentActive(), uid_profile.getAvatar()).c().b(R.drawable.user_bg_round).a((ImageView) getBinding().B);
            }
        }
        ...
        if (targe_uid_profile != null) {
            if (YYRoomInfoManager.e().J() && !YYRoomInfoManager.e().g(targe_uid_profile.getUid())) {
                ...
                BaseYYStudioFragment fragment3 = getFragment();
                ImageLoader.a(fragment3 == null ? null : fragment3.getFragmentActive(), targe_uid_profile.getAvatar()).c().b(R.drawable.user_bg_round).d().a((ImageView) getBinding().C);
            } else {
                BaseYYStudioFragment fragment4 = getFragment();
                ImageLoader.a(fragment4 == null ? null : fragment4.getFragmentActive(), targe_uid_profile.getAvatar()).c().b(R.drawable.user_bg_round).a((ImageView) getBinding().C);
            }
        }
    ...
    public final void getUserInfo() {
            ...
            public void onUIUpdate(BluedEntityA<YYUserInfo> user) {
                ...
                if (yYUserInfo != null) {
                    ...
                    if (TextUtils.equals(userModel == null ? null : userModel.getUid(), yYUserInfo.getUid())) {
                        YYRoomInfoManager.e().a = YYUserCardView.this.getUserModel();
                    }
                }
        ...
        this.a.a.setOnClickListener(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.view.-$$Lambda$YYUserCardView$P-rh9tAYT7-8QvJNDAPIOlnBXoQ
    ...
    private final void h() {
        ...
        ShapeTextView shapeTextView = this.a.T;
        ...
        this.a.t.setOnClickListener(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.view.-$$Lambda$YYUserCardView$RdsNSOR-AgXX2oRLt2vAmvoUSNs
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.a.ac.setEmptyHead(R.drawable.icon_user_mask_with_text);
        this.a.W.setText(getResources().getString(R.string.masked_user_name));
    }
    ...
    public void onClick(View view) {
        ...
        if (valueOf != null && valueOf.intValue() == i) {
            ...
            if (TextUtils.equals(yYUserInfo == null ? null : yYUserInfo.getUid(), YYRoomInfoManager.e().k())) {
                ...
                String c2 = YYRoomInfoManager.e().c(8);
                YYUserInfo yYUserInfo2 = this.k;
                c.a(context, Intrinsics.a(c2, (Object) EncryptTool.b(yYUserInfo2 == null ? null : yYUserInfo2.getUid())), 0, true);
                YYRoomModel b = YYRoomInfoManager.e().b();
                if (b != null) {
        ...
        if (valueOf != null && valueOf.intValue() == i2) {
            ...
            if (TextUtils.equals(yYUserInfo3 == null ? null : yYUserInfo3.getUid(), YYRoomInfoManager.e().k())) {
                IYYRoomInfoCallback c3 = YYRoomInfoManager.e().c();
                Context context2 = getContext();
                String c4 = YYRoomInfoManager.e().c(7);
                YYUserInfo yYUserInfo4 = this.k;
                c3.a(context2, Intrinsics.a(c4, (Object) EncryptTool.b(yYUserInfo4 == null ? null : yYUserInfo4.getUid())), 0, true);
            ...
            if (yYUserInfo5 != null) {
                if (Intrinsics.a((Object) YYRoomInfoManager.e().k(), (Object) yYUserInfo5.getUid())) {
                    ...
                    if (yYUserInfo5.in_target_fans_group_info == null || yYUserInfo5.in_target_fans_group_info.level == null) {
                        ...
                        yYFansWelfareDialog = new YYFansWelfareDialog(fragment3, yYUserInfo5);
                    } else {
                        BaseYYStudioFragment fragment4 = getFragment();
                        Intrinsics.a(fragment4);
                        yYFansWelfareDialog = new YYFansClubAudienceViewDialog(fragment4, yYUserInfo5);
                    }
                    BaseYYStudioFragment fragment5 = getFragment();
                    ...
                    yYFansWelfareDialog.show(parentFragmentManager2, "fans_club_dialog");
                }
            }
