...
public abstract class AbstractBasePresenter {
    ...
    static /* synthetic */ class AnonymousClass79 {
        ...
        static {
            ...
            try {
                a[YYConstants.ApplyFromSource.CoupleVip.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                a[YYConstants.ApplyFromSource.SeatView.ordinal()] = 3;
    ...
    public AbstractBasePresenter(BaseYYStudioFragment baseYYStudioFragment) {
        ...
        YYVipNotifyManager.a.a().a(baseYYStudioFragment.R, baseYYStudioFragment.getFragmentActive(), DensityUtils.a(baseYYStudioFragment.getActivity()));
    }
    ...
    private void a(int i, int i2) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) this.a.aa.getLayoutParams();
        if (i <= 0) {
            layoutParams.width = AppInfo.l;
        } else {
            layoutParams.width = DensityUtils.a(this.a.getContext(), i);
        }
        if (i2 <= 0) {
            layoutParams.height = AppInfo.m;
        } else {
            layoutParams.height = DensityUtils.a(this.a.getContext(), i2);
        }
    ...
    public void a(final long j) {
        ...
        YYRoomHttpUtils.y(b.uid, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntity<YYFirstMeetMode, YYFirstMeetExtra>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.69
    ...
    public void a(EventRoomPkSvgaExtra eventRoomPkSvgaExtra) {
        a(DensityUtils.a(this.a.getContext(), eventRoomPkSvgaExtra.frameWidth), DensityUtils.a(this.a.getContext(), eventRoomPkSvgaExtra.frameHeight));
    ...
    public void a(final YYFirstMeetImMessMode yYFirstMeetImMessMode) {
        ...
        YYRoomHttpUtils.k(b.room_id, b.uid, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntity<YYFirstMeetGiftsListItemMode, YYFirstMeetExtra>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.56
            @Override // com.blued.android.framework.http.BluedUIHttpResponse
            public void onUIUpdate(BluedEntity<YYFirstMeetGiftsListItemMode, YYFirstMeetExtra> bluedEntity) {
                ...
                yYFirstMeetResultDialog.a(AbstractBasePresenter.this.a);
                yYFirstMeetResultDialog.show(AbstractBasePresenter.this.a.getFragmentManager(), "YYFirstMeetResultDialog");
            }
        }, this.a.getFragmentActive());
    }
    ...
    public void a(YYMagicalPrizeModel yYMagicalPrizeModel) {
        ...
        new YYMagicalPrizeFragment(yYMagicalPrizeModel).show(this.a.getParentFragmentManager(), "magical_prize");
    }
    ...
    public void a(final YYPayRequestModel yYPayRequestModel) {
        ...
        YYPayUtils.a(yYPayRequestModel, payFromSource, baseYYStudioFragment, baseYYStudioFragment.getFragmentActive(), new YYPayUtils.PayGiftStatusListener() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.72
            ...
            public void a(YYPayGoodsModel yYPayGoodsModel) {
                ...
                if (TextUtils.equals(yYSeatMemberModel.getUid(), yYPayRequestModel.target_uid) && YYRoomInfoManager.e().a != null) {
    ...
    public void a(final YYRoomModel yYRoomModel, final List<YYImModel> list, final int i, final int i2) {
        ...
        baseYYStudioFragment.postDelaySafeRunOnUiThread(new Runnable() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.71
            ...
            public void run() {
                if (yYRoomModel == null || AbstractBasePresenter.this.a == null) {
                    return;
                }
                int i3 = i;
                if (i3 < 0 || i3 >= i2) {
    ...
    public void a(YYUserInfo yYUserInfo) {
        ...
        yYGiftWallListAndInfoDialog.show(this.a.getChildFragmentManager(), "YYGiftWallListAndInfoDialog");
    }
        ...
        while (true) {
            ...
            if (TextUtils.equals(yYSeatMemberModel.getUid(), str)) {
                ...
                if (baseYYStudioFragment != null && baseYYStudioFragment.E != null) {
                    this.a.E.a(i2, str, str2, yYImModel);
                }
                BaseYYStudioFragment baseYYStudioFragment2 = this.a;
                if (baseYYStudioFragment2 == null || baseYYStudioFragment2.D == null || this.a.D.getVisibility() != 0) {
                    return;
                }
                this.a.D.a(i2, str, str2, yYImModel);
                return;
            }
            i = i2 + 1;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Type inference failed for: r1v3, types: [com.blued.android.module.yy_china.presenter.AbstractBasePresenter$73] */
    public void b(long j) {
        ...
        this.c = new CountDownTimer(j2 + 1000, 1000L) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.73
    ...
    public void b(final EventRoomPkSvgaExtra eventRoomPkSvgaExtra) {
        a(DensityUtils.a(this.a.getContext(), eventRoomPkSvgaExtra.frameWidth), DensityUtils.a(this.a.getContext(), eventRoomPkSvgaExtra.frameHeight));
        SVGAParser.a.b().a(eventRoomPkSvgaExtra.svgaName, new SVGAParser.ParseCompletion() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.59
            ...
            public void onComplete(SVGAVideoEntity sVGAVideoEntity) {
                ...
                AbstractBasePresenter.this.a.aa.setImageDrawable(new SVGADrawable(sVGAVideoEntity, sVGADynamicEntity));
                AbstractBasePresenter.this.a.aa.a();
                SVGAImageView sVGAImageView = AbstractBasePresenter.this.a.aa;
                AbstractBasePresenter abstractBasePresenter = AbstractBasePresenter.this;
                sVGAImageView.setCallback(abstractBasePresenter.a(abstractBasePresenter.a.aa));
            }
    ...
    public void b(final YYFirstMeetImMessMode yYFirstMeetImMessMode) {
        ImageLoader.a(this.a.getFragmentActive(), yYFirstMeetImMessMode.getSource_avatar()).c().a((Target<Drawable>) new SimpleTarget<Drawable>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.57
            /* renamed from: a */
            public void onResourceReady(Drawable drawable, Transition<? super Drawable> transition) {
                final Bitmap bitmap = ((BitmapDrawable) drawable).getBitmap();
                ImageLoader.a(AbstractBasePresenter.this.a.getFragmentActive(), yYFirstMeetImMessMode.getTarget_avatar()).c().a((Target<Drawable>) new SimpleTarget<Drawable>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.57.1
                    /* renamed from: a */
                    public void onResourceReady(Drawable drawable2, Transition<? super Drawable> transition2) {
                        ...
                        AbstractBasePresenter.this.a.a(new YYRoomFullSvgaMode("https://web.bldimg.com/cblued/static/headrightt2.1guuig3laoq12d.svga", sVGADynamicEntity, 1));
                        AbstractBasePresenter.this.a.a(new YYRoomFullSvgaMode("https://web.bldimg.com/cblued/static/headrightt2.1guuig3laoq12d.svga", sVGADynamicEntity, 1));
                    }
                });
            }
    ...
    public void b(String str) {
        ...
        new YYWebViewDialogFragment().a(this.a, str).show(this.a.getChildFragmentManager(), "yy_game_dialog");
        this.a.n();
    }
    ...
    public void c(final EventRoomPkSvgaExtra eventRoomPkSvgaExtra) {
        a(DensityUtils.a(this.a.getContext(), eventRoomPkSvgaExtra.frameWidth), DensityUtils.a(this.a.getContext(), eventRoomPkSvgaExtra.frameHeight));
        SVGAParser.a.b().a(eventRoomPkSvgaExtra.svgaName, new SVGAParser.ParseCompletion() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.60
            @Override // com.blued.android.module.svgaplayer.SVGAParser.ParseCompletion
            public void onComplete(SVGAVideoEntity sVGAVideoEntity) {
                SVGADynamicEntity sVGADynamicEntity = new SVGADynamicEntity();
    ...
    public void c(String str) {
        ...
        LiveAlterDialog.a(this.a.getContext(), inflate, (View.OnClickListener) null, (View.OnClickListener) null, false, true);
    }
    ...
    public void f() {
        ...
        YYRoomHttpUtils.y(YYRoomInfoManager.e().b().uid, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntity<YYFirstMeetMode, YYFirstMeetExtra>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.55
            @Override // com.blued.android.framework.http.BluedUIHttpResponse
            public void onUIUpdate(BluedEntity<YYFirstMeetMode, YYFirstMeetExtra> bluedEntity) {
                if (bluedEntity.hasData()) {
                    YYFirstMeetMode singleData = bluedEntity.getSingleData();
                    ...
                    long c = AbstractBasePresenter.this.c();
                    int i = 0;
                    if (j == c) {
                    ...
                    singleData.setInfo(bluedEntity.extra.getAnchor_info());
                    AbstractBasePresenter.this.a.a(singleData);
                    SharedPreferences.Editor edit = SharedPreferencesUtils.b().edit();
                    edit.putLong("YY_FIRST_MEET_SHOW_MEET_TIME" + YYRoomInfoManager.e().k(), c).apply();
    ...
    private SVGAParser.ParseCompletion g() {
        return new SVGAParser.ParseCompletion() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.58
            @Override // com.blued.android.module.svgaplayer.SVGAParser.ParseCompletion
            public void onComplete(SVGAVideoEntity sVGAVideoEntity) {
                AbstractBasePresenter.this.a.aa.setImageDrawable(new SVGADrawable(sVGAVideoEntity, new SVGADynamicEntity()));
                AbstractBasePresenter.this.a.aa.a();
                SVGAImageView sVGAImageView = AbstractBasePresenter.this.a.aa;
                AbstractBasePresenter abstractBasePresenter = AbstractBasePresenter.this;
                sVGAImageView.setCallback(abstractBasePresenter.a(abstractBasePresenter.a.aa));
    ...
    public void h() {
        ...
        this.a.Q.setText(String.format(this.a.getResources().getString(R.string.yy_magical_notice_text), this.b.count_down));
        this.a.P.startAnimation(AnimationUtils.loadAnimation(this.a.getContext(), R.anim.activity_in_from_left));
        this.a.P.setVisibility(0);
        this.a.postDelaySafeRunOnUiThread(new Runnable() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.62
            @Override // java.lang.Runnable
            public void run() {
                if (AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.P == null) {
                    return;
                }
                AbstractBasePresenter.this.a.P.startAnimation(AnimationUtils.loadAnimation(AbstractBasePresenter.this.a.getContext(), R.anim.activity_out_to_right));
                AbstractBasePresenter.this.a.P.setVisibility(8);
            }
        }, 5000L);
    }
    ...
    public void i() {
        ...
        YYVoteResultView yYVoteResultView = new YYVoteResultView(this.a.getContext());
        yYVoteResultView.a(this.a);
        this.a.a(yYVoteResultView, -2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v0, types: [android.view.View, com.blued.android.module.yy_china.view.YYSayHelloView] */
    public void j() {
        ?? yYSayHelloView = new YYSayHelloView(this.a.getContext());
        yYSayHelloView.a(this.a);
        this.a.a((View) yYSayHelloView, -2, 17, true);
    }
    ...
    public void k() {
        ...
        this.a.J.a(new YYMountModel("", this.b.animation, "", 0, null, null), true);
        this.a.J.a(new SingleClickProxy(new View.OnClickListener() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.74
        ...
        this.a.postDelaySafeRunOnUiThread(new Runnable() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.75
            @Override // java.lang.Runnable
            public void run() {
                AbstractBasePresenter.this.a.J.h();
    ...
    public void l() {
        ...
        YYRoomHttpUtils.t(YYRoomInfoManager.e().b().room_id, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntityA<YYMagicalPrizeModel>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.76
    ...
    public void a() {
        ...
        YYRoomHttpUtils.s(YYRoomInfoManager.e().b().room_id, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntityA<YYPreciousPackageModel>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.63
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.blued.android.framework.http.BluedUIHttpResponse
            /* renamed from: a */
            public void onUIUpdate(BluedEntityA<YYPreciousPackageModel> bluedEntityA) {
                ...
                if (AbstractBasePresenter.this.b == null || StringUtils.a(AbstractBasePresenter.this.b.is_show, 2) != 1) {
                    AbstractBasePresenter.this.a.O.setVisibility(8);
                    return;
                }
                AbstractBasePresenter.this.a.O.setVisibility(0);
                AbstractBasePresenter.this.a.O.a(AbstractBasePresenter.this.b.icon_middle);
                int a = StringUtils.a(AbstractBasePresenter.this.b.count_down, 0);
                if (a <= 1) {
                    AbstractBasePresenter.this.a.O.a();
                } else {
                    ...
                    AbstractBasePresenter.this.b(a);
    ...
    public void a(LifecycleOwner lifecycleOwner) {
        ...
        LiveEventBus.get("display_emoji_image", YYImModel.class).observe(lifecycleOwner, new Observer<YYImModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.2
            ...
            public void onChanged(YYImModel yYImModel) {
                ...
                if (yYAudienceModel == null || (yYMsgEmojiExtra = (YYMsgEmojiExtra) AppInfo.f().fromJson(yYImModel.getMsgExtra(), YYMsgEmojiExtra.class)) == null) {
                    return;
                }
        ...
        LiveEventBus.get("show_frist_meet", YYFirstMeetMessMode.class).observe(lifecycleOwner, new Observer<YYFirstMeetMessMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.3
            ...
            public void onChanged(YYFirstMeetMessMode yYFirstMeetMessMode) {
                if (yYFirstMeetMessMode.getType() == 0) {
                    ...
                    AbstractBasePresenter.this.a.S();
                } else {
        ...
        LiveEventBus.get("relation_invited", YYRelationShipRoomImMode.class).observe(lifecycleOwner, new Observer<YYRelationShipRoomImMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.5
            ...
            public void onChanged(YYRelationShipRoomImMode yYRelationShipRoomImMode) {
                ...
                yYRelationShipInvitedDialog.show(AbstractBasePresenter.this.a.getChildFragmentManager(), "YYRelationShipInvitedDialog");
            }
        });
        LiveEventBus.get("set_manager_msg", YYAudienceModel.class).observe(lifecycleOwner, new Observer<YYAudienceModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.6
            ...
            public void onChanged(YYAudienceModel yYAudienceModel) {
                if (AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.E == null) {
                    return;
                }
                AbstractBasePresenter.this.a.E.a(yYAudienceModel.getUid(), yYAudienceModel.chat_anchor);
        ...
        LiveEventBus.get("show_gift_list", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.7
            ...
            public void onChanged(String str) {
                if (AbstractBasePresenter.this.a == null) {
                    return;
                }
                AbstractBasePresenter.this.a.a(true, "", "");
            }
        });
        LiveEventBus.get("show_gift_view", YYGiftEven.class).observe(lifecycleOwner, new Observer<YYGiftEven>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.8
            ...
            public void onChanged(YYGiftEven yYGiftEven) {
                ...
                AbstractBasePresenter.this.a.a(true, yYGiftEven.a, yYGiftEven.b, yYGiftEven.c);
            }
        });
        LiveEventBus.get("notify_alert_message", YYImModel.class).observe(lifecycleOwner, new Observer<YYImModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.9
            ...
            public void onChanged(YYImModel yYImModel) {
                ...
                if (b != null && yYImModel.target_profile != null) {
                    EventTrackYY.a(ChatRoomProtos.Event.CHAT_ROOM_WARN_POP_SHOW, b.room_id, b.uid, yYImModel.target_profile.getUid(), yYImModel.contents, ((YYMsgWarningExtra) AppInfo.f().fromJson(yYImModel.getMsgExtra(), YYMsgWarningExtra.class)).warning_type);
                }
        ...
        LiveEventBus.get("notify_follow_user", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.10
            ...
            public void onChanged(String str) {
                ...
                if (AbstractBasePresenter.this.a == null || (b = YYRoomInfoManager.e().b()) == null) {
                    return;
                }
                if (TextUtils.equals(str, b.uid)) {
                    ToastUtils.a("你已关注房主", 0);
                }
                YYRoomHttpUtils.f(b.room_id, str, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntityA<Object>>(AbstractBasePresenter.this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.10.1
                    /* JADX INFO: Access modifiers changed from: protected */
                    @Override // com.blued.android.framework.http.BluedUIHttpResponse
                    /* renamed from: a */
                    public void onUIUpdate(BluedEntityA<Object> bluedEntityA) {
                    }
                }, (IRequestHost) AbstractBasePresenter.this.a.getFragmentActive());
            }
        });
        LiveEventBus.get("show_wish_detail", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.11
            ...
            public void onChanged(String str) {
                ...
                new YYWishDetailDialog(AbstractBasePresenter.this.a).show(AbstractBasePresenter.this.a.getParentFragmentManager(), "show_wish_detail_dialog");
            }
        });
        LiveEventBus.get("show_vote_details", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.12
            ...
            public void onChanged(String str) {
                ...
                YYUserVoteView yYUserVoteView = new YYUserVoteView(AbstractBasePresenter.this.a.getContext());
                yYUserVoteView.a(AbstractBasePresenter.this.a, str);
                AbstractBasePresenter.this.a.a(yYUserVoteView, -2);
            }
        });
        LiveEventBus.get("show_vote_result", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.13
            /* renamed from: a */
            public void onChanged(String str) {
                if (AbstractBasePresenter.this.a != null && TextUtils.isEmpty(str)) {
                    AbstractBasePresenter.this.a.y();
        ...
        LiveEventBus.get("event_solo_topic", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.14
            /* renamed from: a */
            public void onChanged(String str) {
                if (AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.E == null || (AbstractBasePresenter.this.a.E instanceof YYSeatSoloAdapter)) {
                    ((YYSeatSoloAdapter) AbstractBasePresenter.this.a.E).a(str);
                } else if (AbstractBasePresenter.this.a != null) {
                    AbstractBasePresenter.this.a.j();
                }
            }
        });
        LiveEventBus.get("show_gift_pk_details", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.15
            ...
            public void onChanged(String str) {
                ...
                YYGiftPkDetailView yYGiftPkDetailView = new YYGiftPkDetailView(AbstractBasePresenter.this.a.getContext());
                yYGiftPkDetailView.a(AbstractBasePresenter.this.a);
                AbstractBasePresenter.this.a.a(yYGiftPkDetailView, -2);
            }
        });
        LiveEventBus.get("show_gift_pk_result", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.16
            ...
            public void onChanged(String str) {
                ...
                YYGiftPKResult yYGiftPKResult = new YYGiftPKResult(AbstractBasePresenter.this.a.getContext());
                yYGiftPKResult.a(AbstractBasePresenter.this.a);
                AbstractBasePresenter.this.a.a((View) yYGiftPKResult, DensityUtils.a(AbstractBasePresenter.this.a.getContext(), 300.0f), -2, 17, true);
            }
        });
        LiveEventBus.get("frist_rechage", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.17
            ...
            public void onChanged(String str) {
                ...
                AbstractBasePresenter.this.a.c(str);
            }
        });
        LiveEventBus.get("EVENT_MARQUEE_GIFT", YYImModel.class).observe(lifecycleOwner, new Observer<YYImModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.18
            ...
            public void onChanged(YYImModel yYImModel) {
                ...
                if (yYAudienceModel2 == null || (yYAudienceModel = yYImModel.source_profile) == null || (yYMsgMarqueeExtra = (YYMsgMarqueeExtra) AppInfo.f().fromJson(yYImModel.getMsgExtra(), YYMsgMarqueeExtra.class)) == null || AbstractBasePresenter.this.a.t == null) {
                    return;
                }
                AbstractBasePresenter.this.a.t.a(AbstractBasePresenter.this.a.t.a(yYMsgMarqueeExtra.send_time, yYAudienceModel.getName(), yYAudienceModel2.getName(), yYMsgMarqueeExtra.goods_count, yYMsgMarqueeExtra.goods_name), yYMsgMarqueeExtra.goods_image);
            }
        });
        LiveEventBus.get("add_new_user", YYImModel.class).observe(lifecycleOwner, new Observer<YYImModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.19
            ...
            public void onChanged(YYImModel yYImModel) {
                String str;
                if (AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.v == null || yYImModel == null || yYImModel.source_profile == null) {
                    return;
                }
                if (AbstractBasePresenter.this.a.v != null && !StringUtils.b(yYImModel.source_profile.enter_effects)) {
                    AbstractBasePresenter.this.a.v.a(yYImModel);
                }
                ...
                if (!YYRoomInfoManager.e().J() || YYRoomInfoManager.e().g(yYImModel.source_profile.getUid())) {
                    ...
                    str = AbstractBasePresenter.this.a.getResources().getString(R.string.masked_user_name);
                }
                AbstractBasePresenter.this.a.J.a(new YYMountModel(str + "飞驰进场", yYImModel.source_profile.mounts_img, yYImModel.source_profile.mounts_icon, 0, null, null));
            }
        });
        LiveEventBus.get("notify_background", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.20
            /* renamed from: a */
            public void onChanged(String str) {
                AbstractBasePresenter.this.a.q.a();
            }
        });
        LiveEventBus.get("notify_confessed", ConfessedIMMode.class).observe(lifecycleOwner, new Observer<ConfessedIMMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.21
            ...
            public void onChanged(ConfessedIMMode confessedIMMode) {
                if (AbstractBasePresenter.this.a != null) {
                    AbstractBasePresenter.this.a.a(confessedIMMode);
                }
            }
        });
        LiveEventBus.get("EVENT_PACK_GIFT_NOTIC", YYPackGiftIMMode.class).observe(lifecycleOwner, new Observer<YYPackGiftIMMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.22
            ...
            public void onChanged(YYPackGiftIMMode yYPackGiftIMMode) {
                if (yYPackGiftIMMode.getFull_server_notification() != null) {
                    ...
                    YYVipNotifyManager.a.a().a(new YYMsgMarqueeModel(YYMsgMarqueeModel.VIP_MARRIAGE, yYPackGiftIMMode.getFull_server_notification()));
                }
            }
        });
        LiveEventBus.get("EVENT_PACK_GIFT", YYPackGiftIMMode.class).observe(lifecycleOwner, new Observer<YYPackGiftIMMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.23
            ...
            public void onChanged(YYPackGiftIMMode yYPackGiftIMMode) {
                if (yYPackGiftIMMode.getStatus() != 1) {
                    ...
                    AbstractBasePresenter.this.a.U();
        ...
        LiveEventBus.get("event_to_charge", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.25
            ...
            public void onChanged(String str) {
                ...
                AbstractBasePresenter.this.a.t();
                AbstractBasePresenter.this.a.n();
            }
        });
        ...
        LiveEventBus.get("EVENT_ROOM_MUSIC", YYMusicMode.class).observe(lifecycleOwner, new Observer<YYMusicMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.27
            ...
            public void onChanged(YYMusicMode yYMusicMode) {
                if (yYMusicMode != null) {
                    AbstractBasePresenter.this.a.a(yYMusicMode);
                }
            }
        });
        LiveEventBus.get("common_report_user", YYReportModel.class).observe(lifecycleOwner, new Observer<YYReportModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.28
            ...
            public void onChanged(final YYReportModel yYReportModel) {
                ...
                popYyDialog.a(new PopYyDialogGetView() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.28.1
                    ...
                    public View a() {
                        YYReportView yYReportView = new YYReportView(AbstractBasePresenter.this.a.getContext());
                        yYReportView.a(AbstractBasePresenter.this.a, yYReportModel);
                ...
                popYyDialog.show(AbstractBasePresenter.this.a.getChildFragmentManager(), "YYCardOptionView");
            }
        });
        LiveEventBus.get("open_user", YYUserInfo.class).observe(lifecycleOwner, new Observer<YYUserInfo>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.29
            ...
            public void onChanged(YYUserInfo yYUserInfo) {
                YYRoomModel b = YYRoomInfoManager.e().b();
                if (b != null) {
                    AbstractBasePresenter.this.a.a(yYUserInfo.getUid(), yYUserInfo.getName(), yYUserInfo.getAvatar(), YYRoomInfoManager.e().a.chat_anchor, b.isExistById(yYUserInfo.getUid()));
                }
            }
        });
        LiveEventBus.get("update_wish_gift", YYMsgWishListModel.class).observe(lifecycleOwner, new Observer<YYMsgWishListModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.30
            ...
            public void onChanged(YYMsgWishListModel yYMsgWishListModel) {
                ...
                AbstractBasePresenter.this.a.A.setVisibility(0);
                AbstractBasePresenter.this.a.A.setItems(yYMsgWishListModel.list);
            }
        });
        LiveEventBus.get("pre_pay_succes", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.31
            /* renamed from: a */
            public void onChanged(String str) {
                AbstractBasePresenter.this.a.r();
            }
        });
        LiveEventBus.get("EVENT_MARQUEE_MATCH", YYMsgVipMatchExtra.class).observe(lifecycleOwner, new Observer<YYMsgVipMatchExtra>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.32
            ...
            public void onChanged(YYMsgVipMatchExtra yYMsgVipMatchExtra) {
                if (yYMsgVipMatchExtra == null || AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.t == null) {
                    return;
                }
                AbstractBasePresenter.this.a.t.a(AbstractBasePresenter.this.a.t.a(yYMsgVipMatchExtra.vip_name, yYMsgVipMatchExtra.target_name), "");
            }
        });
        ...
        LiveEventBus.get("event_rank_list", YYMsgUpdateUserList.class).observe(lifecycleOwner, new Observer<YYMsgUpdateUserList>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.34
            ...
            public void onChanged(YYMsgUpdateUserList yYMsgUpdateUserList) {
                ...
                if (yYMsgUpdateUserList == null || yYMsgUpdateUserList.seats == null || yYMsgUpdateUserList.seats.isEmpty()) {
                    AbstractBasePresenter.this.a.s.setGoldDatas(null);
                }
                AbstractBasePresenter.this.a.s.setGoldDatas(yYMsgUpdateUserList.seats);
            }
        });
        ...
        LiveEventBus.get("EVENT_JUMP_ROOM", YYJumpRoomMode.class).observe(lifecycleOwner, new Observer<YYJumpRoomMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.37
            ...
            public void onChanged(YYJumpRoomMode yYJumpRoomMode) {
                YYJumpLoadingFragment.a(AbstractBasePresenter.this.a.getContext());
                YYRoomInfoManager.e().a((BaseFragmentActivity) AbstractBasePresenter.this.a.getActivity(), yYJumpRoomMode.getRoomid(), yYJumpRoomMode.getSource());
            }
        });
        LiveEventBus.get("EVENT_APPLY_CLOSE_ROOM_MESS", Integer.class).observe(lifecycleOwner, new Observer<Integer>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.38
            ...
            public void onChanged(Integer num) {
                AbstractBasePresenter.this.a.d(num.intValue());
            }
        });
        LiveEventBus.get("show_matching_pk_new", YYEventMatching.class).observe(lifecycleOwner, new Observer<YYEventMatching>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.39
            ...
            public void onChanged(YYEventMatching yYEventMatching) {
                YYPKMatchingFragment.a.a(yYEventMatching).show(AbstractBasePresenter.this.a.getParentFragmentManager(), "new_matching_dialog");
            }
        });
        LiveEventBus.get("EVENT_PRIZE_MESSAGE", YYGlobalMsgModel.class).observe(lifecycleOwner, new Observer<YYGlobalMsgModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.40
            ...
            public void onChanged(YYGlobalMsgModel yYGlobalMsgModel) {
                ...
                if (i == 1) {
                    YYGlobalMsgMarqueeModel yYGlobalMsgMarqueeModel2 = (YYGlobalMsgMarqueeModel) AppInfo.f().fromJson(yYGlobalMsgModel.body, YYGlobalMsgMarqueeModel.class);
                    if (yYGlobalMsgMarqueeModel2 == null) {
                        return;
                    }
                    AbstractBasePresenter.this.a.t.a(yYGlobalMsgMarqueeModel2);
                } else if (i == 4) {
                    YYEnergyBallMsgModel yYEnergyBallMsgModel = (YYEnergyBallMsgModel) AppInfo.f().fromJson(yYGlobalMsgModel.body, YYEnergyBallMsgModel.class);
                    if (yYEnergyBallMsgModel == null) {
                        return;
                    }
                    new YYPrizeDialog(yYEnergyBallMsgModel.prizeName, yYEnergyBallMsgModel.prizeImg, yYEnergyBallMsgModel.prizeValue).show(AbstractBasePresenter.this.a.getFragmentManager(), "prize_dialog");
                } else if (i != 7) {
                    if (i == 8 && (yYGlobalMsgMarqueeModel = (YYGlobalMsgMarqueeModel) AppInfo.f().fromJson(yYGlobalMsgModel.body, YYGlobalMsgMarqueeModel.class)) != null) {
                        YYVipNotifyManager.a.a().a(new YYMsgMarqueeModel(YYMsgMarqueeModel.VIP_MARRIAGE, yYGlobalMsgMarqueeModel));
                    }
                } else {
                    YYMsgMuteExtra yYMsgMuteExtra = (YYMsgMuteExtra) AppInfo.f().fromJson(yYGlobalMsgModel.body, YYMsgMuteExtra.class);
        ...
        LiveEventBus.get("EVENT_NOTICE_ROOM_BANNER_ACTIVITY_RANK", YYBannerRankModel.class).observe(lifecycleOwner, new Observer<YYBannerRankModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.41
            ...
            public void onChanged(YYBannerRankModel yYBannerRankModel) {
                if (yYBannerRankModel == null || AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.L == null) {
                    return;
                }
                AbstractBasePresenter.this.a.L.a(yYBannerRankModel);
            }
        });
        LiveEventBus.get("EVENT_HOST_UP", YYHostUpMode.class).observe(lifecycleOwner, new Observer<YYHostUpMode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.42
            ...
            public void onChanged(final YYHostUpMode yYHostUpMode) {
                if (yYHostUpMode == null || AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.K == null) {
                    return;
                }
                if (!StringUtils.b(yYHostUpMode.getMaterial())) {
                    AbstractBasePresenter.this.a.K.a(new YYMountModel("", "", "", 0, yYHostUpMode, new LiveAnimationListener() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.42.1
                        ...
                        public void b() {
                            ...
                            AppInfo.n().postDelayed(new Runnable() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.42.1.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    YYVipNotifyManager.a.a().a(new YYMsgMarqueeModel(YYMsgMarqueeModel.HOST_UP_MARRIAGE, yYHostUpMode));
                                }
                            }, 10000L);
                        }
                    }));
        ...
        LiveEventBus.get("EVENT_UP", IMJsonContents95Model.class).observe(lifecycleOwner, new Observer<IMJsonContents95Model>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.43
            ...
            public void onChanged(IMJsonContents95Model iMJsonContents95Model) {
                YYUpMode yYUpMode;
                if (iMJsonContents95Model.getBusiness() != 2 || iMJsonContents95Model.getType() != 2 || (yYUpMode = (YYUpMode) AppInfo.f().fromJson(iMJsonContents95Model.getExtra(), YYUpMode.class)) == null || StringUtils.b(iMJsonContents95Model.getMaterial())) {
                    return;
                }
                yYUpMode.setBroadcast_background(iMJsonContents95Model.getMaterial());
                YYVipNotifyManager.a.a().a(new YYMsgMarqueeModel(YYMsgMarqueeModel.UP_MARRIAGE, yYUpMode));
            }
        });
        LiveEventBus.get("update_coin_num", YYPreciousPackageModel.class).observe(lifecycleOwner, new Observer<YYPreciousPackageModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.44
            ...
            public void onChanged(YYPreciousPackageModel yYPreciousPackageModel) {
                if (AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.O == null || yYPreciousPackageModel == null) {
                    return;
                }
        ...
        LiveEventBus.get("fall_down_prize", YYPreciousPackageModel.class).observe(lifecycleOwner, new Observer<YYPreciousPackageModel>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.45
            /* renamed from: a */
            public void onChanged(YYPreciousPackageModel yYPreciousPackageModel) {
                if (AbstractBasePresenter.this.a == null || yYPreciousPackageModel == null) {
                    return;
                }
                if (AbstractBasePresenter.this.b != null) {
                ...
                if (AbstractBasePresenter.this.a.O != null) {
                    AbstractBasePresenter.this.a.O.a(AbstractBasePresenter.this.b.icon_middle);
        ...
        LiveEventBus.get("show_music", String.class).observe(this.a, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.47
            /* renamed from: a */
            public void onChanged(String str) {
                AbstractBasePresenter.this.a.p();
            }
        });
        LiveEventBus.get("play_svga_room_pk", EventRoomPkSvgaExtra.class).observe(lifecycleOwner, new Observer<EventRoomPkSvgaExtra>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.48
            ...
            public void onChanged(EventRoomPkSvgaExtra eventRoomPkSvgaExtra) {
                if (AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.aa == null || eventRoomPkSvgaExtra == null) {
                    return;
                }
        ...
        LiveEventBus.get("show_inner_dialog", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.49
            ...
            public void onChanged(String str) {
                ...
                yYWebViewDialogFragment.a(AbstractBasePresenter.this.a, str);
                yYWebViewDialogFragment.show(AbstractBasePresenter.this.a.getParentFragmentManager(), "inner_web_dialog");
            }
        });
        LiveEventBus.get("EVENT_SHOW_LOAD_DIALOG", String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.50
            ...
            public void onChanged(String str) {
                ...
                if (!z) {
                    new YYPackGiftDialog().show(AbstractBasePresenter.this.a.getChildFragmentManager(), "YYPackGiftDialog");
                } else if (!z) {
                } else {
                    new YYConfessedListDialog().show(AbstractBasePresenter.this.a.getChildFragmentManager(), "YYConfessedListDialog");
                }
            }
        });
        LiveEventBus.get("show_coming_event", IMJsonContents108Model.class).observe(lifecycleOwner, new Observer<IMJsonContents108Model>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.51
            ...
            public void onChanged(IMJsonContents108Model iMJsonContents108Model) {
                if (iMJsonContents108Model.getActivity_info() != null && iMJsonContents108Model.getType() == 0) {
                    ...
                    if (valueOf.longValue() > 0 && AbstractBasePresenter.this.a.F) {
                ...
                FrameLayout frameLayout = (FrameLayout) AbstractBasePresenter.this.a.c.findViewById(R.id.fra_add_view_layout);
                ...
                if (iMJsonContents108Model.getType() == 3) {
                    ...
                    if (YYRoomInfoManager.e().y()) {
                        AbstractBasePresenter.this.a.z.setVisibility(8);
                    } else {
                        AbstractBasePresenter.this.a.z.a(AbstractBasePresenter.this.a, (IMJsonContents109Model) null);
                    }
                    ...
                    if (iMJsonContents108Model.getType() != 1 || iMJsonContents108Model.getCountdown_time() > 0) {
                        ...
                        AbstractBasePresenter.this.d = new FloatComingEventsView(AbstractBasePresenter.this.a.getContext());
                        AbstractBasePresenter.this.d.a(AbstractBasePresenter.this.a, iMJsonContents108Model);
                        frameLayout.addView(AbstractBasePresenter.this.d, layoutParams);
                        AbstractBasePresenter.this.d.setY(AbstractBasePresenter.this.a.getResources().getDimensionPixelOffset(R.dimen.dp_300));
                    }
                }
            }
        });
        LiveEventBus.get("theme_activity_gifts", IMJsonContents109Model.class).observe(lifecycleOwner, new Observer<IMJsonContents109Model>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.52
            ...
            public void onChanged(IMJsonContents109Model iMJsonContents109Model) {
                if (AbstractBasePresenter.this.a == null || AbstractBasePresenter.this.a.z == null || iMJsonContents109Model == null) {
                    return;
                }
                AbstractBasePresenter.this.a.z.a(AbstractBasePresenter.this.a, iMJsonContents109Model);
            }
        });
        LiveEventBus.get("EVENT_SHOW_DOUBLE_PEOPLE_NOTICE", DoublePeopleNoticeImNode.class).observe(lifecycleOwner, new Observer<DoublePeopleNoticeImNode>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.53
            ...
            public void onChanged(DoublePeopleNoticeImNode doublePeopleNoticeImNode) {
                if (doublePeopleNoticeImNode != null) {
                    YYVipNotifyManager.a.a().a(new YYMsgMarqueeModel(YYMsgMarqueeModel.DOUBLE_PEOPLE_MARRIAGE, doublePeopleNoticeImNode));
                }
            }
        });
        LiveEventBus.get(LiveEventBusConstant.e, String.class).observe(lifecycleOwner, new Observer<String>() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.54
            ...
            public void onChanged(String str) {
                if (AbstractBasePresenter.this.a != null) {
                    AbstractBasePresenter.this.a.z();
                }
            }
        });
        b(lifecycleOwner);
    ...
    public void a(YYGiftModel yYGiftModel, int i, String str, boolean z) {
        ...
        YYRoomModel b;
        if (yYGiftModel == null || (baseYYStudioFragment = this.a) == null || !baseYYStudioFragment.isAdded() || !this.a.getFragmentActive().isActive() || (b = YYRoomInfoManager.e().b()) == null) {
            return;
        }
    ...
    public void a(String str, String str2) {
        ...
        YYRoomHttpUtils.a(new BluedUIHttpResponse<BluedEntityA<YYUserInfo>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.78
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.blued.android.framework.http.BluedUIHttpResponse
            /* renamed from: a */
        ...
        }, str, str2, this.a.getFragmentActive());
    }
    ...
    public void a(final boolean z) {
        ...
        YYRoomHttpUtils.r(new BluedUIHttpResponse<BluedEntityA<YYRoomBasicMode>>(baseYYStudioFragment.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.68
            ...
            public void onUIUpdate(BluedEntityA<YYRoomBasicMode> bluedEntityA) {
                ...
                if (bluedEntityA == null || !bluedEntityA.hasData() || AbstractBasePresenter.this.a == null || (singleData = bluedEntityA.getSingleData()) == null) {
                    return;
                }
                ...
                if (b != null) {
                    ...
                    if (!z && !AbstractBasePresenter.this.a.F) {
                        YYImMsgManager.a().e();
                    }
    ...
    public void b(final YYClickApplyEvent yYClickApplyEvent) {
        ...
        View inflate = LayoutInflater.from(this.a.getContext()).inflate(R.layout.dialog_apply_mic_layout, (ViewGroup) null);
        ((TextView) inflate.findViewById(R.id.dialog_title)).setText(b());
        LiveAlterDialog.a(this.a.getContext(), inflate, new View.OnClickListener() { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.65
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                YYRoomModel b;
                Tracker.onClick(view);
            ...
            public void onClick(View view) {
                ...
                YYRoomModel b = YYRoomInfoManager.e().b();
                if (b != null) {
                    int i = AnonymousClass79.a[yYClickApplyEvent.getSource().ordinal()];
                    if (i == 1) {
    ...
    public final void c(final YYClickApplyEvent yYClickApplyEvent) {
        ...
        YYRoomHttpUtils.d(b.room_id, yYClickApplyEvent.getSeatNumber() < 0 ? 0 : yYClickApplyEvent.getSeatNumber(), new BluedUIHttpResponse<BluedEntityA<Object>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.67
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.blued.android.framework.http.BluedUIHttpResponse
            /* renamed from: a */
            public void onUIUpdate(BluedEntityA<Object> bluedEntityA) {
            ...
            public boolean onUIFailure(int i, String str) {
                if (i == 40380002) {
                    ...
                    if (AbstractBasePresenter.this.a != null) {
                        if (AbstractBasePresenter.this.a instanceof PlayingStudioFragment) {
                            ((PlayingStudioFragment) AbstractBasePresenter.this.a).aj = true;
                        }
                        AbstractBasePresenter.this.a.G();
                    }
                }
    ...
    public void d() {
        ...
        YYRoomHttpUtils.l(b.room_id, (BluedUIHttpResponse) new BluedUIHttpResponse<BluedEntityA<YYImModel>>(this.a.getFragmentActive()) { // from class: com.blued.android.module.yy_china.presenter.AbstractBasePresenter.70
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.blued.android.framework.http.BluedUIHttpResponse
            /* renamed from: a */
