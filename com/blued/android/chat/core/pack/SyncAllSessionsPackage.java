...
/* loaded from: source-6737240-dex2jar.jar:com/blued/android/chat/core/pack/SyncAllSessionsPackage.class */
public class SyncAllSessionsPackage extends SyncBasePackage {
    public SyncAllSessionsPackage(long j) {
        super((short) 1, j);
    }
