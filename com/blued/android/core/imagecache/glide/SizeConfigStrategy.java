...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    private static final Bitmap.Config[] f9649a = {Bitmap.Config.ARGB_8888, null};
    private static final Bitmap.Config[] b = {Bitmap.Config.RGB_565};

    /* renamed from: c  reason: collision with root package name */
    private static final Bitmap.Config[] f9650c = {Bitmap.Config.ARGB_4444};
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f9651a[Bitmap.Config.RGB_565.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f9651a[Bitmap.Config.ARGB_4444.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f9651a[Bitmap.Config.ALPHA_8.ordinal()] = 4;
    ...
    public static final class Key implements Poolable {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Key) {
                Key key = (Key) obj;
                z = false;
                if (this.f9652a == key.f9652a) {
                    z = false;
                    if (Util.a(this.f9653c, key.f9653c)) {
                        z = true;
                    }
                }
            }
        ...
        public int hashCode() {
            int i = this.f9652a;
            Bitmap.Config config = this.f9653c;
            return (i * 31) + (config != null ? config.hashCode() : 0);
        }

        public String toString() {
            return SizeConfigStrategy.a(this.f9652a, this.f9653c);
        }
    }
    ...
    private static Bitmap.Config[] b(Bitmap.Config config) {
        int i = AnonymousClass1.f9651a[config.ordinal()];
        return i != 1 ? i != 2 ? i != 3 ? i != 4 ? new Bitmap.Config[]{config} : d : f9650c : b : f9649a;
    }
    ...
    public Bitmap a(int i, int i2, Bitmap.Config config) {
        ...
        if (a2 != null) {
            a(Integer.valueOf(b2.f9652a), a2);
    ...
    public void a(Bitmap bitmap) {
        ...
        Integer num = a3.get(Integer.valueOf(a2.f9652a));
        int i = a2.f9652a;
        int i2 = 1;
        if (num != null) {
            i2 = 1 + num.intValue();
