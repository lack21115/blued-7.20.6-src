...
public class BluedToastStyle implements IToastStyle<TextView> {
    ...
    public int c(Context context) {
        return (int) StyleUtils.a(context, 100.0f);
    }
    ...
    protected int h(Context context) {
        return (int) StyleUtils.a(context, 28.0f);
    }

    protected int i(Context context) {
        return (int) StyleUtils.a(context, 14.0f);
    }
