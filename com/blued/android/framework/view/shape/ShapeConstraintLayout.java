...
public class ShapeConstraintLayout extends ConstraintLayout implements BluedSkinSupportable, ShapeHelper.ShapeView {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        ...
        this.a = shapeModel;
        shapeModel.a = obtainStyledAttributes.getBoolean(R.styleable.ShapeConstraintLayout_bg_default_touch, false);
        this.a.h = obtainStyledAttributes.getDrawable(R.styleable.ShapeConstraintLayout_bg_drawable);
        this.a.i = obtainStyledAttributes.getDrawable(R.styleable.ShapeConstraintLayout_bg_touch_drawable);
        this.a.j = obtainStyledAttributes.getDrawable(R.styleable.ShapeConstraintLayout_bg_unable_drawable);
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_solid_color)) {
            ...
            this.a.k = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_solid_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_solid_touch_color)) {
            ...
            this.a.l = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_solid_touch_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_solid_unable_color)) {
            ...
            this.a.m = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_solid_unable_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_stroke_color)) {
            ...
            this.a.n = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_stroke_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_stroke_touch_color)) {
            ...
            this.a.o = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_stroke_touch_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_stroke_unable_color)) {
            ...
            this.a.p = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_stroke_unable_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_start_color)) {
            ...
            this.a.t = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_start_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_center_color)) {
            ...
            this.a.u = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_center_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_end_color)) {
            ...
            this.a.v = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_end_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_start_touch_color)) {
            ...
            this.a.w = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_start_touch_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_center_touch_color)) {
            ...
            this.a.x = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_center_touch_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_end_touch_color)) {
            ...
            this.a.y = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_end_touch_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_start_unable_color)) {
            ...
            this.a.z = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_start_unable_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_center_unable_color)) {
            ...
            this.a.A = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_center_unable_color, 0);
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.ShapeConstraintLayout_gradient_end_unable_color)) {
            ...
            this.a.B = obtainStyledAttributes.getColor(R.styleable.ShapeConstraintLayout_gradient_end_unable_color, 0);
            this.a.ai = com.android.internal.R.color.transparent;
        }
        this.a.q = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_stroke_width, 0.0f);
        this.a.r = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_stroke_dash_width, 0.0f);
        this.a.s = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_stroke_dash_gap, 0.0f);
        this.a.H = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_corner_radius, 0.0f);
        this.a.I = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_top_left_radius, 0.0f);
        this.a.J = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_top_right_radius, 0.0f);
        this.a.K = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_bottom_left_radius, 0.0f);
        this.a.L = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_bottom_right_radius, 0.0f);
        this.a.C = obtainStyledAttributes.getInt(R.styleable.ShapeConstraintLayout_gradient_angle, 0);
        this.a.D = obtainStyledAttributes.getInt(R.styleable.ShapeConstraintLayout_gradient_type, 0);
        this.a.E = obtainStyledAttributes.getDimension(R.styleable.ShapeConstraintLayout_gradient_radius, 0.0f);
        this.a.F = obtainStyledAttributes.getFloat(R.styleable.ShapeConstraintLayout_gradient_center_x, 0.5f);
        this.a.G = obtainStyledAttributes.getFloat(R.styleable.ShapeConstraintLayout_gradient_center_y, 0.5f);
        this.a.M = obtainStyledAttributes.getInt(R.styleable.ShapeConstraintLayout_bg_model, 0);
        this.a.N = obtainStyledAttributes.getInt(R.styleable.ShapeConstraintLayout_shape_type, 0);
        this.a.O = obtainStyledAttributes.getFloat(R.styleable.ShapeConstraintLayout_wh_ratio, 0.0f);
        this.a.aj = obtainStyledAttributes.getBoolean(R.styleable.ShapeConstraintLayout_supportsRtl, true);
    ...
    public void applySkin() {
        Log.e("skin", "ShapeConstraintLayout apply skin solidColor = " + this.a.U);
        try {
