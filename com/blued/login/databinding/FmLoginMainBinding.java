...
public final class FmLoginMainBinding implements ViewBinding {
    ...
    private FmLoginMainBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, FrameLayout frameLayout, FrameLayout frameLayout2, FrameLayout frameLayout3, ImageView imageView, ImageView imageView2, LoginIndicator loginIndicator, TextView textView, ShapeTextView shapeTextView, TextView textView2, ShapeTextView shapeTextView2, TXCloudVideoView tXCloudVideoView, TagViewPager tagViewPager) {
        ...
        this.f6913a = constraintLayout2;
        this.b = frameLayout;
        this.f6914c = frameLayout2;
        this.d = frameLayout3;
        this.e = imageView;
        this.f = imageView2;
                        ...
                        if (imageView != null) {
                            ...
                            if (imageView2 != null) {
                                ...
                                if (loginIndicator != null) {
                                    ...
                                    if (textView != null) {
                                        ShapeTextView findViewById = view.findViewById(R.id.tv_mobile);
                                        if (findViewById != null) {
                                            TextView textView2 = (TextView) view.findViewById(R.id.tv_other);
                                            if (textView2 != null) {
                                                ShapeTextView findViewById2 = view.findViewById(R.id.tv_wechat);
                                                if (findViewById2 != null) {
                                                    ...
                                                    if (tXCloudVideoView != null) {
                                                        ...
                                                        if (tagViewPager != null) {
                                                            return new FmLoginMainBinding((ConstraintLayout) view, constraintLayout, frameLayout, frameLayout2, frameLayout3, imageView, imageView2, loginIndicator, textView, findViewById, textView2, findViewById2, tXCloudVideoView, tagViewPager);
                                                        }
                                                        str = "viewPager";
                                                    } else {
                                                        str = "videoView";
