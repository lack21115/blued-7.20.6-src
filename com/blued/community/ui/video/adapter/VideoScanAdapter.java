...
/* loaded from: source-7206380-dex2jar.jar:com/blued/community/ui/video/adapter/VideoScanAdapter.class */
public class VideoScanAdapter extends RecyclerView.Adapter<ViewHolder> {

    /* renamed from: a  reason: collision with root package name */
    PagerSnapHelper f6718a;
    public boolean b;
    ...
    RecyclerView.OnScrollListener d = new RecyclerView.OnScrollListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.3
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int i) {
            ...
            if (i != 0) {
                ...
                if (!h) {
                    ...
                    return;
                } else if ((layoutManager instanceof LinearLayoutManager) && ((LinearLayoutManager) layoutManager).findLastVisibleItemPosition() > VideoScanAdapter.this.g.size() - 5 && h) {
                    ...
                    if (ShineVideoDataManager.a().g()) {
                        ...
                        ShineVideoDataManager.a().a(false, (IRequestHost) VideoScanAdapter.this.j.getFragmentActive());
                        return;
                    }
                    return;
                } else {
            ...
            View findSnapView = VideoScanAdapter.this.f6718a.findSnapView(layoutManager);
            ...
            if (TextUtils.equals(pLVideoPageView.getVideoUrl(), pLVideoPageView2.getVideoUrl()) && VideoScanAdapter.this.l == findSnapView) {
                return;
            }
    ...
    /* loaded from: source-7206380-dex2jar.jar:com/blued/community/ui/video/adapter/VideoScanAdapter$PageChangeListener.class */
    public interface PageChangeListener {
        void a(PLVideoPageView pLVideoPageView);
    }

    /* loaded from: source-7206380-dex2jar.jar:com/blued/community/ui/video/adapter/VideoScanAdapter$ViewHolder.class */
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, PLVideoPageView.OnPLVideoListener {
        ...
        /* renamed from: c  reason: collision with root package name */
        SeekBar.OnSeekBarChangeListener f6724c;
        ...
        public ViewHolder(View view) {
            ...
            this.Z = new View.OnClickListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.2
                ...
                public void onClick(View view2) {
                    ...
                    ViewHolder.this.W.setThumb(VideoScanAdapter.this.e.getResources().getDrawable(R.drawable.shape_video_oval_anim));
                    ViewHolder.this.W.setThumbOffset(0);
                    ViewHolder.this.W.setOnSeekBarChangeListener(ViewHolder.this.f6724c);
            ...
            this.b = new Runnable() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.4
            ...
            this.f6724c = new SeekBar.OnSeekBarChangeListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.5
                @Override // android.widget.SeekBar.OnSeekBarChangeListener
                public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                    if (z) {
                        ViewHolder.this.b(seekBar.getProgress());
                    }
                }
            ...
            this.f6723a = (ImageView) view.findViewById(R.id.video_animation);
            ...
            int a2 = StatusBarHelper.a(VideoScanAdapter.this.e);
        ...
        private void c(BluedIngSelfFeed bluedIngSelfFeed) {
            ...
            ImageLoader.a(VideoScanAdapter.this.j == null ? null : VideoScanAdapter.this.j.getFragmentActive(), bluedIngSelfFeed.user_avatar).b(R.drawable.user_bg_round).c().a(this.g);
            UserInfoHelper.a(this.t, bluedIngSelfFeed.vbadge, 3);
            if (bluedIngSelfFeed.live > 0) {
                this.t.setVisibility(8);
                this.h.setVisibility(0);
                this.i.setVisibility(0);
                Animation loadAnimation = AnimationUtils.loadAnimation(VideoScanAdapter.this.e, R.anim.anim_feed_list_living);
            ...
            UserInfoHelper.a(VideoScanAdapter.this.e, this.j, userBasicModel, R.color.syc_dark_b);
            ...
            this.m.setText(DistanceUtils.a(VideoScanAdapter.this.e, Integer.toString(bluedIngSelfFeed.feed_dig)));
            this.n.setText(DistanceUtils.a(VideoScanAdapter.this.e, Integer.toString(bluedIngSelfFeed.feed_comment)));
            this.o.setText(DistanceUtils.a(VideoScanAdapter.this.e, Integer.toString(bluedIngSelfFeed.repost_count)));
            ...
            ImageLoader.a(VideoScanAdapter.this.j == null ? null : VideoScanAdapter.this.j.getFragmentActive(), AvatarUtils.a(1, bluedIngSelfFeed.music.music_cover)).b(R.drawable.user_bg_round).c().a(this.N);
        }
        ...
        private void g() {
            ...
            ImageLoader.c(VideoScanAdapter.this.f, "video_like.png").e(VideoScanAdapter.this.f6718a.hashCode()).g(1).a(new ImageLoader.OnAnimationStateListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.6
                public void a() {
                }

                public void b() {
                    ViewHolder.this.f6723a.setVisibility(8);
                }
            }).a(this.f6723a);
        }
        ...
        private void h() {
            ...
            if (!this.R) {
                ...
                logData.is_new_face = this.Y.is_new_face;
                logData.tips = this.Y.tips;
                logData.recommend_time = this.Y.recommend_time;
                CommunityServiceManager.d().a(logData);
                FeedDetailsFragment.a(VideoScanAdapter.this.e, this.Y, 8, new FeedDetailParams(7));
            }
            this.e.postDelayed(new Runnable() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.7
                @Override // java.lang.Runnable
                public void run() {
        ...
        private void i() {
            FeedHttpUtils.a(VideoScanAdapter.this.e, new BluedUIHttpResponse<BluedEntity>() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.8
            ...
            }, UserInfoUtils.c(), this.Y.feed_id, this.Y.is_ads, "", VideoScanAdapter.this.j.getFragmentActive());
        }

        private void j() {
            FeedHttpUtils.a(VideoScanAdapter.this.e, new BluedUIHttpResponse<BluedEntity>() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.9
                public void onFailure(Throwable th, int i, String str) {
                    Pair a2 = BluedHttpUtils.a(th, i, str);
                    if (a2 == null || ((Integer) a2.first).intValue() != 404100) {
                        super.onFailure(th, i, str);
        ...
        private void k() {
            synchronized (this) {
                ...
                CommunityHttpUtils.b(VideoScanAdapter.this.e, new CommunityHttpUtils.IAddOrRemoveAttentionDone() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.10
                    public void a() {
                        DialogUtils.a(VideoScanAdapter.this.j.l);
                    }

                    public void a(String str) {
                        if ("1".equalsIgnoreCase(str) || "3".equalsIgnoreCase(str)) {
                            ViewHolder.this.x.setImageResource(R.drawable.show_video_attentioned);
                            AppInfo.n().postDelayed(new Runnable() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.10.1
                                @Override // java.lang.Runnable
                                public void run() {
                        ...
                        ShineVideoDataManager.a().a(ViewHolder.this.Y.feed_id, ViewHolder.this.Y.relationship);
                    }

                    public void b() {
                        DialogUtils.b(VideoScanAdapter.this.j.l);
                    }
                ...
                }, this.Y.feed_uid, "", VideoScanAdapter.this.j.getFragmentActive());
        ...
        public void l() {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.11
        ...
        private void m() {
            ...
            ImageFileLoader.a((IRequestHost) null).b(this.Y.user_avatar).a(new ImageFileLoader.OnLoadFileListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.12
                public void onUIFinish(File file, Exception exc) {
                    CommunityShareUtils.b().a(VideoScanAdapter.this.e, null, (file == null || !file.exists()) ? null : BitmapFactory.decodeFile(file.getPath()), ViewHolder.this.Y, "shine_video_list_detail", false, 5, "", -1, 8);
                }
            }).a();
        }
        ...
        public void a(int i) {
            ...
            String a2 = videoScanAdapter.a(videoScanAdapter.o);
            if (TextUtils.isEmpty(a2)) {
                return;
            }
            Logger.c("pre_video", new Object[]{a2});
            this.f.a(a2);
        }
        ...
        public void a(long j, long j2) {
            ...
            if (this.W.getThumb() instanceof AnimationDrawable) {
                ...
                VideoLoadingView videoLoadingView2 = this.S;
                if (videoLoadingView2 != null && videoLoadingView2.getVisibility() == 0) {
                    f();
                }
                this.W.setThumb(VideoScanAdapter.this.e.getResources().getDrawable(R.drawable.shape_video_oval_two_write));
                this.W.setThumbOffset(0);
                this.W.setOnSeekBarChangeListener(this.f6724c);
                Logger.b("xpf", new Object[]{"---------------------"});
            }
            this.U.setText(VideoScanAdapter.this.r.format(new Date(j4)));
            this.V.setText(VideoScanAdapter.this.r.format(new Date(j2)));
            if (j2 <= 60000) {
                this.l.setVisibility(8);
            } else if (this.l.getVisibility() == 8) {
                this.l.setVisibility(0);
                this.l.setText(VideoScanAdapter.this.e.getResources().getString(R.string.short_video_long));
            }
        }
        ...
        public void a(long j, long j2, int i) {
            ...
            this.U.setText(VideoScanAdapter.this.r.format(new Date(j)));
            this.V.setText(VideoScanAdapter.this.r.format(new Date(j2)));
        ...
        public void a(BluedIngSelfFeed bluedIngSelfFeed, int i) {
            ...
            c(bluedIngSelfFeed);
            VideoScanAdapter.this.a(this.Y, this.f, this.Z);
            ...
            if (this.Y.feed_videos != null) {
                if (VideoScanAdapter.this.l == null) {
                    if (ShineVideoDataManager.a().j() == i) {
                        CommunityServiceManager.d().a("shine_video_detail_show");
                        this.f.c();
                        VideoScanAdapter.this.l = this.e;
                        VideoScanAdapter.this.o = i;
                        if (VideoScanAdapter.this.k != null) {
                            VideoScanAdapter.this.k.a(this.f);
                        }
                    }
                } else if (VideoScanAdapter.this.l == this.e) {
                    this.f.c();
                    String a2 = VideoScanAdapter.this.a(ShineVideoDataManager.a().j());
                    if (!TextUtils.isEmpty(a2)) {
                        Logger.c("pre_video", new Object[]{a2});
                        this.f.a(a2);
                    }
            ...
            if (this.Y.is_top_hot == 1) {
                ...
                this.P.setOnClickListener(new View.OnClickListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.1
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        ...
                        HotFeedFragment.a.a(VideoScanAdapter.this.e);
                    }
                });
            } else {
        ...
        public void b(long j, long j2, int i) {
            ...
            AppInfo.n().removeCallbacks(this.b);
            this.f.a(j, i, new PLVideoPageView.OnSeekListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.ViewHolder.3
            });
            this.U.setText(VideoScanAdapter.this.r.format(new Date(j)));
            this.V.setText(VideoScanAdapter.this.r.format(new Date(j2)));
        ...
        public void c() {
            ...
            this.I.setVisibility(0);
            this.K.setVisibility(0);
            Animation loadAnimation = AnimationUtils.loadAnimation(VideoScanAdapter.this.e, R.anim.anim_music_cover_rotate_repeat);
            loadAnimation.setInterpolator(new LinearInterpolator());
            this.L.startAnimation(loadAnimation);
            this.O.setVisibility(0);
            ImageLoader.c(VideoScanAdapter.this.f, "video_scan_music_anim.png").g(-1).f().a(this.O);
            this.J.setLines(1);
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.lay_like) {
                ...
                if (id == R.id.img_share_vr) {
                    ...
                    FeedAddPostFragment.a(VideoScanAdapter.this.e);
                } else if (id == R.id.tv_comment) {
                    CommunityServiceManager.d().b(5, this.Y, "", -1);
                    VideoScanAdapter.this.j.i();
                    ...
                    if (this.Y.live > 0) {
                        CommunityServiceManager.b().a(VideoScanAdapter.this.e, userBasicModel, this.Y.live);
                    } else {
                        LogData logData = new LogData();
                        logData.feed_id = this.Y.feed_id;
                        logData.strong_insert_data = this.Y.strong_insert_data;
                        CommunityServiceManager.b().a(VideoScanAdapter.this.e, userBasicModel, FeedMethods.a(VideoScanAdapter.this.f6719c, 0), false, this.g, logData, MessageProtos.StrangerSource.FIND_PLAZA_FLASH_DETAIL);
                    }
                    LogData logData2 = new LogData();
                    logData2.logService = "shine_video_detail_to_profile";
                    logData2.target_uid = this.Y.feed_uid;
                    logData2.id = this.Y.feed_id;
                    if (!TextUtils.isEmpty(this.Y.recommend_text)) {
                        logData2.db_id = this.Y.recommend_text;
                    }
                    CommunityServiceManager.d().a(logData2);
                    ...
                    ShineVideoDataManager.a().d(this.Y);
                } else if (id == R.id.lay_location) {
                    CommunityServiceManager.d().a("shine_video_position_area_click");
                    if (b(this.Y)) {
                        CommunityServiceManager.b().a(VideoScanAdapter.this.e, this.Y.location_lot, this.Y.location_lat, this.Y.location);
                    }
                } else if (id == R.id.lay_music || id == R.id.lay_music_cd) {
                    MusicVideoCollectFragment.a(VideoScanAdapter.this.e, this.Y.music);
                }
            }
        }
    }
    ...
    private void f() {
        ...
        this.h.addOnItemTouchListener(new RecyclerView.SimpleOnItemTouchListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.1
            @Override // androidx.recyclerview.widget.RecyclerView.SimpleOnItemTouchListener, androidx.recyclerview.widget.RecyclerView.OnItemTouchListener
            public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
                return VideoScanAdapter.this.m.onTouchEvent(motionEvent);
            }
        });
        this.m = new GestureDetector(this.e, new GestureDetector.SimpleOnGestureListener() { // from class: com.blued.community.ui.video.adapter.VideoScanAdapter.2
            @Override // android.view.GestureDetector.SimpleOnGestureListener, android.view.GestureDetector.OnDoubleTapListener
            public boolean onDoubleTap(MotionEvent motionEvent) {
                if (VideoScanAdapter.this.l == null || VideoScanAdapter.this.n) {
                    return false;
                }
                ((ViewHolder) VideoScanAdapter.this.h.getChildViewHolder(VideoScanAdapter.this.l)).a(false);
                return false;
            }
            ...
            public void onLongPress(MotionEvent motionEvent) {
                ...
                if (VideoScanAdapter.this.l != null && !VideoScanAdapter.this.n && !VideoScanAdapter.this.j.n) {
                    ((ViewHolder) VideoScanAdapter.this.h.getChildViewHolder(VideoScanAdapter.this.l)).l();
                }
            ...
            public boolean onSingleTapConfirmed(MotionEvent motionEvent) {
                ...
                ((ViewHolder) VideoScanAdapter.this.h.getChildViewHolder(VideoScanAdapter.this.l)).f.d();
                return false;
            }
        });
    }
    ...
    public String a(int i) {
        ...
        int i2 = i + 1;
        return (i2 >= ShineVideoDataManager.a().b().size() || (bluedIngSelfFeed = ShineVideoDataManager.a().b().get(i2)) == null || bluedIngSelfFeed.feed_videos == null || bluedIngSelfFeed.feed_videos.length < 2) ? "" : bluedIngSelfFeed.feed_videos[1];
    }
    ...
    public void a() {
        ...
        for (BluedIngSelfFeed bluedIngSelfFeed : b) {
