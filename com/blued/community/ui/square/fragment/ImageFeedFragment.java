...
public class ImageFeedFragment extends MvpFragment<ImageFeedPresenter> {
    ...
    private void b() {
        ...
        this.f20149c = (RecyclerView) this.i.findViewById(R.id.recycler_view);
        this.d = (SmartRefreshLayout) this.i.findViewById(R.id.refresh_layout);
        this.e = (FloatFooterView) this.i.findViewById(R.id.ll_feed_post);
    }
    ...
    private void c() {
        ...
        if (this.g == null) {
            this.g = new FeedListAdapterForRecyclerView(getContext(), this, this.f20149c, 10);
            NoDataAndLoadFailView noDataAndLoadFailView = new NoDataAndLoadFailView(this.f20148a);
            this.f = noDataAndLoadFailView;
            this.g.setEmptyView(noDataAndLoadFailView);
        }
        j().a(this.g);
        this.f20149c.setAdapter(this.g);
        this.f20149c.setLayoutManager(new GridLayoutManager(getContext(), 1));
        this.f20149c.addOnScrollListener(this.k);
