...
@Metadata
/* loaded from: source-5961304-dex2jar.jar:com/blued/community/ui/subject/fragment/FeedSubjectJoinedFragment.class */
public final class FeedSubjectJoinedFragment extends CommonRecyclerFragment<BluedTopic, BluedEntityBaseExtra> {
    ...
    public CommonMultiItemAdapter<BluedTopic> g() {
        return new FeedSubjectListAdapter(1);
    }
    ...
    @Override // com.blued.community.ui.common.CommonRecyclerFragment
    public String l() {
        return Intrinsics.a(CommunityHttpUtils.a(), (Object) "/ticktocks/super_topics/recorded?filter=joined");
    }
}
