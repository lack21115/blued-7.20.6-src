...
public final class CommentedFeedFragment extends BaseListFragment<CommentedFeedViewModel, BluedIngSelfFeed> {
    ...
    public void m() {
        ...
        if (c4 != null) {
            c4.setNoDataBtnListener(new View.OnClickListener() { // from class: com.blued.community.ui.feed.fragment.-$$Lambda$CommentedFeedFragment$mZ2AEHhughYIXErZxsgTPd4UBow
        ...
        CommentedFeedFragment commentedFeedFragment = this;
        RecyclerView a2 = a();
        ...
        FeedMethods.a(commentedFeedFragment, (FeedListAdapterForRecyclerView) adapter);
    }
