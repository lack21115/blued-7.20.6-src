...
public final class FeedBubblePostGuideDlgFragment$adapter$1 extends CommonMultiItemAdapter<FeedPostSignStateItem> {
    ...
    public void onConvert(CommonViewHolder holder, final FeedPostSignStateItem model, int i) {
        ...
        feedPostSignStateItem = this.f19711a.d;
        boolean a2 = StringsKt.a((CharSequence) bubble_state_id, (CharSequence) (feedPostSignStateItem == null ? null : feedPostSignStateItem.getBubble_state_id()));
        View view = holder.setImageUrl(R.id.state_iv, model.getIcon(), 25.0f).setText(R.id.state_tv, model.getName()).setBackgroundRes(R.id.state_iv_layout, a2 ? R.drawable.item_feed_bubble_iv_selected : CommunityManager.f19086a.a().s() ? R.drawable.item_feed_post_sign_state_iv_bg_black : R.drawable.item_feed_post_sign_state_iv_bg).setTextColor(R.id.state_tv, BluedSkinUtils.a(this.mContext, a2 ? R.color.syc_h : R.color.syc_k)).itemView;
        final FeedBubblePostGuideDlgFragment feedBubblePostGuideDlgFragment = this.f19711a;
