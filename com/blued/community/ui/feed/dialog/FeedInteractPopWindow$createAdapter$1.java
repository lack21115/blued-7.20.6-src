...
public final class FeedInteractPopWindow$createAdapter$1 extends CommonRecycleAdapter<FeedInteractItemModel> {
    final /* synthetic */ FeedInteractPopWindow a;
    ...
    public void onBindViewHolderData(final FeedInteractItemModel item, final int i, final CommonRecycleAdapter.CommonAdapterHolder viewHolder) {
        ...
        Intrinsics.e(item, "item");
        Intrinsics.e(viewHolder, "viewHolder");
        ((LinearLayout) viewHolder.a(R.id.item_feed_interact_content_ly)).setPadding(0, 0, DisplayUtil.a(this.a.getContext(), i != this.dataList.size() - 1 ? 9.0f : 0.0f), 0);
        CommonRecycleAdapter.CommonAdapterHolder a = viewHolder.a(R.id.item_feed_interact_tv, item.getName());
        int i4 = R.id.item_feed_interact_tv;
        Resources resources = this.a.getResources();
        if (i == 0) {
            i3 = this.a.getFeedData().iliked == 1 ? R.color.syc_g : R.color.syc_k;
        } else {
            i2 = this.a.B;
            i3 = i2 == i ? R.color.syc_g : R.color.syc_k;
        }
        a.a(i4, resources.getColor(i3));
        ImageView imageView = (ImageView) viewHolder.a(R.id.item_feed_interact_iv);
        ImageLoader.c(this.a.getFragmentActive(), item.getDrawableRes()).e(imageView.hashCode()).g(-1).a(imageView);
        View a2 = viewHolder.a();
        final FeedInteractPopWindow feedInteractPopWindow = this.a;
        a2.setOnClickListener(new View.OnClickListener() { // from class: com.blued.community.ui.feed.dialog.-$$Lambda$FeedInteractPopWindow$createAdapter$1$Ei8r6cgF3nhKQC_pY8xbqRCUVr8
