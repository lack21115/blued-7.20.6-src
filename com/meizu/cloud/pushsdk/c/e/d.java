...
public class d extends Handler {
    ...
    private final WeakReference<com.meizu.cloud.pushsdk.c.d.a> f24056a;

    public d(com.meizu.cloud.pushsdk.c.d.a aVar) {
        super(Looper.getMainLooper());
        this.f24056a = new WeakReference<>(aVar);
    }

    @Override // android.os.Handler
    public void handleMessage(Message message) {
        com.meizu.cloud.pushsdk.c.d.a aVar = this.f24056a.get();
        if (message.what != 1) {
            super.handleMessage(message);
        } else if (aVar != null) {
            com.meizu.cloud.pushsdk.c.f.a aVar2 = (com.meizu.cloud.pushsdk.c.f.a) message.obj;
            aVar.a(aVar2.f24057a, aVar2.b);
        }
    }
}
