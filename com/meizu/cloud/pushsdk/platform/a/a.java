...
public class a {
    ...
    public a(Context context) {
        this.f10566a = "https://api-push.meizu.com/garcia/api/client/";
        this.b = this.f10566a + "message/registerPush";
        this.f10567c = this.f10566a + "message/unRegisterPush";
        this.d = this.f10566a + "advance/unRegisterPush";
        this.e = this.f10566a + "message/getRegisterSwitch";
        this.f = this.f10566a + "message/changeRegisterSwitch";
        this.g = this.f10566a + "message/changeAllSwitch";
        this.h = this.f10566a + "message/subscribeTags";
        this.i = this.f10566a + "message/unSubscribeTags";
        this.j = this.f10566a + "message/unSubAllTags";
        this.k = this.f10566a + "message/getSubTags";
        this.l = this.f10566a + "message/subscribeAlias";
        this.m = this.f10566a + "message/unSubscribeAlias";
        this.n = this.f10566a + "message/getSubAlias";
        this.o = this.f10566a + "advance/changeRegisterSwitch";
        com.meizu.cloud.pushsdk.c.a.a();
        if (MzSystemUtils.isOverseas()) {
            this.f10566a = "https://api-push.in.meizu.com/garcia/api/client/";
            this.b = this.f10566a + "message/registerPush";
            this.f10567c = this.f10566a + "message/unRegisterPush";
            this.d = this.f10566a + "advance/unRegisterPush";
            this.e = this.f10566a + "message/getRegisterSwitch";
    ...
    public c a(String str, String str2, String str3) {
        ...
        linkedHashMap2.put(com.anythink.expressad.d.a.b.d, com.meizu.cloud.pushsdk.platform.b.a(linkedHashMap, str2));
    ...
    public c<String> a(String str, String str2, String str3, File file) {
        ...
        LinkedHashMap linkedHashMap2 = new LinkedHashMap(linkedHashMap);
        linkedHashMap2.put(com.anythink.expressad.d.a.b.d, com.meizu.cloud.pushsdk.platform.b.a(linkedHashMap, "4a2ca769d79f4856bb3bd982d30de790"));
    ...
    public c b(String str, String str2, String str3) {
        ...
        return com.meizu.cloud.pushsdk.c.a.a(this.f10567c).a(linkedHashMap2).a().a();
    }
