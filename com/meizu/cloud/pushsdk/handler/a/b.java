...
/* loaded from: source-8303388-dex2jar.jar:com/meizu/cloud/pushsdk/handler/a/b.class */
    ...
    public boolean a(Intent intent) {
        ...
        if (a(0, g(intent))) {
            ...
            if (PushConstants.MZ_PUSH_ON_MESSAGE_ACTION.equals(intent.getAction())) {
                z = false;
                if (PushConstants.MZ_PUSH_MESSAGE_METHOD_ACTION_NOTIFICATION_SHOW.equals(k(intent))) {
                    z = true;
                }
            }
            return z;
