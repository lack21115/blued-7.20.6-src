...
/* loaded from: source-8303388-dex2jar.jar:com/meizu/cloud/pushsdk/handler/a/e/c.class */
public class c extends com.meizu.cloud.pushsdk.handler.a.a<RegisterStatus> {
    ...
    public RegisterStatus c(Intent intent) {
        ...
        if (!TextUtils.isEmpty(a2.getPushId())) {
            com.meizu.cloud.pushsdk.util.b.g(d(), a2.getPushId(), d().getPackageName());
            com.meizu.cloud.pushsdk.util.b.a(d(), (int) ((System.currentTimeMillis() / 1000) + a2.getExpireTime()), d().getPackageName());
        }
        return a2;
    }
}
