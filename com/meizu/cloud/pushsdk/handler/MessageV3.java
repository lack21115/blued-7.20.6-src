...
/* loaded from: source-8303388-dex2jar.jar:com/meizu/cloud/pushsdk/handler/MessageV3.class */
        ...
        try {
            ...
            if (!jSONObject.isNull("extra")) {
                ...
                if (!jSONObject2.isNull("ns")) {
                    messageV3.setNotificationStyle(NotificationStyle.parse(jSONObject2.getJSONObject("ns")));
                }
