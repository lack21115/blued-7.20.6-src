...
/* loaded from: source-8829756-dex2jar.jar:com/vivo/push/util/q.class */
public final class q {
    ...
    public static String b(InsideNotificationItem insideNotificationItem) {
        ...
        jSONArray.put(insideNotificationItem.getParams() != null ? new JSONObject(insideNotificationItem.getParams()) : "{}");
