...
/* loaded from: source-8829756-dex2jar.jar:com/zego/zegoavkit2/utils/SoLoadUtil.class */
            ...
            try {
                ...
                if (!file2.exists() || file2.length() != file.length()) {
                    try {
                        ...
                        Log.e("Java_ZegoAVKit", String.format("copyFile from %s to %s failed", file, file2), e2);
                    }
                }
    ...
    */
    private static int unzipSo(android.content.Context r5, java.lang.String r6, java.io.File r7, java.io.File r8) {
        ...
        L4b:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zego.zegoavkit2.utils.SoLoadUtil.unzipSo(android.content.Context, java.lang.String, java.io.File, java.io.File):int");
    }
