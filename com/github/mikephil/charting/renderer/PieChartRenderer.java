...
public class PieChartRenderer extends DataRenderer {
    ...
    protected PieChart f8584a;
    protected Paint b;

    /* renamed from: c  reason: collision with root package name */
    protected Paint f8585c;
    protected Paint d;
    ...
    protected float a(IPieDataSet iPieDataSet) {
        if (iPieDataSet.b() && iPieDataSet.a() / this.o.o() > (iPieDataSet.J() / ((PieData) this.f8584a.getData()).l()) * 2.0f) {
            return 0.0f;
        }
    ...
    protected float a(MPPointF mPPointF, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        float cos = mPPointF.f8597a + (((float) Math.cos(d)) * f);
        float sin = mPPointF.b + (((float) Math.sin(d)) * f);
        double d2 = (f5 + (f6 / 2.0f)) * 0.017453292f;
        return (float) ((f - ((float) ((Math.sqrt(Math.pow(cos - f3, 2.0d) + Math.pow(sin - f4, 2.0d)) / 2.0d) * Math.tan(((180.0d - f2) / 2.0d) * 0.017453292519943295d)))) - Math.sqrt(Math.pow((mPPointF.f8597a + (((float) Math.cos(d2)) * f)) - ((cos + f3) / 2.0f), 2.0d) + Math.pow((mPPointF.b + (((float) Math.sin(d2)) * f)) - ((sin + f4) / 2.0f), 2.0d)));
    }
    ...
    */
    public void a(android.graphics.Canvas r6) {
        ...
        L74:
            ...
            r0.eraseColor(r1)
            r0 = r5
            com.github.mikephil.charting.charts.PieChart r0 = r0.f8584a
    ...
    protected void a(Canvas canvas, IPieDataSet iPieDataSet) {
        ...
        float rotationAngle = pieChartRenderer2.f8584a.getRotationAngle();
        float b = pieChartRenderer2.g.b();
        float a2 = pieChartRenderer2.g.a();
        RectF circleBox = pieChartRenderer2.f8584a.getCircleBox();
        int H = iPieDataSet.H();
        float[] drawAngles = pieChartRenderer2.f8584a.getDrawAngles();
        MPPointF centerCircleBox = pieChartRenderer2.f8584a.getCenterCircleBox();
        float radius = pieChartRenderer2.f8584a.getRadius();
        boolean z = pieChartRenderer2.f8584a.d() && !pieChartRenderer2.f8584a.c();
        float holeRadius = z ? (pieChartRenderer2.f8584a.getHoleRadius() / 100.0f) * radius : 0.0f;
        float holeRadius2 = (radius - ((pieChartRenderer2.f8584a.getHoleRadius() * radius) / 100.0f)) / 2.0f;
        RectF rectF2 = new RectF();
        boolean z2 = z && pieChartRenderer2.f8584a.g();
        int i2 = 0;
        int i3 = 0;
        while (true) {
            i = i3;
        ...
        while (i5 < H) {
            ...
            if (Math.abs(iPieDataSet.e(i5).b()) > Utils.b && (!pieChartRenderer2.f8584a.a(i5) || z2)) {
                ...
                if (z2) {
                    ...
                    float cos = centerCircleBox.f8597a + (((float) Math.cos(d)) * f9);
                ...
                float cos2 = centerCircleBox.f8597a + (((float) Math.cos(d2)) * radius);
                ...
                if (i6 < 0 || f8 % 360.0f > Utils.b) {
                    ...
                    pieChartRenderer2.u.addCircle(centerCircleBox.f8597a, centerCircleBox.b, radius, Path.Direction.CW);
                }
                pieChartRenderer2.v.set(centerCircleBox.f8597a - holeRadius, centerCircleBox.b - holeRadius, centerCircleBox.f8597a + holeRadius, centerCircleBox.b + holeRadius);
                if (!z || (holeRadius <= 0.0f && !z3)) {
                    ...
                    if (i6 < 0 || f8 % 360.0f > Utils.b) {
                        if (z2) {
                            ...
                            float cos3 = centerCircleBox.f8597a + (((float) Math.cos(d4)) * f18);
                            ...
                            this.u.lineTo(centerCircleBox.f8597a + (((float) Math.cos(d5)) * f12), centerCircleBox.b + (f12 * ((float) Math.sin(d5))));
                        }
                        this.u.arcTo(this.v, f17, -f16);
                    } else {
                        this.u.addCircle(centerCircleBox.f8597a, centerCircleBox.b, f12, Path.Direction.CCW);
                    }
    ...
    public void a(Canvas canvas, Highlight[] highlightArr) {
        ...
        float f;
        float f2;
        boolean z = this.f8584a.d() && !this.f8584a.c();
        if (z && this.f8584a.g()) {
            return;
        }
        float b = this.g.b();
        float a3 = this.g.a();
        float rotationAngle = this.f8584a.getRotationAngle();
        float[] drawAngles = this.f8584a.getDrawAngles();
        float[] absoluteAngles = this.f8584a.getAbsoluteAngles();
        MPPointF centerCircleBox = this.f8584a.getCenterCircleBox();
        float radius = this.f8584a.getRadius();
        float holeRadius = z ? (this.f8584a.getHoleRadius() / 100.0f) * radius : 0.0f;
        RectF rectF = this.m;
        ...
        while (true) {
            ...
            if (a4 < drawAngles.length && (a2 = ((PieData) this.f8584a.getData()).a(highlightArr[i3].f())) != null && a2.p()) {
                int H = a2.H();
                int i4 = 0;
                int i5 = 0;
                while (true) {
                ...
                float c2 = a2.c();
                float f5 = radius + c2;
                rectF.set(this.f8584a.getCircleBox());
                float f6 = -c2;
                rectF.inset(f6, f6);
                ...
                if (i7 < 0 || f10 % 360.0f > Utils.b) {
                    Path path = this.u;
                    float f14 = centerCircleBox.f8597a;
                    ...
                    this.u.addCircle(centerCircleBox.f8597a, centerCircleBox.b, f5, Path.Direction.CW);
                }
                if (z2) {
                    float f15 = centerCircleBox.f8597a;
                ...
                this.v.set(centerCircleBox.f8597a - f16, centerCircleBox.b - f16, centerCircleBox.f8597a + f16, centerCircleBox.b + f16);
                if (z && (f16 > 0.0f || z2)) {
                    if (z2) {
                        float f17 = f;
                        if (f < 0.0f) {
                    ...
                    if (i7 < 0 || f10 % 360.0f > Utils.b) {
                        Path path2 = this.u;
                        float f23 = centerCircleBox.f8597a;
                        ...
                        this.u.addCircle(centerCircleBox.f8597a, centerCircleBox.b, f2, Path.Direction.CCW);
                    }
                } else if (f10 % 360.0f > Utils.b) {
                    if (z2) {
                        float f24 = centerCircleBox.f8597a;
                        double d4 = (f9 + (f10 / 2.0f)) * 0.017453292f;
                        this.u.lineTo(f24 + (((float) Math.cos(d4)) * f), centerCircleBox.b + (f * ((float) Math.sin(d4))));
                    } else {
                        this.u.lineTo(centerCircleBox.f8597a, centerCircleBox.b);
                    }
                }
                this.u.close();
    ...
    public void b(Canvas canvas) {
        ...
        float b = this.g.b();
        float a2 = this.g.a();
        float holeRadius = (radius - ((this.f8584a.getHoleRadius() * radius) / 100.0f)) / 2.0f;
        float holeRadius2 = this.f8584a.getHoleRadius() / 100.0f;
        ...
        float f12 = f10;
        float f13 = radius - f9;
        PieData pieData = (PieData) this.f8584a.getData();
        List<IPieDataSet> i = pieData.i();
        float l = pieData.l();
        boolean f14 = this.f8584a.f();
        canvas.save();
        ...
        while (i3 < i.size()) {
            ...
            if (y || f14) {
                ...
                for (int i4 = 0; i4 < H; i4++) {
                    ...
                    String a6 = q.a(this.f8584a.i() ? (e2.b() / l) * 100.0f : e2.b(), e2);
                    String a7 = e2.a();
                    ...
                    if (z || z2) {
                        ...
                        float f18 = mPPointF2.f8597a;
                        float f19 = mPPointF2.b;
                        float f20 = (E + 1.0f) * f13;
                        float f21 = (f20 * cos) + mPPointF2.f8597a;
                    ...
                    if (z3 || z4) {
                        float f24 = (f13 * cos) + mPPointF2.f8597a;
                    ...
                    if (e2.g() != null && iPieDataSet.z()) {
                        Drawable g = e2.g();
                        Utils.a(canvas, g, (int) (((f13 + a5.b) * cos) + mPPointF2.f8597a), (int) (((f13 + a5.b) * sin) + mPPointF2.b + a5.f8597a), g.getIntrinsicWidth(), g.getIntrinsicHeight());
                    }
                    i2++;
                }
                fArr = absoluteAngles;
    ...
    protected void d(Canvas canvas) {
        if (!this.f8584a.d() || this.f == null) {
            return;
        }
        float radius = this.f8584a.getRadius();
        float holeRadius = (this.f8584a.getHoleRadius() / 100.0f) * radius;
        MPPointF centerCircleBox = this.f8584a.getCenterCircleBox();
        if (Color.alpha(this.b.getColor()) > 0) {
            this.f.drawCircle(centerCircleBox.f8597a, centerCircleBox.b, holeRadius, this.b);
        }
        if (Color.alpha(this.f8585c.getColor()) > 0 && this.f8584a.getTransparentCircleRadius() > this.f8584a.getHoleRadius()) {
            int alpha = this.f8585c.getAlpha();
            float transparentCircleRadius = this.f8584a.getTransparentCircleRadius() / 100.0f;
            this.f8585c.setAlpha((int) (alpha * this.g.b() * this.g.a()));
            this.w.reset();
            this.w.addCircle(centerCircleBox.f8597a, centerCircleBox.b, radius * transparentCircleRadius, Path.Direction.CW);
            this.w.addCircle(centerCircleBox.f8597a, centerCircleBox.b, holeRadius, Path.Direction.CCW);
            this.f.drawPath(this.w, this.f8585c);
            this.f8585c.setAlpha(alpha);
        }
        MPPointF.b(centerCircleBox);
    }
    ...
    protected void e(Canvas canvas) {
        CharSequence centerText = this.f8584a.getCenterText();
        if (!this.f8584a.e() || centerText == null) {
            return;
        }
        MPPointF centerCircleBox = this.f8584a.getCenterCircleBox();
        MPPointF centerTextOffset = this.f8584a.getCenterTextOffset();
        float f = centerCircleBox.f8597a + centerTextOffset.f8597a;
        float f2 = centerCircleBox.b + centerTextOffset.b;
        float radius = (!this.f8584a.d() || this.f8584a.c()) ? this.f8584a.getRadius() : this.f8584a.getRadius() * (this.f8584a.getHoleRadius() / 100.0f);
        ...
        rectF2.set(rectF);
        float centerTextRadiusPercent = this.f8584a.getCenterTextRadiusPercent() / 100.0f;
