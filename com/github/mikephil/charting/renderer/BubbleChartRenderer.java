...
public class BubbleChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    protected BubbleDataProvider f22174a;
    private float[] b;
    ...
    public BubbleChartRenderer(BubbleDataProvider bubbleDataProvider, ChartAnimator chartAnimator, ViewPortHandler viewPortHandler) {
        ...
        this.b = new float[4];
        this.f22175c = new float[2];
        this.d = new float[3];
        this.f22174a = bubbleDataProvider;
    ...
    public void a(Canvas canvas) {
        for (IBubbleDataSet iBubbleDataSet : this.f22174a.getBubbleData().i()) {
            if (iBubbleDataSet.B()) {
    ...
    protected void a(Canvas canvas, IBubbleDataSet iBubbleDataSet) {
        ...
        Transformer a2 = this.f22174a.a(iBubbleDataSet.C());
        float a3 = this.g.a();
        this.f.a(this.f22174a, iBubbleDataSet);
        float[] fArr = this.b;
        fArr[0] = 0.0f;
        fArr[2] = 1.0f;
        a2.a(fArr);
        ...
        while (true) {
            ...
            this.f22175c[0] = bubbleEntry.i();
            this.f22175c[1] = bubbleEntry.b() * a3;
            a2.a(this.f22175c);
            float a4 = a(bubbleEntry.a(), iBubbleDataSet.b(), min, c2) / 2.0f;
            if (this.o.i(this.f22175c[1] + a4) && this.o.j(this.f22175c[1] - a4) && this.o.g(this.f22175c[0] + a4)) {
                if (!this.o.h(this.f22175c[0] - a4)) {
                    return;
                }
                this.h.setColor(iBubbleDataSet.a((int) bubbleEntry.i()));
                float[] fArr3 = this.f22175c;
    ...
    public void a(Canvas canvas, Highlight[] highlightArr) {
        BubbleData bubbleData = this.f22174a.getBubbleData();
        float a2 = this.g.a();
        ...
        while (true) {
            ...
            if (iBubbleDataSet != null && iBubbleDataSet.p()) {
                ...
                if (bubbleEntry.b() == highlight.b() && a(bubbleEntry, iBubbleDataSet)) {
                    Transformer a3 = this.f22174a.a(iBubbleDataSet.C());
                    float[] fArr = this.b;
                    fArr[0] = 0.0f;
                    fArr[2] = 1.0f;
                    a3.a(fArr);
                    ...
                    float min = Math.min(Math.abs(this.o.h() - this.o.e()), Math.abs(fArr2[2] - fArr2[0]));
                    this.f22175c[0] = bubbleEntry.i();
                    this.f22175c[1] = bubbleEntry.b() * a2;
                    a3.a(this.f22175c);
                    float[] fArr3 = this.f22175c;
    ...
    public void b(Canvas canvas) {
        BubbleData bubbleData = this.f22174a.getBubbleData();
        if (bubbleData == null || !a(this.f22174a)) {
            return;
        }
        ...
        while (true) {
            ...
            if (a(iBubbleDataSet) && iBubbleDataSet.H() >= 1) {
                ...
                float a2 = this.g.a();
                this.f.a(this.f22174a, iBubbleDataSet);
                float[] a3 = this.f22174a.a(iBubbleDataSet.C()).a(iBubbleDataSet, a2, this.f.f22172a, this.f.b);
                if (max == 1.0f) {
                    max = a2;
                }
                ...
                while (true) {
                    ...
                    int i6 = i5 / 2;
                    int d = iBubbleDataSet.d(this.f.f22172a + i6);
                    ...
                    if (this.o.g(f) && this.o.f(f2)) {
                        BubbleEntry bubbleEntry = (BubbleEntry) iBubbleDataSet.e(i6 + this.f.f22172a);
                        if (iBubbleDataSet.y()) {
