...
public class b {
    ...
    public static class C0575b extends com.kwad.sdk.core.response.kwai.a {
        public int aul;
        public String aum;
        public String aun;
        public String auo;
    ...
    public static void Be() {
        ...
        try {
            c0575b.parseJson(jSONObject);
            if (c0575b.aul == 1 && (a2 = a(ServiceProvider.getContext().getClassLoader(), c0575b)) != null) {
    ...
    private static a a(ClassLoader classLoader, C0575b c0575b) {
