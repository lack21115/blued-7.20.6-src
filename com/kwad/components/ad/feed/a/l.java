...
/* loaded from: source-7994992-dex2jar.jar:com/kwad/components/ad/feed/a/l.class */
public final class l extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void c(View view, final int i) {
        ...
        com.kwad.components.core.d.b.a.a(ap.ao(z).a(new a.b() { // from class: com.kwad.components.ad.feed.a.l.1
    ...
    public final void bindView(AdTemplate adTemplate) {
        ...
        bm();
        com.kwad.sdk.c.kwai.a.a(this, this.eA, this.fu, this.eH, this.eC);
