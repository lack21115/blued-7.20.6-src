...
/* loaded from: source-7994992-dex2jar.jar:com/kwad/components/ad/widget/tailframe/appbar/TailFrameBarAppPortraitVertical.class */
public class TailFrameBarAppPortraitVertical extends a {
    ...
    public final void bindView(AdTemplate adTemplate) {
        if (d.p(adTemplate)) {
            ...
            this.FY.setBackgroundColor(Color.parseColor("#E6FFFFFF"));
        }
