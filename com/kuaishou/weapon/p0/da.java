...
public class da {
    ...
    public void a(final int i) {
        n.a().a(new Runnable() { // from class: com.kuaishou.weapon.p0.da.1
            ...
            public void run() {
                try {
                    h a2 = h.a(da.this.f23815a, "re_po_rt");
                    if (a2.b(de.ah, 1) == 1) {
                        long a3 = de.a(da.this.f23815a).a(de.bd);
                        long currentTimeMillis = System.currentTimeMillis();
                        int b2 = a2.b(de.ak, 0);
                        long b3 = a2.b(de.aj, 6);
                        long j = currentTimeMillis - a3;
                        if (j >= b3 * 3600000 || (i == 100 && b2 == 1 && j >= 14400000)) {
                            cf.a(da.this.f23815a, new bv(da.this.f23815a, i, false).a(cj.e), cj.e, true);
                            de.a(da.this.f23815a).a(de.bd, currentTimeMillis);
                        }
                    }
                } catch (Throwable th) {
                }
