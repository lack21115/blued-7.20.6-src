...
public class u implements Runnable {
    ...
    public static final int f23866a = 1;
    public static final int b = 2;

    /* renamed from: c  reason: collision with root package name */
    public static final int f23867c = 4;
    ...
    private void a(s sVar) {
        ...
        try {
            if (!TextUtils.isEmpty(sVar.j) && sVar.j.length() >= 10) {
                ...
                File file = new File(this.m, sVar.f23861a + "-" + sVar.d + ".tmp");
                File file2 = new File(this.m, sVar.f23861a + "-" + sVar.d + ".zip");
                ...
                if (z2) {
                    ...
                    if (c2 != 0) {
                        ...
                        hashMap.put(iu.h, cj.p);
                        StringBuilder sb = new StringBuilder();
                        sb.append(sVar.f23861a);
                    ...
                    this.s.put(Integer.valueOf(sVar.f23861a), new a(3));
                }
                String a3 = f.a(file2);
                if (z2 && sVar.j.equals(a3)) {
                    ...
                    if (this.k.a(sVar, (String) null, (String) null)) {
                        if (this.s != null && !this.s.containsKey(Integer.valueOf(sVar.f23861a))) {
                            this.s.put(Integer.valueOf(sVar.f23861a), new a(1));
                        }
                        this.n.a(Cdo.b, System.currentTimeMillis(), true);
                        return;
                    }
                    if (this.s != null && !this.s.containsKey(Integer.valueOf(sVar.f23861a))) {
                        this.s.put(Integer.valueOf(sVar.f23861a), new a(4));
                    }
                    this.k.a(sVar.f23861a, sVar.d, (PackageInfo) null);
                    return;
                }
                if (file.exists()) {
                    j = file.length();
    ...
    public JSONObject a() {
        try {
            ...
            if (optInt != 1) {
                if (optInt == -7) {
                    Cdo.a(this.j).a(Cdo.f23829a, 1, false);
                    return null;
                }
                return null;
            }
        ...
        try {
            synchronized (u.class) {
                if (this.p == 1 || this.p == 2 || this.p == 4 || this.r || System.currentTimeMillis() - o >= 300000) {
                    ...
                    if ((System.currentTimeMillis() - this.n.a(Cdo.b)) - (this.n.a(Cdo.f23830c, 6) * 3600000) > 0) {
                        List<s> a2 = this.l.a();
                        ...
                        while (keys2.hasNext()) {
                            ...
                            if (a4 != null) {
                                ...
                                if (indexOf >= 0 && a4.y) {
                                    ...
                                    if (dm.b(a4.d, sVar.d)) {
                                        if (a4.x != sVar.x) {
                                            this.l.c(a4.f23861a, a4.x);
                                        }
                                        if (!this.l.d(a4.f23861a)) {
                                            arrayList2.add(a4);
                                        }
                                    } else {
                                        this.n.a(Cdo.b, System.currentTimeMillis(), true);
                        ...
                        for (s sVar2 : a2) {
                            if (!arrayList4.contains(sVar2.f23862c)) {
                                if (this.i != null) {
                                    this.i.add(Integer.valueOf(sVar2.f23861a));
                                }
                                this.k.a(sVar2.f23862c);
                            }
                        }
                        for (s sVar3 : arrayList3) {
                            if (!arrayList4.contains(sVar3.f23862c)) {
                                if (this.i != null) {
                                    this.i.add(Integer.valueOf(sVar3.f23861a));
                                }
                                this.k.a(sVar3.f23862c);
                            }
                        }
                        ...
                        for (s sVar4 : arrayList5) {
                            if (sVar4 != null) {
                                if (arrayList.contains(sVar4)) {
                                    this.k.a(sVar4.f23861a, sVar4.d, (PackageInfo) null);
