...
public class cn {
    ...
    private JSONObject a() {
        try {
            ...
            h a2 = h.a(this.f23789a, "re_po_rt");
            boolean e = a2.e("a1_p_s_p_s");
            boolean e2 = a2.e("a1_p_s_p_s_c_b");
            ai aiVar = new ai(this.f23789a);
            ...
            jSONObject.put(BaseWrapper.ENTER_ID_OAPS_FLOWMARKET, ab.a(this.f23789a) ? 1 : 0);
            JSONObject a3 = ah.a(this.f23789a);
            if (a3 != null) {
                jSONObject.put("4", a3);
            }
            if (a2.b(de.aa, 0) == 1 && (e || e2)) {
                jSONObject.put("25", al.a(this.f23789a) ? 1 : 0);
            }
            ac acVar = new ac();
            jSONObject.put("7", acVar.a() ? 1 : 0);
            boolean a4 = acVar.a(this.f23789a);
            jSONObject.put("8", a4 ? 1 : 0);
            if (a4) {
                jSONObject.put("61", acVar.b(this.f23789a));
            }
            jSONObject.put("10", acVar.e(this.f23789a));
            jSONObject.put("11", acVar.c(this.f23789a));
            ae aeVar = new ae();
            ...
            jSONObject2.put("03007", bu.a(this.f23789a));
            jSONObject2.put("03014", bg.g(this.f23789a));
            jSONObject2.put("03020", bu.b(this.f23789a));
            jSONObject2.put("03030", bf.d(this.f23789a));
            jSONObject.put("51", jSONObject2);
            jSONObject.put("107", new an().d());
            jSONObject.put(Camera.Parameters.VIDEO_HFR_2X, ab.b(this.f23789a) ? 1 : 0);
    ...
    public String a(String str) {
        ...
        try {
            ...
            String a4 = dk.a(ct.f23798a);
            String b = b(a4);
            if (TextUtils.isEmpty(b) || (a2 = clVar.a(this.f23789a)) == null) {
                return null;
            }
            String str2 = ct.h + "?" + cu.a(this.f23789a);
            String str3 = str2;
            if (ct.a()) {
                str3 = str2;
                if (ct.f23798a.contains("api")) {
                    str3 = "/api" + str2;
                }
            }
            JSONObject jSONObject = new JSONObject();
