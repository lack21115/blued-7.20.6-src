...
/* loaded from: source-8829756-dex2jar.jar:com/umeng/commonsdk/statistics/idtracking/Envelope.class */
public class Envelope {
    ...
    public static Envelope genEncryptEnvelope(Context context, String str, byte[] bArr) {
        try {
            ...
            String string = sharedPreferences.getString(GameAppOperation.GAME_SIGNATURE, null);
            ...
            envelope.seal();
            sharedPreferences.edit().putInt(Context.SERIAL_SERVICE, i + 1).putString(GameAppOperation.GAME_SIGNATURE, envelope.getSignature()).commit();
    ...
    private byte[] genGuid(byte[] bArr, int i) {
        ...
        while (true) {
            ...
            bArr2[i7] = bArr[i7];
            bArr2[(i2 - i7) - 1] = bArr[(bArr.length - i7) - 1];
            i6 = i7 + 1;
        }
        byte b = (byte) (i & 255);
        ...
        while (true) {
            ...
            bArr2[i9] = (byte) (bArr2[i9] ^ new byte[]{b, b2, b3, b4}[i9 % 4]);
            i8 = i9 + 1;
        }
    }
    ...
    public static String getSignature(Context context) {
        ...
        return sharedPreferences.getString(GameAppOperation.GAME_SIGNATURE, null);
    }
    ...
    public void export(Context context) {
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject.put(bh.g, imprintProperty);
            }
            jSONObject.put(GameAppOperation.GAME_SIGNATURE, hexString);
            jSONObject.put("checksum", hexString2);
            File file = new File(context.getFilesDir(), at.b().b(at.b));
            if (!file.exists()) {
                file.mkdir();
            }
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject2.put(bh.g, HelperUtils.getUmengMD5(imprintProperty));
            }
            HelperUtils.writeFile(new File(context.getFilesDir(), at.b().b(at.h)), jSONObject2.toString());
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
    }
