...
/* loaded from: source-8829756-dex2jar.jar:com/umeng/commonsdk/config/d.class */
public class d {
    ...
    /* loaded from: source-8829756-dex2jar.jar:com/umeng/commonsdk/config/d$b.class */
    public enum b {
        inner_rs,
        inner_by,
        inner_gp,
    ...
    /* loaded from: source-8829756-dex2jar.jar:com/umeng/commonsdk/config/d$c.class */
    public enum c {
        push_cpu,
        push_imei,
        push_mac,
    ...
    static {
        ...
        if (strArr2 != null && strArr2.length > 0) {
            ...
            while (true) {
                int i5 = i4;
                if (i5 >= b.values().length) {
                    break;
                }
                i[i5] = b.values()[i5].toString();
                i4 = i5 + 1;
            }
        ...
        if (strArr3 != null && strArr3.length > 0) {
            ...
            while (true) {
                int i7 = i6;
                if (i7 >= c.values().length) {
                    break;
                }
                j[i7] = c.values()[i7].toString();
                i6 = i7 + 1;
            }
