...
public class ay implements au {
    ...
    private static final String f40641a = "com.uodis.opendevice.aidl.OpenDeviceIdentifierService";
    private static final int b = 1;

    /* renamed from: c  reason: collision with root package name */
    private static final int f40642c = 2;
    ...
    static final class b implements IInterface {
        ...
        /* renamed from: a  reason: collision with root package name */
        private IBinder f40644a;

        public b(IBinder iBinder) {
            this.f40644a = iBinder;
        }
        ...
        public String a() throws RemoteException {
            ...
            try {
                obtain.writeInterfaceToken(ay.f40641a);
                this.f40644a.transact(1, obtain, obtain2, 0);
        ...
        public boolean b() throws RemoteException {
            ...
            try {
                obtain.writeInterfaceToken(ay.f40641a);
                boolean z = false;
                this.f40644a.transact(2, obtain, obtain2, 0);
                obtain2.readException();
