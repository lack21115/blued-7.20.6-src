...
public class DBFileTraversalUtil {
    ...
    private static ExecutorService f27100a = Executors.newSingleThreadExecutor();
    ...
    public static void traverseDBFiles(String str, final FileLockCallback fileLockCallback, final a aVar) {
        ...
        if (file.exists() && file.isDirectory()) {
            f27100a.execute(new Runnable() { // from class: com.umeng.analytics.process.DBFileTraversalUtil.1
