...
/* loaded from: source-8756600-dex2jar.jar:com/autonavi/base/amap/mapcore/MapConfig.class */
public class MapConfig implements IMapConfig, Cloneable {
    ...
    public boolean isMapStateChange() {
        ...
        if (mapConfig != null) {
            ...
            float sc = this.lastMapconfig.getSC();
            float sr = this.lastMapconfig.getSR();
            boolean z2 = sx != this.sX;
            this.isCenterChanged = z2;
            if (sy != this.sY) {
                z2 = true;
            }
            this.isCenterChanged = z2;
            boolean z3 = sz != this.sZ;
            ...
            boolean z4 = sr != this.sR;
            this.isBearingChanged = z4;
            z = this.isCenterChanged || this.isZoomChanged || this.isTiltChanged || z4 || this.isNeedUpdateMapRectNextFrame;
            if (z) {
