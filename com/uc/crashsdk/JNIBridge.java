...
/* loaded from: source-8829756-dex2jar.jar:com/uc/crashsdk/JNIBridge.class */
public class JNIBridge {
    ...
    private static String getJavaStackTrace(Thread thread, int i) {
        ...
        if (thread2 != null) {
            return e.a(thread2.getStackTrace(), "getJavaStackTrace").toString();
        }
        return null;
    }
