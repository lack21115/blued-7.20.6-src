...
public final class i implements f {
    ...
    private static final String f8945a = "HMSClassLoaderStrategy";
    private static final String b = "com.huawei.hwid";

    /* renamed from: c  reason: collision with root package name */
    private static final String f8946c = "com.huawei.hms.core.service.HMSCoreService";
    ...
    private static boolean a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            aa.b(f8945a, "Get pkg name failed: null.");
            return false;
        }
        if (f.contains(str)) {
            str2 = "The pkgName belongs to HMS pkg names, the cp is HMS.";
        } else if (!str.startsWith("com.huawei.hwid")) {
            aa.b(f8945a, "The pkg does not start with HMS prefix.");
            return false;
        } else {
            try {
                PackageInfo packageInfo = context.getPackageManager().getPackageInfo(context.getPackageName(), 4);
                if (packageInfo == null) {
                    aa.c(f8945a, "Get callPackage packageInfo failed: null.");
                    return false;
                }
                ServiceInfo[] serviceInfoArr = packageInfo.services;
                if (serviceInfoArr == null) {
                    aa.c(f8945a, "Get service Info failed: null.");
                    return false;
                }
                ...
                while (true) {
                    int i2 = i;
                    if (i2 >= length) {
                        aa.b(f8945a, "The calling package is not HMS.");
                        return false;
                    } else if (TextUtils.equals(serviceInfoArr[i2].name, f8946c)) {
                ...
                aa.c(f8945a, "Get callPackage packageInfo NameNotFoundException.");
                return false;
            }
        }
        aa.b(f8945a, str2);
    ...
    public final ClassLoader a(Context context, String str, int i, PackageInfo packageInfo) {
        ...
        aa.b(f8945a, "The api version is:" + Build.VERSION.SDK_INT + ", callingPkg is HMS, use the hmsNativePath.");
