...
public final class p implements q {
    ...
    private static final String f8954a = "ads_HMSLoadStrategy";
    private static final String b = "content://com.huawei.hms";

    /* renamed from: c  reason: collision with root package name */
    private static final String f8955c = "huawei_module_dynamicloader";
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [com.huawei.hms.ads.uiengineloader.p$1] */
        ...
        new Thread() { // from class: com.huawei.hms.ads.uiengineloader.p.1
            ...
            public final void run() {
                try {
                    ...
                    aa.b(p.f8954a, "remoteVersion:" + b2 + " localModuleVersion:" + i2);
                    if (b2 > i2) {
                        p.c(Context.this, str);
                    }
                } catch (Throwable th) {
                    aa.c(p.f8954a, "copy error: " + th.getLocalizedMessage());
                }
            }
        }.start();
    }
    ...
    public static int b(Context context, String str) throws com.huawei.hms.ads.dynamicloader.j {
        ...
        if (i.containsKey(str) && (bundle = i.get(str)) != null) {
            aa.b(f8954a, "cachedModuleInfo containsKey, version: " + bundle.getInt("module_version"));
            return bundle.getInt("module_version");
        }
        Bundle e2 = e(context, str);
        if (e2 == null) {
            aa.c(f8954a, "Query module bundle info failed: null.");
            return 0;
    ...
    private static Context b(Context context, t tVar) throws com.huawei.hms.ads.dynamicloader.j {
        ...
        if (asInterface == null) {
            aa.c(f8954a, "Get iDynamicLoader failed: null.");
            return null;
        }
    ...
    */
    ...
    private static t d(Context context, String str) throws com.huawei.hms.ads.dynamicloader.j {
        ...
        try {
            Bundle e2 = e(context, str);
            if (e2 == null) {
                aa.c(f8954a, "Failed to get bundle info: null.");
                return tVar;
            }
            int i2 = e2.getInt("errcode");
            if (i2 == 1) {
                aa.c(f8954a, "The query module:" + str + " is not existed in HMS.");
                return tVar;
            } else if (i2 != 0) {
                aa.c(f8954a, "Failed to get bundle info for " + str + ", errcode:" + i2);
                ...
                tVar.f8964c = e2.getInt("module_version");
                tVar.d = e2.getString("loader_path");
                tVar.f = e2.getInt("loader_version");
                tVar.g = e2.getInt("armeabiType");
                aa.b(f8954a, "bundle info: errorCode:" + i2 + ", moduleName:" + str + ", moduleVersion:" + tVar.f8964c + ", modulePath:" + tVar.b + ", loader_version:" + tVar.f + ", loaderPath:" + tVar.d);
                a(context, str, 0);
                StringBuilder sb = new StringBuilder("Query remote version by module name:");
                sb.append(str);
                sb.append(" success.");
                aa.b(f8954a, sb.toString());
                return tVar;
            }
        } catch (com.huawei.hms.ads.dynamicloader.j e3) {
            throw e3;
        } catch (Exception e4) {
            aa.c(f8954a, "Failed to Query remote module version.".concat(String.valueOf(e4)));
            return tVar;
        }
    }
    ...
    private static Bundle e(Context context, String str) {
        try {
            ...
            if (contentResolver == null) {
                aa.c(f8954a, "Query remote version failed: null contentResolver.");
                return null;
            }
            Bundle call = contentResolver.call(Uri.parse("content://com.huawei.hms"), str, null, null);
            if (call == null) {
                aa.c(f8954a, "query module:" + str + " failed: null.");
                return null;
            }
            ...
            aa.b(f8954a, "Query module info result code:".concat(String.valueOf(i2)));
            return call;
        } catch (Exception e2) {
            aa.c(f8954a, "Query module:" + str + " info failed:" + e2.getMessage());
            return null;
        }
    }
    ...
    */
    ...
    public final Context a(Context context, t tVar) throws com.huawei.hms.ads.dynamicloader.j {
        try {
            aa.a(f8954a, "loader_path: " + tVar.d + ", dynamic_loader_path: " + com.huawei.hms.ads.dynamicloader.g.b);
            if (tVar.d.contains(f8955c)) {
                Bundle bundle = new Bundle();
            ...
            aa.b(f8954a, "The loader is not dynamicLoader，use it to load.");
            IDynamicLoader asInterface = IDynamicLoader.Stub.asInterface(r.a(context, tVar.d));
            if (asInterface == null) {
                aa.c(f8954a, "Get iDynamicLoader failed: null.");
                return null;
            ...
            aa.d(f8954a, "Load DynamicModule failed.");
