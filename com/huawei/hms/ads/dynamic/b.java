...
public final class b {
    ...
    private static final String f8853a = "ExecutorsManager";
    ...
    static final class a implements ThreadFactory {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final AtomicInteger f8854a = new AtomicInteger(1);
        ...
        public final Thread newThread(Runnable runnable) {
            Thread thread = new Thread(runnable, this.b + this.f8854a.getAndIncrement());
            thread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: com.huawei.hms.ads.dynamic.b.a.1
                ...
                public final void uncaughtException(Thread thread2, Throwable th) {
                    aa.d(b.f8853a, thread2.getName() + " : " + th.getMessage());
                }
            });
            return thread;
        }
