...
/* loaded from: source-7994992-dex2jar.jar:com/huawei/hms/framework/common/ExceptionCode.class */
public class ExceptionCode {
    ...
    private static int getErrorCodeSocketTimeout(Exception exc) {
        ...
        return z ? !z ? !z ? SOCKET_TIMEOUT : SOCKET_WRITE_TIMEOUT : SOCKET_READ_TIMEOUT : SOCKET_CONNECT_TIMEOUT;
    }
}
