...
/* loaded from: source-7994992-dex2jar.jar:com/huawei/hms/opendevice/OpenDeviceTaskApiCall.class */
public class OpenDeviceTaskApiCall extends TaskApiCall<OpenDeviceHmsClient, OdidResult> {
    ...
    public void doExecute(OpenDeviceHmsClient openDeviceHmsClient, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<OdidResult> taskCompletionSource) {
        ...
        HiAnalyticsClient.reportExit(openDeviceHmsClient.getContext(), getUri(), getTransactionId(), responseErrorCode.getStatusCode(), responseErrorCode.getErrorCode(), 60700300);
