...
public abstract class TaskApiCall<ClientT extends AnyClient, ResultT> {
    ...
    public final void onResponse(ClientT clientt, ResponseErrorCode responseErrorCode, String str, TaskCompletionSource<ResultT> taskCompletionSource) {
        ...
        if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            HMSLog.i("TaskApiCall", "This Task has been canceled, uri:" + this.f22664a + ", transactionId:" + this.d);
            return;
        }
        HMSLog.i("TaskApiCall", "doExecute, uri:" + this.f22664a + ", errorCode:" + responseErrorCode.getErrorCode() + ", transactionId:" + this.d);
