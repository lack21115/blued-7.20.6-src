...
public class w0 {
    ...
    public static String a(String str) {
        ...
        try {
            ...
            z.b("hmsSdk", "url don't starts with https");
            return null;
    ...
    public static String a(String str, int i) {
        ...
        while (true) {
            ...
            stringBuffer.append(".");
            stringBuffer.append(split[(split.length - i) + i3]);
            i2 = i3 + 1;
        }
    }
    ...
    public static boolean b(String str) {
        if (l1.f22767a.booleanValue()) {
            return true;
        }
        String[] strArr = f22796a;
