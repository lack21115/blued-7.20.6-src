...
public class g0 {
    ...
    public long f22743a = 1800000;
    public volatile boolean b = false;

    /* renamed from: c  reason: collision with root package name */
    public a f22744c = null;

    /* loaded from: source-7994992-dex2jar.jar:com/huawei/hms/hatool/g0$a.class */
    public class a {

        /* renamed from: a  reason: collision with root package name */
        public String f22745a = UUID.randomUUID().toString().replace("-", "");
        ...
        public a(long j) {
            this.f22745a += BridgeUtil.UNDERLINE_STR + j;
            this.f22746c = j;
            g0.this.b = false;
        }
        ...
        public void a(long j) {
            if (g0.this.b) {
                g0.this.b = false;
                b(j);
            } else if (b(this.f22746c, j) || a(this.f22746c, j)) {
                b(j);
            } else {
                this.f22746c = j;
                this.b = false;
