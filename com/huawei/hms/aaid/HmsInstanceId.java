...
public class HmsInstanceId {
    ...
    private HuaweiApi<Api.ApiOptions.NoOptions> f22392c;
    ...
    private HmsInstanceId(Context context) {
        ...
        if (context instanceof Activity) {
            this.f22392c = new HuaweiApi<>((Activity) context, (Api<Api.ApiOptions>) api, (Api.ApiOptions) null, (AbstractClientBuilder) new PushClientBuilder());
        } else {
            this.f22392c = new HuaweiApi<>(context, api, (Api.ApiOptions) null, new PushClientBuilder());
        }
        this.f22392c.setKitSdkVersion(60700300);
    }

    private String a(TokenReq tokenReq, int i) throws ApiException {
        if (ProxyCenter.getProxy() != null) {
            HMSLog.i(TAG, "use proxy get token, please check HmsMessageService.onNewToken receive result.");
            ProxyCenter.getProxy().getToken(this.f22391a, tokenReq.getSubjectId(), null);
            return null;
        }
        a(tokenReq.getSubjectId());
        String a2 = h.a(this.f22391a, "push.gettoken");
        try {
            String str = TAG;
            HMSLog.d(str, "getToken req :" + tokenReq.toString());
            f fVar = new f("push.gettoken", tokenReq, this.f22391a, a2);
            fVar.setApiLevel(i);
            return ((TokenResult) Tasks.await(this.f22392c.doWrite(fVar))).getToken();
        } catch (Exception e) {
            if (e.getCause() instanceof ApiException) {
                ApiException apiException = (ApiException) e.getCause();
                h.a(this.f22391a, "push.gettoken", a2, apiException.getStatusCode());
                throw apiException;
            }
    ...
    private void a() throws ApiException {
        if (BaseUtils.getProxyInit(this.f22391a) && ProxyCenter.getProxy() == null && !BaseUtils.isMainProc(this.f22391a)) {
    ...
    private void a(DeleteTokenReq deleteTokenReq, int i) throws ApiException {
        ...
        if (ProxyCenter.getProxy() != null) {
            ...
            ProxyCenter.getProxy().deleteToken(this.f22391a, subjectId, null);
            return;
        }
        String a2 = h.a(this.f22391a, "push.deletetoken");
        try {
            String b = i.a(this.f22391a).b(subjectId);
            if (deleteTokenReq.isMultiSender() && (TextUtils.isEmpty(b) || b.equals(i.a(this.f22391a).b(null)))) {
                i.a(this.f22391a).removeKey(subjectId);
            ...
            eVar.setApiLevel(i);
            Tasks.await(this.f22392c.doWrite(eVar));
            i.a(this.f22391a).c(subjectId);
        } catch (Exception e) {
            if (e.getCause() instanceof ApiException) {
                ApiException apiException = (ApiException) e.getCause();
                h.a(this.f22391a, "push.deletetoken", a2, apiException.getStatusCode());
                throw apiException;
            }
            Context context = this.f22391a;
            ErrorEnum errorEnum = ErrorEnum.ERROR_INTERNAL_ERROR;
    ...
    private void a(String str) {
        ...
        String string = i.a(this.f22391a).getString("subjectId");
        if (TextUtils.isEmpty(string)) {
            i.a(this.f22391a).saveString("subjectId", str);
        } else if (string.contains(str)) {
        } else {
            i a2 = i.a(this.f22391a);
            ...
            if (this.b.containsKey("aaid")) {
                ...
                if (b.e(this.f22391a)) {
                    if (ProxyCenter.getProxy() != null) {
                        ...
                        ProxyCenter.getProxy().deleteAllToken(this.f22391a);
                        return;
                    }
                    DeleteTokenReq b = b.b(this.f22391a);
                    b.setDeleteType(1);
                    b.setMultiSender(false);
                    a(b, 1);
                    BaseUtils.deleteAllTokenCache(this.f22391a);
                }
            }
    ...
    public void deleteToken(String str) throws ApiException {
        ...
        DeleteTokenReq a2 = b.a(this.f22391a, str);
    ...
    public void deleteToken(String str, String str2) throws ApiException {
        b();
        a();
        DeleteTokenReq a2 = b.a(this.f22391a, str, str2);
    ...
    public Task<AAIDResult> getAAID() {
        try {
            return Tasks.callInBackground(new a(this.f22391a.getApplicationContext()));
        } catch (Exception e) {
    ...
    public String getToken(String str) throws ApiException {
        ...
        TokenReq b = b.b(this.f22391a, str);
        b.setAaid(getId());
    ...
    public String getToken(String str, String str2) throws ApiException {
        b();
        a();
        TokenReq b = b.b(this.f22391a, null, str2);
        b.setAaid(getId());
        b.setMultiSender(false);
        i.a(this.f22391a).saveString(this.f22391a.getPackageName(), "1");
        return a(b, 1);
    }
}
