...
/* loaded from: source-8829756-dex2jar.jar:com/xiaomi/push/ex.class */
public enum ex {
    TCP_CONN_FAIL(1),
    TCP_CONN_TIME(2),
    PING_RTT(3),
    ...
    CONN_BOSH_ERR(MtpConstants.DEVICE_PROPERTY_STILL_CAPTURE_MODE),
    BIND_SUCCESS(30000),
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            case MtpConstants.DEVICE_PROPERTY_STILL_CAPTURE_MODE /* 20499 */:
