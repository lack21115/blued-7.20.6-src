...
/* loaded from: source-8829756-dex2jar.jar:com/xiaomi/push/bl.class */
public class bl {
    public static String a(String str) {
        try {
            return String.valueOf(bk.a(MessageDigest.getInstance(AppSigning.SHA1).digest(str.getBytes("UTF-8"))));
