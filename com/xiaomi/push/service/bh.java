...
public class bh implements bg.b.a {
    ...
    public void a(bg.c cVar, bg.c cVar2, int i) {
        ...
        if (cVar2 == bg.c.binding) {
            XMPushService xMPushService = this.f41638a.f1006a;
            cVar4 = this.f41638a.f1005a;
            xMPushService.a(cVar4, 60000L);
            return;
        }
        XMPushService xMPushService2 = this.f41638a.f1006a;
        cVar3 = this.f41638a.f1005a;
