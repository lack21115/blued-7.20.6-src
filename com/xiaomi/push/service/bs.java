...
public class bs {
    ...
    public static String a(String str) {
        ...
        try {
            ...
            cipher.init(1, f41650a);
            return Base64.encodeToString(a(cipher, 1, str.getBytes("UTF-8"), f41650a.getModulus().bitLength()), 2);
        } catch (Throwable th) {
            return null;
        }
    }
