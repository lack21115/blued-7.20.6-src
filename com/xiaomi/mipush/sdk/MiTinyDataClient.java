...
public class MiTinyDataClient {
    ...
    public static class a {
        ...
        private static volatile a f41190a;
        ...
        /* renamed from: a  reason: collision with other field name */
        private C1093a f112a = new C1093a();

        /* renamed from: a  reason: collision with other field name */
        private final ArrayList<hk> f115a = new ArrayList<>();
        ...
        public class C1093a {
            ...
            /* renamed from: a  reason: collision with other field name */
            private ScheduledFuture<?> f118a;

            /* renamed from: a  reason: collision with other field name */
            private ScheduledThreadPoolExecutor f119a = new ScheduledThreadPoolExecutor(1);

            /* renamed from: a  reason: collision with other field name */
            public final ArrayList<hk> f117a = new ArrayList<>();

            /* renamed from: a  reason: collision with other field name */
            private final Runnable f116a = new ab(this);
            ...
            public void a() {
                if (this.f118a == null) {
                    this.f118a = this.f119a.scheduleAtFixedRate(this.f116a, 1000L, 1000L, TimeUnit.MILLISECONDS);
                }
            }

            /* JADX INFO: Access modifiers changed from: private */
            public void b() {
                hk remove = this.f117a.remove(0);
                for (Cif cif : bz.a(Arrays.asList(remove), a.this.f111a.getPackageName(), b.m11457a(a.this.f111a).m11458a(), 30720)) {
                    ...
                    ao.a(a.this.f111a).a((ao) cif, hg.Notification, true, (ht) null);
                }
            }

            public void a(hk hkVar) {
                this.f119a.execute(new aa(this, hkVar));
            }
        }
        ...
        private void a(hk hkVar) {
            synchronized (this.f115a) {
                if (!this.f115a.contains(hkVar)) {
                    this.f115a.add(hkVar);
                    if (this.f115a.size() > 100) {
                        this.f115a.remove(0);
                    }
                }
            }
        ...
        private boolean b(Context context) {
            return b.m11457a(context).m11458a() == null && !a(this.f111a);
        }
        ...
        public void m11418a(Context context) {
            if (context == null) {
                com.xiaomi.channel.commonutils.logger.b.m11394a("context is null, MiTinyDataClientImp.init() failed.");
                return;
            }
            this.f111a = context;
            this.f113a = Boolean.valueOf(a(context));
        ...
        public void a(String str) {
            synchronized (this) {
                if (TextUtils.isEmpty(str)) {
                    com.xiaomi.channel.commonutils.logger.b.m11394a("channel is null, MiTinyDataClientImp.setChannel(String) failed.");
                    return;
                }
                this.f114a = str;
        ...
        */
        public boolean m11420a(com.xiaomi.push.hk r6) {
            /*
                Method dump skipped, instructions count: 382
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.mipush.sdk.MiTinyDataClient.a.m11420a(com.xiaomi.push.hk):boolean");
        }
    ...
    public static void init(Context context, String str) {
        if (context == null) {
            com.xiaomi.channel.commonutils.logger.b.m11394a("context is null, MiTinyDataClient.init(Context, String) failed.");
            return;
        }
        a.a().m11418a(context);
        if (TextUtils.isEmpty(str)) {
            com.xiaomi.channel.commonutils.logger.b.m11394a("channel is null or empty, MiTinyDataClient.init(Context, String) failed.");
        } else {
            a.a().a(str);
        }
    }
