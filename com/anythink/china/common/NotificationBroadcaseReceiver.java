...
public class NotificationBroadcaseReceiver extends BroadcastReceiver {
    ...
    private static final String f6274a = NotificationBroadcaseReceiver.class.getSimpleName();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (hashCode != -1222061724) {
            if (hashCode == 760792937 && action.equals(com.anythink.china.common.b.a.f6308c)) {
                z = true;
            }
