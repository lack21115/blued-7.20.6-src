...
public class b {
    ...
    private static String f7141a = "WebEnvCheckController";
    private static String b = "WebEnvCheck_url";

    /* renamed from: c  reason: collision with root package name */
    private static final String f7142c = "web_check_env_js_file.txt";
    ...
    final class AnonymousClass1 extends com.anythink.expressad.foundation.g.f.b.b {
        ...
        public final void a(String str) {
            ...
            b.this.f = str;
            b.b(b.this, str);
            com.anythink.expressad.foundation.a.a.a.a().a(b.b, this.f7143a);
        }
    ...
    public final class AnonymousClass2 implements Runnable {
        ...
        public final void run() {
            try {
                File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), b.f7142c);
                if (file.exists()) {
                    file.delete();
                }
                m.a(this.f7144a.getBytes(), file);
            } catch (Exception e) {
                o.a(b.f7141a, e.getMessage());
            }
        }
    }
    ...
    private static String e() {
        try {
            File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), f7142c);
            return (file.exists() && file.canRead()) ? m.a(file) : "";
        } catch (Exception e2) {
            o.a(f7141a, e2.getMessage());
            return "";
        }
    }
