...
/* loaded from: source-8756600-dex2jar.jar:com/anythink/expressad/d/b/b.class */
public class b {

    /* renamed from: a  reason: collision with root package name */
    private static String f4302a = "WebEnvCheckController";
    private static String b = "WebEnvCheck_url";

    /* renamed from: c  reason: collision with root package name */
    private static final String f4303c = "web_check_env_js_file.txt";
    ...
    /* loaded from: source-8756600-dex2jar.jar:com/anythink/expressad/d/b/b$1.class */
    final class AnonymousClass1 extends com.anythink.expressad.foundation.g.f.b.b {
        ...
        public final void a(String str) {
            ...
            b.this.f = str;
            b.b(b.this, str);
            com.anythink.expressad.foundation.a.a.a.a().a(b.b, this.f4304a);
        }
    ...
    /* loaded from: source-8756600-dex2jar.jar:com/anythink/expressad/d/b/b$2.class */
    public final class AnonymousClass2 implements Runnable {
        ...
        public final void run() {
            try {
                File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), b.f4303c);
                if (file.exists()) {
                    file.delete();
                }
                m.a(this.f4305a.getBytes(), file);
            } catch (Exception e) {
                o.a(b.f4302a, e.getMessage());
            }
        }
    }
    ...
    private void a(Context context, String str) {
        ...
        String a2 = com.anythink.expressad.foundation.a.a.a.a().a(b);
    ...
    private static String e() {
        try {
            File file = new File(d.b(com.anythink.expressad.foundation.g.c.a.ANYTHINK_OTHER), f4303c);
            return (file.exists() && file.canRead()) ? m.a(file) : "";
        } catch (Exception e2) {
            o.a(f4302a, e2.getMessage());
            return "";
        }
    }
