...
public final class b implements com.anythink.expressad.foundation.g.f.e.a {
    ...
    private static final int f7890a = 100;
    private com.anythink.expressad.foundation.g.f.c.a b;

    /* renamed from: c  reason: collision with root package name */
    private SSLSocketFactory f7891c;
    ...
    static final class a extends FilterInputStream {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final HttpURLConnection f7892a;
        ...
        public final void close() {
            super.close();
            this.f7892a.disconnect();
        }
    }

    public b(SSLSocketFactory sSLSocketFactory, com.anythink.expressad.foundation.g.f.c.a aVar) {
        this.f7891c = sSLSocketFactory;
        this.b = aVar;
    }

    private HttpURLConnection a(URL url) {
        com.anythink.expressad.foundation.g.f.c.a aVar = this.b;
        HttpURLConnection httpURLConnection = (aVar == null || TextUtils.isEmpty(aVar.b) || TextUtils.isEmpty(this.b.f7864c)) ? (HttpURLConnection) url.openConnection() : (HttpURLConnection) url.openConnection(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(this.b.b, Integer.valueOf(this.b.f7864c).intValue())));
    ...
    private HttpURLConnection a(URL url, i<?> iVar) {
        ...
        if ("https".equals(url.getProtocol()) && (sSLSocketFactory = this.f7891c) != null) {
