...
public class d extends e<JSONObject> {
    ...
    private static final String f5046c = d.class.getSimpleName();
    ...
    public final k<JSONObject> a(com.anythink.expressad.foundation.g.f.f.c cVar) {
        try {
            return cVar.f5059a == 204 ? k.a(new JSONObject(), cVar) : k.a(new JSONObject(new String(cVar.b, com.anythink.expressad.foundation.g.f.g.e.a(cVar.d))), cVar);
        } catch (UnsupportedEncodingException e) {
            o.d(f5046c, e.getMessage());
            return k.a(new com.anythink.expressad.foundation.g.f.a.a(8, cVar));
        } catch (JSONException e2) {
            o.d(f5046c, e2.getMessage());
            return k.a(new com.anythink.expressad.foundation.g.f.a.a(8, cVar));
        }
    }
}
