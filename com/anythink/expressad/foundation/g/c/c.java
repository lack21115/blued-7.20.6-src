...
/* loaded from: source-8756600-dex2jar.jar:com/anythink/expressad/foundation/g/c/c.class */
public final class c extends f {
    private static final String b = "anythink_template/";

    /* renamed from: c  reason: collision with root package name */
    private static final String f7841c = "anythink_template/res/.anythink700";
    private static final String d = "anythink_template/res/res";
    private static final String e = "anythink_template/res/html";

    private c(String str) {
        super(str);
        this.f7847a.a(a.AD_ROOT_INTERNAL);
    }
