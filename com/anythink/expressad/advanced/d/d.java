...
public final class d implements com.anythink.expressad.advanced.b.b {
    ...
    private static final String f7036a = "NativeAdvancedShowListenerImpl";
    private o b;

    /* renamed from: c  reason: collision with root package name */
    private com.anythink.expressad.foundation.d.c f7037c;
    private boolean d;
    private c e;
    ...
    private static boolean a(double d, com.anythink.expressad.foundation.d.c cVar) {
        try {
            ...
            long l = c2.l() * 1000;
            long x = c2.x() * 1000;
            com.anythink.expressad.foundation.h.o.d(f7036a, "cbp : " + d + " plct : " + x + " plctb : " + l);
            if (cVar != null) {
                if (cVar.a(x, l)) {
                    cVar.e(1);
                    return true;
            ...
            sb.append(i > 0);
            com.anythink.expressad.foundation.h.o.d(f7036a, sb.toString());
            return i > 0;
        } catch (Exception e) {
            com.anythink.expressad.foundation.h.o.b(f7036a, "CBPERROR", e);
            return false;
        }
    }
