...
public final class a {
    ...
    public static final class C0059a {
        ...
        */
        public final com.anythink.expressad.exoplayer.h.a.a.C0059a a(int r8, int r9) {
            /*
                r7 = this;
                r0 = r7
                int r0 = r0.f4544a
            ...
            L8d:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.anythink.expressad.exoplayer.h.a.a.C0059a.a(int, int):com.anythink.expressad.exoplayer.h.a.a$a");
        }

        public final C0059a a(Uri uri, int i) {
            int i2 = this.f4544a;
            com.anythink.expressad.exoplayer.k.a.a(i2 == -1 || i < i2);
            int[] a2 = a(this.f4545c, i + 1);
            boolean z = false;
            if (a2[i] == 0) {
                z = true;
            }
            ...
            uriArr[i] = uri;
            a2[i] = 1;
            return new C0059a(this.f4544a, a2, uriArr, jArr);
        }

        public final C0059a a(long[] jArr) {
            com.anythink.expressad.exoplayer.k.a.a(this.f4544a == -1 || jArr.length <= this.b.length);
            int length = jArr.length;
            Uri[] uriArr = this.b;
            long[] jArr2 = jArr;
            ...
            return new C0059a(this.f4544a, this.f4545c, this.b, jArr2);
        }

        public final boolean a() {
            return this.f4544a == -1 || a(-1) < this.f4544a;
        }

        public final C0059a b() {
            if (this.f4544a == -1) {
                return new C0059a(0, new int[0], new Uri[0], new long[0]);
            }
            int[] iArr = this.f4545c;
            int length = iArr.length;
            ...
            return new C0059a(length, copyOf, this.b, this.d);
        }

        public final C0059a b(int i) {
            com.anythink.expressad.exoplayer.k.a.a(this.f4544a == -1 && this.f4545c.length <= i);
            return new C0059a(i, a(this.f4545c, i), (Uri[]) Arrays.copyOf(this.b, i), a(this.d, i));
        }
    }
    ...
    private a(long[] jArr, C0059a[] c0059aArr, long j, long j2) {
        this.g = c0059aArr.length;
        this.h = jArr;
        this.i = c0059aArr;
        this.j = j;
        this.k = j2;
    ...
    private a a(int i) {
        C0059a[] c0059aArr = this.i;
        C0059a[] c0059aArr2 = (C0059a[]) Arrays.copyOf(c0059aArr, c0059aArr.length);
        c0059aArr2[i] = c0059aArr2[i].b();
        return new a(this.h, c0059aArr2, this.j, this.k);
    }

    private a a(int i, int i2) {
        com.anythink.expressad.exoplayer.k.a.a(i2 > 0);
        if (this.i[i].f4544a == i2) {
            return this;
        }
        C0059a[] c0059aArr = this.i;
        C0059a[] c0059aArr2 = (C0059a[]) Arrays.copyOf(c0059aArr, c0059aArr.length);
        c0059aArr2[i] = this.i[i].b(i2);
        return new a(this.h, c0059aArr2, this.j, this.k);
    }
    ...
    private a a(int i, int i2, Uri uri) {
        C0059a[] c0059aArr = this.i;
        C0059a[] c0059aArr2 = (C0059a[]) Arrays.copyOf(c0059aArr, c0059aArr.length);
        c0059aArr2[i] = c0059aArr2[i].a(uri, i2);
        return new a(this.h, c0059aArr2, this.j, this.k);
    }
    ...
    private a b(int i, int i2) {
        C0059a[] c0059aArr = this.i;
        C0059a[] c0059aArr2 = (C0059a[]) Arrays.copyOf(c0059aArr, c0059aArr.length);
        c0059aArr2[i] = c0059aArr2[i].a(3, i2);
        return new a(this.h, c0059aArr2, this.j, this.k);
    }
    ...
    private a c(int i, int i2) {
        C0059a[] c0059aArr = this.i;
        C0059a[] c0059aArr2 = (C0059a[]) Arrays.copyOf(c0059aArr, c0059aArr.length);
        c0059aArr2[i] = c0059aArr2[i].a(2, i2);
        return new a(this.h, c0059aArr2, this.j, this.k);
    }
    ...
    private a d(int i, int i2) {
        C0059a[] c0059aArr = this.i;
        C0059a[] c0059aArr2 = (C0059a[]) Arrays.copyOf(c0059aArr, c0059aArr.length);
        c0059aArr2[i] = c0059aArr2[i].a(4, i2);
        return new a(this.h, c0059aArr2, this.j, this.k);
    }
    ...
    public final a a(long[][] jArr) {
        ...
        while (true) {
            ...
            c0059aArr2[i2] = c0059aArr2[i2].a(jArr[i2]);
            i = i2 + 1;
        }
    }
}
