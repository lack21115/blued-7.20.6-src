...
public final class i {
    ...
    public static final g.a f7318a = new g.a() { // from class: com.anythink.expressad.exoplayer.e.i.1
    ...
    public final boolean a() {
        return (this.b == -1 || this.f7319c == -1) ? false : true;
    }
    ...
    public final boolean a(com.anythink.expressad.exoplayer.g.a aVar) {
        ...
        while (true) {
            ...
            a.InterfaceC0129a a2 = aVar.a(i2);
            if (a2 instanceof com.anythink.expressad.exoplayer.g.b.e) {
                ...
                if (e.equals(eVar.f7351c) && a(eVar.d)) {
                    return true;
                }
                ...
                if (d.equals(iVar.b) && e.equals(iVar.f7359c) && a(iVar.d)) {
                    return true;
                }
            } else {
                continue;
