...
final class g {
    ...
    private static final int f7562c = 2;
    ...
    public final int a(int i) {
        int i2;
        int hashCode;
        int hashCode2 = (this.f7563a * 31) + this.b.hashCode();
        if (i < 2) {
            long a2 = j.a(this.f);
            i2 = hashCode2 * 31;
    ...
    public final long a(long j, long j2) {
        n a2 = a(j);
        if (a2.b()) {
            return -Math.min(a2.a() ? Long.MAX_VALUE : a2.f7558c, j2);
        }
        long j3 = j + j2;
        long j4 = a2.b + a2.f7558c;
        long j5 = j4;
        if (j4 < j3) {
            ...
            do {
                ...
                j5 = Math.max(j4, next.b + next.f7558c);
                j4 = j5;
            } while (j5 < j3);
        }
    ...
    public final n a(long j) {
        ...
        if (floor == null || floor.b + floor.f7558c <= j) {
    ...
    public final void a(DataOutputStream dataOutputStream) {
        dataOutputStream.writeInt(this.f7563a);
    ...
    public final n b(n nVar) {
        ...
        n a2 = nVar.a(this.f7563a);
        if (nVar.e.renameTo(a2.e)) {
            this.e.add(a2);
            return a2;
        }
        throw new a.C0138a("Renaming of " + nVar.e + " to " + a2.e + " failed.");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        return this.f7563a == gVar.f7563a && this.b.equals(gVar.b) && this.e.equals(gVar.e) && this.f.equals(gVar.f);
    }
