...
public class m extends com.anythink.core.common.c.a<com.anythink.core.common.a.i> {
    ...
    private static volatile m f6600c;
    ...
    public static final class a {
        ...
        public static final String f6601a = "video_res_cache_info";
        public static final String b = "video_url";

        /* renamed from: c  reason: collision with root package name */
        public static final String f6602c = "file_path";
    ...
    private void d(String str) {
        try {
            Cursor query = a().query(a.f6601a, null, null, null, null, null, null);
    ...
    private boolean e(String str) {
        ...
        Cursor query = a().query(a.f6601a, new String[]{"video_url"}, "video_url=?", new String[]{str}, null, null, null);
    ...
    public final com.anythink.core.common.a.i a(String str) {
        try {
            Cursor query = a().query(a.f6601a, null, "video_url=?", new String[]{str}, null, null, null);
            if (query.moveToNext()) {
                com.anythink.core.common.a.i iVar = new com.anythink.core.common.a.i();
                iVar.a(str);
                iVar.b(query.getString(query.getColumnIndex(a.f6602c)));
                iVar.a(query.getInt(query.getColumnIndex("ready_rate")));
                iVar.b(query.getLong(query.getColumnIndex(a.e)));
                iVar.a(query.getLong(query.getColumnIndex("total_size")));
    ...
    */
    ...
    public final void b(String str) {
        ...
        try {
            ...
            b().update(a.f6601a, contentValues, "video_url = ? ", new String[]{str});
        } catch (Throwable th) {
        }
    }
    ...
    public final void c(String str) {
        ...
        try {
            b().delete(a.f6601a, "video_url=?", new String[]{str});
        } catch (Throwable th) {
    ...
    public final List<com.anythink.core.common.a.i> d() {
        ...
        try {
            Cursor query = a().query(a.f6601a, null, null, null, null, null, "update_time DESC");
            if (query.getCount() > 0 && query.moveToPosition(((int) Math.round(((query.getCount() * 1.0d) + 1.0d) / 2.0d)) - 1)) {
                ...
                b().delete(a.f6601a, "update_time<=?", new String[]{String.valueOf(j)});
                return arrayList;
            }
        } catch (Throwable th) {
