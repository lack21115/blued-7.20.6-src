...
public class a extends h {
    ...
    private static final String f26259a = a.class.getSimpleName();
    private Context b;
    ...
    public a(Context context, String str, d dVar, com.opos.mobad.q.a.h hVar, com.opos.mobad.ad.d.b bVar) {
        ...
        this.f26260c = str;
        bVar = bVar == null ? com.opos.mobad.ad.d.b.f25678a : bVar;
        this.h = bVar;
    ...
    public void b() {
        com.opos.cmn.an.f.a.b(f26259a, "destroyAd");
        if (f.e()) {
            this.i.a();
            super.b();
        }
    ...
    public boolean b(String str, int i) {
        this.g = 0;
        this.j = 0;
        com.opos.mobad.model.b.a(this.b.getApplicationContext()).a(this.b, this.f26260c, 5, str, i, new b.a() { // from class: com.opos.mobad.j.a.1
            ...
            public void a(final int i2, final a.C0707a c0707a) {
                a.this.c(new Callable<Boolean>() { // from class: com.opos.mobad.j.a.1.1
                    ...
                    public Boolean call() throws Exception {
                        com.opos.cmn.an.f.a.b(a.f26259a, " call load succ");
                        a.this.d = c0707a;
                        a.this.g = i2;
                        return true;
                    }
    ...
    public int f() {
        a.C0707a c0707a;
        return (!e() || (c0707a = this.d) == null) ? super.f() : c0707a.b.X();
    }

    @Override // com.opos.mobad.ad.g.a, com.opos.mobad.ad.g
    public int g() {
        a.C0707a c0707a;
        return (!e() || (c0707a = this.d) == null) ? super.g() : c0707a.b.Y();
    }
}
