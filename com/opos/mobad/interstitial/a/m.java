...
public class m implements com.opos.mobad.n.a {
    ...
    private AdItemData f12556c;
    private MaterialData d;
    private com.opos.mobad.n.a e;
    private FrameLayout f;
    private com.opos.mobad.o.c.a g;
    private a.InterfaceC0551a h = new a.InterfaceC0551a() { // from class: com.opos.mobad.interstitial.a.m.1
        @Override // com.opos.mobad.o.c.a.InterfaceC0551a
        public void a_(View view, int[] iArr) {
            a.InterfaceC0538a interfaceC0538a = m.this.b;
    ...
    private void a(MaterialData materialData) {
        ...
        if (aVar == null || this.f.indexOfChild(aVar.a()) < 0) {
            ...
            com.opos.mobad.o.c.a aVar2 = new com.opos.mobad.o.c.a(this.f12555a, this.h);
            this.g = aVar2;
            aVar2.a(new a.b(materialData.ab().a().a(), 75, 75));
            View a2 = this.g.a();
            a2.setVisibility(0);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(com.opos.cmn.an.h.f.a.a(this.f12555a, 75.0f), com.opos.cmn.an.h.f.a.a(this.f12555a, 75.0f));
            if (materialData.ab().c() == 0) {
                layoutParams.gravity = 5;
                if (com.opos.cmn.an.h.f.a.d(this.f12555a)) {
                    layoutParams.gravity |= 80;
                    layoutParams.rightMargin = com.opos.cmn.an.h.f.a.a(this.f12555a, 16.0f);
                    layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.f12555a, 140.0f);
                } else {
                    layoutParams.gravity |= 16;
                    layoutParams.rightMargin = com.opos.cmn.an.h.f.a.a(this.f12555a, 37.0f);
                }
            } else {
                layoutParams.gravity = 3;
                if (com.opos.cmn.an.h.f.a.d(this.f12555a)) {
                    layoutParams.gravity = 48;
                    layoutParams.leftMargin = com.opos.cmn.an.h.f.a.a(this.f12555a, 16.0f);
                    layoutParams.topMargin = com.opos.cmn.an.h.f.a.a(this.f12555a, 140.0f);
                } else {
                    layoutParams.gravity |= 16;
                    layoutParams.leftMargin = com.opos.cmn.an.h.f.a.a(this.f12555a, 37.0f);
                }
            }
    ...
    public void a(com.opos.mobad.n.d.h hVar) {
        ...
        if (this.f12556c == null || this.d == null) {
            return;
        }
