...
final class c implements g {
    ...
    private a.C0521a f12309c;

    public c(Context context, View view, a.C0521a c0521a) {
        this.f12308a = view;
        this.b = context;
        this.f12309c = c0521a;
    }
    ...
    public final void a(Object obj) {
        ...
        if (e()) {
            try {
                ...
                ZkViewSDK.a().a(this.f12308a, hashMap);
            } catch (Exception e) {
                com.opos.mobad.e.a.a.b.a.a();
                a.c d = com.opos.mobad.e.a.a.b.a.d().a(this.f12309c).d("7");
    ...
    public final void b() {
        ...
        if (e()) {
            try {
                ZkViewSDK.a().b(this.f12308a);
            } catch (Exception e) {
                com.opos.mobad.e.a.a.b.a.a();
                a.c d = com.opos.mobad.e.a.a.b.a.d().a(this.f12309c).d("2");
                d.e("zk pause error! + msg:" + e.getMessage()).a(this.b);
                com.opos.cmn.an.f.a.d("MatView", "pause error!" + this.f12308a);
            }
        }
    }
    ...
    public final void c() {
        ...
        if (e()) {
            try {
                ZkViewSDK.a().a(this.f12308a);
            } catch (Exception e) {
                com.opos.mobad.e.a.a.b.a.a();
                a.c d = com.opos.mobad.e.a.a.b.a.d().a(this.f12309c).d("1");
                d.e("zk resume error! + msg:" + e.getMessage()).a(this.b);
                com.opos.cmn.an.f.a.d("MatView", "resume error!" + this.f12308a);
            }
        }
    }
    ...
    public final void d() {
        ...
        if (e()) {
            try {
                ZkViewSDK.a().c(this.f12308a);
            } catch (Exception e) {
                com.opos.mobad.e.a.a.b.a.a();
                a.c d = com.opos.mobad.e.a.a.b.a.d().a(this.f12309c).d("3");
                d.e("zk release error! + msg:" + e.getMessage()).a(this.b);
                com.opos.cmn.an.f.a.d("MatView", "release error!" + this.f12308a);
            }
        }
    }
}
