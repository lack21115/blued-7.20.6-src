...
public class k implements com.opos.mobad.n.a {
    ...
    private volatile boolean f13170a = false;
    private int f = 64;
    ...
    private void a(com.opos.mobad.c.c.a aVar) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(this.b, this.f13171c);
    ...
    private void b(com.opos.mobad.c.c.a aVar) {
        this.p = ag.a(this.g, this.b, this.f13171c, aVar);
        this.l.addView(this.p, new RelativeLayout.LayoutParams(this.b, this.f13171c));
    ...
    private void b(com.opos.mobad.n.d.e eVar) {
        this.m.a(eVar.m, eVar.l, eVar.f, eVar.e, this.r, this.f13170a);
    }
    ...
    private void f() {
        ...
        this.f13171c = com.opos.cmn.an.h.f.a.a(this.g, 144.0f);
    ...
    private void k() {
        ...
        aVar.a(new a.InterfaceC0508a() { // from class: com.opos.mobad.n.g.k.5
    ...
    public void a() {
        ...
        com.opos.cmn.an.f.a.b("BlockBigImageVideo1", "current state has stop mDestroy = " + this.f13170a);
    }
    ...
    public void b() {
        ...
        com.opos.cmn.an.f.a.b("BlockBigImageVideo1", "error state mDestroy " + this.f13170a);
    }
