...
public class c implements com.opos.mobad.n.a {
    ...
    private volatile boolean f26805a = false;
    private int d = 0;
    private int e = 0;
    ...
    private void a(final ImageView imageView, final com.opos.mobad.n.d.g gVar) {
        ...
        this.t.a(gVar.f26633a, gVar.b, this.b, this.f26806c, new a.InterfaceC0676a() { // from class: com.opos.mobad.n.g.c.3
            ...
            public void a(int i, final Bitmap bitmap) {
                ...
                if (gVar == null) {
                    ...
                    com.opos.mobad.c.b.b.a(new Runnable() { // from class: com.opos.mobad.n.g.c.3.1
                        ...
                        public void run() {
                            Bitmap bitmap2;
                            if (c.this.f26805a || (bitmap2 = bitmap) == null || bitmap2.isRecycled()) {
                                return;
                            }
    ...
    private void d(com.opos.mobad.n.d.d dVar) {
        ...
        xVar.a(dVar, this.t, this.f26805a);
    }
    ...
    private void f() {
        ...
        if (i == 0) {
            ...
            this.f26806c = com.opos.cmn.an.h.f.a.a(this.h, 258.0f);
            a2 = com.opos.cmn.an.h.f.a.a(this.h, 180.0f);
        } else if (i != 1) {
            if (i == 2) {
                this.b = com.opos.cmn.an.h.f.a.a(this.h, 320.0f);
                this.f26806c = com.opos.cmn.an.h.f.a.a(this.h, 288.0f);
    ...
    private void g() {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(this.b, this.f26806c);
    ...
    private void i() {
        ...
        aVar.a(new a.InterfaceC0678a() { // from class: com.opos.mobad.n.g.c.2
