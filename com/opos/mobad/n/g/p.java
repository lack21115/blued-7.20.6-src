...
public class p implements com.opos.mobad.n.a {
    ...
    private volatile boolean f13207a = false;
    private int b = 256;

    /* renamed from: c  reason: collision with root package name */
    private int f13208c = 144;
    ...
    private void a(com.opos.mobad.c.c.a aVar) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(this.b, this.f13208c);
    ...
    private void b(com.opos.mobad.c.c.a aVar) {
        this.m = ag.a(this.e, this.b, this.f13208c, aVar);
        this.j.addView(this.m, new RelativeLayout.LayoutParams(this.b, this.f13208c));
    ...
    private void j() {
        ...
        aVar.a(new a.InterfaceC0508a() { // from class: com.opos.mobad.n.g.p.5
    ...
    public void a() {
        ...
        com.opos.cmn.an.f.a.b("BlockBigImageVideo3", "current state has stop mDestroy = " + this.f13207a);
    }
    ...
    public void b() {
        ...
        com.opos.cmn.an.f.a.b("BlockBigImageVideo3", "error state mDestroy " + this.f13207a);
    }
