...
public class b implements com.opos.mobad.n.a {
    ...
    private void a(final ImageView imageView, final com.opos.mobad.n.d.g gVar) {
        ...
        this.t.a(gVar.f12945a, gVar.b, this.b, this.f13111c, new a.InterfaceC0506a() { // from class: com.opos.mobad.n.g.b.3
            ...
            public void a(int i, final Bitmap bitmap) {
                ...
                if (gVar == null) {
                    ...
                    com.opos.mobad.c.b.b.a(new Runnable() { // from class: com.opos.mobad.n.g.b.3.1
                        ...
                        public void run() {
                            Bitmap bitmap2;
                            if (b.this.f13110a || (bitmap2 = bitmap) == null || bitmap2.isRecycled()) {
                                return;
                            }
    ...
    private void d(com.opos.mobad.n.d.d dVar) {
        ...
        xVar.a(dVar, this.t, this.f13110a);
    }
    ...
    private void f() {
        ...
        if (i == 0) {
            ...
            this.f13111c = com.opos.cmn.an.h.f.a.a(this.h, 258.0f);
            a2 = com.opos.cmn.an.h.f.a.a(this.h, 180.0f);
        } else if (i != 1) {
            if (i == 2) {
                this.b = com.opos.cmn.an.h.f.a.a(this.h, 320.0f);
                this.f13111c = com.opos.cmn.an.h.f.a.a(this.h, 288.0f);
    ...
    private void g() {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(this.b, this.f13111c);
    ...
    private void i() {
        ...
        aVar.a(new a.InterfaceC0508a() { // from class: com.opos.mobad.n.g.b.2
