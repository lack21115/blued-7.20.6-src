...
public class ae extends LinearLayout {
    ...
    public ae(Context context, a aVar) {
        super(context);
        this.f26772a = new com.opos.mobad.n.c.g() { // from class: com.opos.mobad.n.g.ae.1
    ...
    private void a() {
        ...
        this.b.setTextSize(1, this.f.f26775a);
        ...
        this.d.addView(this.f26773c, layoutParams2);
    ...
    public void a(a.InterfaceC0708a interfaceC0708a) {
        com.opos.cmn.an.f.a.b("BlockTipBar", "setListener " + interfaceC0708a);
    ...
    public void a(boolean z, boolean z2, com.opos.mobad.n.d.g gVar, String str) {
        ...
        if (z) {
            ...
            this.d.setOnClickListener(this.f26772a);
            this.d.setOnTouchListener(this.f26772a);
            this.b.setOnClickListener(this.f26772a);
            this.b.setOnTouchListener(this.f26772a);
        } else {
        ...
        if (drawable != null) {
            ...
            layoutParams.height = com.opos.cmn.an.h.f.a.a(getContext(), this.f.f26776c);
        } else {
