...
public class f implements com.opos.mobad.n.a {
    ...
    private volatile boolean f26827a = false;
    private int b = 256;

    /* renamed from: c  reason: collision with root package name */
    private int f26828c = 144;
    private int d = 64;
    ...
    private void b(com.opos.mobad.n.d.d dVar) {
        ...
        yVar.a(dVar, this.u, this.f26827a, dVar.z);
    }
    ...
    private void d(final com.opos.mobad.n.d.d dVar) {
        ...
        this.u.a(dVar.g.get(0).f26633a, dVar.g.get(0).b, this.b, this.f26828c, new a.InterfaceC0676a() { // from class: com.opos.mobad.n.g.f.3
            ...
            public void a(int i, final Bitmap bitmap) {
                ...
                if (dVar.g.get(0) == null) {
                    ...
                    com.opos.mobad.c.b.b.a(new Runnable() { // from class: com.opos.mobad.n.g.f.3.1
                        ...
                        public void run() {
                            Bitmap bitmap2;
                            if (f.this.f26827a || (bitmap2 = bitmap) == null || bitmap2.isRecycled()) {
                                return;
                            }
    ...
    private void f() {
        ...
        if (i == 0) {
            ...
            if (i == 2) {
                this.b = com.opos.cmn.an.h.f.a.a(this.f, 256.0f);
                this.f26828c = com.opos.cmn.an.h.f.a.a(this.f, 168.0f);
                this.s = true;
            }
            this.e = this.f26828c + com.opos.cmn.an.h.f.a.a(this.f, 24.0f);
        } else {
            this.b = com.opos.cmn.an.h.f.a.a(this.f, 256.0f);
    ...
    private void g() {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(this.b, this.f26828c);
    ...
    private void j() {
        this.q = y.a(this.f, this.b, this.f26828c, true);
        this.n.addView(this.q, new RelativeLayout.LayoutParams(this.b, this.f26828c));
    }

    private void k() {
        this.k = new ImageView(this.f);
        this.n.addView(this.k, new RelativeLayout.LayoutParams(this.b, this.f26828c));
    }
    ...
    private void n() {
        ...
        aVar.a(new a.InterfaceC0678a() { // from class: com.opos.mobad.n.g.f.2
