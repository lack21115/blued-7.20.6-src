...
public class c extends View {
    ...
    public c(Context context, a aVar) {
        ...
        this.f12915c.setStyle(Paint.Style.FILL);
        this.f12915c.setColor(486539264);
        this.d = com.opos.cmn.an.h.f.a.a(getContext(), aVar.b / 2);
        this.e = com.opos.cmn.an.h.f.a.a(getContext(), aVar.f12917c / 2);
        this.f12914a = com.opos.cmn.an.h.f.a.a(getContext(), this.b);
        this.f = (com.opos.cmn.an.h.f.a.a(getContext(), aVar.b) - this.f12914a) / 2;
        int a2 = com.opos.cmn.an.h.f.a.a(getContext(), aVar.f12917c);
        int i = this.f12914a;
        int i2 = (a2 - i) / 2;
        this.g = i2;
        this.h = this.f + i;
    ...
    private void a(Canvas canvas) {
        ...
        int i3 = this.k;
        canvas.drawRoundRect(rectF, i3, i3, this.f12915c);
        ...
        int i16 = this.k;
        canvas.drawRoundRect(rectF6, i16, i16, this.f12915c);
        a(canvas, this.l, rect, rectF6);
        int i17 = this.f;
        int i18 = this.j;
        RectF rectF7 = new RectF(i17 + i18, this.g + i18, this.h + i18, this.i + i18);
        int i19 = this.k;
        canvas.drawRoundRect(rectF7, i19, i19, this.f12915c);
