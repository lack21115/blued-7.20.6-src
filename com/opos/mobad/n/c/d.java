...
public final class d {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f26607a[Bitmap.Config.ALPHA_8.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f26607a[Bitmap.Config.ARGB_4444.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f26607a[Bitmap.Config.ARGB_8888.ordinal()] = 4;
                ...
                if (i3 >= 1) {
                    ...
                    if (i4 >= 1) {
                        ...
                        if (i5 <= bitmap.getWidth()) {
                            ...
                            if (config2 != null) {
                                int i7 = AnonymousClass1.f26607a[config2.ordinal()];
