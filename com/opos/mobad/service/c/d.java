...
public class d {
    ...
    private com.opos.cmn.i.a f27316c;
        ...
        public void a(final a.InterfaceC0645a interfaceC0645a) {
            ...
            if (list != null && list.size() > 0) {
                ...
                com.opos.cmn.an.j.b.c(new Runnable() { // from class: com.opos.mobad.service.c.d.1.1
                    ...
                    public void run() {
                        try {
                            com.opos.mobad.d.d.a().a(list, new a.InterfaceC0677a() { // from class: com.opos.mobad.service.c.d.1.1.1
                            ...
                            }, com.opos.mobad.c.a(f.a(d.this.f27315a)));
                        } catch (Exception e) {
    ...
    public d(Context context) {
        ...
        this.f27316c = new com.opos.cmn.i.a(new AnonymousClass1(), Integer.MAX_VALUE, 10000);
    }
    ...
    public void a(List<a.b> list) {
        for (a.b bVar : list) {
            if (bVar != null && !TextUtils.isEmpty(bVar.f25806a)) {
                String b = this.b.b(bVar.f25806a);
                e.a(this.f27315a, b);
    ...
    public void a(String[] strArr) {
        ...
        } else if (com.opos.cmn.an.h.c.a.e(this.f27315a)) {
            this.d = b(strArr);
    ...
    public boolean a(String str) {
        ...
        File a2 = f.a(this.f27315a, this.b.b(str));
        if (a2 == null) {
