...
public class a {
    ...
    private Map<Integer, String> f13624a = new ConcurrentHashMap();
    ...
    public void a(Map<Integer, String> map) {
        ...
        this.f13624a = new ConcurrentHashMap(map);
        com.opos.cmn.an.f.a.b("Dynamic-Config", "refreshStrategy map = " + this.f13624a);
    }

    public boolean a() {
        Map<Integer, String> map = this.f13624a;
