...
public final class b {
    ...
    public static final int f11377a;
    public static final UUID b;

    /* renamed from: c  reason: collision with root package name */
    public static final UUID f11378c;
    public static final UUID d;
    public static final UUID e;
    public static final UUID f;

    static {
        f11377a = com.opos.exoplayer.core.i.u.f11822a < 23 ? 1020 : 6396;
        b = new UUID(0L, 0L);
        f11378c = new UUID(1186680826959645954L, -5988876978535335093L);
