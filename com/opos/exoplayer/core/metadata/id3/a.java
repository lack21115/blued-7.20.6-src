...
public final class a implements com.opos.exoplayer.core.metadata.a {
    ...
    public static final int f25538a = u.f("ID3");
    ...
    private static ChapterFrame a(m mVar, int i, int i2, boolean z, int i3, InterfaceC0667a interfaceC0667a) {
        int d = mVar.d();
        int b2 = b(mVar.f25496a, d);
        String str = new String(mVar.f25496a, d, b2 - d, "ISO-8859-1");
        mVar.c(b2 + 1);
        int o = mVar.o();
        int o2 = mVar.o();
        long m = mVar.m();
        if (m == ExpandableListView.PACKED_POSITION_VALUE_NULL) {
            m = -1;
        }
        long m2 = mVar.m();
        if (m2 == ExpandableListView.PACKED_POSITION_VALUE_NULL) {
            m2 = -1;
        }
        ArrayList arrayList = new ArrayList();
        while (mVar.d() < d + i) {
            Id3Frame a2 = a(i2, mVar, z, i3, interfaceC0667a);
            if (a2 != null) {
                arrayList.add(a2);
            }
        }
    ...
    private static Id3Frame a(int i, m mVar, boolean z, int i2, InterfaceC0667a interfaceC0667a) {
        int u;
        boolean z2;
        boolean z3;
        boolean z4;
        ...
        if (g != 0 || g2 != 0 || g3 != 0 || g4 != 0 || i3 != 0 || h != 0) {
            int d = mVar.d() + i3;
            if (d <= mVar.c()) {
                if (interfaceC0667a == null || interfaceC0667a.a(i, g, g2, g3, g4)) {
                    int i4 = h;
                    if (i == 3) {
                        boolean z7 = (i4 & 128) != 0;
                        z4 = (i4 & 64) != 0;
                    ...
                    if (z6 || z4) {
                        ...
                        try {
                            try {
                                Id3Frame a2 = (g == 84 && g2 == 88 && g3 == 88 && (i == 2 || g4 == 88)) ? a(mVar, i7) : g == 84 ? a(mVar, i7, a(i, g, g2, g3, g4)) : (g == 87 && g2 == 88 && g3 == 88 && (i == 2 || g4 == 88)) ? b(mVar, i7) : g == 87 ? b(mVar, i7, a(i, g, g2, g3, g4)) : (g == 80 && g2 == 82 && g3 == 73 && g4 == 86) ? c(mVar, i7) : (g == 71 && g2 == 69 && g3 == 79 && (g4 == 66 || i == 2)) ? d(mVar, i7) : (i != 2 ? !(g == 65 && g2 == 80 && g3 == 73 && g4 == 67) : !(g == 80 && g2 == 73 && g3 == 67)) ? (g == 67 && g2 == 79 && g3 == 77 && (g4 == 77 || i == 2)) ? e(mVar, i7) : (g == 67 && g2 == 72 && g3 == 65 && g4 == 80) ? a(mVar, i7, i, z, i2, interfaceC0667a) : (g == 67 && g2 == 84 && g3 == 79 && g4 == 67) ? b(mVar, i7, i, z, i2, interfaceC0667a) : c(mVar, i7, a(i, g, g2, g3, g4)) : a(mVar, i7, i);
                                if (a2 == null) {
    ...
    private static String a(int i) {
        ...
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i != 3 ? "ISO-8859-1" : "UTF-8" : CharEncoding.UTF_16BE;
            }
            str = "UTF-16";
        }
        return str;
    ...
    */
    ...
    private static ChapterTocFrame b(m mVar, int i, int i2, boolean z, int i3, InterfaceC0667a interfaceC0667a) {
        int d = mVar.d();
        int b2 = b(mVar.f25496a, d);
        String str = new String(mVar.f25496a, d, b2 - d, "ISO-8859-1");
        mVar.c(b2 + 1);
        ...
        for (int i4 = 0; i4 < g2; i4++) {
            int d2 = mVar.d();
            int b3 = b(mVar.f25496a, d2);
            strArr[i4] = new String(mVar.f25496a, d2, b3 - d2, "ISO-8859-1");
            mVar.c(b3 + 1);
        }
        ArrayList arrayList = new ArrayList();
        while (mVar.d() < d + i) {
    ...
    private static int f(m mVar, int i) {
        ...
        while (true) {
            ...
            if ((bArr[d] & 255) == 255) {
                i3 = i;
                if (bArr[i2] == 0) {
                    System.arraycopy((Object) bArr, d + 2, (Object) bArr, i2, (i - d) - 2);
                    i3 = i - 1;
                }
            }
            d = i2;
    ...
    public Metadata a(byte[] bArr, int i) {
        ...
        int d = mVar.d();
        int i2 = a2.f25539a == 2 ? 6 : 10;
        int i3 = a2.f25540c;
        if (a2.b) {
            i3 = f(mVar, a2.f25540c);
        }
        mVar.b(i3 + d);
        boolean z = false;
        if (!a(mVar, a2.f25539a, i2, false)) {
            if (a2.f25539a != 4 || !a(mVar, 4, i2, true)) {
                com.opos.cmn.an.f.a.c("Id3Decoder", "Failed to validate ID3 tag with majorVersion=" + a2.f25539a);
                return null;
            }
            z = true;
        }
        while (mVar.b() >= i2) {
            Id3Frame a3 = a(a2.f25539a, mVar, z, i2, this.b);
            if (a3 != null) {
                arrayList.add(a3);
            }
        }
