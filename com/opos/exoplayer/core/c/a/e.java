...
final class e extends b {
    ...
    public e(n nVar) {
        super(nVar);
        this.b = new m(k.f11800a);
        this.f11397c = new m(4);
    }
    ...
    protected void b(m mVar, long j) {
        ...
        if (g == 0 && !this.e) {
            ...
            mVar.a(mVar2.f11808a, 0, mVar.b());
            com.opos.exoplayer.core.video.a a2 = com.opos.exoplayer.core.video.a.a(mVar2);
            this.d = a2.b;
            this.f11395a.a(Format.a((String) null, "video/avc", (String) null, -1, -1, a2.f11878c, a2.d, -1.0f, a2.f11877a, -1, a2.e, (DrmInitData) null));
            this.e = true;
        } else if (g == 1 && this.e) {
            byte[] bArr = this.f11397c.f11808a;
            byte b = (byte) 0;
            bArr[0] = b;
            bArr[1] = b;
            bArr[2] = b;
            ...
            while (true) {
                ...
                mVar.a(this.f11397c.f11808a, 4 - i2, this.d);
                this.f11397c.c(0);
                int u = this.f11397c.u();
                this.b.c(0);
                this.f11395a.a(this.b, 4);
                this.f11395a.a(mVar, u);
                i3 = i + 4 + u;
            }
            this.f11395a.a((l * 1000) + j, this.f == 1 ? 1 : 0, i, 0, null);
        }
    }
}
