...
public final class c implements h {
    ...
    private static final Constructor<? extends e> f25101a;
    private int b;
    ...
    public e[] a() {
        ...
        synchronized (this) {
            ...
            if (f25101a != null) {
                try {
                    eVarArr[11] = f25101a.newInstance(new Object[0]);
                } catch (Exception e) {
