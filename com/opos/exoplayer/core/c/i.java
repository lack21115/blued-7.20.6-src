...
public final class i {
    ...
    public static final a.InterfaceC0497a f11557a = new a.InterfaceC0497a() { // from class: com.opos.exoplayer.core.c.i.1
        @Override // com.opos.exoplayer.core.metadata.id3.a.InterfaceC0497a
    ...
    public boolean a() {
        return (this.b == -1 || this.f11558c == -1) ? false : true;
    }
    ...
    public boolean a(Metadata metadata) {
        ...
        while (true) {
            ...
            if (a2 instanceof CommentFrame) {
                ...
                if (a(commentFrame.b, commentFrame.f11844c)) {
                    return true;
                }
            }
            i = i2 + 1;
