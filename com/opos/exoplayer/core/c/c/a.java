...
public final class a implements e {
    ...
    public static final h f25103a = new h() { // from class: com.opos.exoplayer.core.c.c.a.1
    ...
    private static final int f25104c = u.f("Info");
    ...
    public interface InterfaceC0650a extends l {
        long a(long j);
    }
    ...
    private boolean a(f fVar, boolean z) {
        ...
        int i5 = 0;
        while (true) {
            if (!fVar.b(this.g.f25496a, 0, 4, i3 > 0)) {
                break;
            }
            this.g.c(0);
            int o = this.g.o();
    ...
    private int b(f fVar) {
        if (this.q == 0) {
            fVar.a();
            if (!fVar.b(this.g.f25496a, 0, 4, true)) {
                return -1;
            }
            this.g.c(0);
            int o = this.g.o();
        ...
        this.q = i;
        if (i <= 0) {
            this.k.a(((this.p * 1000000) / this.h.d) + this.o, 1, this.h.f25248c, 0, null);
            this.p += this.h.g;
            this.q = 0;
            return 0;
        }
    ...
    private void c(f fVar) {
        ...
        while (true) {
            int i2 = i;
            fVar.c(this.g.f25496a, 0, 10);
            this.g.c(0);
            if (this.g.k() != com.opos.exoplayer.core.metadata.id3.a.f25538a) {
                fVar.a();
                fVar.c(i2);
                return;
            }
            ...
            if (this.m == null) {
                ...
                System.arraycopy((Object) this.g.f25496a, 0, (Object) bArr, 0, 10);
                fVar.c(bArr, 10, t);
                Metadata a2 = new com.opos.exoplayer.core.metadata.id3.a((this.e & 2) != 0 ? i.f25245a : null).a(bArr, i3);
                this.m = a2;
                if (a2 != null) {
                    this.i.a(a2);
                }
    ...
    private InterfaceC0650a d(f fVar) {
        int i;
        m mVar = new m(this.h.f25248c);
        fVar.c(mVar.f25496a, 0, this.h.f25248c);
        if ((this.h.f25247a & 1) != 0) {
            if (this.h.e != 1) {
                i = 36;
            }
            i = 21;
    ...
    private InterfaceC0650a e(f fVar) {
        fVar.c(this.g.f25496a, 0, 4);
        this.g.c(0);
        j.a(this.g.o(), this.h);
    ...
    public int a(f fVar, k kVar) {
        ...
        if (this.n == null) {
            InterfaceC0650a d2 = d(fVar);
            this.n = d2;
            if (d2 == null || (!d2.a() && (this.e & 1) != 0)) {
                this.n = e(fVar);
            }
            this.j.a(this.n);
            this.k.a(Format.a((String) null, this.h.b, (String) null, -1, 4096, this.h.e, this.h.d, -1, this.i.b, this.i.f25246c, (List<byte[]>) null, (DrmInitData) null, 0, (String) null, (this.e & 2) != 0 ? null : this.m));
        }
        return b(fVar);
    }
