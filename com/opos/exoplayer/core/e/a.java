...
public final class a implements d, d.a {
    ...
    public final d f11586a;
    long b;

    /* renamed from: c  reason: collision with root package name */
    long f11587c;
    private d.a d;
    private C0487a[] e = new C0487a[0];
    private long f;
    ...
    final class C0487a implements i {
        ...
        public int a(long j) {
            ...
            return this.f11590a.a(a.this.b + j);
        }
        ...
        public int a(com.opos.exoplayer.core.l lVar, com.opos.exoplayer.core.b.e eVar, boolean z) {
            ...
            int a2 = this.f11590a.a(lVar, eVar, z);
            if (a2 == -5) {
                Format format = lVar.f11827a;
                if (format.u != -1 || format.v != -1) {
                    int i2 = 0;
                    int i3 = a.this.b != 0 ? 0 : format.u;
                    if (a.this.f11587c == Long.MIN_VALUE) {
                        i2 = format.v;
                    }
                    lVar.f11827a = format.a(i3, i2);
                    return -5;
                }
            } else if (a.this.f11587c != Long.MIN_VALUE && ((a2 == -4 && eVar.f11386c >= a.this.f11587c) || (a2 == -3 && a.this.d() == Long.MIN_VALUE))) {
                eVar.a();
                eVar.a_(4);
                this.f11591c = true;
                return -4;
        ...
        @Override // com.opos.exoplayer.core.e.i
        public boolean b() {
            return !a.this.f() && this.f11590a.b();
        }
    ...
    public a(d dVar, boolean z) {
        ...
        this.f11587c = com.anythink.expressad.exoplayer.b.b;
    }
    ...
    public long a(long j, w wVar) {
        ...
        long j3 = j2 + j;
        return this.f11586a.a(j3, b(j3, wVar)) - this.b;
    }
    ...
    */
    ...
    public void a(long j, boolean z) {
        this.f11586a.a(this.b + j, z);
    }

    @Override // com.opos.exoplayer.core.e.d
    public void a(d.a aVar, long j) {
        this.d = aVar;
        this.f11586a.a(this, this.b + j);
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // com.opos.exoplayer.core.e.d.a
    public void a(d dVar) {
        com.opos.exoplayer.core.i.a.b((this.b == com.anythink.expressad.exoplayer.b.b || this.f11587c == com.anythink.expressad.exoplayer.b.b) ? false : true);
        this.d.a((d) this);
    }
    ...
    */
    public long b(long r6) {
        ...
        L34:
            ...
            r10 = r0
            r0 = r5
            com.opos.exoplayer.core.e.d r0 = r0.f11586a
            r1 = r10
            long r0 = r0.b(r1)
            r6 = r0
            r0 = r6
    ...
    public boolean c(long j) {
        return this.f11586a.c(this.b + j);
    }
