...
public class a {
    ...
    public static final String f24923a = a.class.getSimpleName();
    ...
    final class C0643a extends com.opos.cmn.func.dl.base.a {
        C0643a() {
        }
        ...
        private void a(c cVar) {
            final com.opos.cmn.func.dl.base.a.b bVar = cVar.f24893a;
            if (TextUtils.isEmpty(bVar.h)) {
                return;
            }
            a.this.f24924c.g().d().execute(new Runnable() { // from class: com.opos.cmn.func.dl.base.f.a.a.1
    ...
    public a(d dVar, b bVar) {
        this.f24924c = dVar;
        this.d = bVar;
        this.h = new com.opos.cmn.func.dl.base.d.b(this.f24924c.f(), this);
        dVar.a(new C0643a());
    }

    public final com.opos.cmn.func.dl.base.a.a.d a() {
        if (this.g == null) {
            this.g = new com.opos.cmn.func.dl.base.a.a.d(this.f24924c.f(), this, this.f24924c.b());
        }
        return this.g;
    }
    ...
    public final void a(final DownloadRequest downloadRequest, final boolean z) {
        if (downloadRequest == null) {
            com.opos.cmn.an.f.a.d(f24923a, "Request is null,do nothing");
        } else {
