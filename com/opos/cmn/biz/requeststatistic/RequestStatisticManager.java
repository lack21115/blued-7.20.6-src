...
public class RequestStatisticManager {
    ...
    private static final String f24664a = RequestStatisticManager.class.getSimpleName();
    ...
    private static String a(Context context) {
        ...
        if (context != null) {
            try {
                ...
                com.opos.cmn.an.f.a.b(f24664a, "net access fail", e);
                return "";
            }
        }
        return "";
    ...
    static /* synthetic */ JSONObject a(RequestStatisticManager requestStatisticManager, StatisticEvent statisticEvent) {
        ...
        jSONObject2.put("pkg", requestStatisticManager.f24665c.getPackageName());
        ...
        jSONObject2.put("net", a(requestStatisticManager.f24665c));
        boolean a2 = com.opos.cmn.biz.c.b.a.a();
        com.opos.cmn.an.f.a.b("Utils", "isOverseas=".concat(String.valueOf(a2)));
        if (a2) {
            jSONObject2.put("gaId", com.opos.cmn.g.a.b.g(requestStatisticManager.f24665c));
        }
        jSONObject2.put(com.anythink.expressad.foundation.g.a.L, com.opos.cmn.biz.a.b.a(requestStatisticManager.f24665c));
        jSONObject2.put("rn", d.a(requestStatisticManager.f24665c));
        jSONObject2.put("duId", "");
        jSONObject2.put("ouId", com.opos.cmn.g.a.b.a(requestStatisticManager.f24665c));
    ...
    private boolean b() {
        return (this.f24665c == null || this.d == null) ? false : true;
    }
    ...
    public void init(Context context, InitParams initParams) {
        this.f24665c = context.getApplicationContext();
        final com.opos.cmn.biz.requeststatistic.a.d a2 = com.opos.cmn.biz.requeststatistic.a.d.a();
        if (a2.b == null) {
            a2.b = context;
            a2.f24680c = new com.opos.cmn.biz.requeststatistic.a.b(context);
    ...
    public void report(final StatisticEvent statisticEvent) {
        com.opos.cmn.an.f.a.b(f24664a, "report:".concat(String.valueOf(statisticEvent)));
        if (!b()) {
        ...
        if (com.opos.cmn.an.f.a.a(this.f24665c)) {
            com.opos.cmn.an.j.b.a().execute(new Runnable() { // from class: com.opos.cmn.biz.requeststatistic.RequestStatisticManager.1
                ...
                public void run() {
                    try {
                        ...
                        com.opos.cmn.an.f.a.b(RequestStatisticManager.f24664a, "send data:".concat(String.valueOf(jSONArray2)));
                        ...
                        String str = com.opos.cmn.biz.requeststatistic.a.d.f24679a;
                        com.opos.cmn.an.f.a.b(str, "add cache with data:" + cVar.b);
                        a3.d.offer(cVar);
                        if (a3.e != null) {
                            a3.e.a();
                        }
                        a.a(RequestStatisticManager.this.f24665c, jSONArray2, new a.InterfaceC0630a() { // from class: com.opos.cmn.biz.requeststatistic.RequestStatisticManager.1.1
                            @Override // com.opos.cmn.biz.requeststatistic.a.InterfaceC0630a
                            public void onFail() {
                                com.opos.cmn.an.f.a.b(RequestStatisticManager.f24664a, "report request fail");
                            }
                            ...
                            public void onSuccess() {
                                ...
                                final c cVar2 = cVar;
                                String str2 = com.opos.cmn.biz.requeststatistic.a.d.f24679a;
                                com.opos.cmn.an.f.a.b(str2, "delete cache with id:" + cVar2.f24677a);
                                if (!a4.d.remove(cVar2)) {
                                    String str3 = com.opos.cmn.biz.requeststatistic.a.d.f24679a;
                                    com.opos.cmn.an.f.a.b(str3, "remove from db:" + cVar2.f24677a);
                                    com.opos.cmn.an.j.b.a().execute(new Runnable() { // from class: com.opos.cmn.biz.requeststatistic.a.d.4
                                        ...
                                        public final void run() {
                                            ...
                                            try {
                                                try {
                                                    b bVar = d.this.f24680c;
                                                    c cVar3 = cVar2;
                                                    long j = cVar3.f24677a;
                                                    if (j < 0) {
                                                        com.opos.cmn.an.f.a.c(b.f24676a, "delete data by id had not init");
                                                    ...
                                                    com.opos.cmn.an.f.a.b(d.f24679a, "delete fail", e);
                                                }
                                            } finally {
                        ...
                        com.opos.cmn.an.f.a.d(RequestStatisticManager.f24664a, "request parse json fail", e);
                    }
                }
            });
        } else {
            com.opos.cmn.an.f.a.b(f24664a, "log buried point switch is closed, cannot upload log buried point");
        }
    }
    ...
    public void reportCacheIfNeed() {
        ...
        } else if (com.opos.cmn.an.f.a.a(this.f24665c)) {
            com.opos.cmn.biz.requeststatistic.a.d.a().b();
            return;
        } else {
            str = f24664a;
