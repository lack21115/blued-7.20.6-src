...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/internal/ThemeEnforcement.class */
    ...
    private static boolean isCustomTextAppearanceValid(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, int... iArr2) {
        ...
        while (true) {
            ...
            if (i4 >= length) {
                obtainStyledAttributes.recycle();
                return true;
            } else if (obtainStyledAttributes.getResourceId(iArr2[i4], -1) == -1) {
                obtainStyledAttributes.recycle();
                return false;
            } else {
                i3 = i4 + 1;
