...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/internal/FlowLayout.class */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (z2) {
                    childAt.layout(i7 - measuredWidth2, i13, (i7 - i12) - i6, paddingTop);
                } else {
                    childAt.layout(i14, i13, measuredWidth2, paddingTop);
                }
                i8 = i12 + i6 + i5 + childAt.getMeasuredWidth() + this.itemSpacing;
                i9 = i13;
            }
            i10 = i11 + 1;
        }
