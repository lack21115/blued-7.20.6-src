...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/datepicker/CalendarItemStyle.class */
final class CalendarItemStyle {
    ...
    public void styleItem(TextView textView) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            materialShapeDrawable = new RippleDrawable(this.textColor.withAlpha(30), materialShapeDrawable, materialShapeDrawable2);
        }
        ViewCompat.setBackground(textView, new InsetDrawable(materialShapeDrawable, this.insets.left, this.insets.top, this.insets.right, this.insets.bottom));
    }
}
