...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/animation/MotionSpec.class */
public class MotionSpec {
    ...
    private PropertyValuesHolder[] clonePropertyValuesHolder(PropertyValuesHolder[] propertyValuesHolderArr) {
        ...
        while (true) {
            ...
            propertyValuesHolderArr2[i2] = propertyValuesHolderArr[i2].mo64clone();
            i = i2 + 1;
        }
    }
