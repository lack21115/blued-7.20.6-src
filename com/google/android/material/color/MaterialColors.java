...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/color/MaterialColors.class */
public class MaterialColors {
    ...
    public static ColorRoles getColorRoles(int i, boolean z) {
        return z ? new ColorRoles(getColorRole(i, 40), getColorRole(i, 100), getColorRole(i, 90), getColorRole(i, 10)) : new ColorRoles(getColorRole(i, 70), getColorRole(i, 10), getColorRole(i, 20), getColorRole(i, 80));
    }
