...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/timepicker/MaterialTimePicker.class */
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/android/material/timepicker/MaterialTimePicker$Builder.class */
    ...
    public void updateInputMode(MaterialButton materialButton) {
        ...
        materialButton.setIconResource(dataForMode.first.intValue());
        materialButton.setContentDescription(getResources().getString(dataForMode.second.intValue()));
