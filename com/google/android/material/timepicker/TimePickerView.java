...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/timepicker/TimePickerView.class */
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/android/material/timepicker/TimePickerView$OnDoubleTapListener.class */
    interface OnDoubleTapListener {
        void onDoubleTap();
    }

    /* loaded from: source-8110460-dex2jar.jar:com/google/android/material/timepicker/TimePickerView$OnPeriodChangeListener.class */
    interface OnPeriodChangeListener {
        void onPeriodChange(int i);
    }

    /* loaded from: source-8110460-dex2jar.jar:com/google/android/material/timepicker/TimePickerView$OnSelectionChange.class */
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.setAccessibilityLiveRegion(this.minuteView, 2);
        ViewCompat.setAccessibilityLiveRegion(this.hourView, 2);
        setupDoubleTap();
        setUpDisplay();
    }
