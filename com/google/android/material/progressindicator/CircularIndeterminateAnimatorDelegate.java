...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/progressindicator/CircularIndeterminateAnimatorDelegate.class */
public final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DELAY_TO_COLLAPSE_IN_MS = {LiveProtos.Event.LIVE_USER_RANDOM_GIFT_PAGE_SHOW_VALUE, 2017, 3367, 4717};
    ...
    private void maybeUpdateSegmentColors(int i) {
        ...
        while (true) {
            ...
            if (fractionInRange >= 0.0f && fractionInRange <= 1.0f) {
                int length = (i3 + this.indicatorColorIndexOffset) % this.baseSpec.indicatorColors.length;
    ...
    private void updateSegmentPositions(int i) {
        ...
        while (true) {
            ...
            if (i3 >= 4) {
                ...
                fArr[0] = fArr[0] + ((this.segmentPositions[1] - this.segmentPositions[0]) * this.completeEndFraction);
            ...
            float fractionInRange = getFractionInRange(i, DELAY_TO_EXPAND_IN_MS[i3], LiveProtos.Event.LIVE_USER_RANDOM_GIFT_PAGE_SHOW_VALUE);
            float[] fArr4 = this.segmentPositions;
            fArr4[1] = fArr4[1] + (this.interpolator.getInterpolation(fractionInRange) * 250.0f);
            float fractionInRange2 = getFractionInRange(i, DELAY_TO_COLLAPSE_IN_MS[i3], LiveProtos.Event.LIVE_USER_RANDOM_GIFT_PAGE_SHOW_VALUE);
            float[] fArr5 = this.segmentPositions;
            fArr5[0] = fArr5[0] + (this.interpolator.getInterpolation(fractionInRange2) * 250.0f);
            i2 = i3 + 1;
        }
    }
