...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/progressindicator/IndeterminateDrawable.class */
public final class IndeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    public void draw(Canvas canvas) {
        ...
        while (true) {
            int i2 = i;
            if (i2 >= this.animatorDelegate.segmentColors.length) {
                canvas.restore();
                return;
            }
            int i3 = i2 * 2;
            this.drawingDelegate.fillIndicator(canvas, this.paint, this.animatorDelegate.segmentPositions[i3], this.animatorDelegate.segmentPositions[i3 + 1], this.animatorDelegate.segmentColors[i2]);
            i = i2 + 1;
        }
    }
