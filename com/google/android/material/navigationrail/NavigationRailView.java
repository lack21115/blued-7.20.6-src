...
/* loaded from: source-8110460-dex2jar.jar:com/google/android/material/navigationrail/NavigationRailView.class */
    ...
    private int makeMinWidthSpec(int i) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            if (suggestedMinimumWidth > 0) {
                i2 = View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), suggestedMinimumWidth + getPaddingLeft() + getPaddingRight()), 1073741824);
            }
        }
        return i2;
    }
