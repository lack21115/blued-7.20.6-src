...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/graph/AbstractNetwork.class */
public abstract class AbstractNetwork<N, E> implements Network<N, E> {

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.google.common.graph.AbstractNetwork$1  reason: invalid class name */
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/graph/AbstractNetwork$1.class */
            ...
            return AbstractNetwork.this.allowsParallelEdges() ? super.edges() : new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                ...
                public boolean contains(@NullableDecl Object obj) {
                    if (obj instanceof EndpointPair) {
                        ...
                        boolean z = false;
                        if (AnonymousClass1.this.isOrderingCompatible(endpointPair)) {
                            z = false;
                            if (AnonymousClass1.this.nodes().contains(endpointPair.nodeU())) {
                                z = false;
                                if (AnonymousClass1.this.successors((AnonymousClass1) endpointPair.nodeU()).contains(endpointPair.nodeV())) {
                                    z = true;
                                }
                            }
                        }
