...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/collect/ImmutableListMultimap.class */
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    private static final long serialVersionUID = 0;
    @LazyInit
    private transient ImmutableListMultimap<V, K> inverse;

    /* loaded from: source-8110460-dex2jar.jar:com/google/common/collect/ImmutableListMultimap$Builder.class */
