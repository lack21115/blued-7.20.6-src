...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/collect/TreeBasedTable.class */
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    private static final long serialVersionUID = 0;
    private final Comparator<? super C> columnComparator;

    /* loaded from: source-8110460-dex2jar.jar:com/google/common/collect/TreeBasedTable$Factory.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/collect/TreeBasedTable$TreeRow.class */
    public class TreeRow extends StandardTable<R, C, V>.Row implements SortedMap<C, V> {
        ...
        public SortedMap<C, V> computeBackingRowMap() {
            ...
            if (wholeRow != null) {
                ...
                if (c2 != null) {
                    sortedMap = wholeRow.tailMap(c2);
                }
                C c3 = this.upperBound;
                SortedMap<C, V> sortedMap2 = sortedMap;
                if (c3 != null) {
                    sortedMap2 = sortedMap.headMap(c3);
                }
                return sortedMap2;
            }
            return null;
        ...
        boolean rangeContains(@NullableDecl Object obj) {
            if (obj != null) {
                ...
                if (c2 == null || compare(c2, obj) <= 0) {
                    C c3 = this.upperBound;
                    return c3 == null || compare(c3, obj) > 0;
                }
                return false;
            }
            return false;
