...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/collect/TopKSelector.class */
public final class TopKSelector<T> {
    ...
    private void trim() {
        ...
        int i2;
        int i3 = (this.k * 2) - 1;
        int log2 = IntMath.log2(i3 + 0, RoundingMode.CEILING);
        int i4 = 0;
        int i5 = 0;
        int i6 = 0;
        while (true) {
            ...
            if (i4 < i3) {
                ...
                i6 = i;
                if (i8 >= log2 * 3) {
                    Arrays.sort(this.buffer, max, i2, this.comparator);
                    break;
                }
            } else {
                break;
