...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager.class */
public final class ServiceManager implements ServiceManagerBridge {
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager$EmptyServiceManagerWarning.class */
    static final class EmptyServiceManagerWarning extends Throwable {
        private EmptyServiceManagerWarning() {
        }
    }

    /* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager$Listener.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager$NoOpService.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager$ServiceListener.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager$ServiceManagerState.class */
    public static final class ServiceManagerState {
        ...
        /* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager$ServiceManagerState$AwaitHealthGuard.class */
        ...
        /* loaded from: source-8110460-dex2jar.jar:com/google/common/util/concurrent/ServiceManager$ServiceManagerState$StoppedGuard.class */
        ...
        void transitionService(Service service, Service.State state, Service.State state2) {
            ...
            try {
                ...
                if (this.ready) {
                    ...
                    if (stopwatch == null) {
                        stopwatch2 = Stopwatch.createStarted();
                        this.startupTimers.put(service, stopwatch2);
                    }
                    if (state2.compareTo(Service.State.RUNNING) >= 0 && stopwatch2.isRunning()) {
                        stopwatch2.stop();
                        if (!(service instanceof NoOpService)) {
                            ServiceManager.logger.log(Level.FINE, "Started {0} in {1}.", new Object[]{service, stopwatch2});
                        }
                    }
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        ImmutableList<Service> immutableList = copyOf;
        if (copyOf.isEmpty()) {
            ...
            immutableList = ImmutableList.of(new NoOpService());
        }
    ...
    public String toString() {
        return MoreObjects.toStringHelper((Class<?>) ServiceManager.class).add(k2.d, Collections2.filter(this.services, Predicates.not(Predicates.instanceOf(NoOpService.class)))).toString();
    }
}
