...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/io/ByteStreams.class */
public final class ByteStreams {
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/ByteStreams$ByteArrayDataInputStream.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/ByteStreams$ByteArrayDataOutputStream.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/ByteStreams$LimitedInputStream.class */
    ...
    public static long skipUpTo(InputStream inputStream, long j) throws IOException {
        ...
        while (j2 < j) {
            ...
            if (skipSafely == 0) {
                ...
                long read = inputStream.read(bArr2, 0, min);
                j4 = read;
                if (read == -1) {
                    return j2;
                }
    ...
    private static byte[] toByteArrayInternal(InputStream inputStream, Deque<byte[]> deque, int i) throws IOException {
        ...
        while (true) {
            ...
            int min = Math.min(i4, MAX_ARRAY_LEN - i2);
            ...
            i3 = IntMath.saturatedMultiply(i4, 2);
        }
    }
}
