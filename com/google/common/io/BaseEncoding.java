...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/io/BaseEncoding.class */
public abstract class BaseEncoding {
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/BaseEncoding$Alphabet.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/BaseEncoding$Base16Encoding.class */
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            while (true) {
                ...
                bArr[i3] = (byte) ((this.alphabet.decode(charSequence.charAt(i)) << 4) | this.alphabet.decode(charSequence.charAt(i + 1)));
                i += 2;
                i2 = i3 + 1;
            }
        }
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/BaseEncoding$Base64Encoding.class */
    static final class Base64Encoding extends StandardBaseEncoding {
        ...
        int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            while (i < trimTrailingPadding.length()) {
                int i3 = i + 1;
                int decode = this.alphabet.decode(trimTrailingPadding.charAt(i));
                int i4 = i3 + 1;
                int decode2 = (decode << 18) | (this.alphabet.decode(trimTrailingPadding.charAt(i3)) << 12);
                int i5 = i2 + 1;
                ...
                if (i4 < trimTrailingPadding.length()) {
                    i = i4 + 1;
                    int decode3 = decode2 | (this.alphabet.decode(trimTrailingPadding.charAt(i4)) << 6);
                    i2 = i5 + 1;
                    bArr[i5] = (byte) ((decode3 >>> 8) & 255);
                    if (i < trimTrailingPadding.length()) {
                        bArr[i2] = (byte) ((decode3 | this.alphabet.decode(trimTrailingPadding.charAt(i))) & 255);
                        i2++;
                        i++;
                    }
                }
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/BaseEncoding$DecodingException.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/BaseEncoding$SeparatedBaseEncoding.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/io/BaseEncoding$StandardBaseEncoding.class */
    public static class StandardBaseEncoding extends BaseEncoding {
        ...
        public boolean canDecode(CharSequence charSequence) {
            ...
            while (true) {
                int i2 = i;
                if (i2 >= trimTrailingPadding.length()) {
                    return true;
                }
        ...
        int decodeTo(byte[] bArr, CharSequence charSequence) throws DecodingException {
            ...
            while (i2 < trimTrailingPadding.length()) {
                ...
                while (true) {
                    i = i5;
                    if (i4 >= this.alphabet.charsPerChunk) {
                        break;
                    }
                    ...
                    if (i2 + i4 < trimTrailingPadding.length()) {
                        j = j2 | this.alphabet.decode(trimTrailingPadding.charAt(i + i2));
                        i6 = i + 1;
                    }
                    i4++;
                    i5 = i6;
                }
                int i7 = this.alphabet.bytesPerChunk;
                int i8 = this.alphabet.bitsPerChar;
                int i9 = (this.alphabet.bytesPerChunk - 1) * 8;
                while (i9 >= (i7 * 8) - (i * i8)) {
        ...
        void encodeChunkTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            while (true) {
                ...
                appendable.append(this.alphabet.encode(((int) (j >>> ((((i2 + 1) * 8) - i6) - i3))) & this.alphabet.mask));
                i7 = i3 + this.alphabet.bitsPerChar;
            }
        ...
        void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            while (true) {
                ...
                encodeChunkTo(appendable, bArr, i + i4, Math.min(this.alphabet.bytesPerChunk, i2 - i4));
                i3 = i4 + this.alphabet.bytesPerChunk;
            }
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (obj instanceof StandardBaseEncoding) {
                ...
                if (this.alphabet.equals(standardBaseEncoding.alphabet)) {
                    z = false;
                    if (Objects.equal(this.paddingChar, standardBaseEncoding.paddingChar)) {
                        z = true;
                    }
                }
            }
        ...
        public BaseEncoding lowerCase() {
            ...
            if (baseEncoding == null) {
                ...
                baseEncoding2 = lowerCase == this.alphabet ? this : newInstance(lowerCase, this.paddingChar);
        ...
        CharSequence trimTrailingPadding(CharSequence charSequence) {
            ...
            while (true) {
                i = length - 1;
                if (i < 0 || charSequence.charAt(i) != charValue) {
                    break;
                }
                length = i;
            }
        ...
        public BaseEncoding upperCase() {
            ...
            if (baseEncoding == null) {
                ...
                baseEncoding2 = upperCase == this.alphabet ? this : newInstance(upperCase, this.paddingChar);
        ...
        public BaseEncoding withPadChar(char c2) {
            if (8 % this.alphabet.bitsPerChar != 0) {
                Character ch = this.paddingChar;
                return (ch == null || ch.charValue() != c2) ? newInstance(this.alphabet, Character.valueOf(c2)) : this;
            }
            return this;
        }
