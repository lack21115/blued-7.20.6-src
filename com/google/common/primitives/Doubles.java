...
/* loaded from: source-8110460-dex2jar.jar:com/google/common/primitives/Doubles.class */
public final class Doubles extends DoublesMethodsForWeb {
    public static final int BYTES = 8;
    static final Pattern FLOATING_POINT_PATTERN = fpPattern();

    /* loaded from: source-8110460-dex2jar.jar:com/google/common/primitives/Doubles$DoubleArrayAsList.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/primitives/Doubles$DoubleConverter.class */
    ...
    /* loaded from: source-8110460-dex2jar.jar:com/google/common/primitives/Doubles$LexicographicalComparator.class */
    ...
    public static int indexOf(double[] dArr, double[] dArr2) {
        ...
        while (true) {
            int i2 = i;
            if (i2 >= (dArr.length - dArr2.length) + 1) {
                return -1;
            }
            int i3 = 0;
            while (true) {
