...
/* loaded from: source-7994992-dex2jar.jar:com/google/zxing/qrcode/detector/Detector.class */
    ...
    private float sizeOfBlackWhiteBlackRun(int i, int i2, int i3, int i4) {
        ...
        while (i13 != i12) {
            ...
            if ((i15 == 1) == this.image.get(z2 ? i14 : i13, z2 ? i13 : i14)) {
                if (i15 == 2) {
                    return MathUtils.distance(i13, i14, i8, i7);
                }
                i16 = i15 + 1;
            }
            int i17 = i9 + abs2;
        ...
        if (i15 == 2) {
            return MathUtils.distance(i12, i6, i8, i7);
        }
        return Float.NaN;
    }
