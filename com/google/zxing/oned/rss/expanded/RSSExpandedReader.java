...
/* loaded from: source-7994992-dex2jar.jar:com/google/zxing/oned/rss/expanded/RSSExpandedReader.class */
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    DataCharacter decodeDataCharacter(BitArray bitArray, FinderPattern finderPattern, boolean z, boolean z2) throws NotFoundException {
        ...
        while (true) {
            int i4 = i3;
            if (i4 >= dataCharacterCounters.length) {
                break;
            }
        ...
        while (true) {
            ...
            float f2 = (dataCharacterCounters[i8] * 1.0f) / sum;
            int i16 = (int) (0.5f + f2);
            if (i16 > 0) {
                i2 = i16;
                if (i16 > 8) {
            ...
            if ((i8 & 1) == 0) {
                oddCounts[i17] = i2;
                oddRoundingErrors[i17] = f2 - i2;
            } else {
                evenCounts[i17] = i2;
                evenRoundingErrors[i17] = f2 - i2;
            }
            i7 = i8 + 1;
        }
    }
