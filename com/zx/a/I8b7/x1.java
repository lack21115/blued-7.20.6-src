...
public class x1 extends p0 {
    ...
    public final ConcurrentHashMap<String, LinkedList<ZXIDListener>> f42227a = new ConcurrentHashMap<>();
    ...
    public void a(String str) {
        try {
            ...
            for (String str2 : this.f42227a.keySet()) {
                Iterator<ZXIDListener> it = this.f42227a.get(str2).iterator();
                while (it.hasNext()) {
