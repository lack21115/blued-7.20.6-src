...
public class i extends e {
    ...
    public static void c() throws Exception {
        ...
        JSONObject jSONObject = new JSONObject(k.a(Base64.decode(new JSONObject(a3.e.b()).getString("data"), 2), e.f28427a, "UDID_ENC_AUTHTAG"));
        ...
        if (!TextUtils.equals(string, t2.l)) {
            t2.l = string;
            u1Var.f28516a.a(4, string, false);
        }
        ...
        if (!TextUtils.equals(jSONObject3, t2.u)) {
            t2.u = jSONObject3;
            u1Var.f28516a.a(11, jSONObject3, true);
        }
                ...
                if (jSONArray == null || jSONArray.length() <= 0) {
                    ...
                    if (i == 1) {
                        ...
                        while (true) {
                            ...
                            jSONArray.put(i3, k.a(Base64.decode(jSONArray.getString(i3), 2), e.f28427a, "UDID_ENC_AUTHTAG"));
                            i2 = i3 + 1;
                        }
                    } else if (i == 3) {
        ...
        u1 u1Var5 = u1.a.f28517a;
        u1Var5.f28516a.getClass();
        if (true != t2.m) {
            t2.m = true;
            b3 b3Var7 = u1Var5.f28516a;
