...
public class l {
    ...
    public static Map<Class<? extends b>, b> f28453a = new HashMap();

    public static <T extends c> T a(Class<? extends b> cls, Class<T> cls2) {
        b bVar = (b) ((HashMap) f28453a).get(cls);
        if (bVar == null) {
    ...
    public static void a(Context context, Class<? extends b> cls, Class<? extends c>... clsArr) throws IllegalAccessException, InstantiationException {
        ...
        while (true) {
            ...
            c cVar = bVar2.f28411a.get(cls2);
            c cVar2 = cVar;
            if (cVar == null) {
                cVar2 = cls2.newInstance();
                bVar2.f28411a.put(cls2, cVar2);
            }
            cVar2.f28418a = bVar2;
            i = i2 + 1;
        }
        if (bVar2.f28412c.getAndSet(true)) {
            return;
        }
        bVar2.b = new a(bVar2, applicationContext, bVar2.a(), null, bVar2.c());
        for (Class<? extends c> cls3 : bVar2.f28411a.keySet()) {
            bVar2.f28411a.get(cls3).getClass();
        }
    }
}
