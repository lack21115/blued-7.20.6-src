...
public final class FollowedUsersNotificationManager {
    ...
    public static final FollowedUsersNotificationManager f16008a;
    private static final String b;

    /* renamed from: c  reason: collision with root package name */
    private static final SparseArray<ViewState> f16009c;
    ...
    public static final class NotificationRemoveRunnable implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final FrameLayout f16010a;
        private final View b;

        /* renamed from: c  reason: collision with root package name */
        private final FriendsNotificationExtra f16011c;
        ...
        public NotificationRemoveRunnable(FrameLayout frameLayout, View view, FriendsNotificationExtra friendsNotificationExtra) {
            ...
            this.b = view;
            this.f16011c = friendsNotificationExtra;
        }
        ...
        public void run() {
            ...
            FollowedUsersNotificationManager.f16008a.a(this.f16010a, this.b, (FriendsNotificationExtra) null);
        }
    }
    ...
    public static final class NotificationType {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final Companion f16012a = new Companion(null);
    ...
    static {
        ...
        f16008a = followedUsersNotificationManager;
    ...
    public static final void a(DialogInterface dialogInterface, int i) {
        ...
        CallHelloManager.a().a((Context) f16008a.c(), (IRequestHost) null, false, 13);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(View view, TranslateAnimation translateAnimation) {
        Intrinsics.e(translateAnimation, "$animation");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(FriendsNotificationExtra friendsNotificationExtra, Ref.ObjectRef objectRef, View view, View view2) {
        Activity c2;
        Tracker.onClick(view2);
        Intrinsics.e(friendsNotificationExtra, "$model");
        Intrinsics.e(objectRef, "$id");
        Intrinsics.e(view, "$rootView");
        String str = friendsNotificationExtra.notification_type;
        if (str != null) {
            switch (str.hashCode()) {
                case 3872:
                    if (str.equals("yy")) {
                        YYRoomInfoManager e2 = YYRoomInfoManager.e();
                        FollowedUsersNotificationManager followedUsersNotificationManager = f16008a;
                        Fragment c3 = followedUsersNotificationManager.c(followedUsersNotificationManager.c());
                        e2.a(c3 == null ? null : c3.getActivity(), String.valueOf(friendsNotificationExtra.yy_rome_id), "yy_open_pop");
                        break;
                    }
                    break;
                case 3046161:
                    if (str.equals("care")) {
                        ...
                        Activity c4 = f16008a.c();
                        String str2 = friendsNotificationExtra.user_id;
                        Intrinsics.c(str2, "model.user_id");
                        a2.a(c4, Long.parseLong(str2), "", friendsNotificationExtra.user_head_img, 0, 0, 0, 0, "", false, 0, 0, logData, new MsgSourceEntity(MessageProtos.StrangerSource.UNKNOWN_STRANGER_SOURCE, ""));
                        break;
                    }
                    break;
                case 3138974:
                    if (str.equals(IAdInterListener.AdProdType.PRODUCT_FEEDS)) {
                        ...
                        bluedIngSelfFeed.feed_id = String.valueOf(friendsNotificationExtra.circle_id);
                ...
                case 3322092:
                    if (str.equals("live")) {
                        LiveRoomData liveRoomData = new LiveRoomData(friendsNotificationExtra.rome_id, 0, "", "", "", friendsNotificationExtra.rome_master_img, friendsNotificationExtra.vbadge);
                ...
                case 97513456:
                    ...
                    break;
                case 103668165:
                    if (str.equals("match") && (c2 = f16008a.c()) != null) {
                        DateTodayManager dateTodayManager = DateTodayManager.f18714a;
                        Activity activity = c2;
                        String str3 = friendsNotificationExtra.user_id;
                        Intrinsics.c(str3, "model.user_id");
                        dateTodayManager.a(activity, null, Long.parseLong(str3), friendsNotificationExtra.user_head_img);
                        break;
                    }
                    break;
                case 109801339:
                    if (str.equals("super")) {
                        ...
                        Activity c5 = f16008a.c();
                        String str4 = friendsNotificationExtra.user_id;
                        Intrinsics.c(str4, "model.user_id");
                        a3.a(c5, Long.parseLong(str4), "", friendsNotificationExtra.user_head_img, 0, 0, 0, 0, "", false, 0, 0, logData2, new MsgSourceEntity(MessageProtos.StrangerSource.UNKNOWN_STRANGER_SOURCE, ""));
                        break;
                    }
                    break;
                case 763850025:
                    if (str.equals("push_call_time")) {
                        if (friendsNotificationExtra.push_type != 2) {
                ...
                case 778559857:
                    if (str.equals("bubble_feed")) {
                        final FeedTopBannerModel feedTopBannerModel = (FeedTopBannerModel) AppInfo.f().fromJson(friendsNotificationExtra.extra, (Class<Object>) FeedTopBannerModel.class);
                        ...
                        AppInfo.n().postDelayed(new Runnable() { // from class: com.soft.blued.manager.-$$Lambda$FollowedUsersNotificationManager$GiB5kfxhpj6Ms4ipDnEWBSMns_E
                            @Override // java.lang.Runnable
                            public final void run() {
                                FollowedUsersNotificationManager.a(feedTopBannerModel);
                            }
                        }, 50L);
                        break;
                    }
        ...
        EventTrackMessage.f(MessageProtos.Event.POPUP_BANNER_CLICK, (String) objectRef.a, friendsNotificationExtra.notification_type);
        if (view.getParent() == null || !(view.getParent() instanceof FrameLayout)) {
            return;
        }
        FollowedUsersNotificationManager followedUsersNotificationManager2 = f16008a;
        ViewParent parent = view.getParent();
        if (parent == null) {
            throw new NullPointerException("null cannot be cast to non-null type android.widget.FrameLayout");
        }
        followedUsersNotificationManager2.a((FrameLayout) parent, view, (FriendsNotificationExtra) null);
    }
    ...
    private final View b(FriendsNotificationExtra friendsNotificationExtra) {
        ...
        ImageLoader.a((IRequestHost) null, friendsNotificationExtra.user_head_img).d(2131237310).b((int) R.drawable.user_bg_round_blur).c().a(100).a(a2.f);
        ...
        if (!TextUtils.isEmpty(friendsNotificationExtra.tags)) {
            ...
            str = Intrinsics.a(format, format2);
        }
        a2.k.setText(str);
        return inflate;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void b(FrameLayout frameLayout, FriendsNotificationExtra friendsNotificationExtra) {
        Intrinsics.e(frameLayout, "$decorView");
        Intrinsics.e(friendsNotificationExtra, "$model");
        f16008a.a(frameLayout, friendsNotificationExtra);
    }

    private final View c(FriendsNotificationExtra friendsNotificationExtra) {
        List user_avatar;
        View inflate = LayoutInflater.from(AppInfo.d()).inflate(R.layout.notification_feed_city_banner_layout, (ViewGroup) null);
        NotificationFeedCityBannerLayoutBinding a2 = NotificationFeedCityBannerLayoutBinding.a(inflate);
        Intrinsics.c(a2, "bind(layout)");
        ...
        if (feedTopBannerModel != null) {
            ...
            a2.f15807c.setText(feedTopBannerModel.getButton_text());
        }
        if (feedTopBannerModel != null && (user_avatar = feedTopBannerModel.getUser_avatar()) != null && (!user_avatar.isEmpty())) {
            if (user_avatar.size() > 1) {
                ImageLoader.a((IRequestHost) null, (String) user_avatar.get(1)).d(2131237310).c().a(a2.b);
            }
            ImageLoader.a((IRequestHost) null, (String) user_avatar.get(0)).d(2131237310).c().a(a2.f15806a);
        }
        Intrinsics.c(inflate, "layout");
        return inflate;
    }
    ...
    private final View e(FriendsNotificationExtra friendsNotificationExtra) {
        View inflate = LayoutInflater.from(AppInfo.d()).inflate(R.layout.flash_notification_layout, (ViewGroup) null);
        FlashNotificationLayoutBinding a2 = FlashNotificationLayoutBinding.a(inflate);
        Intrinsics.c(a2, "bind(layout)");
        a2.f15056c.setOnClickListener(new View.OnClickListener() { // from class: com.soft.blued.manager.-$$Lambda$FollowedUsersNotificationManager$9meVFO79pKLaubiByQOQhkSSM5A
    ...
    private final View f(FriendsNotificationExtra friendsNotificationExtra) {
        View inflate = LayoutInflater.from(AppInfo.d()).inflate(R.layout.special_care_notification_layout, (ViewGroup) null);
        SpecialCareNotificationLayoutBinding a2 = SpecialCareNotificationLayoutBinding.a(inflate);
        Intrinsics.c(a2, "bind(layout)");
        ImageLoader.a((IRequestHost) null, friendsNotificationExtra.user_head_img).d(2131237310).b(2131237310).c().a(a2.f15901c);
    ...
    public static final void f() {
        CommonAlertDialog.a(f16008a.c(), "", AppInfo.d().getString(R.string.hello_call_notification_open_dialog_tips), AppInfo.d().getString(2131887320), new DialogInterface.OnClickListener() { // from class: com.soft.blued.manager.-$$Lambda$FollowedUsersNotificationManager$iy_VLfapxYXdfjpz_PwJfm94Mhg
    ...
    private final View g(FriendsNotificationExtra friendsNotificationExtra) {
        View inflate = LayoutInflater.from(AppInfo.d()).inflate(R.layout.privilege_user_notification_layout, (ViewGroup) null);
        PrivilegeUserNotificationLayoutBinding a2 = PrivilegeUserNotificationLayoutBinding.a(inflate);
        Intrinsics.c(a2, "bind(layout)");
        a2.h.setText(friendsNotificationExtra.notification_title);
        ImageLoader.c((IRequestHost) null, "super_privilege_user_notification.png").f().g(-1).a(a2.d);
        ImageLoader.a((IRequestHost) null, friendsNotificationExtra.user_head_img).d(2131237310).b(2131237310).c().a(a2.f15883c);
    ...
    private final View h(FriendsNotificationExtra friendsNotificationExtra) {
        View inflate = LayoutInflater.from(AppInfo.d()).inflate(R.layout.users_notification_layout, (ViewGroup) null);
        UsersNotificationLayoutBinding a2 = UsersNotificationLayoutBinding.a(inflate);
        Intrinsics.c(a2, "bind(layout)");
        a2.n.setText(friendsNotificationExtra.notification_title);
        a2.f15920a.setVisibility(8);
        a2.i.setVisibility(0);
        if (Intrinsics.a(friendsNotificationExtra.notification_type, "yy")) {
            a2.g.setVisibility(0);
            a2.h.setVisibility(8);
            ImageLoader.c((IRequestHost) null, "anim_chat_list.png").f().g(-1).a(a2.g);
            a2.i.setImageDrawable(BluedSkinUtils.b(AppInfo.d(), (int) R.drawable.yy_live_notification_layout_background));
        } else {
            a2.g.setVisibility(8);
            a2.h.setVisibility(0);
            ImageLoader.c((IRequestHost) null, "anim_live_list.png").f().g(-1).a(a2.h);
            a2.i.setImageDrawable(BluedSkinUtils.b(AppInfo.d(), (int) R.drawable.video_live_notification_layout_background));
        }
    ...
    public final void a(Activity activity) {
        if (activity != null) {
            ...
            SparseArray<ViewState> sparseArray = f16009c;
    ...
    public final void a(ViewGroup viewGroup, View view) {
        ...
        try {
            ...
            ViewState viewState = f16009c.get(viewGroup.hashCode());
            ...
            f16009c.remove(viewGroup.hashCode());
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
    ...
    public final void a(final FrameLayout frameLayout, final View view, final long j) {
        ...
        translateAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.soft.blued.manager.FollowedUsersNotificationManager$showAnimation$1
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                FollowedUsersNotificationManager.NotificationRemoveRunnable notificationRemoveRunnable = new FollowedUsersNotificationManager.NotificationRemoveRunnable(frameLayout, view, null);
                sparseArray = FollowedUsersNotificationManager.f16009c;
                ...
                FollowedUsersNotificationManager.f16008a.a().postDelayed(notificationRemoveRunnable, j);
            }
    ...
    public final void a(FrameLayout frameLayout, final View view, FriendsNotificationExtra friendsNotificationExtra) {
        ...
        e.post(new Runnable() { // from class: com.soft.blued.manager.-$$Lambda$FollowedUsersNotificationManager$8KbWHE17hSYO6Y2gpSiBbxQGc0I
            @Override // java.lang.Runnable
            public final void run() {
                FollowedUsersNotificationManager.a(view, translateAnimation);
            }
        });
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:52:0x01bf, code lost:
        if (kotlin.jvm.internal.Intrinsics.a(r9.notification_type, "yy") == false) goto L51;
     */
    /* JADX WARN: Code restructure failed: missing block: B:53:0x01c2, code lost:
        r0.a = java.lang.String.valueOf(r9.yy_rome_id);
     */
    /* JADX WARN: Code restructure failed: missing block: B:54:0x01d1, code lost:
        r0.a = java.lang.String.valueOf(r9.rome_id);
     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x01dd, code lost:
        r12 = com.soft.blued.manager.FollowedUsersNotificationManager.f16008a.h(r9);
     */
    ...
    */
    ...
    public final void a(final FriendsNotificationExtra friendsNotificationExtra) {
        ...
        if (UiUtils.a(c2)) {
            ...
            ViewState viewState = f16009c.get(frameLayout2.hashCode());
            if (viewState == null || viewState.a() == null) {
                f16008a.a().postDelayed(new Runnable() { // from class: com.soft.blued.manager.-$$Lambda$FollowedUsersNotificationManager$A0go089beZVN9AAI-w6dQhn7bj0
                    @Override // java.lang.Runnable
                    public final void run() {
                        FollowedUsersNotificationManager.b(frameLayout2, friendsNotificationExtra);
                    }
                }, 50L);
            } else {
                f16008a.a(frameLayout2, viewState.a(), friendsNotificationExtra);
            }
        }
    }
    ...
    public final boolean b(String str) {
        ...
        if (c3 != null) {
            ...
            LogUtils.c(Intrinsics.a("curFragment: ", simpleName));
            return ((TextUtils.equals(str, "care") && Intrinsics.a(simpleName, MsgChattingFragment.class.getSimpleName())) || Intrinsics.a(simpleName, RecordingOnliveFragment.class.getSimpleName()) || Intrinsics.a(simpleName, PlayingOnliveFragment.class.getSimpleName()) || Intrinsics.a(simpleName, PlayingOnliveFullModeFragment.class.getSimpleName()) || Intrinsics.a(simpleName, FeedAddPostFragment.class.getSimpleName()) || Intrinsics.a(simpleName, PlayingStudioFragment.class.getSimpleName()) || Intrinsics.a(simpleName, YYCreateRoomFragment.class.getSimpleName()) || Intrinsics.a(simpleName, RecordingStudioFragment.class.getSimpleName()) || Intrinsics.a(simpleName, ChannelFragment.class.getSimpleName()) || Intrinsics.a(simpleName, SerialSplashFragment.class.getSimpleName())) ? false : true;
        }
        return true;
    }
    ...
    public final Fragment c(Activity activity) {
        ...
        while (true) {
            int i = size - 1;
            BaseFragment baseFragment2 = (Fragment) fragments.get(size);
            ...
            if (baseFragment2 instanceof BaseFragment) {
                ...
                if (baseFragment4.isAdded()) {
                    baseFragment3 = baseFragment;
                    if (!baseFragment4.isHidden()) {
                        baseFragment3 = baseFragment;
                        if (!baseFragment4.isDetached()) {
                            List<Fragment> fragments2 = baseFragment4.getChildFragmentManager().getFragments();
                            ...
                            if (fragments2.isEmpty()) {
                                ...
                                if (size2 >= 0) {
                                    while (true) {
                                        int i2 = size2 - 1;
                                        baseFragment3 = (Fragment) fragments2.get(size2);
                                        if (!(baseFragment3 instanceof BaseFragment) || !baseFragment3.getUserVisibleHint()) {
                                            baseFragment3 = baseFragment2;
                                        }
                                        if (i2 < 0) {
                                            break;
