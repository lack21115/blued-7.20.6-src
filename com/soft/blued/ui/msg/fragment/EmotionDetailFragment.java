...
public class EmotionDetailFragment extends SimpleFragment {
    ...
    private CommonTopTitleNoTrans f18654a;
    private ImageView b;
    ...
    public void b() {
        ...
        this.f18654a.setCenterText(a(emotionDetailModel));
        ImageLoader.a(getFragmentActive(), this.o.banner).a(this.b);
        this.f18655c.setText(this.o.name);
        this.d.setText(h());
    ...
    private void e() {
        ...
        ChatHttpUtils.a(emotionDetailModel.code, new BluedUIHttpResponse<BluedEntityA<EmotionDownloadModel>>(getFragmentActive()) { // from class: com.soft.blued.ui.msg.fragment.EmotionDetailFragment.2
            ...
            public void onUIUpdate(BluedEntityA<EmotionDownloadModel> bluedEntityA) {
                ...
                EmotionDetailFragment.this.s = ((EmotionDownloadModel) bluedEntityA.getSingleData()).download;
    ...
    public void f() {
        ...
        FileDownloader.a(this.s, str2, new AnonymousClass3(str2), (IRequestHost) null);
    }
    ...
    public void onInitView() {
        super.onInitView();
        CommonTopTitleNoTrans findViewById = this.rootView.findViewById(R.id.emotion_detail_title);
        this.f18654a = findViewById;
        findViewById.setLeftClickListener(new View.OnClickListener() { // from class: com.soft.blued.ui.msg.fragment.-$$Lambda$EmotionDetailFragment$nxYwFCGeCdxcSWz7sXzydSyh8eQ
        ...
        this.f18655c = (TextView) this.rootView.findViewById(R.id.emotion_detail_name);
        ...
        this.m = this.rootView.findViewById(R.id.emotion_detail_lv);
        ListAdapter listAdapter = new CommonAdapter<EmotionIconsModel>(R.layout.item_emotion_detail_icon) { // from class: com.soft.blued.ui.msg.fragment.EmotionDetailFragment.1
            public void a(CommonAdapter.ViewHolder viewHolder, EmotionIconsModel emotionIconsModel, int i) {
                ((ImageView) viewHolder.a((int) R.id.item_emotion_detail_icon_id)).getLayoutParams().height = (AppInfo.l - DisplayUtil.a(this.a, 75.0f)) / 4;
                viewHolder.b((int) R.id.item_emotion_detail_icon_id, emotionIconsModel.image);
            }
        };
        this.j = listAdapter;
    ...
    public void onLoadData() {
        ...
        ChatHttpUtils.a(this.q, this.args.getString("emotion_code"), new BluedUIHttpResponse<BluedEntityA<EmotionDetailModel>>(getFragmentActive()) { // from class: com.soft.blued.ui.msg.fragment.EmotionDetailFragment.4
            ...
            public void onUIUpdate(BluedEntityA<EmotionDetailModel> bluedEntityA) {
                ...
                EmotionDetailFragment.this.o = (EmotionDetailModel) bluedEntityA.getSingleData();
                EmotionDetailFragment.this.q = ((EmotionDetailModel) bluedEntityA.getSingleData()).emotion_id;
                EmotionDetailFragment.this.p = ((EmotionDetailModel) bluedEntityA.getSingleData()).code;
                EmotionDetailFragment.this.b();
            }
        });
        if (TypeUtils.a(EmotionDataManager.a().c())) {
                ...
                public void onUIUpdate(BluedEntityA<EmotionListItemModel> bluedEntityA) {
                    if (bluedEntityA != null) {
                        ...
                        while (true) {
                            ...
                            EmotionListItemModel emotionListItemModel = (EmotionListItemModel) it.next();
                            if (StringUtils.a(emotionListItemModel.code, EmotionDetailFragment.this.p)) {
                                emotionListItemModel.downloadState = EmotionDetailFragment.this.r;
                                break;
                            }
                        }
