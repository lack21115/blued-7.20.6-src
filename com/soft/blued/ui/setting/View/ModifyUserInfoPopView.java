...
public class ModifyUserInfoPopView {
    ...
    private void f() {
        ...
        a();
        View findViewById = this.f19568a.findViewById(2131370973);
        this.b = findViewById;
        ...
        View findViewById2 = this.f19568a.findViewById(2131367715);
        this.f19569c = findViewById2;
        findViewById2.setVisibility(8);
        this.f19569c.setOnClickListener(new View.OnClickListener() { // from class: com.soft.blued.ui.setting.View.ModifyUserInfoPopView.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Tracker.onClick(view);
            }
        });
        MyPopupWindow myPopupWindow = new MyPopupWindow(this.f19568a, -1, -1, true);
        ...
        this.h.update();
        this.f = (TextView) this.f19568a.findViewById(2131372708);
        this.g = (TextView) this.f19568a.findViewById(com.soft.blued.R.id.tv_btn);
        ...
        this.f19569c.setLayoutParams(layoutParams);
    ...
    private void g() {
        this.f19569c.startAnimation(AnimationUtils.loadAnimation(this.d, 2130772112));
    ...
    public void a() {
        this.f19568a = this.e.inflate(com.soft.blued.R.layout.modify_user_info_pop_view, (ViewGroup) null);
    }

    public boolean b() {
        return this.f19569c.getVisibility() == 0;
    }

    public void c() {
        this.b.clearAnimation();
        this.f19569c.clearAnimation();
        if (this.h.isShowing()) {
            this.h.a();
        }
        this.h.showAtLocation(this.f19568a, 49, 0, 0);
        this.f19569c.setVisibility(0);
        g();
    }

    public void d() {
        if (this.f19569c.getVisibility() == 8) {
            return;
        }
    ...
    public void e() {
        ...
        alphaAnimation.setFillAfter(true);
        this.b.startAnimation(alphaAnimation);
        this.f19569c.startAnimation(AnimationUtils.loadAnimation(this.d, 2130772113));
    }
}
