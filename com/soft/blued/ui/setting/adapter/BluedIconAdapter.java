...
public class BluedIconAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private LayoutInflater f19590c;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.f19592a = (ImageView) view.findViewById(2131364373);
        }
    }
    ...
    public BluedIconAdapter(Context context, List<BluedIcon> list) {
        ...
        this.d = list;
        this.f19590c = LayoutInflater.from(context);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    /* renamed from: a */
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(this.f19590c.inflate(R.layout.item_blued_icon, (ViewGroup) null));
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        if (viewHolder != null) {
            ...
            viewHolder.f19592a.setImageResource(bluedIcon.getIconResourceId());
            if (bluedIcon.isChecked()) {
                viewHolder.f19592a.getBackground().setAlpha(255);
            } else {
                viewHolder.f19592a.getBackground().setAlpha(0);
            }
            viewHolder.f19592a.setOnClickListener(new View.OnClickListener() { // from class: com.soft.blued.ui.setting.adapter.BluedIconAdapter.1
