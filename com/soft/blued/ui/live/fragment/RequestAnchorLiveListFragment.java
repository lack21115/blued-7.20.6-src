...
public class RequestAnchorLiveListFragment extends BaseListFragment<RequestAnchorLiveModel, RequestAnchorLiveExtra> {
    ...
    public class AnonymousClass1 extends CommonAdapter<RequestAnchorLiveModel> {
        ...
        public /* synthetic */ void a(RequestAnchorLiveModel requestAnchorLiveModel, View view) {
            ...
            UserInfoFragmentNew.a(this.a, requestAnchorLiveModel.uid, "");
        }

        public void a(CommonAdapter.ViewHolder viewHolder, final RequestAnchorLiveModel requestAnchorLiveModel, int i) {
            viewHolder.e((int) R.id.item_request_live_avatar, requestAnchorLiveModel.avatar).a((int) R.id.item_request_live_name, requestAnchorLiveModel.name);
            BitmapUtils.a(RequestAnchorLiveListFragment.this.getContext(), (ImageView) viewHolder.a((int) R.id.item_request_live_rich_level), requestAnchorLiveModel.rich_level);
            long j = requestAnchorLiveModel.time * 1000;
            if (!TimeAndDateUtils.g(j)) {
                viewHolder.a((int) R.id.item_request_live_time, ((SimpleDateFormat) TimeAndDateUtils.a.get()).format(new Date(j)));
            } else if (TimeAndDateUtils.f(j)) {
                viewHolder.a((int) R.id.item_request_live_time, ((SimpleDateFormat) TimeAndDateUtils.f.get()).format(new Date(j)));
            } else if (TimeAndDateUtils.h(j)) {
                viewHolder.a((int) R.id.item_request_live_time, this.a.getResources().getString(R.string.biao_msg_yesterday));
            } else {
                viewHolder.a((int) R.id.item_request_live_time, ((SimpleDateFormat) TimeAndDateUtils.g.get()).format(new Date(j)));
            }
            if (LiveDataManager.a().h()) {
                viewHolder.b((int) R.id.item_request_live_gift_layout, 0);
                ImageView imageView = (ImageView) viewHolder.a((int) R.id.item_request_live_gift_iv);
                if (requestAnchorLiveModel.status == 0 || requestAnchorLiveModel.goods_info == null) {
                    imageView.setVisibility(8);
                    viewHolder.b((int) R.id.item_request_live_gift_count, 8);
                } else {
                    viewHolder.a(imageView, requestAnchorLiveModel.goods_info.image_static);
                    imageView.setVisibility(0);
                    viewHolder.b((int) R.id.item_request_live_gift_count, 0);
                }
                if (requestAnchorLiveModel.status == 1) {
                    viewHolder.a((int) R.id.item_request_live_gift_state, BluedSkinUtils.a(RequestAnchorLiveListFragment.this.getContext(), 2131102264), "(开播后收到礼物)");
                } else if (requestAnchorLiveModel.status == 2) {
                    viewHolder.a((int) R.id.item_request_live_gift_state, BluedSkinUtils.a(RequestAnchorLiveListFragment.this.getContext(), 2131102264), "(已领取)");
                } else if (requestAnchorLiveModel.status == 3) {
                    viewHolder.a((int) R.id.item_request_live_gift_state, BluedSkinUtils.a(RequestAnchorLiveListFragment.this.getContext(), 2131102264), "(已退回)");
                } else {
                    viewHolder.a((int) R.id.item_request_live_gift_state, BluedSkinUtils.a(RequestAnchorLiveListFragment.this.getContext(), 2131102263), "求开播");
                }
            } else {
                viewHolder.b((int) R.id.item_request_live_gift_layout, 8);
            }
    ...
    private void d() {
        this.a.f();
        this.a.setCenterText("求开播");
        this.a.setLeftClickListener(new View.OnClickListener() { // from class: com.soft.blued.ui.live.fragment.-$$Lambda$RequestAnchorLiveListFragment$fiSFqh3sZO6FA5_81z7B74tdd-4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public void a(View view) {
        ...
        LiveRoomHttpUtils.e(new BluedUIHttpResponse<BluedEntityA<BluedLiveState>>(getFragmentActive()) { // from class: com.soft.blued.ui.live.fragment.RequestAnchorLiveListFragment.2
            ...
            public void onUIUpdate(BluedEntityA<BluedLiveState> bluedEntityA) {
                LiveUtils.a(RequestAnchorLiveListFragment.this.getContext(), (BluedLiveState) bluedEntityA.getSingleData());
            }
    ...
    public void b(BluedEntity<RequestAnchorLiveModel, RequestAnchorLiveExtra> bluedEntity) {
        ...
        this.j.setText(String.valueOf(((RequestAnchorLiveExtra) bluedEntity.extra).count));
        long currentTimeMillis = (System.currentTimeMillis() - (((RequestAnchorLiveExtra) bluedEntity.extra).last_live_time * 1000)) / 1000;
        ...
        this.k.setText(String.valueOf(((RequestAnchorLiveExtra) bluedEntity.extra).rewardCount));
    }
