...
public class LiveJoinFansFragment_ViewBinding implements Unbinder {
    ...
    public LiveJoinFansFragment_ViewBinding(LiveJoinFansFragment liveJoinFansFragment, View view) {
        ...
        liveJoinFansFragment.fl_main = Utils.a(view, R.id.fl_main, "field 'fl_main'");
        liveJoinFansFragment.top_title = (CommonTopTitleNoTrans) Utils.a(view, R.id.top_title, "field 'top_title'", CommonTopTitleNoTrans.class);
        liveJoinFansFragment.refresh_view = (SmartRefreshLayout) Utils.a(view, R.id.refresh_view, "field 'refresh_view'", SmartRefreshLayout.class);
        liveJoinFansFragment.recycle_view = (RecyclerView) Utils.a(view, R.id.recycle_view, "field 'recycle_view'", RecyclerView.class);
        liveJoinFansFragment.ll_no_fans = Utils.a(view, R.id.ll_no_fans, "field 'll_no_fans'");
        liveJoinFansFragment.tv_no_data = (TextView) Utils.a(view, R.id.tv_no_data, "field 'tv_no_data'", TextView.class);
