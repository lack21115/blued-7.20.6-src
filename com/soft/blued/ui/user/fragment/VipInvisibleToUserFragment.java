...
public class VipInvisibleToUserFragment extends MVIBaseFragment<VipInvisibleToUserViewModel> {
    static final /* synthetic */ KProperty<Object>[] b = {Reflection.a(new PropertyReference1Impl(VipInvisibleToUserFragment.class, "viewBinding", "getViewBinding()Lcom/soft/blued/databinding/FragmentVipInvisibleToUserBinding;", 0))};

    /* renamed from: c  reason: collision with root package name */
    public CommonDialogFragment f34173c;
    ...
    public VipInvisibleToUserFragment() {
        ...
        this.e = this instanceof DialogFragment ? new DialogFragmentViewBindingProperty(new Function1<VipInvisibleToUserFragment, FragmentVipInvisibleToUserBinding>() { // from class: com.soft.blued.ui.user.fragment.VipInvisibleToUserFragment$special$$inlined$viewBindingFragment$default$1
            @Override // kotlin.jvm.functions.Function1
            /* renamed from: a */
            public final FragmentVipInvisibleToUserBinding invoke(VipInvisibleToUserFragment fragment) {
    ...
    public static final void a(VipInvisibleToUserFragment this$0, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void b(VipInvisibleToUserFragment this$0, View view) {
        Tracker.onClick(view);
        Intrinsics.e(this$0, "this$0");
        if (!this$0.h.isEmpty()) {
            BluedStructureExtKt.a(this$0, new VipInvisibleToUserAction.cancelInvisibleUser(this$0.h));
        }
        if (this$0.a() != null) {
            this$0.a().dismiss();
        }
    ...
    public final CommonDialogFragment a() {
        CommonDialogFragment commonDialogFragment = this.f34173c;
    ...
    public final void a(CommonDialogFragment commonDialogFragment) {
        ...
        this.f34173c = commonDialogFragment;
    }
        ...
        if (b2 != null && (context = getContext()) != null) {
            ...
            c().a(new InvisibleUserDeleteListener() { // from class: com.soft.blued.ui.user.fragment.VipInvisibleToUserFragment$initView$1$1$3
                ...
                public void a(InvisibleToUserModel.InvisibleUser user) {
                    ...
                    f.add(str);
                    VipInvisibleToUserFragment.this.c().getData().remove(user);
                    ...
                    textView.setText(sb.toString());
                    EventTrackPersonalProfile.d(PersonalProfileProtos.Event.HIDE_SETTING_SEE_HIDE_LIST_ONE_REMOVE, user.uid);
                }
            });
    ...
    public void o() {
        ...
        BluedStructureExtKt.a(this, viewLifecycleOwner, new PropertyReference1Impl() { // from class: com.soft.blued.ui.user.fragment.VipInvisibleToUserFragment$liveDataObserver$1
            ...
            public final void a(InvisibleToUserModel it) {
                Intrinsics.e(it, "it");
                VipInvisibleToUserFragment.this.a(it);
            }
