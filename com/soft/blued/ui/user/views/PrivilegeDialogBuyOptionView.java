...
public class PrivilegeDialogBuyOptionView extends LinearLayout {
    ...
    private ShapeConstraintLayout f20695c;
    private TextView d;
    private TextView e;
    private TextView f;
    private TextView g;
    ...
    public void a() {
        View inflate = LayoutInflater.from(this.f20694a).inflate(R.layout.item_privilege_pay_option_dialog, this);
        this.b = inflate;
        this.f20695c = inflate.findViewById(R.id.ll_item);
    ...
    public void setOptionView(PrivilegeBuyOptionForJsonParse.ProductBean productBean) {
        ShapeHelper.b(this.f20695c, 2131101780);
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.f20695c.getLayoutParams();
        if (productBean.choosen) {
            layoutParams.width = DensityUtils.a(this.f20694a, 100.0f);
            layoutParams.height = DensityUtils.a(this.f20694a, 133.0f);
            ShapeHelper.b(this.f20695c, 2131099653);
            ShapeHelper.d(this.f20695c, 2131102251);
            ...
            this.d.setPadding(0, DensityUtils.a(this.f20694a, 10.0f), 0, 0);
            this.e.setTextSize(14.0f);
            this.f.setTextSize(14.0f);
            this.h.setTextSize(14.0f);
        } else {
            layoutParams.width = DensityUtils.a(this.f20694a, 100.0f);
            layoutParams.height = DensityUtils.a(this.f20694a, 109.0f);
            ShapeHelper.d(this.f20695c, 2131101266);
            ShapeHelper.b(this.f20695c, 2131101266);
            this.g.setVisibility(8);
            this.d.setPadding(0, DensityUtils.a(this.f20694a, 31.0f), 0, 0);
            this.d.setTextSize(22.0f);
            this.e.setTextSize(12.0f);
            this.f.setTextSize(12.0f);
            this.h.setTextSize(12.0f);
        }
        this.f20695c.setLayoutParams(layoutParams);
        if (productBean.showBeans) {
            if (productBean.discount_beans > 0) {
                TextView textView = this.f;
                textView.setText(productBean.discount_beans + this.f20694a.getResources().getString(R.string.Live_SendPresent_wandou) + "/" + productBean.unit);
            } else {
                TextView textView2 = this.f;
                textView2.setText(productBean.average_beans + this.f20694a.getResources().getString(R.string.Live_SendPresent_wandou) + "/" + productBean.unit);
            }
