...
public class LiveHorizontalView extends LinearLayout {
    ...
    class AnonymousClass1 implements View.OnClickListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ NearbyLiveExtra f30704a;
        final /* synthetic */ LiveHorizontalView b;

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            Tracker.onClick(view);
            WebViewShowInfoFragment.show(this.b.f30702a, this.f30704a.url, 0);
        }
    }
    ...
    public void a(Context context) {
        ...
        this.f30703c = (TextView) this.b.findViewById(R.id.tv_live_title);
        this.d = (TextView) this.b.findViewById(R.id.tv_live_count);
        this.e = (ImageView) this.b.findViewById(2131365652);
        this.f = (RecyclerView) this.b.findViewById(2131369529);
        CustomLinearLayoutManager customLinearLayoutManager = new CustomLinearLayoutManager(this.f30702a);
        ...
        this.h = new LiveRecyclerAdapter(this.f30702a);
        setVisibility(8);
    }
