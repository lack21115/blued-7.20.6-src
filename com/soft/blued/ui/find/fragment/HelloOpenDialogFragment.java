...
public class HelloOpenDialogFragment extends MvpFragment<HelloOpenDialogPresenter> {
    ...
    public void a(Bundle bundle) {
        ...
        this.tvCount.setText(String.valueOf(j().n()));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.call_open /* 2131362697 */:
                if (j().m()) {
                    EventTrackGuy.a(GuyProtos.Event.VOCATIVE_BUY_SUCCESS_POP_OPEN_BTN_CLICK, j().p() ? GuyProtos.VocativeType.VOCATIVE_QUIET : GuyProtos.VocativeType.VOCATIVE_COMMON);
                } else {
                    EventTrackGuy.a(GuyProtos.Event.VOCATIVE_OPEN_POP_OPEN_BTN_CLICK, j().p() ? GuyProtos.VocativeType.VOCATIVE_QUIET : GuyProtos.VocativeType.VOCATIVE_COMMON);
                }
                final boolean p = j().p();
                CallHelloManager.a().a(getContext(), new CallHelloManager.ToOpenListener() { // from class: com.soft.blued.ui.find.fragment.HelloOpenDialogFragment.1
                    ...
                    public void done(boolean z) {
                        if (z && HomeActivity.f30985c != null) {
                            CallHelloManager.a().a(HomeActivity.f30985c, (IRequestHost) null, p, HelloOpenDialogFragment.this.j().o());
                        }
