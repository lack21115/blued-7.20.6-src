...
public class BluedMyChatFriendListAdapter extends BaseAdapter {
    ...
    private LayoutInflater f17192a;
    private Context b;

    /* renamed from: c  reason: collision with root package name */
    private GroupInviteFromChatListFragment f17193c;
    private String d;
    ...
    private void a(SessionModel sessionModel, SessionSettingModel sessionSettingModel, ViewHolder viewHolder) {
        ...
        viewHolder.f17199c.setTextColor(this.b.getResources().getColor(2131100365));
        ChatFriendListAdapter.a(this.b, viewHolder.b, viewHolder.f17199c, sessionModel, str);
        if (TimeAndDateUtils.f(sessionModel.lastMsgTime)) {
            this.d = ((SimpleDateFormat) TimeAndDateUtils.c.get()).format(new Date(sessionModel.lastMsgTime));
        } else {
            this.d = ((SimpleDateFormat) TimeAndDateUtils.d.get()).format(new Date(sessionModel.lastMsgTime));
        }
    ...
    public int getCount() {
        return this.f17193c.b.size();
    }

    @Override // android.widget.Adapter
    public Object getItem(int i) {
        return this.f17193c.b.get(i);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = this.f17192a.inflate(R.layout.item_invite_from_msg_friend_list, viewGroup, false);
            ...
            viewHolder.f17198a = (TextView) view.findViewById(R.id.msg_friend_item_name);
            viewHolder.e = (CheckBox) view.findViewById(R.id.cb_member_invite);
            viewHolder.b = view.findViewById(R.id.lay_secret);
            viewHolder.f17199c = (TextView) view.findViewById(R.id.msg_friend_item_content);
        ...
        if (this.f17193c.b != null && this.f17193c.b.size() != 0) {
            if (i < this.f17193c.b.size() && (sessionModel = this.f17193c.b.get(i)) != null) {
                ...
                if (s != 1) {
                    if (s == 2) {
                        GroupInviteFromChatListFragment groupInviteFromChatListFragment = this.f17193c;
                        ...
                        a(sessionModel, sessionSettingModel, viewHolder.f17198a);
                        ...
                        UserRelationshipUtils.a(this.b, viewHolder.f17198a, userBasicModel);
                        UserInfoHelper.a(viewHolder.g, sessionModel.vBadge, 3);
                    } else if (s == 3) {
                        GroupInviteFromChatListFragment groupInviteFromChatListFragment2 = this.f17193c;
                        if (groupInviteFromChatListFragment2 != null) {
                            activityFragmentActive = groupInviteFromChatListFragment2.getFragmentActive();
                        }
                        ImageLoader.a(activityFragmentActive, sessionModel.avatar).b((int) R.drawable.group_default_head).c().a(viewHolder.f);
                    ...
                    viewHolder.i.setVisibility(8);
                    viewHolder.f17198a.setText(this.b.getResources().getString(R.string.biao_v4_msg_groupnotice));
                ...
                if (GroupMemberInviteFragment.f17120a.size() > 0) {
                    ...
                    while (true) {
                        int i4 = i3;
                        if (i4 >= GroupMemberInviteFragment.f17120a.size()) {
                            break;
                        }
                        if (GroupMemberInviteFragment.f17120a.get(i4).equals(valueOf) && s2 == GroupMemberInviteFragment.e.get(i4).shortValue()) {
                            viewHolder.e.setChecked(true);
                            viewHolder.e.setEnabled(true);
                        }
                        i3 = i4 + 1;
                            ...
                            viewHolder2.e.setOnClickListener(new View.OnClickListener() { // from class: com.soft.blued.ui.group.adapter.BluedMyChatFriendListAdapter.1.1
                                ...
                                public void onClick(View view2) {
                                    ...
                                    if (!StringUtils.d(valueOf)) {
                                        ...
                                        GroupMemberInviteFragment.f17120a.add(valueOf);
                                        GroupMemberInviteFragment.b.add(str);
                                        GroupMemberInviteFragment.f17121c.add(str2);
                            ...
                            viewHolder2.e.setOnClickListener(new View.OnClickListener() { // from class: com.soft.blued.ui.group.adapter.BluedMyChatFriendListAdapter.1.2
                                ...
                                public void onClick(View view2) {
                                    ...
                                    if (GroupMemberInviteFragment.f17120a != null) {
                                        ...
                                        while (true) {
                                            int i8 = i7;
                                            if (i8 >= GroupMemberInviteFragment.f17120a.size()) {
                                                break;
                                            }
                                            if (GroupMemberInviteFragment.f17120a.get(i8).equals(valueOf)) {
                                                GroupMemberInviteFragment.f17120a.remove(GroupMemberInviteFragment.f17120a.get(i8));
                                                GroupMemberInviteFragment.b.remove(GroupMemberInviteFragment.b.get(i8));
                                                GroupMemberInviteFragment.f17121c.remove(GroupMemberInviteFragment.f17121c.get(i8));
