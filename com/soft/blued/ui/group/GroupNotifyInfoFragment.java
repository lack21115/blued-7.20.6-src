...
public class GroupNotifyInfoFragment extends BaseFragment implements View.OnClickListener {
    ...
    private String f30837a = GroupNotifyInfoFragment.class.getSimpleName();
    private String R = BridgeUtil.SPLIT_MARK;
    ...
    public class Clickable extends ClickableSpan {
        ...
        public void onClick(View view) {
            if (StringUtils.d(this.f30844c)) {
                UserInfoFragmentNew.d(this.b, this.d, "");
            } else {
                UserInfoFragmentNew.a(this.b, this.f30844c, "");
            }
        }
    ...
    private void a() {
        ...
        this.f30838c = (LinearLayout) this.v.findViewById(R.id.ll_group_notify_oprate);
        ...
        this.f = (TextView) this.v.findViewById(2131372879);
        this.g = (TextView) this.v.findViewById(2131372876);
        ...
        if (getArguments() != null) {
            ...
            this.A = getArguments().getString(ReqAckPackage.REQ_RESPONSE_KEY.AVATAR);
            this.z = getArguments().getString(ContactsContract.Contacts.AggregationSuggestions.PARAMETER_MATCH_NICKNAME);
            this.B = getArguments().getString(ATCustomRuleKeys.AGE);
            ...
            this.P = getArguments().getInt(ReqAckPackage.REQ_RESPONSE_KEY.VBADGE);
                ...
                try {
                    if (bluedEntityA.hasData()) {
                        ...
                        if (GroupNotifyInfoFragment.this.K.equals("allowed")) {
                            GroupNotifyInfoFragment.this.f30838c.setVisibility(8);
                            ...
                            GroupNotifyInfoFragment.this.f30838c.setVisibility(0);
    ...
    private void a(final boolean z) {
        GroupHttpUtils.d(getActivity(), new BluedUIHttpResponse<BluedEntity>() { // from class: com.soft.blued.ui.group.GroupNotifyInfoFragment.2
            ...
            public void onUIFinish() {
                super.onUIFinish();
                DialogUtils.b(GroupNotifyInfoFragment.this.x);
                if (this.f30840a && this.b == 403009014) {
                    this.f30840a = false;
                    if (StringUtils.d(this.f30841c)) {
                        return;
                    }
                    BluedEntity bluedEntity = (BluedEntity) AppInfo.f().fromJson(this.f30841c, new TypeToken<BluedEntity<Object, BluedGroupOpsAlreadyNotify>>() { // from class: com.soft.blued.ui.group.GroupNotifyInfoFragment.2.1
                    }.getType());
                    String uid = UserInfo.getInstance().getLoginUserInfo().getUid();
    ...
    private void b() {
        CommonTopTitleNoTrans commonTopTitleNoTrans = (CommonTopTitleNoTrans) this.v.findViewById(2131370749);
