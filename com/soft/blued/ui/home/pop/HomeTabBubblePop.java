...
public final class HomeTabBubblePop extends AttachPopupView {
    static final /* synthetic */ KProperty<Object>[] t = {Reflection.a(new PropertyReference1Impl(HomeTabBubblePop.class, "vb", "getVb()Lcom/soft/blued/databinding/PopDiscoveryFeedBinding;", 0))};
    ...
    public HomeTabBubblePop(Context context) {
        ...
        this.u = new CustomViewBindingProperty(new Function1<HomeTabBubblePop, PopDiscoveryFeedBinding>() { // from class: com.soft.blued.ui.home.pop.HomeTabBubblePop$special$$inlined$viewBindingFragment$default$1
            ...
            /* renamed from: a */
            public final PopDiscoveryFeedBinding invoke(HomeTabBubblePop popView) {
                Intrinsics.e(popView, "popView");
                return PopDiscoveryFeedBinding.a(popView.getPopupImplView());
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(HomeTabBubblePop this$0, View view) {
    ...
    public final void setText(String str) {
        ...
        PopDiscoveryFeedBinding vb = getVb();
        TextView textView = vb == null ? null : vb.f29515c;
        if (textView == null) {
            return;
        }
    ...
    public final void setTextResId(int i) {
        TextView textView;
        PopDiscoveryFeedBinding vb = getVb();
        if (vb == null || (textView = vb.f29515c) == null) {
            return;
        }
        textView.setText(i);
    }
