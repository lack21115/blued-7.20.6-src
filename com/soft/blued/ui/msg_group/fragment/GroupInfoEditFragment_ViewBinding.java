...
public class GroupInfoEditFragment_ViewBinding implements Unbinder {
    ...
    public GroupInfoEditFragment_ViewBinding(final GroupInfoEditFragment groupInfoEditFragment, View view) {
        ...
        groupInfoEditFragment.tv_description = (TextView) Utils.a(view, R.id.tv_description, "field 'tv_description'", TextView.class);
        ...
        groupInfoEditFragment.iv_attention = (ImageView) Utils.a(view, R.id.iv_attention, "field 'iv_attention'", ImageView.class);
