...
public final class PopVipBuyCancelTipsBinding implements ViewBinding {
    ...
    public final ShapeLinearLayout f29564a;
    public final ShapeLinearLayout b;

    /* renamed from: c  reason: collision with root package name */
    public final IndefinitePagerIndicator f29565c;
    ...
    private PopVipBuyCancelTipsBinding(LinearLayout linearLayout, ShapeLinearLayout shapeLinearLayout, ShapeLinearLayout shapeLinearLayout2, IndefinitePagerIndicator indefinitePagerIndicator, ImageView imageView, ImageView imageView2, LinearLayout linearLayout2, LinearLayout linearLayout3, LinearLayout linearLayout4, LinearLayout linearLayout5, LinearLayout linearLayout6, ShapeConstraintLayout shapeConstraintLayout, LinearLayout linearLayout7, AutoScrollViewPager autoScrollViewPager, ShapeTextView shapeTextView, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, ShapeTextView shapeTextView2, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12, TextView textView13) {
        this.C = linearLayout;
        this.f29564a = shapeLinearLayout;
        this.b = shapeLinearLayout2;
        this.f29565c = indefinitePagerIndicator;
        this.d = imageView;
        this.e = imageView2;
    ...
    public static PopVipBuyCancelTipsBinding a(View view) {
        ...
        if (shapeLinearLayout != null) {
            ShapeLinearLayout shapeLinearLayout2 = (ShapeLinearLayout) view.findViewById(2131362557);
            if (shapeLinearLayout2 != null) {
                IndefinitePagerIndicator indefinitePagerIndicator = (IndefinitePagerIndicator) view.findViewById(2131364744);
                if (indefinitePagerIndicator != null) {
                    ImageView imageView = (ImageView) view.findViewById(R.id.iv_bottom_bg);
                    if (imageView != null) {
                        ImageView imageView2 = (ImageView) view.findViewById(2131365972);
                        if (imageView2 != null) {
                                    ...
                                    if (linearLayout3 != null) {
                                        ...
                                        if (linearLayout4 != null) {
                                            ...
                                            if (linearLayout5 != null) {
                                                ShapeConstraintLayout shapeConstraintLayout = (ShapeConstraintLayout) view.findViewById(R.id.ll_regression_item);
                                                if (shapeConstraintLayout != null) {
                                                    LinearLayout linearLayout6 = (LinearLayout) view.findViewById(2131368288);
                                                    if (linearLayout6 != null) {
                                                        AutoScrollViewPager autoScrollViewPager = (AutoScrollViewPager) view.findViewById(R.id.pager_privilege);
                                                        if (autoScrollViewPager != null) {
                                                            ShapeTextView shapeTextView = (ShapeTextView) view.findViewById(R.id.tv_annual_discount);
                                                            if (shapeTextView != null) {
                                                                ...
                                                                if (textView != null) {
                                                                    ...
                                                                    if (textView2 != null) {
                                                                        ...
                                                                        if (textView3 != null) {
                                                                            TextView textView4 = (TextView) view.findViewById(2131371197);
                                                                            if (textView4 != null) {
                                                                                TextView textView5 = (TextView) view.findViewById(R.id.tv_first_buy_money);
                                                                                if (textView5 != null) {
                                                                                    ShapeTextView shapeTextView2 = (ShapeTextView) view.findViewById(R.id.tv_month_discount);
                                                                                            ...
                                                                                            if (textView7 != null) {
                                                                                                ...
                                                                                                if (textView8 != null) {
                                                                                                    ...
                                                                                                    if (textView9 != null) {
                                                                                                        ...
                                                                                                        if (textView10 != null) {
                                                                                                            TextView textView11 = (TextView) view.findViewById(2131372658);
                                                                                                            if (textView11 != null) {
                                                                                                                TextView textView12 = (TextView) view.findViewById(2131372754);
                                                                                                                if (textView12 != null) {
                                                                                                                    TextView textView13 = (TextView) view.findViewById(2131372814);
                                                                                                                    if (textView13 != null) {
                                                                                                                        return new PopVipBuyCancelTipsBinding((LinearLayout) view, shapeLinearLayout, shapeLinearLayout2, indefinitePagerIndicator, imageView, imageView2, linearLayout, linearLayout2, linearLayout3, linearLayout4, linearLayout5, shapeConstraintLayout, linearLayout6, autoScrollViewPager, shapeTextView, textView, textView2, textView3, textView4, textView5, shapeTextView2, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13);
                                                                                                                    }
                                                                                                                    str = "tvTopTitle";
                                                                                                                } else {
                                                                                                                    str = "tvTitle";
