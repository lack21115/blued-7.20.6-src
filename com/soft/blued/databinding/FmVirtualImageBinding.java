...
public final class FmVirtualImageBinding implements ViewBinding {
    ...
    public final ShapeRelativeLayout f15083c;
    ...
    private FmVirtualImageBinding(ConstraintLayout constraintLayout, RelativeLayout relativeLayout, RelativeLayout relativeLayout2, ShapeRelativeLayout shapeRelativeLayout, ConstraintLayout constraintLayout2, FrameLayout frameLayout, FrameLayout frameLayout2, FrameLayout frameLayout3, ConstraintLayout constraintLayout3, ImageView imageView, ImageView imageView2, ImageView imageView3, NoDataAndLoadFailView noDataAndLoadFailView, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, TextView textView, View view, View view2, View view3, View view4, View view5, View view6) {
        ...
        this.f15083c = shapeRelativeLayout;
    ...
    public static FmVirtualImageBinding a(View view) {
        ...
        if (relativeLayout != null) {
            ...
            if (relativeLayout2 != null) {
                ShapeRelativeLayout findViewById = view.findViewById(R.id.btn_share);
                                    ...
                                    if (constraintLayout2 != null) {
                                        ...
                                        if (imageView != null) {
                                            ...
                                            if (imageView2 != null) {
                                                ...
                                                if (imageView3 != null) {
                                                    NoDataAndLoadFailView findViewById2 = view.findViewById(2131368721);
                                                    if (findViewById2 != null) {
                                                        ...
                                                        if (relativeLayout3 != null) {
                                                            ...
                                                            if (relativeLayout4 != null) {
                                                                ...
                                                                if (textView != null) {
                                                                    View findViewById3 = view.findViewById(R.id.v_double_tap_guide);
                                                                    if (findViewById3 != null) {
                                                                        View findViewById4 = view.findViewById(R.id.v_header);
                                                                        if (findViewById4 != null) {
                                                                            View findViewById5 = view.findViewById(R.id.v_left_arm);
                                                                            if (findViewById5 != null) {
                                                                                View findViewById6 = view.findViewById(R.id.v_lower_body);
                                                                                if (findViewById6 != null) {
                                                                                    View findViewById7 = view.findViewById(R.id.v_right_arm);
                                                                                    if (findViewById7 != null) {
                                                                                        View findViewById8 = view.findViewById(R.id.v_upper_body);
                                                                                        if (findViewById8 != null) {
                                                                                            return new FmVirtualImageBinding((ConstraintLayout) view, relativeLayout, relativeLayout2, findViewById, constraintLayout, frameLayout, frameLayout2, frameLayout3, constraintLayout2, imageView, imageView2, imageView3, findViewById2, relativeLayout3, relativeLayout4, textView, findViewById3, findViewById4, findViewById5, findViewById6, findViewById7, findViewById8);
                                                                                        }
                                                                                        str = "vUpperBody";
                                                                                    } else {
                                                                                        str = "vRightArm";
