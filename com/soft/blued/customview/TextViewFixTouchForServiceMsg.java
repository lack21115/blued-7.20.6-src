...
public class TextViewFixTouchForServiceMsg extends EmojiTextView {
    ...
    public class ButtonSpan extends ClickableSpan {
        ...
        public void onClick(View view) {
            View.OnClickListener onClickListener = this.f14840a;
        ...
        public void updateDrawState(TextPaint textPaint) {
            textPaint.setColor(BluedSkinUtils.a(this.b, this.f14841c));
        ...
        try {
            ...
            if (!TextUtils.isEmpty(text) && (text instanceof Spannable)) {
                ...
                if (clickableSpanArr.length == 0) {
                    if (this.f14838a >= 0 && this.b >= this.f14838a) {
                        if (spannable.length() >= this.b) {
                            spannable.setSpan(new BackgroundColorSpan(0), this.f14838a, this.b, 33);
                        }
                        this.f14838a = -1;
                        this.b = -1;
                    }
                    ...
                    this.f14838a = spannable.getSpanStart(clickableSpanArr[0]);
                    int spanEnd = spannable.getSpanEnd(clickableSpanArr[0]);
                    this.b = spanEnd;
                    if (this.f14838a < 0 || spanEnd < this.f14838a || spanEnd > spannable.length()) {
                        return true;
                    }
                    spannable.setSpan(new BackgroundColorSpan(Color.parseColor("#0A000000")), this.f14838a, this.b, 33);
                    return true;
                } else if ((action == 1 || action == 3) && this.f14838a >= 0 && this.b >= this.f14838a && this.b <= spannable.length()) {
                    spannable.setSpan(new BackgroundColorSpan(0), this.f14838a, this.b, 33);
                    this.f14838a = -1;
                    this.b = -1;
                    return true;
    ...
    public void setExpandText(CharSequence charSequence) {
        ...
        if (maxLines != -1) {
            ...
            if (a2.getLineCount() > maxLines) {
                CharSequence subSequence = this.f14839c.subSequence(0, a2.getLineEnd(maxLines - 1));
