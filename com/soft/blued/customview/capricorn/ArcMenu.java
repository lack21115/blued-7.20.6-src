...
public class ArcMenu extends RelativeLayout {
    ...
    class AnonymousClass2 implements View.OnClickListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ OnItemDisappearListener f14880a;
        final /* synthetic */ View.OnClickListener b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ ArcMenu f14881c;

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            Tracker.onClick(view);
            this.f14881c.a(view, true, 400L).setAnimationListener(new Animation.AnimationListener() { // from class: com.soft.blued.customview.capricorn.ArcMenu.2.1
                @Override // android.view.animation.Animation.AnimationListener
                public void onAnimationEnd(Animation animation) {
                    AnonymousClass2.this.f14881c.postDelayed(new Runnable() { // from class: com.soft.blued.customview.capricorn.ArcMenu.2.1.1
                        @Override // java.lang.Runnable
                        public void run() {
                            AnonymousClass2.this.f14881c.a();
                            if (AnonymousClass2.this.f14880a != null) {
                                AnonymousClass2.this.f14880a.a();
                            }
                        }
                    }, 0L);
                }
            ...
            this.f14881c.a(false);
            int childCount = this.f14881c.f14877a.getChildCount();
            int i = 0;
            while (true) {
                int i2 = i;
                if (i2 >= childCount) {
                ...
                View childAt = this.f14881c.f14877a.getChildAt(i2);
                if (view != childAt) {
                    this.f14881c.a(childAt, false, 300L);
                }
                i = i2 + 1;
            }
            this.f14881c.f14877a.invalidate();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void a() {
        int childCount = this.f14877a.getChildCount();
        int i = 0;
        while (true) {
            int i2 = i;
            if (i2 >= childCount) {
                ...
                this.f14877a.getChildAt(i2).clearAnimation();
                i = i2 + 1;
            }
        }
    }
    ...
    private void a(Context context) {
        ...
        this.f14877a = (ArcLayout) findViewById(R.id.item_layout);
        ...
        this.b.setOnTouchListener(new View.OnTouchListener() { // from class: com.soft.blued.customview.capricorn.ArcMenu.1
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
                    ArcMenu.this.f14877a.a(true);
                    return false;
                }
                return false;
            }
        });
        this.f14878c = (ImageView) findViewById(R.id.control_hint);
    }

    private void a(AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, R.styleable.ArcLayout, 0, 0);
            this.f14877a.a(obtainStyledAttributes.getFloat(1, 270.0f), obtainStyledAttributes.getFloat(2, 360.0f));
            this.f14877a.setChildSize(obtainStyledAttributes.getDimensionPixelSize(0, this.f14877a.getChildSize()));
            obtainStyledAttributes.recycle();
        }
    }

    public void a(boolean z) {
        ArcLayout arcLayout = this.f14877a;
        if (arcLayout != null) {
            arcLayout.b(z);
        }
    }
    ...
    public void setOnExpandListener(ArcLayout.OnExpandListener onExpandListener) {
        this.f14877a.a(onExpandListener, this.b);
    }
}
