...
public class BallSpinFadeLoaderIndicator extends BaseIndicatorController {
    ...
    float[] f14916a = {1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f};
    ...
    public List<Animator> a() {
        ...
        int[] iArr = {0, 120, 240, 360, 480, 600, UGCTransitionRules.DEFAULT_IMAGE_WIDTH, 780, 840};
        int i = 0;
        while (true) {
            final int i2 = i;
            if (i2 >= 8) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.soft.blued.customview.loadingIndicator.BallSpinFadeLoaderIndicator.1
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    BallSpinFadeLoaderIndicator.this.f14916a[i2] = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    public void a(Canvas canvas, Paint paint) {
        ...
        while (true) {
            ...
            canvas.translate(a2.f14919a, a2.b);
            float[] fArr = this.f14916a;
