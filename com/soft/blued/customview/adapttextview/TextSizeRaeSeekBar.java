...
public class TextSizeRaeSeekBar extends AppCompatSeekBar {
    ...
    private void a() {
        this.f28549a = FontAdjustTextHelper.c();
        int[] d = FontAdjustTextHelper.d();
        this.b = d;
        setMax(d.length - 1);
        this.f28550c.setColor(BluedSkinUtils.a(getContext(), 2131100624));
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(this.h, this.f28550c);
        int i = 0;
        while (true) {
            int i2 = i;
            if (i2 > max) {
            ...
            canvas.drawCircle(paddingLeft, height, FontAdjustTextHelper.a(getContext(), 3.0f), this.f28550c);
            String[] strArr = this.f28549a;
            String str = strArr[i2 % strArr.length];
            this.d.setTextSize(a(this.b[i2]));
            this.d.getTextBounds(str, 0, str.length(), this.h);
            float a2 = paddingLeft - (a(this.d, this.f28549a[i2]) / 2);
            int[] iArr = this.b;
