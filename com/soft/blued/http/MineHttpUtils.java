...
public class MineHttpUtils {
    public static void a() {
        ...
        HttpManager.a(str, new BluedUIHttpResponse<BluedEntityA<MinePageModel>>(null) { // from class: com.soft.blued.http.MineHttpUtils.1
            ...
            public void onUIUpdate(BluedEntityA<MinePageModel> bluedEntityA) {
                ...
                if (bluedEntityA == null || !bluedEntityA.hasData() || (userInfoEntity = ((MinePageModel) bluedEntityA.getSingleData()).user) == null || UserInfo.getInstance().getLoginUserInfo() == null || !uid.equalsIgnoreCase(UserInfo.getInstance().getLoginUserInfo().uid)) {
                    return;
                }
        ...
        }, (IRequestHost) null).a(a2).b(BluedHttpTools.a(true)).h();
    }
    ...
    public static void c(BluedUIHttpResponse bluedUIHttpResponse, String str) {
        Map a2 = BluedHttpTools.a();
        a2.put("code", str);
        HttpManager.a(BluedHttpUrl.q() + "/groups/boost", bluedUIHttpResponse, (IRequestHost) null).b(BluedHttpTools.a(true)).a(a2).h();
    }
