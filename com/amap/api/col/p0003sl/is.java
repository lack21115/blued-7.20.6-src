...
/* renamed from: com.amap.api.col.3sl.is  reason: invalid package */
/* loaded from: source-6737240-dex2jar.jar:com/amap/api/col/3sl/is.class */
public final class is {
    ...
    public static boolean a(Context context) {
        ...
        if (TextUtils.isEmpty(f5178a) || !TextUtils.isDigitsOnly(f5178a)) {
            return false;
        }
