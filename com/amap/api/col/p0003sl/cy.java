...
public final class cy {
    ...
    private static StyleElement a(Map<Integer, StyleItem> map, int i, int i2, cu cuVar) {
        ...
        if (styleItem == null) {
            styleItem2 = new StyleItem(cuVar.f4825c);
            styleItem2.mainKey = cuVar.f4824a;
    ...
    private static String a(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        try {
            ...
            Cipher cipher = Cipher.getInstance(b.f23739a);
    ...
    private void a(cz czVar) {
        if (this.f4833c != -1) {
            Map<Integer, StyleItem> a2 = czVar.a();
            for (cu cuVar : a("roads", "trafficRoadBackgroundColor")) {
                a(a2, cuVar.d, cw.a("fillColor"), cuVar).value = this.f4833c;
                a(a2, cuVar.d, cw.a("strokeColor"), cuVar).value = this.f4833c;
            }
        }
    }
    ...
    private void a(String str, String str2, Map<Integer, StyleItem> map, JSONObject jSONObject, boolean z) throws JSONException {
        ...
        List<cu> a2 = a(str, str2);
        for (cu cuVar : a2) {
            if (cuVar == null || cuVar.f4825c == -1000) {
                return;
            }
            int i = cuVar.d;
            if (jSONObject.optBoolean(CalendarContract.CalendarColumns.VISIBLE, true)) {
                ...
                if (!jSONObject.optBoolean("showLabel", true)) {
                    ...
                    StyleElement a3 = a(map, i, cw.a("textStrokeColor"), cuVar);
                    a3.opacity = 0.0f;
                    a3.visible = 0;
                    a3.textureId = -1;
                }
                ...
                StyleElement a4 = a(map, i, cw.a(CalendarContract.CalendarColumns.VISIBLE), cuVar);
                a4.textureId = -1;
                a4.visible = 0;
            }
        }
    ...
    private static void a(Map<Integer, StyleItem> map, JSONObject jSONObject, int i, int i2, cu cuVar) throws JSONException {
        int a2;
        StyleElement a3 = a(map, i, i2, cuVar);
    ...
    private static void a(Map<Integer, StyleItem> map, JSONObject jSONObject, String str, String str2, int i, cu cuVar) {
        try {
            ...
            int a2 = cw.a(str);
            StyleElement a3 = a(map, i, a2, cuVar);
            a3.value = i2;
            a3.opacity = f;
            if (cuVar.f != null && cuVar.f.equals("China")) {
                a(map, i, a2, cuVar).opacity = 0.0f;
            } else if (cuVar.e != null && cuVar.e.equals("water") && a2 == 3) {
                StyleElement a4 = a(map, i, 2, cuVar);
                a4.value = i2;
                a4.opacity = f;
            }
        } catch (Throwable th) {
            ...
            while (true) {
                ...
                if (!TextUtils.isEmpty(optString)) {
                    if ("background".equals(optString)) {
                        ...
                        if (b != null && (a2 = cx.a(optString)) != null && a2.length != 0) {
                            String optString2 = optJSONObject.optString("elementType");
                            if (!TextUtils.isEmpty(optString2)) {
                                int a4 = cw.a(optString2);
                                if (a4 != -1) {
                                    a(map, optJSONObject, b, a2, a4);
                                }
                            }
                        }
                    }
        ...
        while (i2 < length) {
            ...
            if (optJSONObject3 != null) {
                ...
                if (optJSONObject3.has("styleMap")) {
                    a(optJSONObject3.optJSONArray("styleMap"), optString, (String) null, optString2, this.f4832a);
                    str = str3;
                    str2 = str4;
                            ...
                            while (true) {
                                ...
                                if (optJSONObject5 != null) {
                                    ...
                                    if (optJSONObject5.has("styleMap")) {
                                        a(optJSONObject5.optJSONArray("styleMap"), optString, optString3, optString2 + "-" + optString4, this.f4832a);
                                            ...
                                            if (i6 < length3) {
                                                ...
                                                if (optJSONObject6 != null) {
                                                    ...
                                                    if (optJSONObject6.has("styleMap")) {
                                                        a(optJSONObject6.optJSONArray("styleMap"), optString, optString3 + "-" + optString5, optString2 + "-" + optString4 + "-" + optString6, this.f4832a);
                                                    }
                                                }
                                                i5 = i6 + 1;
                                            }
                ...
                length = i;
                this.f4832a.add(new cu(20021, d, "roads", "trafficRoadBackgroundColor", null));
                i2++;
