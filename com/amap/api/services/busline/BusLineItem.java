...
/* loaded from: source-6737240-dex2jar.jar:com/amap/api/services/busline/BusLineItem.class */
public class BusLineItem implements Parcelable {
    ...
    public BusLineItem(Parcel parcel) {
        ...
        this.j = fe.e(parcel.readString());
        this.k = fe.e(parcel.readString());
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            String str = this.g;
            return str == null ? busLineItem.g == null : str.equals(busLineItem.g);
        }
        return false;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(fe.a(this.j));
        parcel.writeString(fe.a(this.k));
