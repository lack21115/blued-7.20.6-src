...
import com.amap.api.col.p0003sl.cn;

/* loaded from: source-6737240-dex2jar.jar:com/amap/api/maps/model/Text.class */
public final class Text {
    ...
    private void a() {
        this.marker.setIcon(cn.b(this.textOptions));
    }
    ...
    public final void setAlign(int i, int i2) {
        try {
            ...
            this.marker.setAnchor(cn.a(this.textOptions.getAlignX(), true), cn.a(this.textOptions.getAlignY(), false));
            a();
        } catch (Throwable th) {
            th.printStackTrace();
        }
