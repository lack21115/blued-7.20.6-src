...
public class b {
    ...
    int X = 10000;
    int Y = 2;
    String Z = "网络不太好，请稍等一下";
    int aa = 1500;
    int ab = 2;
    String ac = "回答不正确，请重试";
    int ad = 1500;
    String ae = "用于拍摄人脸照片";
    String af = "您知悉并同意应用提供者：";
    String ag = "收集、使用您本人的身份信息和人脸图像";
    String ah = "向合法数据持有者核实您的身份信息";
    String ai = "本操作数据仅用于身份核实，安全可靠";
    String aj = "请勾选授权协议";
    String ak = "上述为个人敏感信息，您知悉并同意";
    String al = "《个人信息处理授权协议》";
    String am = "，如拒绝授权，将无法使用本功能";
    String an = "确认退出？";
    String ao = "亲，再等1秒即可完成";
    String ap = "确定";
    String aq = "取消";
