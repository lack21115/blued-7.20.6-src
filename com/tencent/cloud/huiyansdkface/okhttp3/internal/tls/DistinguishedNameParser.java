...
final class DistinguishedNameParser {
    ...
    private int a(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.b) {
            throw new IllegalStateException("Malformed DN: " + this.f22341a);
        }
        char c2 = this.g[i];
        if (c2 >= '0' && c2 <= '9') {
            i2 = c2 - '0';
    ...
    private String a() {
        ...
        int i3 = this.f22342c;
        if (i3 >= this.b) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f22341a);
        }
        this.e = i3;
        if (this.g[i3] == ' ') {
            while (true) {
    ...
    */
    ...
    private char e() {
        ...
        return this.g[this.f22342c];
    }

    private char f() {
        int i;
        int i2;
        int a2 = a(this.f22342c);
        this.f22342c++;
        if (a2 < 128) {
            return (char) a2;
        }
    ...
    public String findMostSpecific(String str) {
        ...
        this.e = 0;
        this.f = 0;
        this.g = this.f22341a.toCharArray();
        String a2 = a();
        String str2 = a2;
        if (a2 == null) {
            return null;
