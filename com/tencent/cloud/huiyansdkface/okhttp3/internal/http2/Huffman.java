...
class Huffman {
    ...
    private static final Huffman f36012c = new Huffman();
    ...
    private void a(int i, int i2, byte b2) {
        ...
        while (true) {
            ...
            if (b2 > 8) {
                b2 = (byte) (b2 - 8);
                int i3 = (i2 >>> b2) & 255;
                if (node3.f36013a == null) {
                    throw new IllegalStateException("invalid dictionary: prefix not unique");
                }
                if (node3.f36013a[i3] == null) {
                    node3.f36013a[i3] = new Node();
                }
                node2 = node3.f36013a[i3];
            } else {
                int i4 = 8 - b2;
                int i5 = (i2 << i4) & 255;
                int i6 = i5;
    ...
    public byte[] a(byte[] bArr) {
        ...
        while (true) {
            ...
            i4 += 8;
            while (i4 >= 8) {
                node2 = node2.f36013a[(i3 >>> (i4 - 8)) & 255];
                if (node2.f36013a == null) {
        ...
        while (i > 0) {
            Node node3 = node.f36013a[(i3 << (8 - i)) & 255];
            if (node3.f36013a != null || node3.f36014c > i) {
                break;
            }
