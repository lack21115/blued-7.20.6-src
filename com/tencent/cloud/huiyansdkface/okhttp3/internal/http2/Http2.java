...
/* loaded from: source-8457232-dex2jar.jar:com/tencent/cloud/huiyansdkface/okhttp3/internal/http2/Http2.class */
public final class Http2 {
    ...
    static {
        ...
        while (true) {
            ...
            strArr[i5] = Util.format("%8s", Integer.toBinaryString(i5)).replace(' ', '0');
            i4 = i5 + 1;
        }
        String[] strArr2 = b;
        strArr2[0] = "";
    ...
    public static String a(boolean z, int i, int i2, byte b2, byte b3) {
        String[] strArr = d;
        return Util.format("%s 0x%08x %5d %-13s %s", z ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), b2 < strArr.length ? strArr[b2] : Util.format("0x%02x", Byte.valueOf(b2)), a(b2, b3));
    }
