...
public class k implements com.tencent.cloud.huiyansdkface.a.e.c {
    ...
    private static ExecutorService f35464a = Executors.newSingleThreadExecutor(new ThreadFactory() { // from class: com.tencent.cloud.huiyansdkface.a.c.a.k.1
    ...
    private com.tencent.cloud.huiyansdkface.a.c.a f35465c;
    ...
    private byte[] a(com.tencent.cloud.huiyansdkface.a.a.a.d dVar) {
        int i = this.f;
        int a2 = i == 842094169 ? a(dVar.f35431a, dVar.b) : ((dVar.f35431a * dVar.b) * ImageFormat.getBitsPerPixel(i)) / 8;
    ...
    public void b() {
        ...
        this.b.setPreviewCallbackWithBuffer(new Camera.PreviewCallback() { // from class: com.tencent.cloud.huiyansdkface.a.c.a.k.2
            ...
            public void onPreviewFrame(final byte[] bArr, Camera camera) {
                ...
                k.f35464a.submit(new Runnable() { // from class: com.tencent.cloud.huiyansdkface.a.c.a.k.2.1
