...
public class f {
    ...
    public static final class b implements com.tencent.qmsp.sdk.b.e {
        ...
        public void a(int i, JSONObject jSONObject) {
            if (i == 161) {
                com.tencent.qmsp.sdk.f.g.a(f.f38516a, 1, String.format("ret: %d", 161));
            }
        }
    }
    ...
    public static void a(String str, int i) {
        ...
        if (a(a2)) {
            try {
                ...
                com.tencent.qmsp.sdk.f.g.a(f38516a, 1, jSONObject2.toString());
