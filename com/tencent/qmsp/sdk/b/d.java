...
public class d {
    ...
    private static byte[][] f24841a = {new byte[]{16, 99, -74, 82, 99, 26, 112, -8, 43, 100}, new byte[]{8, Byte.MAX_VALUE, -87, 73, 34, 55, 118, -78, 113, 62, -29, 0, 102, 56, 120, -16, 53, 113, -89, 73, 44, 55, 114, -90, 101, 93, Byte.MIN_VALUE, 105, 11, 123, 34, -77, 117, 43, -13, 119, 39, 53, 115, -14, 50, 99, -13, 110, 26, 96, 55, -39, 44, 119, -106, 88, 58, 114}, new byte[]{20, 96, -3, 68, 33, 44, 121}};

    public static String a(int i) {
        return h.a(f24841a[i]);
    }

    public static void a(b bVar) {
        HttpURLConnection httpURLConnection;
        String str = bVar.f24838a;
        String str2 = bVar.d;
        String str3 = bVar.f24839c;
        c cVar = new c(bVar);
        try {
