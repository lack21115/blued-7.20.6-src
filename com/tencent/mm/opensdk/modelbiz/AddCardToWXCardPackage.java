...
/* loaded from: source-8829756-dex2jar.jar:com/tencent/mm/opensdk/modelbiz/AddCardToWXCardPackage.class */
public class AddCardToWXCardPackage {
    private static final String TAG = "MicroMsg.AddCardToWXCardPackage";

    /* loaded from: source-8829756-dex2jar.jar:com/tencent/mm/opensdk/modelbiz/AddCardToWXCardPackage$Req.class */
    public static class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            ...
            for (WXCardItem wXCardItem : this.cardArrary) {
                if (wXCardItem == null || wXCardItem.cardId == null || wXCardItem.cardId.length() > 1024) {
                    return false;
                }
                if (wXCardItem.cardExtMsg != null && wXCardItem.cardExtMsg.length() > 1024) {
                    return false;
                }
            }
            return true;
    ...
    /* loaded from: source-8829756-dex2jar.jar:com/tencent/mm/opensdk/modelbiz/AddCardToWXCardPackage$Resp.class */
    ...
    /* loaded from: source-8829756-dex2jar.jar:com/tencent/mm/opensdk/modelbiz/AddCardToWXCardPackage$WXCardItem.class */
