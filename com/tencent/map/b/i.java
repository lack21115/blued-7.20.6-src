...
public final class i {
    ...
    public static String a(d.b bVar, List<NeighboringCellInfo> list) {
        ...
        int i2 = bVar.b;
        int i3 = bVar.f23525c;
        if (a(bVar.f23524a, i2, i3, bVar.d, bVar.e)) {
        ...
        if (list != null) {
            try {
                ...
                for (NeighboringCellInfo neighboringCellInfo : list) {
                    ...
                    if (a(bVar.f23524a, i2, i3, parseInt, neighboringCellInfo.getCid())) {
                        if (i > 0) {
                            sb.append(",");
                        }
