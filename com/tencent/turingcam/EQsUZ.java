...
public class EQsUZ {
    ...
    private static final String f26120a = WOMZP.b("mdNjPO1K7FJ+9CbSnlMtKMQ1GBI=");
    ...
    public static class spXPg {
        ...
        public <T> T a() {
            return (T) this.f26121a;
        }
    }

    public static boolean a(Object obj, String str, spXPg spxpg) {
        try {
            Field field = (Field) Class.class.getDeclaredMethod(f26120a, String.class).invoke(obj.getClass(), str);
            if (field != null) {
