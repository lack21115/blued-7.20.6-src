...
/* loaded from: source-8457232-dex2jar.jar:com/tencent/bugly/idasc/proguard/bq.class */
public final class bq extends m {
    static byte[] y;
    static Map<String, String> z;

    /* renamed from: a  reason: collision with root package name */
    public int f21615a = 0;
    public String b = "";
    ...
    public final void a(k kVar) {
        this.f21615a = kVar.a(this.f21615a, 0, true);
        this.b = kVar.b(1, true);
        this.f21616c = kVar.b(2, true);
    ...
    public final void a(l lVar) {
        lVar.a(this.f21615a, 0);
        lVar.a(this.b, 1);
        lVar.a(this.f21616c, 2);
        lVar.a(this.d, 3);
        String str = this.e;
        if (str != null) {
            lVar.a(str, 4);
