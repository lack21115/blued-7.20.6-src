...
public class e {
    ...
    public static b a(DataInputStream dataInputStream) {
        b bVar = new b();
        try {
            bVar.f39751a = dataInputStream.readInt();
            bVar.b = dataInputStream.readInt();
            int readInt = dataInputStream.readInt();
            bVar.f39752c = readInt;
    ...
    private static PublicKey a(String str) {
        ...
        try {
            return KeyFactory.getInstance(h.a(f39750c)).generatePublic(new X509EncodedKeySpec(Base64.decode(str2, 0)));
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
