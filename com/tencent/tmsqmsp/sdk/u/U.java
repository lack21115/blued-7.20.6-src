package com.tencent.tmsqmsp.sdk.u;
...
import com.tencent.tmsqmsp.sdk.base.e;

/* loaded from: source-8829756-dex2jar.jar:com/tencent/tmsqmsp/sdk/u/U.class */
public class U {
    public static final String BEACON_ID_VERSION = "4.1";
    public static final String COMMIT_HASH = "7c379f8f8616b60feea1a972f87242927e7504ce";

    static {
        try {
            System.loadLibrary("tmsqmp");
        } catch (Throwable th) {
            th.printStackTrace();
            load_so();
        }
    ...
    private static String getP() {
        try {
            return (String) Class.forName("com.tencent.tmsbeacon.event.open.BeaconReport").getDeclaredMethod("getSoPath", new Class[0]).invoke(null, new Object[0]);
        } catch (Throwable th) {
            th.printStackTrace();
            return null;
        }
