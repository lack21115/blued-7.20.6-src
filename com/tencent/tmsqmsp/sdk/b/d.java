...
/* loaded from: source-8829756-dex2jar.jar:com/tencent/tmsqmsp/sdk/b/d.class */
public class d {
    ...
    public static void a(b bVar) {
        ...
        if (httpURLConnection instanceof HttpURLConnection) {
            ...
            sb.append(str);
            sb.append("  ok");
            com.tencent.tmsqmsp.sdk.f.g.c(a4, 0, sb.toString());
            com.tencent.tmsqmsp.sdk.c.f.i().d().a(cVar);
        }
    }
