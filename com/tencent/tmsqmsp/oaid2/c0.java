...
public class c0 {
    ...
    public static final Uri f39620a = Uri.parse("content://cn.nubia.identity/identity");
    ...
    public static String a(Context context, String str) {
        ...
        try {
            ...
            if (i >= 17) {
                ContentProviderClient acquireUnstableContentProviderClient = context.getContentResolver().acquireUnstableContentProviderClient(f39620a);
                ...
                call = context.getContentResolver().call(f39620a, "getAAID", str, null);
            }
    ...
    public static boolean a(Context context) {
        ...
        try {
            ...
            if (i >= 17) {
                ...
                call = context.getContentResolver().call(f39620a, "isSupport", null, null);
            }
            if (call.getInt("code", -1) == 0) {
    ...
    public static String b(Context context) {
        ...
        try {
            ...
            if (i >= 17) {
                ...
                call = context.getContentResolver().call(f39620a, "getOAID", null, null);
            }
            if (call.getInt("code", -1) == 0) {
                String string = call.getString("id");
                StringBuilder sb = new StringBuilder();
