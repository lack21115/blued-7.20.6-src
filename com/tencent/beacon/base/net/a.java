...
public class a implements Callback<byte[]> {
    ...
    final /* synthetic */ JceRequestEntity f34959a;
    final /* synthetic */ boolean b;

    /* renamed from: c  reason: collision with root package name */
    final /* synthetic */ Callback f34960c;
    final /* synthetic */ c d;

    /* JADX INFO: Access modifiers changed from: package-private */
    public a(c cVar, JceRequestEntity jceRequestEntity, boolean z, Callback callback) {
        this.d = cVar;
        this.f34959a = jceRequestEntity;
        this.b = z;
        this.f34960c = callback;
    }
    ...
    public void onResponse(byte[] bArr) {
        if (bArr == null || bArr.length <= 0) {
            onFailure(new d(this.f34959a.getType().name(), this.b ? "402" : "452", 200, "raw response == null", null));
            return;
        }
        try {
            StringBuilder sb = new StringBuilder();
            sb.append("jceRequest: ");
            sb.append(this.f34959a.getType());
            ...
            this.f34960c.onResponse(bArr);
            this.d.f();
        } catch (Exception e) {
            onFailure(new d(this.f34959a.getType().name(), this.b ? "403" : "453", 200, e.getMessage(), e));
        }
    }
