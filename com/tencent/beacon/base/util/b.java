...
/* loaded from: source-8457232-dex2jar.jar:com/tencent/beacon/base/util/b.class */
public class b {
    ...
    public static byte[] a(byte[] bArr, int i, String str) {
        ...
        if (bArr != null) {
            ...
            try {
                ...
                c.a(th);
                g e = g.e();
                e.a("507", "data length: " + bArr.length + ",type:" + i + ",key: " + str, th);
                bArr2 = null;
            }
        }
        return bArr2;
    ...
    public static byte[] b(byte[] bArr, int i) {
        ...
        if (bArr != null) {
            ...
            try {
                ...
                g e = g.e();
                e.a("509", "zipData length: " + bArr.length + ",type:" + i, th);
                c.a(th);
