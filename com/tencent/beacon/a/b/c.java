...
public class c implements Runnable {
    ...
    final /* synthetic */ Throwable f21235c;
    ...
    public void run() {
        ...
        synchronized (this.f) {
            ...
            linkedHashMap.put("error_code", this.f21234a);
            linkedHashMap.put("error_msg", this.b);
            linkedHashMap.put("error_stack_full", com.tencent.beacon.base.util.b.a(this.f21235c));
            ...
            com.tencent.beacon.base.util.c.d("[atta] upload a new error, errorCode: %s, message: %s, stack: %s", this.f21234a, this.b, com.tencent.beacon.base.util.b.a(this.f21235c));
        }
    }
}
