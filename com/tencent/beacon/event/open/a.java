...
/* synthetic */ class a {
    ...
    static {
        ...
        try {
            f21382a[EventType.DT_NORMAL.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            f21382a[EventType.IMMEDIATE_MSF.ordinal()] = 3;
        } catch (NoSuchFieldError e3) {
        }
        try {
            f21382a[EventType.IMMEDIATE_WNS.ordinal()] = 4;
        } catch (NoSuchFieldError e4) {
        }
        try {
            f21382a[EventType.REALTIME.ordinal()] = 5;
        } catch (NoSuchFieldError e5) {
        }
        try {
            f21382a[EventType.DT_REALTIME.ordinal()] = 6;
