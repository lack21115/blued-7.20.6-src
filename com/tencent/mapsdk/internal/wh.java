...
public class wh {
    ...
    private TileOverlayOptions f38099c;
    private vh d;
    ...
    private void a() {
        yi yiVar;
        ei k;
        if (this.b != null || (yiVar = this.f38098a) == null || yiVar.getMap() == null || this.f38098a.A() == null || (k = this.d.k()) == null) {
            return;
        }
        na.c(ma.h, "获取海外图图源：" + k);
        rc A = this.f38098a.A();
        ...
        this.f38099c = new TileOverlayOptions().tileProvider(this.e).betterQuality(false).versionInfo(f).zIndex(1).diskCacheDir(g);
        this.b = A.d0().a(this.f38099c);
        na.c(ma.h, "开启海外图");
    }

    private boolean a(x5[] x5VarArr) {
        x5[] m0;
        yi yiVar = this.f38098a;
    ...
    private void d() {
        if (y9.c("4.5.9", "4.0.9", 3)) {
            ha.a(mc.b(this.f38098a.getContext()).h() + "/tencentmapsdk/rastermap/unmainland");
            ha.a(mc.b(this.f38098a.getContext()).c().getPath() + "/rastermap/taiwan");
        }
    }
    ...
    public void b() {
        na.c(ma.h, "检查海外图状态");
        yi yiVar = this.f38098a;
        if (yiVar == null || yiVar.getMap() == null || this.f38098a.getMapContext() == null) {
            return;
        }
        rc mapContext = this.f38098a.getMapContext();
        if (this.f38098a.getMap().V() < 7) {
            i();
            na.c(ma.h, "级别无效");
            return;
        }
        ...
        boolean a2 = this.f38098a.getMapContext().a();
    ...
    public void h() {
        b();
        TileOverlayOptions tileOverlayOptions = this.f38099c;
