...
/* loaded from: source-8829756-dex2jar.jar:com/tencent/mapsdk/internal/pj.class */
public class pj {
    ...
    private void a() {
        ...
        while (true) {
            ...
            if (this.i) {
                byte[] bArr = this.f37706a;
                bArr[i] = (byte) (bArr[i] ^ this.b[i]);
            } else {
                byte[] bArr2 = this.f37706a;
                bArr2[i] = (byte) (bArr2[i] ^ this.f37707c[this.e + i]);
            }
            this.f = i + 1;
        }
        System.arraycopy((Object) b(this.f37706a), 0, (Object) this.f37707c, this.d, 8);
        this.f = 0;
        while (true) {
            int i2 = this.f;
            if (i2 >= 8) {
                System.arraycopy((Object) this.f37706a, 0, (Object) this.b, 0, 8);
                int i3 = this.d;
                this.e = i3;
                this.d = i3 + 8;
                this.f = 0;
    ...
    private byte[] b(byte[] bArr, int i, int i2, byte[] bArr2) {
        ...
        this.f37707c = new byte[this.f + i2 + 10];
        ...
        while (true) {
            ...
            int i11 = this.f;
            if (i11 < 8) {
                byte[] bArr4 = this.f37706a;
                this.f = i11 + 1;
                bArr4[i11] = (byte) (b() & 255);
                this.g++;
            }
            if (this.f == 8) {
                a();
        ...
        while (true) {
            ...
            if (i8 > 2) {
                while (i10 != 0) {
                    ...
                    int i13 = i10;
                    if (i11 < 8) {
                        this.f37707c[i9] = (byte) (bArr4[(this.e + i) + i11] ^ this.b[i11]);
                        i12 = i9 + 1;
                        i13 = i10 - 1;
                        this.f = i11 + 1;
                    }
