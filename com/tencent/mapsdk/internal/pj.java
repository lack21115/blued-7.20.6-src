...
public class pj {
    ...
    private void a() {
        ...
        while (true) {
            ...
            if (this.i) {
                ...
                byte[] bArr2 = this.f24015a;
                bArr2[i] = (byte) (bArr2[i] ^ this.f24016c[this.e + i]);
            }
            this.f = i + 1;
        }
        System.arraycopy(b(this.f24015a), 0, this.f24016c, this.d, 8);
        this.f = 0;
        while (true) {
            int i2 = this.f;
            if (i2 >= 8) {
                System.arraycopy(this.f24015a, 0, this.b, 0, 8);
                int i3 = this.d;
                this.e = i3;
                this.d = i3 + 8;
                this.f = 0;
    ...
    private byte[] b(byte[] bArr, int i, int i2, byte[] bArr2) {
        ...
        this.f24016c = new byte[this.f + i2 + 10];
        ...
        while (true) {
            ...
            if (i8 > 2) {
                while (i10 != 0) {
                    ...
                    int i13 = i10;
                    if (i11 < 8) {
                        this.f24016c[i9] = (byte) (bArr4[(this.e + i) + i11] ^ this.b[i11]);
                        i12 = i9 + 1;
                        i13 = i10 - 1;
                        this.f = i11 + 1;
                    }
