...
public final class lj implements Callback<byte[]> {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            com.tencent.tmsbeacon.base.util.c.a(lj.this.f23932c, 4, "delete: %s", Boolean.valueOf(lj.this.g.a(lj.this.f, sb.substring(0, sb.lastIndexOf(",")))));
    ...
    public void onResponse(byte[] bArr) {
        com.tencent.tmsbeacon.base.util.c.a(this.f23932c, 3, "report success! sendingID will delete this time's IDs. offer task: %s! ", Boolean.valueOf(((EventModule) com.tencent.tmsbeacon.a.c.c.d().a(ModuleName.EVENT)).c().a(new a())));
    ...
    public void onFailure(com.tencent.tmsbeacon.base.net.d dVar) {
        com.tencent.tmsbeacon.base.util.c.a(this.f23932c, 3, "send failure reason: %s. LogID: %s.", dVar.toString(), this.d);
        this.e.a(this.b);
    }
}
