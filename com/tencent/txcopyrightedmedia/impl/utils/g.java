...
public final class g {
    ...
    public final int a() {
        return this.f40099a.getInt("MAX_CACHE_ITEM_COUNT", 50);
    }

    public final int b() {
        String string = this.f40099a.getString("LAST_SDK_VERSION", null);
        if (TextUtils.isEmpty(string)) {
            return -1;
        }
