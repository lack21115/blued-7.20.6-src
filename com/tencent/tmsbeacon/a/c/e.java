...
/* loaded from: source-8829756-dex2jar.jar:com/tencent/tmsbeacon/a/c/e.class */
public class e implements e.a {
    ...
    /* loaded from: source-8829756-dex2jar.jar:com/tencent/tmsbeacon/a/c/e$a.class */
    ...
    private e() {
        Context c2 = c.d().c();
        this.b = c2;
        com.tencent.tmsbeacon.base.net.b.e.a(c2, this);
        E();
    }
    ...
    private String F() {
        ...
        com.tencent.tmsbeacon.base.util.c.a("[DeviceInfo] NetWork Type:" + str, new Object[0]);
        return str;
    }
    ...
    public void B() {
        String string = com.tencent.tmsbeacon.a.d.a.a().getString("BEACON_ANDROID_ID_DENGTA", "");
        this.f = string;
            ...
            while (true) {
                try {
                    ...
                    try {
                        ...
                        com.tencent.tmsbeacon.base.util.b.a(bufferedReader);
                        return false;
                    } catch (Throwable th2) {
                        com.tencent.tmsbeacon.base.util.b.a(bufferedReader);
                        throw th2;
    ...
    public String D() {
        if (TextUtils.isEmpty(this.g)) {
            try {
                ...
                return "harmony".equals(cls.getMethod("getOsBrand", new Class[0]).invoke(cls, new Object[0])) ? "Y" : "N";
            } catch (Throwable th) {
                com.tencent.tmsbeacon.base.util.c.a("[DeviceInfo] isHarmonyOS occur a problem.", new Object[0]);
                return "N";
            }
        }
        return this.g;
    ...
    public String a(Context context) {
        try {
            if (Integer.parseInt(Build.VERSION.SDK) < 9) {
                com.tencent.tmsbeacon.base.util.c.b("[audit] Api level < 9;return null!", new Object[0]);
                return "";
            }
            ...
            com.tencent.tmsbeacon.base.util.c.a(sb.toString(), new Object[0]);
            return String.valueOf(packageInfo.lastUpdateTime);
        } catch (Throwable th) {
            com.tencent.tmsbeacon.base.util.c.a(th);
            com.tencent.tmsbeacon.base.util.c.b("[audit] get app_last_updated_time failed!", new Object[0]);
            return "";
        }
    }
    ...
    */
    public java.lang.String f() {
        ...
        L60:
            ...
            r3 = r11
            r1[r2] = r3
            com.tencent.tmsbeacon.base.util.b.a(r0)
            r0 = r9
            return r0
        L6e:
            r10 = move-exception
        ...
        L78:
            r0 = r10
            com.tencent.tmsbeacon.base.util.c.a(r0)     // Catch: java.lang.Throwable -> L8a
            r0 = 1
            java.io.Closeable[] r0 = new java.io.Closeable[r0]
            r1 = r0
            r2 = 0
        ...
        L8a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.tmsbeacon.a.c.e.f():java.lang.String");
    }
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(13:1|(3:2|3|4)|(3:5|6|7)|8|9|10|11|(3:12|13|14)|15|(6:16|17|18|19|20|21)|22|23|(1:(0))) */
    ...
    */
    public java.lang.String p() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.tmsbeacon.a.c.e.p():java.lang.String");
    }
    ...
    public int r() {
        try {
            ...
            com.tencent.tmsbeacon.base.util.c.b("[model] CPU Count: Failed.", new Object[0]);
            com.tencent.tmsbeacon.base.util.c.a(e);
            return 1;
        }
    }
                ...
                try {
                    ...
                    if (readLine == null) {
                        try {
                            ...
                            com.tencent.tmsbeacon.base.util.c.b("[model] IO close error!", new Object[0]);
                            com.tencent.tmsbeacon.base.util.c.a(th);
                            return null;
                        }
                    }
                    ...
                    th = th3;
                    try {
                        com.tencent.tmsbeacon.base.util.c.b("[model] get free RAM error!", new Object[0]);
                        com.tencent.tmsbeacon.base.util.c.a(th);
                        if (bufferedReader != null) {
                            try {
                                ...
                                com.tencent.tmsbeacon.base.util.c.b("[model] IO close error!", new Object[0]);
                                com.tencent.tmsbeacon.base.util.c.a(th4);
                                return null;
                            }
                        }
                        if (fileReader != null) {
                        ...
                        if (bufferedReader != null) {
                            try {
                                ...
                                com.tencent.tmsbeacon.base.util.c.b("[model] IO close error!", new Object[0]);
                                com.tencent.tmsbeacon.base.util.c.a(th6);
                                throw th5;
                            }
                        }
                        if (fileReader != null) {
    ...
    public String v() {
        ArrayList<String> a2 = com.tencent.tmsbeacon.base.util.b.a(new String[]{"/system/bin/sh", "-c", "getprop ro.build.fingerprint"});
    ...
    public String w() {
        if (TextUtils.isEmpty(this.d)) {
            ...
            this.d = (((blockCount * blockSize) / 1024) / 1024) + "";
            com.tencent.tmsbeacon.base.util.c.a("[DeviceInfo] Rom Size:" + this.d, new Object[0]);
            return this.d;
        }
        return this.d;
    }
