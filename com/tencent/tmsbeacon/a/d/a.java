...
public class a implements SharedPreferences {
    ...
    private static volatile a f39481a;
    private boolean b;

    /* renamed from: c  reason: collision with root package name */
    private g f39482c;
    private SharedPreferences$EditorC1031a d;
    ...
    public static class SharedPreferences$EditorC1031a implements SharedPreferences.Editor {

        /* renamed from: a  reason: collision with root package name */
        private g f39483a;

        public SharedPreferences$EditorC1031a(g gVar) {
            this.f39483a = gVar;
        }
        ...
        public SharedPreferences.Editor putBoolean(String str, boolean z) {
            this.f39483a.b(str, Boolean.valueOf(z));
            return this;
        }

        @Override // android.content.SharedPreferences.Editor
        public SharedPreferences.Editor putFloat(String str, float f) {
            this.f39483a.b(str, Float.valueOf(f));
            return this;
        }

        @Override // android.content.SharedPreferences.Editor
        public SharedPreferences.Editor putInt(String str, int i) {
            this.f39483a.b(str, Integer.valueOf(i));
            return this;
        }

        @Override // android.content.SharedPreferences.Editor
        public SharedPreferences.Editor putLong(String str, long j) {
            this.f39483a.b(str, Long.valueOf(j));
            return this;
        }

        @Override // android.content.SharedPreferences.Editor
        public SharedPreferences.Editor putString(String str, String str2) {
            this.f39483a.b(str, str2);
            return this;
        }

        @Override // android.content.SharedPreferences.Editor
        public SharedPreferences.Editor putStringSet(String str, Set<String> set) {
            this.f39483a.b(str, (Set) set);
            return this;
        }
    ...
    */
    ...
    public void a(Context context) {
        synchronized (this) {
            ...
            try {
                ...
                this.f39482c = a2;
                this.d = new SharedPreferences$EditorC1031a(a2);
                this.b = true;
            } catch (IOException e) {
    ...
    public boolean contains(String str) {
        return this.f39482c.a(str);
    }

    @Override // android.content.SharedPreferences
    public SharedPreferences$EditorC1031a edit() {
        if (!this.b) {
    ...
    public Set<String> getStringSet(String str, Set<String> set) {
        return !this.b ? set : this.f39482c.a(str, (Set) set);
    }
