...
public final class d {
    ...
    public static int a(EventType eventType) {
        int i = a.f25872a[eventType.ordinal()];
        int i2 = 3;
        if (i == 3 || i == 4) {
            i2 = 1;
        } else if (i == 5) {
    ...
    public static Map<String, String> a(String str, Map<String, String> map) {
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            if (length <= 0 || !e(valueOf)) {
                ...
                com.tencent.tmsbeacon.a.b.d.b().a("102", "[event] eventName: " + str + ", key: " + valueOf + " should be ASCII code in 32-126!");
            } else {
                ...
                if (length > 64) {
                    ...
                    com.tencent.tmsbeacon.a.b.d.b().a("102", str3);
                ...
                if (trim2.length() > 10240) {
                    ...
                    com.tencent.tmsbeacon.a.b.d.b().a("103", str5);
    ...
    public static String b(String str) {
        if (TextUtils.isEmpty(str)) {
            if (com.tencent.tmsbeacon.base.util.e.f25839a.get()) {
