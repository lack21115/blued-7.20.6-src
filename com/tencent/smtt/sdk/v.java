...
class v {
    ...
    protected DexLoader f38912a;

    public v(DexLoader dexLoader) {
        this.f38912a = null;
        this.f38912a = dexLoader;
    }

    public Object a(Context context) {
        DexLoader dexLoader = this.f38912a;
    ...
    public void a(Object obj) {
        this.f38912a.invokeMethod(obj, "com.tencent.tbs.player.TbsPlayerProxy", "onUserStateChanged", new Class[0], new Object[0]);
    }

    public void a(Object obj, Activity activity, int i) {
        this.f38912a.invokeMethod(obj, "com.tencent.tbs.player.TbsPlayerProxy", "onActivity", new Class[]{Activity.class, Integer.TYPE}, activity, Integer.valueOf(i));
    }
