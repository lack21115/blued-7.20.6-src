...
/* loaded from: source-8829756-dex2jar.jar:com/tencent/smtt/sdk/ui/dialog/e.class */
public class e {

    /* renamed from: a  reason: collision with root package name */
    public static String[][] f38902a = {new String[]{".3gp", "video/3gpp"}, new String[]{".apk", "application/vnd.Android.package-archive"}, new String[]{".asf", "video/x-ms-asf"}, new String[]{".avi", "video/x-msvideo"}, new String[]{".bin", "application/octet-stream"}, new String[]{".bmp", "image/bmp"}, new String[]{".c", "text/plain"}, new String[]{".class", "application/octet-stream"}, new String[]{".conf", "text/plain"}, new String[]{".cpp", "text/plain"}, new String[]{".doc", "application/msword"}, new String[]{".docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"}, new String[]{".xls", "application/vnd.ms-excel"}, new String[]{".xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}, new String[]{".exe", "application/octet-stream"}, new String[]{".gif", ax.B}, new String[]{".gtar", "application/x-gtar"}, new String[]{com.kuaishou.weapon.p0.d.b, "application/x-gzip"}, new String[]{".h", "text/plain"}, new String[]{".htm", ClipDescription.MIMETYPE_TEXT_HTML}, new String[]{".html", ClipDescription.MIMETYPE_TEXT_HTML}, new String[]{ShareConstants.JAR_SUFFIX, "application/java-archive"}, new String[]{".java", "text/plain"}, new String[]{".jpeg", ax.V}, new String[]{".jpg", ax.V}, new String[]{".js", "application/x-javascript"}, new String[]{com.anythink.china.common.a.a.f, "text/plain"}, new String[]{".m3u", "audio/x-mpegurl"}, new String[]{".m4a", "audio/mp4a-latm"}, new String[]{".m4b", "audio/mp4a-latm"}, new String[]{".m4p", "audio/mp4a-latm"}, new String[]{".m4u", "video/vnd.mpegurl"}, new String[]{".m4v", "video/x-m4v"}, new String[]{".mov", "video/quicktime"}, new String[]{".mp2", "audio/x-mpeg"}, new String[]{".mp3", "audio/x-mpeg"}, new String[]{".mp4", "video/mp4"}, new String[]{".mpc", "application/vnd.mpohun.certificate"}, new String[]{".mpe", o.m}, new String[]{".mpeg", o.m}, new String[]{".mpg", o.m}, new String[]{".mpg4", "video/mp4"}, new String[]{".mpga", "audio/mpeg"}, new String[]{".msg", "application/vnd.ms-outlook"}, new String[]{".ogg", "audio/ogg"}, new String[]{".pdf", "application/pdf"}, new String[]{".png", ax.Z}, new String[]{".pps", "application/vnd.ms-powerpoint"}, new String[]{".ppt", "application/vnd.ms-powerpoint"}, new String[]{".pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation"}, new String[]{".prop", "text/plain"}, new String[]{".rc", "text/plain"}, new String[]{".rmvb", "audio/x-pn-realaudio"}, new String[]{".rtf", "application/rtf"}, new String[]{".sh", "text/plain"}, new String[]{".tar", "application/x-tar"}, new String[]{".tgz", "application/x-compressed"}, new String[]{".txt", "text/plain"}, new String[]{".wav", "audio/x-wav"}, new String[]{".wma", "audio/x-ms-wma"}, new String[]{".wmv", "audio/x-ms-wmv"}, new String[]{".wps", "application/vnd.ms-works"}, new String[]{".xml", "text/plain"}, new String[]{".z", "application/x-compress"}, new String[]{".zip", "application/zip"}, new String[]{".7z", "application/7z"}, new String[]{"", "*/*"}};
    ...
    public static Drawable a(String str) {
        ...
        if ("x5_tbs_activity_picker_check".equals(str)) {
            return new BitmapDrawable(c(f38903c));
        }
        return null;
    }
    ...
    public static String e(String str) {
        ...
        while (true) {
            int i2 = i;
            String[][] strArr = f38902a;
            if (i2 >= strArr.length) {
                str2 = "*/*";
                break;
            } else if (str3.equalsIgnoreCase(strArr[i2][0])) {
                str2 = f38902a[i2][1];
                break;
            } else {
                i = i2 + 1;
        ...
        if ("*/*".equalsIgnoreCase(str2)) {
            str4 = MimeTypeMap.getSingleton().getMimeTypeFromExtension(substring.toLowerCase());
        }
        String str5 = str4;
        if (str4 == null) {
            str5 = d(substring);
