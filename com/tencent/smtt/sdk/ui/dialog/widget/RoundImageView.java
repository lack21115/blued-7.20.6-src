...
public class RoundImageView extends ImageView {
    ...
    private Paint f25213a;
    private Xfermode b;

    /* renamed from: c  reason: collision with root package name */
    private Bitmap f25214c;
    private float[] d;
    private RectF e;
    private int f;
    ...
    private void a(int i, int i2) {
        this.i.reset();
        this.f25213a.setStrokeWidth(i);
        this.f25213a.setColor(i2);
    ...
    private void a(Canvas canvas, int i, int i2, RectF rectF, float[] fArr) {
        ...
        canvas.drawPath(this.i, this.f25213a);
    }

    @Override // android.view.View
    public void invalidate() {
        this.g = null;
        Bitmap bitmap = this.f25214c;
        if (bitmap != null) {
            bitmap.recycle();
            this.f25214c = null;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (bitmap == null || bitmap.isRecycled()) {
            ...
            if (drawable != null) {
                ...
                Bitmap bitmap2 = this.f25214c;
                if (bitmap2 == null || bitmap2.isRecycled()) {
                    this.f25214c = a();
                }
                this.f25213a.reset();
                this.f25213a.setFilterBitmap(false);
                this.f25213a.setXfermode(this.b);
                Bitmap bitmap3 = this.f25214c;
                if (bitmap3 != null) {
                    canvas2.drawBitmap(bitmap3, 0.0f, 0.0f, this.f25213a);
                }
                this.f25213a.setXfermode(null);
                canvas.drawBitmap(createBitmap, 0.0f, 0.0f, (Paint) null);
                this.g = new WeakReference<>(createBitmap);
            }
        } else {
            this.f25213a.setXfermode(null);
            canvas.drawBitmap(bitmap, 0.0f, 0.0f, this.f25213a);
        }
