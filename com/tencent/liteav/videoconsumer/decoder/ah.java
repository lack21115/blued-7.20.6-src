...
final /* synthetic */ class ah implements Runnable {
    ...
    private final VideoDecodeController f36752a;
    private final long b;

    /* renamed from: c  reason: collision with root package name */
    private final long f36753c;

    private ah(VideoDecodeController videoDecodeController, long j, long j2) {
        this.f36752a = videoDecodeController;
        this.b = j;
        this.f36753c = j2;
    }
    ...
    public final void run() {
        long j;
        VideoDecodeController videoDecodeController = this.f36752a;
        long j2 = this.b;
        long j3 = this.f36753c;
        if (videoDecodeController.j) {
            ...
            if (dVar.l == 0) {
                LiteavLog.i(dVar.f36779a, "decode first frame success");
            }
            dVar.l = j2;
            dVar.t = 0;
            ...
            if (elapsedRealtime - aVar.b >= TimeUnit.SECONDS.toMillis(1L)) {
                ...
                aVar.f36771c = j / Math.max(aVar.f.size(), 1);
                aVar.f.clear();
            }
            aw.this.b.updateStatus(com.tencent.liteav.videobase.videobase.i.STATUS_VIDEO_DECODER_COST, Long.valueOf(j4));
            long elapsedRealtime2 = SystemClock.elapsedRealtime();
            if (aVar.f36770a == 0) {
                aVar.f36770a = elapsedRealtime2;
            }
            if (elapsedRealtime2 >= aVar.f36770a + TimeUnit.SECONDS.toMillis(1L)) {
                aVar.f36770a = elapsedRealtime2;
                long j6 = aVar.f36771c;
            ...
            if (bVar.f36772a == 0) {
                bVar.f36772a = elapsedRealtime3;
            }
            if (elapsedRealtime3 > bVar.f36772a + TimeUnit.SECONDS.toMillis(1L) && elapsedRealtime3 > bVar.b + TimeUnit.SECONDS.toMillis(2L)) {
                LiteavLog.e("DecodeSmoothStatistics", "frame interval [%d] > %d", Long.valueOf(elapsedRealtime3 - bVar.f36772a), Long.valueOf(TimeUnit.SECONDS.toMillis(1L)));
                bVar.b = elapsedRealtime3;
            }
            bVar.f36772a = elapsedRealtime3;
            awVar.b();
            if (!awVar.g) {
                ...
                LiteavLog.d(awVar.f36768a, "first frame decoded cost time: " + (SystemClock.elapsedRealtime() - awVar.h) + ", before decode first frame received: " + awVar.i);
            }
