...
public final class b {
    ...
    public final VideoDecoderDef.DecodeAbility f36776a;
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final b f36777a = new b((byte) 0);
    }

    private b() {
        this.f36776a = new VideoDecoderDef.DecodeAbility();
        com.tencent.liteav.base.util.j jVar = new com.tencent.liteav.base.util.j();
        this.b = jVar;
        jVar.a(c.a(this));
        synchronized (this) {
            this.f36776a.f36742c = a();
        }
    }
