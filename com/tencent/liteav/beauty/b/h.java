...
public final class h extends com.tencent.liteav.videobase.a.b {
    ...
    public GLConstants.GLScaleType f36383a;
    public boolean b;

    /* renamed from: c  reason: collision with root package name */
    private final Context f36384c;
    ...
    private a i = null;
    private a.InterfaceC0927a j = new a.InterfaceC0927a() { // from class: com.tencent.liteav.beauty.b.h.1
    };
    ...
    public final void onDraw(int i, com.tencent.liteav.videobase.frame.d dVar, FloatBuffer floatBuffer, FloatBuffer floatBuffer2) {
        ...
        if (isInitialized()) {
            ...
            if (this.e == null) {
                this.e = new com.tencent.liteav.videobase.frame.j(this.mOutputSize.f36340a, this.mOutputSize.b);
            }
            if (!this.d.hasTransformParams() && this.d.getPixelBufferType() == GLConstants.PixelBufferType.TEXTURE_2D && this.d.getPixelFormatType() == GLConstants.PixelFormatType.RGBA) {
                ...
                this.e.a(this.d, this.f36383a, a3);
                a2 = a3.a();
            }
            d dVar2 = this.f;
            dVar2.setFloatOnDraw(dVar2.f36374a, this.b ? 1.0f : 0.0f);
    ...
    public final void onUninit() {
        ...
        if (aVar != null) {
            ...
            aVar2.b = true;
            if (aVar2.f36350a != null) {
                aVar2.f36350a.interrupt();
                aVar2.f36350a = null;
            }
            this.h = null;
        }
