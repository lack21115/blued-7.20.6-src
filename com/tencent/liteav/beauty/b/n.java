...
public class n extends com.tencent.liteav.videobase.a.b {
    ...
    public static final class a {
        ...
        public FloatBuffer f22704a = null;
        ...
        public final void a() {
            this.b = null;
            OpenGlUtils.deleteTexture(this.f22705c);
            this.f22705c = -1;
        }
    }
    ...
    private boolean compareWaterMarkList(List<o> list, List<o> list2) {
        ...
        while (true) {
            ...
            if (!oVar.f22706a.equals(oVar2.f22706a) || oVar.b != oVar2.b || oVar.f22707c != oVar2.f22707c || oVar.d != oVar2.d) {
                return false;
            }
            i = i2 + 1;
        }
    ...
    private void setWatermark(Bitmap bitmap, float f, float f2, float f3, int i) {
        ...
        if (aVarArr == null || i >= aVarArr.length || aVarArr[i] == null) {
            ...
            if (aVar.b == null || !aVar.b.equals(bitmap)) {
                if (aVar.f22705c != -1 && aVar.b != null && (aVar.b.getWidth() != bitmap.getWidth() || aVar.b.getHeight() != bitmap.getHeight())) {
                    OpenGlUtils.deleteTexture(aVar.f22705c);
                    aVar.f22705c = -1;
                }
                aVar.f22705c = OpenGlUtils.loadTexture(bitmap, aVar.f22705c, false);
            }
            aVar.b = bitmap;
        }
    }
    ...
    public void calculateOffsetMatrix(int i, int i2, float f, float f2, float f3, int i3) {
        ...
        aVarArr[i3].f22704a = ByteBuffer.allocateDirect(VERTICES_COORDS.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        float[] fArr = new float[VERTICES_COORDS.length];
        fArr[0] = (f * 2.0f) - 1.0f;
        fArr[1] = 1.0f - (f2 * 2.0f);
        fArr[2] = fArr[0];
        fArr[3] = fArr[1] - (((((i2 / i) * f3) * this.mOutputSize.f22649a) / this.mOutputSize.b) * 2.0f);
        ...
        while (true) {
            int i5 = i4;
            if (i5 > 7) {
                this.mRenderObjects[i3].f22704a.put(fArr).position(0);
                return;
            } else {
    ...
    public void onInit(com.tencent.liteav.videobase.frame.e eVar) {
        ...
        if (oVar != null) {
            setWatermark(oVar.f22706a, this.mWatermark.b, this.mWatermark.f22707c, this.mWatermark.d);
        }
    ...
    public void onOutputSizeChanged(int i, int i2) {
        ...
        o oVar = this.mWatermark;
        if (oVar != null && oVar.f22706a != null) {
            calculateOffsetMatrix(this.mWatermark.f22706a.getWidth(), this.mWatermark.f22706a.getHeight(), this.mWatermark.b, this.mWatermark.f22707c, this.mWatermark.d, 0);
        }
        ...
        for (int i3 = 0; i3 < this.mWaterMarkList.size(); i3++) {
            ...
            if (oVar2 != null && oVar2.f22706a != null) {
                calculateOffsetMatrix(oVar2.f22706a.getWidth(), oVar2.f22706a.getHeight(), oVar2.b, oVar2.f22707c, oVar2.d, i3 + this.mBaseMarkOffset);
            }
        }
    }
    ...
    public void setWaterMarkList(List<o> list) {
        ...
        if (this.mRenderObjects != null) {
            ...
            while (true) {
                ...
                OpenGlUtils.deleteTexture(aVarArr[i2].f22705c);
                this.mRenderObjects[i2].f22705c = -1;
                i = i2 + 1;
            }
        }
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            if (oVar != null) {
                ...
                setWatermark(oVar.f22706a, oVar.b, oVar.f22707c, oVar.d, i3 + this.mBaseMarkOffset);
            }
        }
    }
    ...
    public void setWatermark(Bitmap bitmap, float f, float f2, float f3) {
        ...
        this.mWatermark.f22706a = bitmap;
        this.mWatermark.b = f;
        this.mWatermark.f22707c = f2;
