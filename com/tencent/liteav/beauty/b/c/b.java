...
public final class b extends com.tencent.liteav.videobase.a.b {
    ...
    public final boolean canBeSkipped() {
        return ((double) Math.abs(this.f22682c[0])) < 1.0E-5d && ((double) Math.abs(this.f22682c[1])) < 1.0E-5d && ((double) Math.abs(this.f22682c[2])) < 1.0E-5d;
    }

    @Override // com.tencent.liteav.videobase.a.b
    public final void onInit(e eVar) {
        super.onInit(eVar);
        this.f22681a = GLES20.glGetUniformLocation(getProgramId(), "singleStepOffset");
    ...
    public final void onOutputSizeChanged(int i, int i2) {
        ...
        setFloatVec2OnDraw(this.f22681a, new float[]{2.0f / i, 2.0f / i2});
    }
}
