...
public final class ax {
    ...
    CaptureSourceInterface.SourceType f37141a = CaptureSourceInterface.SourceType.NONE;
    VideoProducerDef.ProducerMode b = VideoProducerDef.ProducerMode.AUTO;

    /* renamed from: c  reason: collision with root package name */
    VideoProducerDef.HomeOrientation f37142c = VideoProducerDef.HomeOrientation.UNSET;
    ...
    public static final /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f37143a[VideoProducerDef.ProducerMode.HIGH_QUALITY.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f37143a[VideoProducerDef.ProducerMode.MANUAL.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f37143a[VideoProducerDef.ProducerMode.AUTO.ordinal()] = 4;
    ...
    */
    ...
    private static void a(com.tencent.liteav.base.util.n nVar, com.tencent.liteav.base.util.n nVar2) {
        if (nVar.f36340a > 1920) {
            nVar2.a(nVar);
            return;
        }
        nVar2.f36340a = WBConstants.SDK_NEW_PAY_VERSION;
        nVar2.b = (nVar.b * nVar2.f36340a) / nVar.f36340a;
    }

    private static void b(com.tencent.liteav.base.util.n nVar, com.tencent.liteav.base.util.n nVar2) {
        if (nVar.f36340a > 1280) {
            nVar2.a(nVar);
            return;
        }
        nVar2.f36340a = 1280;
    ...
    private static com.tencent.liteav.base.util.n c(com.tencent.liteav.base.util.n nVar, com.tencent.liteav.base.util.n nVar2) {
        ...
        if (nVar.f36340a <= 0 || nVar.b <= 0) {
            ...
            nVar3.b = nVar2.b;
            nVar3.f36340a = (nVar.f36340a * nVar3.b) / nVar.b;
            return nVar3;
        } else {
            nVar3.f36340a = nVar2.f36340a;
            nVar3.b = (nVar.b * nVar3.f36340a) / nVar.f36340a;
            return nVar3;
        }
    }
    ...
    private com.tencent.liteav.base.util.n e() {
        ...
        if (this.j.f36340a <= 0 || this.j.b <= 0) {
            nVar2.a(h);
        } else {
            nVar2.a(this.j);
        }
        if (this.f37141a == CaptureSourceInterface.SourceType.CAMERA && this.j.f36340a > this.j.b) {
            nVar2.a();
        }
        boolean z = nVar2.b > nVar2.f36340a;
        if (z) {
            nVar2.a();
        }
        int i = AnonymousClass1.f37143a[this.b.ordinal()];
        if (i == 1) {
            nVar.a(nVar2);
        } else if (i != 2) {
            if (i != 3) {
                a(nVar2, nVar);
            } else if (this.i.f36340a <= 0 || this.i.b <= 0) {
                a(nVar2, nVar);
            } else {
                nVar.a(this.i);
                z = false;
            }
        } else if (nVar2.f36340a <= 1920) {
            nVar.f36340a = WBConstants.SDK_NEW_PAY_VERSION;
            nVar.b = (nVar2.b * nVar.f36340a) / nVar2.f36340a;
        } else {
            nVar.a(nVar2);
        }
        if (z) {
    ...
    private com.tencent.liteav.base.util.n f() {
        ...
        if (d.f36340a <= 0 || d.b <= 0) {
            d.a(h);
        }
        if (this.f37141a == CaptureSourceInterface.SourceType.CAMERA && this.e != null && d.f36340a > d.b) {
            d.a();
        }
        boolean z = d.b > d.f36340a;
        if (z) {
            d.a();
        }
        int i = AnonymousClass1.f37143a[this.b.ordinal()];
        ...
        } else if (d.f36340a <= 1920) {
            nVar.f36340a = WBConstants.SDK_NEW_PAY_VERSION;
            nVar.b = (d.b * nVar.f36340a) / d.f36340a;
        } else {
            nVar.a(d);
        }
        if (z) {
        ...
        nVar.f36340a = ((nVar.f36340a + 7) / 8) * 8;
        nVar.b = ((nVar.b + 7) / 8) * 8;
        return nVar;
    }

    public final VideoProducerDef.HomeOrientation a() {
        return this.f37141a == CaptureSourceInterface.SourceType.CAMERA ? this.f37142c : VideoProducerDef.HomeOrientation.UNSET;
    }
    ...
    public final com.tencent.liteav.base.util.n b() {
        ...
        if (e.f36340a > this.l.f36340a || e.b > this.l.b) {
            this.l.a(e);
    ...
    public final com.tencent.liteav.base.util.n c() {
        ...
        if (f.f36340a > this.g.f36340a || f.b > this.g.b) {
            this.g.a(f);
        } else if (Math.abs(f.c() - this.g.c()) > 0.001d) {
            this.g.a(f);
        }
        f.a(this.g);
        if (this.f37141a == CaptureSourceInterface.SourceType.CAMERA && (this.f37142c == VideoProducerDef.HomeOrientation.RIGHT || this.f37142c == VideoProducerDef.HomeOrientation.LEFT)) {
            f.a();
        }
        return f;
    }
    ...
    public final com.tencent.liteav.base.util.n d() {
        ...
        if (nVar2 == null || nVar2.f36340a == 0 || this.j.b == 0) {
            LiteavLog.e("VideoResolutionSupervisor", "encode size is invalid.");
            return nVar;
        }
        nVar.a(this.j);
        if (this.f37141a == CaptureSourceInterface.SourceType.SCREEN) {
            double c2 = this.m.c();
            if (this.k.d()) {
                c2 = this.k.c();
            }
            a(nVar, c2);
            if (this.d != null) {
                boolean z = this.j.f36340a >= this.j.b;
