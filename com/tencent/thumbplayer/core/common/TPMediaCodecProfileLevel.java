...
public final class TPMediaCodecProfileLevel {
    ...
    static {
        ...
        hevcLumaSampleMap.put(256, Integer.valueOf((int) SurfaceControl.FX_SURFACE_MASK));
        hevcLumaSampleMap.put(512, Integer.valueOf((int) SurfaceControl.FX_SURFACE_MASK));
        ...
        vp9LumaSampleMap.put(32, Integer.valueOf((int) SurfaceControl.FX_SURFACE_MASK));
        ...
        vp8LumaSampleMap.put(2, Integer.valueOf((int) SurfaceControl.FX_SURFACE_MASK));
    ...
    public static int getAV1MaxLumaSample(int i) {
        ...
        Integer num2 = num;
        if (num == null) {
            num2 = av1LumaSampleMap.get(8192);
        }
    ...
    public static int getVP8MaxLumaSample(int i) {
        return (vp8LumaSampleMap.containsKey(Integer.valueOf(i)) ? vp8LumaSampleMap.get(Integer.valueOf(i)) : vp8LumaSampleMap.get(2)).intValue();
    }
