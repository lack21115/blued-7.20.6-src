...
/* loaded from: source-8829756-dex2jar.jar:com/tencent/thumbplayer/api/proxy/TPProxyEnum.class */
public class TPProxyEnum {
    ...
    /* loaded from: source-8829756-dex2jar.jar:com/tencent/thumbplayer/api/proxy/TPProxyEnum$TP_DLTYPE.class */
    public @interface TP_DLTYPE {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8829756-dex2jar.jar:com/tencent/thumbplayer/api/proxy/TPProxyEnum$TP_PROXY_EVENTID.class */
    public @interface TP_PROXY_EVENTID {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: source-8829756-dex2jar.jar:com/tencent/thumbplayer/api/proxy/TPProxyEnum$TP_TASK_TYPE.class */
