...
public final class QjsR0 extends ucT3w implements Cloneable {
    ...
    public static Map<String, String> f39910a;
    public static Map<Integer, Integer> b;

    /* renamed from: c  reason: collision with root package name */
    public static Map<String, String> f39911c;
    ...
    public final void a(nyvKz nyvkz) {
        ...
        this.h = (Map) nyvkz.a((nyvKz) f39910a, 3, true);
        this.i = (Map) nyvkz.a((nyvKz) b, 4, true);
        this.j = nyvkz.a(this.j, 5, true);
        this.k = (Map) nyvkz.a((nyvKz) f39911c, 6, false);
    }
