...
public interface s5pTT extends IInterface {
    ...
    public static abstract class spXPg extends Binder implements s5pTT {
        ...
        public static final String f39988a = kC0XR.a(kC0XR.M0);
        ...
        public static final class C1063spXPg implements s5pTT {

            /* renamed from: a  reason: collision with root package name */
            public IBinder f39989a;

            public C1063spXPg(IBinder iBinder) {
                this.f39989a = iBinder;
            }
            ...
            public final boolean a() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(spXPg.f39988a);
                    obtain.writeInt(2000);
                    boolean z = false;
                    this.f39989a.transact(3, obtain, obtain2, 0);
            ...
            public final int b() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(spXPg.f39988a);
                    this.f39989a.transact(12, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final int c() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(spXPg.f39988a);
                    obtain.writeInt(2000);
                    this.f39989a.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt();
                } finally {
                    obtain2.recycle();
            ...
            public final SWw7W d() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(spXPg.f39988a);
                    obtain.writeInt(2000);
                    this.f39989a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final int e() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(spXPg.f39988a);
                    obtain.writeInt(2000);
                    this.f39989a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt();
                } finally {
                    obtain2.recycle();
