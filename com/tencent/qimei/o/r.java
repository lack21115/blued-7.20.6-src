...
public final class r implements Runnable {
    ...
    public static final Map<String, r> f24700a = new ConcurrentHashMap();
    public b d;
    public long f;
    public long g;
    public String i;
    ...
    public static class a {
        ...
        public final InterfaceC0807a b;

        /* renamed from: c  reason: collision with root package name */
        public AtomicInteger f24703c = new AtomicInteger();
        ...
        public a(int i, InterfaceC0807a interfaceC0807a) {
            this.f24702a = i;
    ...
    public static r a(String str, b bVar) {
        ...
        synchronized (r.class) {
            try {
                r rVar2 = f24700a.get(str);
                rVar = rVar2;
                if (rVar2 == null) {
                    rVar = new r(str);
                    rVar.d = bVar;
                    f24700a.put(str, rVar);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static /* synthetic */ void b(r rVar) {
        String str = rVar.i;
        int nextInt = com.tencent.qimei.s.e.f24722a.nextInt(101);
    ...
    public final void a(String str, int i, String str2) {
        a aVar = this.j;
        boolean z = true;
        if (aVar.f24703c.get() < aVar.f24702a - 1) {
            z = false;
        }
        if (z) {
            String str3 = this.i;
            com.tencent.qimei.n.c a2 = com.tencent.qimei.n.i.a().a(com.tencent.qimei.n.e.REPORT_QM_ERROR_CODE.K, str.equals("451") ? "1001" : Constants.DEFAULT_UIN).a(com.tencent.qimei.n.e.REPORT_QM_ERROR_DESC.K, "error code: " + i + ", msg:" + str2);
            a2.f24665a = str3;
            a2.f24666c = "/report";
    ...
    public final void a(String str, String str2) {
        ...
        if (d == null || d.isEmpty()) {
            String str3 = this.i;
            com.tencent.qimei.n.c a3 = com.tencent.qimei.n.i.a().a(com.tencent.qimei.n.e.REPORT_QM_ERROR_CODE.K, "1002");
        ...
        l a5 = l.a(this.i);
        Qimei qimei = a5.f24690c;
        a5.b(d);
        Qimei qimei2 = a5.f24690c;
        boolean z = a5.g;
        ...
        Qimei qimei3 = l.a(this.i).f24690c;
    ...
    public final void c() {
        ...
        a aVar = this.j;
        aVar.f24703c.getAndIncrement();
        boolean z = aVar.f24703c.get() >= aVar.f24702a;
        if (z) {
            aVar.f24703c.set(0);
            a.InterfaceC0807a interfaceC0807a = aVar.b;
            if (interfaceC0807a != null) {
                n nVar = (n) interfaceC0807a;
                if (!com.tencent.qimei.v.d.a(nVar.f24696a.i).u().isEmpty()) {
                    nVar.f24696a.h = true;
                    com.tencent.qimei.b.a.a().a(10000L, nVar.f24696a);
                }
            }
        }
        if (z) {
