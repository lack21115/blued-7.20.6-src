...
public class w {
    ...
    public static final Map<String, w> f38400a = new ConcurrentHashMap();
    public final String b;

    /* renamed from: c  reason: collision with root package name */
    public final Object f38401c = new Object();
    ...
    public static w a(String str) {
        ...
        synchronized (w.class) {
            try {
                w wVar2 = f38400a.get(str);
                wVar = wVar2;
                if (wVar2 == null) {
                    wVar = new w(str);
                    f38400a.put(str, wVar);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final String a() {
        ...
        String a2 = m.f38382a.a(com.tencent.qimei.j.a.a(), this.b, i, jSONObject.toString());
