...
public class g {
    ...
    j.a f39055a = new j.a() { // from class: com.tencent.tendinsv.tool.g.1
        ...
        public void a(Activity activity) {
            try {
                g.this.k.execute(new Runnable() { // from class: com.tencent.tendinsv.tool.g.1.1
                    ...
                    public void run() {
                        g.this.l = t.b(g.this.f39056c, t.u, 100L);
    ...
    public void a(e eVar, boolean z) {
        if (com.tencent.tendinsv.b.av) {
            try {
                ...
                fVar.g = Build.MODEL;
                fVar.h = Build.BRAND;
                fVar.i = t.b(this.f39056c, t.V, (String) null);
                fVar.f39053a = com.tencent.tendinsv.utils.a.a(fVar.i);
                eVar.f39051a = fVar.f39053a;
                t.a(this.f39056c, "DID", fVar.f39053a);
                eVar.w = com.tencent.tendinsv.utils.a.a(eVar.f39051a + eVar.b + eVar.f39052c + eVar.d + eVar.f + eVar.l + eVar.m + eVar.r + eVar.s + eVar.t + eVar.u);
                long b2 = t.b(this.f39056c, t.s, 1L);
                long j = b2;
                if (b2 == 1) {
                    t.a(this.f39056c, t.s, System.currentTimeMillis());
                    j = System.currentTimeMillis();
                }
                long b3 = t.b(this.f39056c, t.t, 600L);
                if (b3 == -1) {
                    return;
                }
                if (b3 == 0) {
                ...
                if (("4".equals(eVar.l) && 4 == eVar.m) || (("4".equals(eVar.l) && eVar.q == 0) || 11 == eVar.m || System.currentTimeMillis() > j + (b3 * 1000))) {
                    this.l = t.b(this.f39056c, t.u, 100L);
                    if (this.e.b() > 0) {
    ...
    public void a(final String str, final boolean z, String str2) {
        this.i = t.b(this.f39056c, t.M, 10000);
        String b2 = t.b(this.f39056c, "appId", "");
        if (!com.tencent.tendinsv.utils.d.b(b2)) {
            b2 = this.d;
        }
        String b3 = t.b(this.f39056c, t.N, "0MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAJaqWkyQhbQ6EbYBFaxhfblDc3wmzSV27D/CncV6b1dG9DW/9rPqKLP9TvpcxA8OTgQR/WZ1YKwtcHJurR83spkCAwEAAQ==");
        String str3 = str2;
        if (com.tencent.tendinsv.utils.d.a(str2)) {
            str3 = com.tencent.tendinsv.utils.b.a();
        }
        String a2 = h.a(this.f39056c);
        String b4 = h.b(this.f39056c);
        if (com.tencent.tendinsv.utils.d.b(b2)) {
            final String str4 = str3;
            new com.tencent.tendinsv.d.b(com.tencent.tendinsv.b.C, this.f39056c).a(com.tencent.tendinsv.d.g.a().b(b2, str3, str, a2, b4), new com.tencent.tendinsv.d.a() { // from class: com.tencent.tendinsv.tool.g.3
    ...
    public void c() {
        try {
            ...
            this.f.addAll(this.e.a(String.valueOf(t.b(this.f39056c, t.u, 100L))));
            ArrayList arrayList = new ArrayList();
            this.g = arrayList;
        ...
        this.k.execute(new Runnable() { // from class: com.tencent.tendinsv.tool.g.2
            ...
            public void run() {
                try {
                    e eVar = new e();
                    eVar.b = str3;
                    eVar.f39052c = com.tencent.tendinsv.b.ap;
                    ...
                    if (1 == i3) {
                        ...
                        eVar.g = t.b(g.this.f39056c, "uuid", "");
                    }
                    eVar.h = d.a().b();
                    eVar.i = k.a().b();
                    ...
                    if (!"cache".equals(str2) && !"check_error".equals(str2) && (1 != i4 || i5 != 0 || i3 == 4)) {
                        ...
                        long b2 = t.b(g.this.f39056c, t.t, 600L);
                        if (b2 == -1 || b2 == 0) {
                            return;
                        }
                        long parseLong = Long.parseLong(t.b(g.this.f39056c, t.O, Camera.Parameters.VIDEO_HFR_4X));
                        if (parseLong > 0) {
    ...
    public void b() {
        try {
            if (com.tencent.tendinsv.b.av && com.tencent.tendinsv.b.aB) {
                long b2 = t.b(this.f39056c, t.t, 600L);
                String b3 = t.b(this.f39056c, t.P, "1");
                if (b2 == -1 || b2 == 0 || !"1".equals(b3)) {
                    return;
                }
                com.tencent.tendinsv.utils.j.a().b((Application) this.f39056c, this.f39055a);
                com.tencent.tendinsv.utils.j.a().a((Application) this.f39056c, this.f39055a);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
