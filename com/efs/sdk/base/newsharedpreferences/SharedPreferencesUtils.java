...
/* loaded from: source-7206380-dex2jar.jar:com/efs/sdk/base/newsharedpreferences/SharedPreferencesUtils.class */
public class SharedPreferencesUtils {
    private static final HashMap<String, SharedPreferencesWrapper> sSpCache = new HashMap<>();

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: source-7206380-dex2jar.jar:com/efs/sdk/base/newsharedpreferences/SharedPreferencesUtils$SharedPreferencesWrapper.class */
    ...
    private static SharedPreferences getNewSharedPreferences(Context context, String str, boolean z, boolean z2) {
        ...
        synchronized (sSpCache) {
            SharedPreferencesWrapper sharedPreferencesWrapper2 = sSpCache.get(str);
        ...
        if (sharedPreferencesWrapper.mSharedPreferences == null) {
            synchronized (sharedPreferencesWrapper) {
                try {
                    ...
                    SharedPreferencesWrapper sharedPreferencesWrapper3 = sharedPreferencesWrapper;
                }
            }
        }
    ...
    private static void handleReplace(Context context, String str, boolean z) {
