...
/* loaded from: source-4181928-dex2jar.jar:com/android/internal/telephony/TelephonyProperties.class */
public interface TelephonyProperties {
    ...
    public static final String PROPERTY_APN_RUIM_OPERATOR_NUMERIC = "net.cdma.ruim.operator.numeric";
    ...
    public static final String PROPERTY_IMS_AUDIO_OUTPUT = "persist.radio.ims.audio.output";
    ...
    public static final String PROPERTY_LTE_ON_GSM_DEVICE = "telephony.lteOnGsmDevice";
    ...
    public static final String PROPERTY_RUIM_OMH_CARD = "ril.cdma.omhcard";
