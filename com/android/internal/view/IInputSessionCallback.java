...
/* loaded from: source-4181928-dex2jar.jar:com/android/internal/view/IInputSessionCallback.class */
public interface IInputSessionCallback extends IInterface {

    /* loaded from: source-4181928-dex2jar.jar:com/android/internal/view/IInputSessionCallback$Stub.class */
    public static abstract class Stub extends Binder implements IInputSessionCallback {
        ...
        /* loaded from: source-4181928-dex2jar.jar:com/android/internal/view/IInputSessionCallback$Stub$Proxy.class */
        ...
        public static IInputSessionCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IInputSessionCallback)) ? new Proxy(iBinder) : (IInputSessionCallback) queryLocalInterface;
        }
