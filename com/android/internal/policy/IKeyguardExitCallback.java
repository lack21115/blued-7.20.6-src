...
/* loaded from: source-4181928-dex2jar.jar:com/android/internal/policy/IKeyguardExitCallback.class */
public interface IKeyguardExitCallback extends IInterface {

    /* loaded from: source-4181928-dex2jar.jar:com/android/internal/policy/IKeyguardExitCallback$Stub.class */
    public static abstract class Stub extends Binder implements IKeyguardExitCallback {
        ...
        /* loaded from: source-4181928-dex2jar.jar:com/android/internal/policy/IKeyguardExitCallback$Stub$Proxy.class */
        ...
        public static IKeyguardExitCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IKeyguardExitCallback)) ? new Proxy(iBinder) : (IKeyguardExitCallback) queryLocalInterface;
        }
