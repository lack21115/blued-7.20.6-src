...
/* loaded from: source-4181928-dex2jar.jar:com/android/internal/policy/IKeyguardStateCallback.class */
public interface IKeyguardStateCallback extends IInterface {

    /* loaded from: source-4181928-dex2jar.jar:com/android/internal/policy/IKeyguardStateCallback$Stub.class */
    public static abstract class Stub extends Binder implements IKeyguardStateCallback {
        ...
        static final int TRANSACTION_onShowingStateChanged_0 = 1;
        static final int TRANSACTION_onSimSecureStateChanged_1 = 2;

        /* loaded from: source-4181928-dex2jar.jar:com/android/internal/policy/IKeyguardStateCallback$Stub$Proxy.class */
        ...
        public static IKeyguardStateCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IKeyguardStateCallback)) ? new Proxy(iBinder) : (IKeyguardStateCallback) queryLocalInterface;
        }
