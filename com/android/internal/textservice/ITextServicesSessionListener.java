...
/* loaded from: source-4181928-dex2jar.jar:com/android/internal/textservice/ITextServicesSessionListener.class */
public interface ITextServicesSessionListener extends IInterface {

    /* loaded from: source-4181928-dex2jar.jar:com/android/internal/textservice/ITextServicesSessionListener$Stub.class */
    public static abstract class Stub extends Binder implements ITextServicesSessionListener {
        ...
        /* loaded from: source-4181928-dex2jar.jar:com/android/internal/textservice/ITextServicesSessionListener$Stub$Proxy.class */
        ...
        public static ITextServicesSessionListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ITextServicesSessionListener)) ? new Proxy(iBinder) : (ITextServicesSessionListener) queryLocalInterface;
        }
