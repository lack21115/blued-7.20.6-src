...
/* loaded from: source-273268-dex2jar.jar:com/android/org/conscrypt/OpenSSLRSAPublicKey.class */
public class OpenSSLRSAPublicKey implements RSAPublicKey, OpenSSLKeyHolder {
    ...
    private void ensureReadParams() {
        ...
        byte[][] bArr = NativeCrypto.get_RSA_public_params(this.key.getPkeyContext());
