...
/* loaded from: source-4181928-dex2jar.jar:com/android/ims/internal/IImsEcbmListener.class */
public interface IImsEcbmListener extends IInterface {

    /* loaded from: source-4181928-dex2jar.jar:com/android/ims/internal/IImsEcbmListener$Stub.class */
    public static abstract class Stub extends Binder implements IImsEcbmListener {
        ...
        static final int TRANSACTION_enteredECBM_0 = 1;
        static final int TRANSACTION_exitedECBM_1 = 2;

        /* loaded from: source-4181928-dex2jar.jar:com/android/ims/internal/IImsEcbmListener$Stub$Proxy.class */
        ...
        public static IImsEcbmListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IImsEcbmListener)) ? new Proxy(iBinder) : (IImsEcbmListener) queryLocalInterface;
        }
