...
/* loaded from: source-7994992-dex2jar.jar:com/igexin/assist/control/honor/ManufacturePushManager.class */
public class ManufacturePushManager implements AbstractPushManager {
    ...
    public void turnOnPush(Context context) {
        HonorPushClient.getInstance().turnOffNotificationCenter(new HonorPushCallback<Void>() { // from class: com.igexin.assist.control.honor.ManufacturePushManager.2
            @Override // com.hihonor.push.sdk.HonorPushCallback
            public void onFailure(int i, String str) {
