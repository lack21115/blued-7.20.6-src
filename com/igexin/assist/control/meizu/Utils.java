...
/* loaded from: source-7994992-dex2jar.jar:com/igexin/assist/control/meizu/Utils.class */
public class Utils {
    public static String getAppIdByBuildConfig(ApplicationInfo applicationInfo) {
        try {
            ...
            return (String) cls.getField("MEIZU_APP_ID").get(cls);
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    ...
    public static String getAppKeyByBuildConfig(ApplicationInfo applicationInfo) {
        try {
            ...
            Class<?> cls = Class.forName(str + ".BuildConfig");
            return (String) cls.getField("MEIZU_APP_KEY").get(cls);
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
