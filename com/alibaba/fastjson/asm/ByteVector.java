...
/* loaded from: source-6737240-dex2jar.jar:com/alibaba/fastjson/asm/ByteVector.class */
public class ByteVector {
    ...
    private void enlarge(int i) {
        ...
        System.arraycopy((Object) this.data, 0, (Object) bArr, 0, this.length);
        this.data = bArr;
    }
    ...
    public ByteVector putByteArray(byte[] bArr, int i, int i2) {
        ...
        if (bArr != null) {
            System.arraycopy((Object) bArr, i, (Object) this.data, this.length, i2);
        }
        this.length += i2;
        return this;
    }
