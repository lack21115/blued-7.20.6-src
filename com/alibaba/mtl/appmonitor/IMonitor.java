...
/* loaded from: source-6737240-dex2jar.jar:com/alibaba/mtl/appmonitor/IMonitor.class */
public interface IMonitor extends IInterface {

    /* loaded from: source-6737240-dex2jar.jar:com/alibaba/mtl/appmonitor/IMonitor$Stub.class */
    public static abstract class Stub extends Binder implements IMonitor {
        ...
        public static IMonitor asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMonitor)) ? new a(iBinder) : (IMonitor) queryLocalInterface;
        }
