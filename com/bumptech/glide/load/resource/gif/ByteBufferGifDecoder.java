...
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, GifDrawable> {
    ...
    private static final GifDecoderFactory f20987a = new GifDecoderFactory();
    private static final GifHeaderParserPool b = new GifHeaderParserPool();

    /* renamed from: c  reason: collision with root package name */
    private final Context f20988c;
    ...
    public static class GifHeaderParserPool {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Queue<GifHeaderParser> f20989a = Util.a(0);
        ...
        GifHeaderParser a(ByteBuffer byteBuffer) {
            GifHeaderParser a2;
            synchronized (this) {
                GifHeaderParser poll = this.f20989a.poll();
        ...
        void a(GifHeaderParser gifHeaderParser) {
            synchronized (this) {
                gifHeaderParser.a();
                this.f20989a.offer(gifHeaderParser);
            }
        }
    }

    public ByteBufferGifDecoder(Context context, List<ImageHeaderParser> list, BitmapPool bitmapPool, ArrayPool arrayPool) {
        this(context, list, bitmapPool, arrayPool, b, f20987a);
    }
    ...
    private GifDrawableResource a(ByteBuffer byteBuffer, int i, int i2, GifHeaderParser gifHeaderParser, Options options) {
        ...
        try {
            ...
            if (b2.c() > 0 && b2.d() == 0) {
                Bitmap.Config config = options.a(GifOptions.f21000a) == DecodeFormat.PREFER_RGB_565 ? Bitmap.Config.RGB_565 : Bitmap.Config.ARGB_8888;
                ...
                GifDrawableResource gifDrawableResource = new GifDrawableResource(new GifDrawable(this.f20988c, a3, UnitTransformation.a(), i, i2, i3));
