...
/* loaded from: source-7206380-dex2jar.jar:com/bytedance/pangle/service/PluginService.class */
public abstract class PluginService extends Service implements a {
    ...
    protected Object createActivityManagerProxy() {
        return Proxy.newProxyInstance(getClassLoader(), new Class[]{Class.forName(IActivityManager.descriptor)}, new InvocationHandler() { // from class: com.bytedance.pangle.service.PluginService.1
