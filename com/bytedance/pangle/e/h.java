...
public final class h implements Closeable {
    ...
    private final FileInputStream f7781a;
    private a b;
    ...
    static final class a {
        ...
        private a(FileChannel fileChannel) {
            this.f7783a = new byte[16];
            fileChannel.position(0L);
            fileChannel.read(ByteBuffer.wrap(this.f7783a));
            byte[] bArr = this.f7783a;
            if (bArr[0] != Byte.MAX_VALUE || bArr[1] != 69 || bArr[2] != 76 || bArr[3] != 70) {
                throw new IOException(String.format("bad elf magic: %x %x %x %x.", Byte.valueOf(this.f7783a[0]), Byte.valueOf(this.f7783a[1]), Byte.valueOf(this.f7783a[2]), Byte.valueOf(this.f7783a[3])));
            }
            byte b = bArr[4];
            h.a(b, 2, "bad elf class: " + ((int) this.f7783a[4]));
            byte b2 = this.f7783a[5];
            h.a(b2, 2, "bad elf data encoding: " + ((int) this.f7783a[5]));
            ByteBuffer allocate = ByteBuffer.allocate(this.f7783a[4] == 1 ? 36 : 48);
            allocate.order(this.f7783a[5] == 1 ? ByteOrder.LITTLE_ENDIAN : ByteOrder.BIG_ENDIAN);
            h.b(fileChannel, allocate, "failed to read rest part of ehdr.");
            this.b = allocate.getShort();
            this.f7784c = allocate.getShort();
            int i = allocate.getInt();
            this.d = i;
            h.a(i, 1, "bad elf version: " + this.d);
            byte b3 = this.f7783a[4];
            if (b3 == 1) {
                this.e = allocate.getInt();
                this.f = allocate.getInt();
                this.g = allocate.getInt();
            } else if (b3 != 2) {
                throw new IOException("Unexpected elf class: " + ((int) this.f7783a[4]));
            } else {
    ...
    static final class b {
        ...
        private b(ByteBuffer byteBuffer, int i) {
            if (i == 1) {
                this.f7785a = byteBuffer.getInt();
                this.f7786c = byteBuffer.getInt();
                ...
                this.f7785a = byteBuffer.getInt();
                this.b = byteBuffer.getInt();
                this.f7786c = byteBuffer.getLong();
    ...
    static final class c {
        ...
        private c(ByteBuffer byteBuffer, int i) {
            if (i == 1) {
                this.f7787a = byteBuffer.getInt();
                this.b = byteBuffer.getInt();
                this.f7788c = byteBuffer.getInt();
                this.d = byteBuffer.getInt();
                this.e = byteBuffer.getInt();
                this.f = byteBuffer.getInt();
                this.g = byteBuffer.getInt();
                ...
                this.f7787a = byteBuffer.getInt();
                this.b = byteBuffer.getInt();
                this.f7788c = byteBuffer.getLong();
                this.d = byteBuffer.getLong();
                this.e = byteBuffer.getLong();
                this.f = byteBuffer.getLong();
                this.g = byteBuffer.getInt();
    ...
    private h(File file) {
        ...
        this.f7781a = fileInputStream;
        FileChannel channel = fileInputStream.getChannel();
        this.b = new a(channel, (byte) 0);
        ByteBuffer allocate = ByteBuffer.allocate(128);
        allocate.limit(this.b.j);
        allocate.order(this.b.f7783a[5] == 1 ? ByteOrder.LITTLE_ENDIAN : ByteOrder.BIG_ENDIAN);
        channel.position(this.b.f);
        this.f7782c = new b[this.b.k];
        int i = 0;
        while (true) {
            int i2 = i;
            if (i2 >= this.f7782c.length) {
                break;
            }
            b(channel, allocate, "failed to read phdr.");
            this.f7782c[i2] = new b(allocate, this.b.f7783a[4], (byte) 0);
            i = i2 + 1;
        }
        ...
        while (true) {
            ...
            this.d[i4] = new c(allocate, this.b.f7783a[4], (byte) 0);
            i3 = i4 + 1;
        }
        if (this.b.n <= 0) {
            return;
        ...
        this.f7781a.getChannel().position(cVar.e);
        b(this.f7781a.getChannel(), allocate2, "failed to read section: " + cVar.k);
        c[] cVarArr = this.d;
        ...
        while (true) {
            ...
            c cVar2 = cVarArr[i6];
            allocate2.position(cVar2.f7787a);
            cVar2.k = a(allocate2);
