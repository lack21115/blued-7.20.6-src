...
public class b1 {
    ...
    public b1(String str, m0 m0Var) {
        ...
        this.f21196a = str;
        this.f21197c = 0;
        if (System.currentTimeMillis() - m0Var.e.getLong(a.a(new StringBuilder(), this.f21196a, "downgrade_time"), 0L) < 10800000) {
            SharedPreferences sharedPreferences = this.b.e;
            this.f21197c = sharedPreferences.getInt(this.f21196a + "downgrade_index", 0);
            return;
        }
        SharedPreferences.Editor edit = this.b.e.edit();
        SharedPreferences.Editor remove = edit.remove(this.f21196a + "downgrade_time");
        remove.remove(this.f21196a + "downgrade_index").apply();
    }
