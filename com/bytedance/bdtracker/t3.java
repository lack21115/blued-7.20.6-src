...
public final class t3 {
    ...
    public Map<String, String> a() {
        ...
        r3.a(hashMap, "id", this.f7706a);
        r3.a(hashMap, "req_id", this.b);
        r3.a(hashMap, "is_track_limited", String.valueOf(this.f7707c));
    ...
    public JSONObject b() {
        ...
        r3.a(jSONObject, "id", this.f7706a);
        r3.a(jSONObject, "req_id", this.b);
        r3.a(jSONObject, "is_track_limited", this.f7707c);
