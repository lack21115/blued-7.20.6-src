...
public final class g2 {
    ...
    public void addHeaderInfo(String str, String str2) {
        ...
        b.b(this.f7615a).setHeaderInfo(str, str2);
    }

    @JavascriptInterface
    public String getABTestConfigValueForKey(String str, String str2) {
        z2.a("bridge:getABTestConfigValueForKey: {}, {}", str, str2);
        return (String) b.b(this.f7615a).getAbConfig(str, str2);
    }

    @JavascriptInterface
    public String getAbSdkVersion() {
        z2.a("bridge:getAbSdkVersion");
        return b.b(this.f7615a).getAbSdkVersion();
    }

    @JavascriptInterface
    public String getAppId() {
        return TextUtils.isEmpty(this.f7615a) ? AppLog.getAppId() : this.f7615a;
    }

    @JavascriptInterface
    public String getClientUdid() {
        z2.a("bridge:getClientUdid");
        return b.b(this.f7615a).getClientUdid();
    }

    @JavascriptInterface
    public String getIid() {
        z2.a("bridge:getIid");
        return b.b(this.f7615a).getIid();
    }

    @JavascriptInterface
    public String getOpenUdid() {
        z2.a("bridge:getOpenUdid");
        return b.b(this.f7615a).getOpenUdid();
    }

    @JavascriptInterface
    public String getSsid() {
        z2.a("bridge:getSsid");
        return b.b(this.f7615a).getSsid();
    }

    @JavascriptInterface
    public String getUdid() {
        z2.a("bridge:getUdid");
        return b.b(this.f7615a).getUdid();
    }

    @JavascriptInterface
    public String getUuid() {
        z2.a("bridge:getUuid");
        return b.b(this.f7615a).getUserUniqueID();
    }
    ...
    public void setHeaderInfo(String str) {
        ...
        if (TextUtils.isEmpty(str) || str.equals("undefined")) {
            b.b(this.f7615a).setHeaderInfo(null);
            return;
        }
        ...
        b.b(this.f7615a).setHeaderInfo(hashMap);
    }
    ...
    */
    ...
    public void setUserUniqueId(String str) {
        ...
        b.b(this.f7615a).setUserUniqueID(str);
    }
}
