...
public class l1 {
    ...
    public static class a {
        ...
        public JSONObject a() {
            try {
                ...
                jSONObject.put("x", this.f21248a);
                jSONObject.put("y", this.b);
                jSONObject.put("width", this.f21249c);
        ...
        public String toString() {
            ...
            a2.append(this.f21248a);
            a2.append(", y=");
            a2.append(this.b);
            a2.append(", width=");
            a2.append(this.f21249c);
            a2.append(", height=");
            a2.append(this.d);
            a2.append('}');
            return a2.toString();
    ...
    public static class b {
        ...
        public String toString() {
            ...
            a2.append(this.f21250a);
            a2.append('\'');
            a2.append(", frameModel=");
            a2.append(this.b);
            a2.append(", elementPath='");
            a2.append(this.f21251c);
            a2.append('\'');
