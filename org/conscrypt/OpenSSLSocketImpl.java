...
/* loaded from: source-3503164-dex2jar.jar:org/conscrypt/OpenSSLSocketImpl.class */
public abstract class OpenSSLSocketImpl extends AbstractConscryptSocket {
    ...
    public final void setAlpnProtocols(byte[] bArr) {
        ...
        setApplicationProtocols(SSLUtils.decodeProtocols(bArr2));
    }
    ...
    public final void setAlpnProtocols(String[] strArr) {
        ...
        if (strArr == null) {
            strArr2 = EmptyArray.STRING;
        }
        setApplicationProtocols(strArr2);
    }
