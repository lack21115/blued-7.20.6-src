...
/* loaded from: source-3503164-dex2jar.jar:org/conscrypt/ct/CertificateEntry.class */
public class CertificateEntry {
    private final byte[] certificate;
    private final LogEntryType entryType;
    private final byte[] issuerKeyHash;

    /* loaded from: source-3503164-dex2jar.jar:org/conscrypt/ct/CertificateEntry$LogEntryType.class */
