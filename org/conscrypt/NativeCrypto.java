...
/* loaded from: source-3503164-dex2jar.jar:org/conscrypt/NativeCrypto.class */
public final class NativeCrypto {
    ...
    /* loaded from: source-3503164-dex2jar.jar:org/conscrypt/NativeCrypto$Range.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: source-3503164-dex2jar.jar:org/conscrypt/NativeCrypto$SSLHandshakeCallbacks.class */
    ...
    private static int X509_NAME_hash(X500Principal x500Principal, String str) {
        try {
            ...
            byte b = digest[0];
            return ((digest[3] & 255) << 24) | ((digest[1] & 255) << 8) | ((b & 255) << 0) | ((digest[2] & 255) << 16);
    ...
    public static String[] checkEnabledCipherSuites(String[] strArr) {
        ...
        while (true) {
            ...
            } else if (!strArr[i2].equals("TLS_EMPTY_RENEGOTIATION_INFO_SCSV") && !strArr[i2].equals("TLS_FALLBACK_SCSV") && !SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.contains(strArr[i2]) && !SUPPORTED_LEGACY_CIPHER_SUITES_SET.contains(strArr[i2])) {
    ...
    public static String[] getSupportedCipherSuites() {
        return SSLUtils.concat(new String[]{SUPPORTED_TLS_1_3_CIPHER_SUITES, (String[]) SUPPORTED_TLS_1_2_CIPHER_SUITES.clone()});
    }
