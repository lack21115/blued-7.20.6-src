...
/* loaded from: source-3503164-dex2jar.jar:org/conscrypt/OpenSSLECPrivateKey.class */
    ...
    public static OpenSSLKey wrapJCAPrivateKeyForTLSStackOnly(PrivateKey privateKey, ECParameterSpec eCParameterSpec) throws InvalidKeyException {
        ...
        if (eCParameterSpec == null) {
            ...
            if (privateKey instanceof ECKey) {
                eCParameterSpec2 = ((ECKey) privateKey).getParams();
            }
        }
        ...
        try {
            return new OpenSSLKey(NativeCrypto.getECPrivateKeyWrapper(privateKey, OpenSSLECGroupContext.getInstance(eCParameterSpec2).getNativeRef()), true);
        } catch (InvalidAlgorithmParameterException e) {
            throw new InvalidKeyException("Invalid EC parameters: " + eCParameterSpec2);
        }
    }
