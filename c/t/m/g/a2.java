...
public class a2 {
    ...
    public static void a(z1 z1Var, z1 z1Var2, z1 z1Var3) {
        ...
        if (i == i2) {
            int i3 = z1Var.f4024c;
            int i4 = z1Var2.f4024c;
            if (i3 == i4 && i2 == z1Var3.b && i4 == z1Var3.f4024c) {
                int i5 = 0;
                while (true) {
                    int i6 = i5;
                    if (i6 >= z1Var.b) {
                    ...
                    while (true) {
                        int i8 = i7;
                        if (i8 < z1Var.f4024c) {
                            z1Var.f4023a[i6][i8] = z1Var2.f4023a[i6][i8] * z1Var3.f4023a[i6][i8];
                            i7 = i8 + 1;
                        }
                    }
                    i5 = i6 + 1;
    ...
    public static void b(z1 z1Var, z1 z1Var2, z1 z1Var3) {
        ...
        if (z1Var.b != z1Var2.b || z1Var.f4024c != z1Var3.f4024c || z1Var2.f4024c != z1Var3.b) {
            a();
            throw null;
        }
        int i = 0;
            ...
            while (true) {
                ...
                if (i4 < z1Var.f4024c) {
                    ...
                    while (true) {
                        int i6 = i5;
                        if (i6 < z1Var2.f4024c) {
                            d += z1Var2.f4023a[i2][i6] * z1Var3.f4023a[i6][i4];
                            i5 = i6 + 1;
                        }
                    }
                    z1Var.f4023a[i2][i4] = d;
                    i3 = i4 + 1;
                }
            }
            i = i2 + 1;
