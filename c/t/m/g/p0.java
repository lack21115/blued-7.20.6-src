...
public class p0 {
    ...
    public void a(String str) {
        synchronized (this.f3915a) {
            ...
            while (true) {
                int i2 = i;
                if (i2 < length) {
                    m2.a(this.f3916c, aVarArr[i2].a(str), true);
                    i = i2 + 1;
                }
            }
        }
    ...
    public void a(byte[] bArr) {
        synchronized (this.f3915a) {
            if (bArr != null) {
                System.arraycopy((Object) bArr, 0, (Object) this.f3916c, 0, Math.min(bArr.length, this.f3916c.length));
            }
        }
    }
    ...
    public boolean b(String str) {
        synchronized (this.f3915a) {
            ...
            while (true) {
                ...
                if (!m2.a(this.f3916c, aVarArr[i2].a(str))) {
                    return false;
                }
                i = i2 + 1;
            }
