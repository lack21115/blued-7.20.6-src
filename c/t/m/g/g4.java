...
public class g4 {
    ...
    public class b extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            int i;
            String str;
            if (message.what == 1 && (l6Var = (l6) k6.a(g4.this.f3771a).a()) != null) {
                if (l6Var == l6.k) {
                    str = "ERROR_NETWORK";
                    i = 1;
                } else {
                ...
                g4.this.f3772c.sendEmptyMessageDelayed(1, 1000L);
            }
        }
    }
    ...
    public int a(int i, TencentLocationListener tencentLocationListener) {
        ...
        if (i == 10) {
            ...
            return TencentLocationManager.getInstance(this.f3771a.f3944a).requestSingleFreshLocation(create, tencentLocationListener, Looper.getMainLooper());
        } else if (i == 12) {
            ...
            return TencentLocationManager.getInstance(this.f3771a.f3944a).requestLocationUpdates(create2, tencentLocationListener, Looper.getMainLooper());
        } else {
            if (i != 11) {
                i2 = 0;
            } else if (!k6.a(this.f3771a).b()) {
                return -1;
            } else {
                this.b = tencentLocationListener;
                int a2 = k6.a(this.f3771a).a(TencentLocationManager.DR_TYPE_WALK);
                i2 = a2;
                if (a2 == 0) {
                    if (this.d == 0) {
                        this.d = System.currentTimeMillis();
                    }
                    this.f3772c.sendEmptyMessageDelayed(1, 1000L);
                    return a2;
                }
            }
            return i2;
    ...
    public void b(int i, TencentLocationListener tencentLocationListener) {
        if (i == 12) {
            TencentLocationManager.getInstance(this.f3771a.f3944a).removeUpdates(tencentLocationListener);
        } else if (i == 11) {
            k6.a(this.f3771a).d();
            this.f3772c.removeCallbacksAndMessages(null);
            this.d = 0L;
        }
    }
}
