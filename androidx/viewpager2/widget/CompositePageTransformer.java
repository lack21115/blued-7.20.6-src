...
public final class CompositePageTransformer implements ViewPager2.PageTransformer {
    ...
    private final List<ViewPager2.PageTransformer> f3584a = new ArrayList();

    public void addTransformer(ViewPager2.PageTransformer pageTransformer) {
        this.f3584a.add(pageTransformer);
    }

    public void removeTransformer(ViewPager2.PageTransformer pageTransformer) {
        this.f3584a.remove(pageTransformer);
    }

    @Override // androidx.viewpager2.widget.ViewPager2.PageTransformer
    public void transformPage(View view, float f) {
        for (ViewPager2.PageTransformer pageTransformer : this.f3584a) {
