...
public final class AnimateLayoutChangeDetector {
    ...
    private static final ViewGroup.MarginLayoutParams f3581a;
    private LinearLayoutManager b;

    static {
        ViewGroup.MarginLayoutParams marginLayoutParams = new ViewGroup.MarginLayoutParams(-1, -1);
        f3581a = marginLayoutParams;
    ...
    private boolean b() {
        ...
        while (true) {
            ...
            if (i4 < childCount) {
                ...
                ViewGroup.MarginLayoutParams marginLayoutParams = layoutParams instanceof ViewGroup.MarginLayoutParams ? (ViewGroup.MarginLayoutParams) layoutParams : f3581a;
                int[] iArr2 = iArr[i4];
                if (z) {
                    top = childAt.getLeft();
