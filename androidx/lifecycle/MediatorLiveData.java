...
/* loaded from: source-8756600-dex2jar.jar:androidx/lifecycle/MediatorLiveData.class */
public class MediatorLiveData<T> extends MutableLiveData<T> {
    private SafeIterableMap<LiveData<?>, Source<?>> mSources = new SafeIterableMap<>();

    /* loaded from: source-8756600-dex2jar.jar:androidx/lifecycle/MediatorLiveData$Source.class */
