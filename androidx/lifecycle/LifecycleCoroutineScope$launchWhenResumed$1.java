...
@Metadata
@DebugMetadata(b = "Lifecycle.kt", c = {114}, d = "invokeSuspend", e = "androidx.lifecycle.LifecycleCoroutineScope$launchWhenResumed$1")
/* loaded from: source-8756600-dex2jar.jar:androidx/lifecycle/LifecycleCoroutineScope$launchWhenResumed$1.class */
final class LifecycleCoroutineScope$launchWhenResumed$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((LifecycleCoroutineScope$launchWhenResumed$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f42314a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.a(obj);
            this.label = 1;
            if (PausingDispatcherKt.whenResumed(this.this$0.getLifecycle$lifecycle_runtime_ktx_release(), this.$block, this) == a2) {
                return a2;
            }
        } else if (i != 1) {
