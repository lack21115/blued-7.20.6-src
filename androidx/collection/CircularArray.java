...
public final class CircularArray<E> {
    ...
    public CircularArray(int i) {
        ...
        this.f1895a = (E[]) new Object[highestOneBit];
    }
    ...
    private void a() {
        ...
        System.arraycopy(this.f1895a, 0, objArr, i2, this.b);
        this.f1895a = (E[]) objArr;
        this.b = 0;
        this.f1896c = length;
        this.d = i3 - 1;
    }
    ...
    public E get(int i) {
        ...
        return this.f1895a[this.d & (this.b + i)];
    }
    ...
    public E getLast() {
        ...
        int i2 = this.f1896c;
        if (i != i2) {
            return this.f1895a[(i2 - 1) & this.d];
        }
        throw new ArrayIndexOutOfBoundsException();
    }

    public boolean isEmpty() {
        return this.b == this.f1896c;
    }
    ...
    public int size() {
        return (this.f1896c - this.b) & this.d;
    }
}
