...
public final class LayoutInflaterCompat {
    ...
    static class Factory2Wrapper implements LayoutInflater.Factory2 {
        ...
        /* renamed from: a  reason: collision with root package name */
        final LayoutInflaterFactory f2642a;

        Factory2Wrapper(LayoutInflaterFactory layoutInflaterFactory) {
            this.f2642a = layoutInflaterFactory;
        }

        @Override // android.view.LayoutInflater.Factory2
        public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
            return this.f2642a.onCreateView(view, str, context, attributeSet);
        }

        @Override // android.view.LayoutInflater.Factory
        public View onCreateView(String str, Context context, AttributeSet attributeSet) {
            return this.f2642a.onCreateView(null, str, context, attributeSet);
        }

        public String toString() {
            return getClass().getName() + "{" + this.f2642a + i.d;
        }
    }
    ...
    public static LayoutInflaterFactory getFactory(LayoutInflater layoutInflater) {
        ...
        if (factory instanceof Factory2Wrapper) {
            return ((Factory2Wrapper) factory).f2642a;
        }
        return null;
    }
