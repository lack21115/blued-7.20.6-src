...
/* loaded from: source-8756600-dex2jar.jar:androidx/core/view/ViewConfigurationCompat.class */
public final class ViewConfigurationCompat {

    /* renamed from: a  reason: collision with root package name */
    private static Method f2615a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f2615a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
            } catch (Exception e) {
    ...
    private static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f2615a) != null) {
            try {
