...
public final class ViewConfigurationCompat {
    ...
    private static Method f2663a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f2663a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
            } catch (Exception e) {
    ...
    private static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f2663a) != null) {
            try {
