...
public class CallbackWithHandler {
    ...
    private final FontsContractCompat.FontRequestCallback f2523a;
    private final Handler b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public CallbackWithHandler(FontsContractCompat.FontRequestCallback fontRequestCallback) {
        this.f2523a = fontRequestCallback;
    ...
    private void a(final int i) {
        final FontsContractCompat.FontRequestCallback fontRequestCallback = this.f2523a;
