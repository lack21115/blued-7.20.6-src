...
/* loaded from: source-8756600-dex2jar.jar:androidx/core/graphics/ColorUtils.class */
public final class ColorUtils {
    ...
    public static Color compositeColors(Color color, Color color2) {
        ...
        if (components2[componentCount] > 0.0f) {
            f2 = alpha / components2[componentCount];
            f = alpha2 / components2[componentCount];
        }
        int i = 0;
        while (true) {
            int i2 = i;
            ...
            components2[i2] = (components[i2] * f2) + (components2[i2] * f);
            i = i2 + 1;
        }
    }
