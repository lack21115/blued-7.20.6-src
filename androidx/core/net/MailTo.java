...
public final class MailTo {
    ...
    private HashMap<String, String> f2456a = new HashMap<>();
        ...
        if (isMailTo(str)) {
            ...
            if (substring != null) {
                ...
                while (true) {
                    ...
                    if (split2.length != 0) {
                        mailTo.f2456a.put(Uri.decode(split2[0]).toLowerCase(Locale.ROOT), split2.length > 1 ? Uri.decode(split2[1]) : null);
                    }
                    i = i2 + 1;
                }
            }
    ...
    public String getBcc() {
        return this.f2456a.get("bcc");
    }

    public String getBody() {
        return this.f2456a.get(TtmlUtils.TAG_BODY);
    }

    public String getCc() {
        return this.f2456a.get("cc");
    }
    ...
    public String getSubject() {
        return this.f2456a.get("subject");
    }

    public String getTo() {
        return this.f2456a.get("to");
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("mailto:");
        sb.append('?');
        for (Map.Entry<String, String> entry : this.f2456a.entrySet()) {
