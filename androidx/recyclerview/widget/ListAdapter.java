...
public abstract class ListAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    final AsyncListDiffer<T> f3251a;
    ...
    class AnonymousClass1 implements AsyncListDiffer.ListListener<T> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ ListAdapter f3252a;

        @Override // androidx.recyclerview.widget.AsyncListDiffer.ListListener
        public void onCurrentListChanged(List<T> list, List<T> list2) {
            this.f3252a.onCurrentListChanged(list, list2);
        }
    }

    public List<T> getCurrentList() {
        return this.f3251a.getCurrentList();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        return this.f3251a.getCurrentList().size();
    }
    ...
    public void submitList(List<T> list) {
        this.f3251a.submitList(list);
    }

    public void submitList(List<T> list, Runnable runnable) {
        this.f3251a.submitList(list, runnable);
    }
}
