...
/* loaded from: source-8756600-dex2jar.jar:androidx/activity/ComponentActivity.class */
public class ComponentActivity extends androidx.core.app.ComponentActivity implements OnBackPressedDispatcherOwner, ContextAware, ActivityResultCaller, ActivityResultRegistryOwner, HasDefaultViewModelProviderFactory, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    /* loaded from: source-8756600-dex2jar.jar:androidx/activity/ComponentActivity$NonConfigurationInstances.class */
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if (viewModelStore == null) {
            ...
            if (nonConfigurationInstances != null) {
                viewModelStore2 = nonConfigurationInstances.b;
            }
        }
    ...
    public void reportFullyDrawn() {
        try {
            ...
            } else if (Build.VERSION.SDK_INT == 19 && ContextCompat.checkSelfPermission(this, Manifest.permission.UPDATE_DEVICE_STATS) == 0) {
                super.reportFullyDrawn();
            }
        } finally {
            Trace.endSection();
