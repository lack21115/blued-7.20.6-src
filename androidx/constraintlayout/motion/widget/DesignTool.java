...
public class DesignTool implements ProxyInterface {
    ...
    static final HashMap<Pair<Integer, Integer>, String> f2167a = new HashMap<>();
    static final HashMap<String, String> b = new HashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private final MotionLayout f2168c;
    ...
    static {
        f2167a.put(Pair.create(4, 4), "layout_constraintBottom_toBottomOf");
        f2167a.put(Pair.create(4, 3), "layout_constraintBottom_toTopOf");
        f2167a.put(Pair.create(3, 4), "layout_constraintTop_toBottomOf");
        f2167a.put(Pair.create(3, 3), "layout_constraintTop_toTopOf");
        f2167a.put(Pair.create(6, 6), "layout_constraintStart_toStartOf");
        f2167a.put(Pair.create(6, 7), "layout_constraintStart_toEndOf");
        f2167a.put(Pair.create(7, 6), "layout_constraintEnd_toStartOf");
        f2167a.put(Pair.create(7, 7), "layout_constraintEnd_toEndOf");
        f2167a.put(Pair.create(1, 1), "layout_constraintLeft_toLeftOf");
        f2167a.put(Pair.create(1, 2), "layout_constraintLeft_toRightOf");
        f2167a.put(Pair.create(2, 2), "layout_constraintRight_toRightOf");
        f2167a.put(Pair.create(2, 1), "layout_constraintRight_toLeftOf");
        f2167a.put(Pair.create(5, 5), "layout_constraintBaseline_toBaselineOf");
    ...
    private static void a(int i, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i2, int i3) {
        String str = f2167a.get(Pair.create(Integer.valueOf(i2), Integer.valueOf(i3)));
    ...
    public int designAccess(int i, String str, Object obj, float[] fArr, int i2, float[] fArr2, int i3) {
        ...
        } else if (this.f2168c.f2184a == null || view == null) {
            return -1;
        } else {
            MotionController motionController2 = this.f2168c.f.get(view);
        ...
        if (i != 0) {
            if (i == 1) {
                int duration = this.f2168c.f2184a.getDuration() / 16;
                motionController.a(fArr2, duration);
                return duration;
            } else if (i == 2) {
                int duration2 = this.f2168c.f2184a.getDuration() / 16;
                motionController.a(fArr2, (int[]) null);
                return duration2;
            } else if (i != 3) {
                return -1;
            } else {
                int duration3 = this.f2168c.f2184a.getDuration() / 16;
    ...
    public void dumpConstraintSet(String str) {
        if (this.f2168c.f2184a == null) {
            this.f2168c.f2184a = this.d;
        }
        int a2 = this.f2168c.a(str);
        PrintStream printStream = System.out;
        printStream.println(" dumping  " + str + " (" + a2 + ")");
        try {
            this.f2168c.f2184a.a(a2).dump(this.f2168c.f2184a, new int[0]);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public int getAnimationKeyFrames(Object obj, float[] fArr) {
        ...
        int duration = this.f2168c.f2184a.getDuration() / 16;
        MotionController motionController = this.f2168c.f.get(obj);
    ...
    public String getEndState() {
        int endState = this.f2168c.getEndState();
        if (this.h == endState) {
            return this.f;
        }
        String b2 = this.f2168c.b(endState);
        if (b2 != null) {
            this.f = b2;
            this.h = endState;
        }
    ...
    public int getKeyFrameInfo(Object obj, int i, int[] iArr) {
        MotionController motionController = this.f2168c.f.get((View) obj);
        if (motionController == null) {
            return 0;
        }
    ...
    public float getKeyFramePosition(Object obj, int i, float f, float f2) {
        MotionController motionController;
        if ((obj instanceof View) && (motionController = this.f2168c.f.get((View) obj)) != null) {
    ...
    public Object getKeyframe(int i, int i2, int i3) {
        ...
        return this.f2168c.f2184a.a(this.f2168c.getContext(), i, i2, i3);
    }
    ...
    public Object getKeyframe(Object obj, int i, int i2) {
        ...
        return this.f2168c.f2184a.a(this.f2168c.getContext(), i, ((View) obj).getId(), i2);
    }
    ...
    public Object getKeyframeAtLocation(Object obj, float f, float f2) {
        ...
        if (view == null || (motionController = this.f2168c.f.get(view)) == null) {
            return null;
        }
    ...
    public Boolean getPositionKeyframe(Object obj, Object obj2, float f, float f2, String[] strArr, float[] fArr) {
        if (obj instanceof KeyPositionBase) {
            View view = (View) obj2;
            this.f2168c.f.get(view).a(view, (KeyPositionBase) obj, f, f2, strArr, fArr);
            this.f2168c.rebuildScene();
            this.f2168c.j = true;
            return true;
        }
        return false;
    ...
    public float getProgress() {
        return this.f2168c.getProgress();
    }

    public String getStartState() {
        int startState = this.f2168c.getStartState();
        if (this.g == startState) {
            return this.e;
        }
        String b2 = this.f2168c.b(startState);
        if (b2 != null) {
            this.e = b2;
            this.g = startState;
        }
        return this.f2168c.b(startState);
    }
    ...
    public long getTransitionTimeMs() {
        return this.f2168c.getTransitionTimeMs();
    }
    ...
    public void setAttributes(int i, String str, Object obj, Object obj2) {
        ...
        int a2 = this.f2168c.a(str);
        ConstraintSet a3 = this.f2168c.f2184a.a(a2);
        if (a3 == null) {
            return;
        }
        a3.clear(view.getId());
        ...
        a(a3, view, hashMap, 1);
        a(i, a3, view, hashMap);
        this.f2168c.updateState(a2, a3);
        this.f2168c.requestLayout();
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public void setKeyFrame(Object obj, int i, String str, Object obj2) {
        if (this.f2168c.f2184a != null) {
            this.f2168c.f2184a.setKeyframe((View) obj, i, str, obj2);
            this.f2168c.i = i / 100.0f;
            this.f2168c.h = 0.0f;
            this.f2168c.rebuildScene();
            this.f2168c.b(true);
        }
    ...
    public boolean setKeyFramePosition(Object obj, int i, int i2, float f, float f2) {
        if ((obj instanceof View) && this.f2168c.f2184a != null) {
            MotionController motionController = this.f2168c.f.get(obj);
            int i3 = (int) (this.f2168c.g * 100.0f);
            if (motionController != null) {
                View view = (View) obj;
                if (this.f2168c.f2184a.a(view, i3)) {
                    float a2 = motionController.a(2, f, f2);
                    float a3 = motionController.a(5, f, f2);
                    this.f2168c.f2184a.setKeyframe(view, i3, "motion:percentX", Float.valueOf(a2));
                    this.f2168c.f2184a.setKeyframe(view, i3, "motion:percentY", Float.valueOf(a3));
                    this.f2168c.rebuildScene();
                    this.f2168c.b(true);
                    this.f2168c.invalidate();
                    return true;
                }
                return false;
            }
    ...
    public void setState(String str) {
        ...
        int a2 = this.f2168c.a(str2);
        this.g = a2;
        if (a2 != 0) {
            if (a2 == this.f2168c.getStartState()) {
                this.f2168c.setProgress(0.0f);
            } else if (a2 == this.f2168c.getEndState()) {
                this.f2168c.setProgress(1.0f);
            } else {
                this.f2168c.transitionToState(a2);
                this.f2168c.setProgress(1.0f);
            }
        }
        this.f2168c.requestLayout();
    ...
    public void setTransition(String str, String str2) {
        ...
        int a2 = this.f2168c.a(str);
        int a3 = this.f2168c.a(str2);
        this.f2168c.setTransition(a2, a3);
        this.g = a2;
        this.h = a3;
        this.e = str;
        this.f = str2;
    ...
    public void setViewDebug(Object obj, int i) {
        MotionController motionController;
        if ((obj instanceof View) && (motionController = this.f2168c.f.get(obj)) != null) {
