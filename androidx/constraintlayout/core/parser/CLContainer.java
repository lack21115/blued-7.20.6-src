...
/* loaded from: source-8756600-dex2jar.jar:androidx/constraintlayout/core/parser/CLContainer.class */
public class CLContainer extends CLElement {
    ...
    public CLArray getArray(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no array found for key <" + str + ">, found [" + cLElement.a() + "] : " + cLElement, this);
    }
    ...
    public boolean getBoolean(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no boolean found for key <" + str + ">, found [" + cLElement.a() + "] : " + cLElement, this);
    }
    ...
    public float getFloat(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no float found for key <" + str + ">, found [" + cLElement.a() + "] : " + cLElement, this);
    }
    ...
    public int getInt(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no int found for key <" + str + ">, found [" + cLElement.a() + "] : " + cLElement, this);
    }
    ...
    public CLObject getObject(String str) throws CLParsingException {
        ...
        throw new CLParsingException("no object found for key <" + str + ">, found [" + cLElement.a() + "] : " + cLElement, this);
    }
