...
public class CLToken extends CLElement {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f2084a[Type.FALSE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f2084a[Type.NULL.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f2084a[Type.UNKNOWN.ordinal()] = 4;
    ...
    public boolean validate(char c2, long j) {
        boolean z;
        int i = AnonymousClass1.f2084a[this.g.ordinal()];
        boolean z2 = false;
        if (i == 1) {
            boolean z3 = false;
            if (this.h[this.f2083a] == c2) {
                z3 = true;
            }
            z = z3;
            if (z3) {
                z = z3;
                if (this.f2083a + 1 == this.h.length) {
                    setEnd(j);
                    z = z3;
                }
            }
            ...
            boolean z4 = false;
            if (this.i[this.f2083a] == c2) {
                z4 = true;
            }
            z = z4;
            if (z4) {
                z = z4;
                if (this.f2083a + 1 == this.i.length) {
                    setEnd(j);
                    z = z4;
                }
            }
        } else if (i == 3) {
            if (this.j[this.f2083a] == c2) {
                z2 = true;
            }
            z = z2;
            if (z2) {
                z = z2;
                if (this.f2083a + 1 == this.j.length) {
                    setEnd(j);
                    z = z2;
                }
            }
