...
/* loaded from: source-8756600-dex2jar.jar:androidx/constraintlayout/core/widgets/Optimizer.class */
public class Optimizer {
    ...
    public static void a(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, ConstraintWidget constraintWidget) {
        ...
        if (constraintWidget.q > 0 || constraintWidget.getVisibility() == 8) {
            ...
            linearSystem.addEquality(constraintWidget.mBaseline.b, constraintWidget.q + i2);
        }
