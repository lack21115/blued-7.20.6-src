...
public class MockView extends View {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            while (true) {
                ...
                if (index == R.styleable.MockView_mock_label) {
                    this.f2188a = obtainStyledAttributes.getString(index);
        ...
        if (this.f2188a == null) {
            try {
                this.f2188a = context.getResources().getResourceEntryName(getId());
            } catch (Exception e) {
            }
        }
        this.b.setColor(this.h);
        this.b.setAntiAlias(true);
        this.f2189c.setColor(this.i);
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.f2189c.getTextBounds(str, 0, str.length(), this.g);
        ...
        canvas.drawText(this.f2188a, width2, height2, this.f2189c);
    }
}
