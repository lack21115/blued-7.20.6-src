...
public class StateSet {
        ...
        public State(Context context, XmlPullParser xmlPullParser) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == R.styleable.State_android_id) {
                    this.f2287a = obtainStyledAttributes.getResourceId(index, this.f2287a);
                } else if (index == R.styleable.State_constraints) {
                    this.f2288c = obtainStyledAttributes.getResourceId(index, this.f2288c);
                    String resourceTypeName = context.getResources().getResourceTypeName(this.f2288c);
                    context.getResources().getResourceName(this.f2288c);
    ...
    public static class Variant {
        ...
        public Variant(Context context, XmlPullParser xmlPullParser) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == R.styleable.Variant_constraints) {
                    ...
                    this.f2289a = obtainStyledAttributes.getDimension(index, this.f2289a);
                } else {
        ...
        boolean a(float f, float f2) {
            if (Float.isNaN(this.f2289a) || f >= this.f2289a) {
                if (Float.isNaN(this.b) || f2 >= this.b) {
                    if (Float.isNaN(this.f2290c) || f <= this.f2290c) {
    ...
    public int convertToConstraintSet(int i, int i2, float f, float f2) {
        ...
        return variant != null ? variant.e : state.f2288c;
    }
    ...
    public boolean needsToChange(int i, float f, float f2) {
        ...
        return (this.f2286c == -1 || !valueAt.b.get(this.f2286c).a(f, f2)) && this.f2286c != valueAt.findMatch(f, f2);
    }
    ...
    public int updateConstraints(int i, int i2, float f, float f2) {
        ...
        if (i != i2) {
            ...
            return findMatch2 == -1 ? state.f2288c : state.b.get(findMatch2).e;
        }
        State valueAt = i2 == -1 ? this.d.valueAt(0) : this.d.get(this.b);
        if (valueAt == null) {
            return -1;
        }
        if ((this.f2286c == -1 || !valueAt.b.get(i).a(f, f2)) && i != (findMatch = valueAt.findMatch(f, f2))) {
            return findMatch == -1 ? valueAt.f2288c : valueAt.b.get(findMatch).e;
        }
        return i;
    }
}
