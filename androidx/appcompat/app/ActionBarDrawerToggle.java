...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    static class FrameworkActionBarDelegate implements Delegate {
        ...
        public Context getActionBarThemedContext() {
            android.app.ActionBar actionBar = this.f1534a.getActionBar();
            return actionBar != null ? actionBar.getThemedContext() : this.f1534a;
        }
        ...
        public Drawable getThemeUpIndicator() {
            ...
            return ActionBarDrawerToggleHoneycomb.getThemeUpIndicator(this.f1534a);
        }
        ...
        public void setActionBarDescription(int i) {
            if (Build.VERSION.SDK_INT < 18) {
                this.b = ActionBarDrawerToggleHoneycomb.setActionBarDescription(this.b, this.f1534a, i);
                return;
            }
            android.app.ActionBar actionBar = this.f1534a.getActionBar();
            if (actionBar != null) {
        ...
        public void setActionBarUpIndicator(Drawable drawable, int i) {
            ...
            if (actionBar != null) {
                ...
                this.b = ActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(this.f1534a, drawable, i);
    ...
    static class ToolbarCompatDelegate implements Delegate {
        ...
        /* renamed from: a  reason: collision with root package name */
        final Toolbar f1535a;
        final Drawable b;

        /* renamed from: c  reason: collision with root package name */
        final CharSequence f1536c;

        ToolbarCompatDelegate(Toolbar toolbar) {
            this.f1535a = toolbar;
            this.b = toolbar.getNavigationIcon();
            this.f1536c = toolbar.getNavigationContentDescription();
        }

        @Override // androidx.appcompat.app.ActionBarDrawerToggle.Delegate
        public Context getActionBarThemedContext() {
            return this.f1535a.getContext();
        }
        ...
        public void setActionBarDescription(int i) {
            if (i == 0) {
                this.f1535a.setNavigationContentDescription(this.f1536c);
            } else {
                this.f1535a.setNavigationContentDescription(i);
            }
        }

        @Override // androidx.appcompat.app.ActionBarDrawerToggle.Delegate
        public void setActionBarUpIndicator(Drawable drawable, int i) {
            this.f1535a.setNavigationIcon(drawable);
    ...
    ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, DrawerArrowDrawable drawerArrowDrawable, int i, int i2) {
        ...
        this.k = false;
        if (toolbar != null) {
            this.f1532c = new ToolbarCompatDelegate(toolbar);
            toolbar.setNavigationOnClickListener(new View.OnClickListener() { // from class: androidx.appcompat.app.ActionBarDrawerToggle.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    Tracker.onClick(view);
                    if (ActionBarDrawerToggle.this.f1531a) {
            ...
            this.f1532c = ((DelegateProvider) activity).getDrawerToggleDelegate();
        } else {
            this.f1532c = new FrameworkActionBarDelegate(activity);
        }
        this.d = drawerLayout;
        this.i = i;
        this.j = i2;
        if (drawerArrowDrawable == null) {
            this.e = new DrawerArrowDrawable(this.f1532c.getActionBarThemedContext());
        } else {
    ...
    void a(int i) {
        this.f1532c.setActionBarDescription(i);
    }

    void a(Drawable drawable, int i) {
        if (!this.k && !this.f1532c.isNavigationVisible()) {
            Log.w("ActionBarDrawerToggle", "DrawerToggle may not show up because NavigationIcon is not visible. You may need to call actionbar.setDisplayHomeAsUpEnabled(true);");
            this.k = true;
        }
        this.f1532c.setActionBarUpIndicator(drawable, i);
    }

    Drawable b() {
        return this.f1532c.getThemeUpIndicator();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        if (menuItem != null && menuItem.getItemId() == 16908332 && this.f1531a) {
            a();
            return true;
        }
        return false;
