...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.b = propertyMapper.mapInt("imeOptions", 16843364);
            this.f1875c = propertyMapper.mapInt("maxWidth", 16843039);
            this.d = propertyMapper.mapBoolean("iconifiedByDefault", R.attr.iconifiedByDefault);
            this.e = propertyMapper.mapObject("queryHint", R.attr.queryHint);
            this.f1874a = true;
        }
        ...
        public void readProperties(SearchView searchView, PropertyReader propertyReader) {
            ...
            propertyReader.readInt(this.f1875c, searchView.getMaxWidth());
    ...
    public static class PreQAutoCompleteTextViewReflector {
        ...
        /* renamed from: a  reason: collision with root package name */
        private Method f1876a;
        private Method b;

        /* renamed from: c  reason: collision with root package name */
        private Method f1877c;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f1878a = ((Boolean) parcel.readValue(null)).booleanValue();
        }
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.f1878a + i.d;
        }

        @Override // androidx.customview.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i) {
            super.writeToParcel(parcel, i);
            parcel.writeValue(Boolean.valueOf(this.f1878a));
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        /* renamed from: a  reason: collision with root package name */
        final Runnable f1879a;
        private int b;

        /* renamed from: c  reason: collision with root package name */
        private SearchView f1880c;
        private boolean d;
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            ...
            this.f1879a = new Runnable() { // from class: androidx.appcompat.widget.SearchView.SearchAutoComplete.1
        ...
        public void onWindowFocusChanged(boolean z) {
            ...
            if (z && this.f1880c.hasFocus() && getVisibility() == 0) {
                this.d = true;
    ...
    static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            boolean z4 = false;
            if (z2) {
                if (!z || this.f1883c.contains(x, y)) {
                    motionEvent.setLocation(x - this.f1883c.left, y - this.f1883c.top);
                } else {
                    motionEvent.setLocation(this.f1882a.getWidth() / 2, this.f1882a.getHeight() / 2);
                }
                z4 = this.f1882a.dispatchTouchEvent(motionEvent);
            }
            return z4;
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.U = new View.OnClickListener() { // from class: androidx.appcompat.widget.SearchView.5
            ...
            public void onClick(View view) {
                ...
                if (view == SearchView.this.b) {
                    ...
                    SearchView.this.c();
                } else if (view == SearchView.this.f1863c) {
                    SearchView.this.b();
                } else if (view == SearchView.this.e) {
                    SearchView.this.e();
                } else if (view == SearchView.this.f1862a) {
                    SearchView.this.h();
                }
            }
        };
        this.j = new View.OnKeyListener() { // from class: androidx.appcompat.widget.SearchView.6
            ...
            public boolean onKey(View view, int i3, KeyEvent keyEvent) {
                ...
                if (!SearchView.this.f1862a.isPopupShowing() || SearchView.this.f1862a.getListSelection() == -1) {
                    if (!SearchView.this.f1862a.a() && keyEvent.hasNoModifiers() && keyEvent.getAction() == 1 && i3 == 66) {
                        view.cancelLongPress();
                        SearchView searchView = SearchView.this;
                        searchView.a(0, (String) null, searchView.f1862a.getText().toString());
                        return true;
                    }
                    return false;
                }
        ...
        this.f1862a = searchAutoComplete;
        ...
        this.f1863c = (ImageView) findViewById(R.id.search_go_btn);
        ...
        this.f1863c.setImageDrawable(obtainStyledAttributes.getDrawable(R.styleable.SearchView_goIcon));
        ...
        this.f1863c.setOnClickListener(this.U);
        this.e.setOnClickListener(this.U);
        this.f1862a.setOnClickListener(this.U);
        this.f1862a.addTextChangedListener(this.ab);
        this.f1862a.setOnEditorActionListener(this.V);
        this.f1862a.setOnItemClickListener(this.W);
        this.f1862a.setOnItemSelectedListener(this.aa);
        this.f1862a.setOnKeyListener(this.j);
        this.f1862a.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: androidx.appcompat.widget.SearchView.3
        ...
        View findViewById = findViewById(this.f1862a.getDropDownAnchor());
        this.n = findViewById;
    ...
    */
    private void a(boolean r5) {
        ...
        L13:
            r0 = r4
            androidx.appcompat.widget.SearchView$SearchAutoComplete r0 = r0.f1862a
    ...
    private void b(int i2) {
        Editable text = this.f1862a.getText();
    ...
    private void b(boolean z) {
        this.f1863c.setVisibility((this.G && j() && hasFocus() && (z || !this.L)) ? 0 : 8);
    }
    ...
    private CharSequence c(CharSequence charSequence) {
        if (this.E && this.u != null) {
            int textSize = (int) (this.f1862a.getTextSize() * 1.25d);
    ...
    private void k() {
        this.m.setVisibility((j() && (this.f1863c.getVisibility() == 0 || this.e.getVisibility() == 0)) ? 0 : 8);
    }

    private void l() {
        boolean z = !TextUtils.isEmpty(this.f1862a.getText());
        boolean z2 = true;
        if (!z) {
            z2 = this.E && !this.O;
        }
    ...
    private void n() {
        ...
        SearchAutoComplete searchAutoComplete = this.f1862a;
    ...
    private void o() {
        this.f1862a.setThreshold(this.h.getSuggestThreshold());
        this.f1862a.setImeOptions(this.h.getImeOptions());
        ...
        if (this.h.getSuggestAuthority() != null) {
            ...
            this.f1862a.setAdapter(suggestionsAdapter);
    ...
    private void p() {
        this.f1862a.dismissDropDown();
    }

    private void setQuery(CharSequence charSequence) {
        this.f1862a.setText(charSequence);
        this.f1862a.setSelection(TextUtils.isEmpty(charSequence) ? 0 : charSequence.length());
    }

    void a() {
        int[] iArr = this.f1862a.hasFocus() ? FOCUSED_STATE_SET : EMPTY_STATE_SET;
    ...
    boolean a(int i2, int i3, String str) {
        ...
        if (onSuggestionListener == null || !onSuggestionListener.onSuggestionClick(i2)) {
            b(i2, 0, null);
            this.f1862a.setImeVisibility(false);
            p();
            return true;
        }
        return false;
    ...
    boolean a(View view, int i2, KeyEvent keyEvent) {
        if (this.h != null && this.g != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            if (i2 == 66 || i2 == 84 || i2 == 61) {
                return a(this.f1862a.getListSelection(), 0, (String) null);
            }
            if (i2 != 21 && i2 != 22) {
                return (i2 == 19 && this.f1862a.getListSelection() == 0) ? false : false;
            }
            this.f1862a.setSelection(i2 == 21 ? 0 : this.f1862a.length());
            this.f1862a.setListSelection(0);
            this.f1862a.clearListSelection();
            this.f1862a.c();
            return true;
        }
        return false;
    ...
    void c() {
        if (!TextUtils.isEmpty(this.f1862a.getText())) {
            this.f1862a.setText("");
            this.f1862a.requestFocus();
            this.f1862a.setImeVisibility(true);
        } else if (this.E) {
    ...
    void g() {
        if (this.n.getWidth() > 1) {
            ...
            this.f1862a.getDropDownBackground().getPadding(rect);
            this.f1862a.setDropDownHorizontalOffset(isLayoutRtl ? -rect.left : paddingLeft - (rect.left + dimensionPixelSize));
            this.f1862a.setDropDownWidth((((this.n.getWidth() + rect.left) + rect.right) + dimensionPixelSize) - paddingLeft);
        }
    }

    public int getImeOptions() {
        return this.f1862a.getImeOptions();
    }

    public int getInputType() {
        return this.f1862a.getInputType();
    }
    ...
    void h() {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f1862a.refreshAutoCompleteResults();
            return;
        }
        i.a(this.f1862a);
        i.b(this.f1862a);
    ...
    public void onActionViewCollapsed() {
        ...
        clearFocus();
        a(true);
        this.f1862a.setImeOptions(this.P);
        this.O = false;
    }
    ...
    public void onActionViewExpanded() {
        ...
        this.O = true;
        int imeOptions = this.f1862a.getImeOptions();
        this.P = imeOptions;
        this.f1862a.setImeOptions(imeOptions | 33554432);
        this.f1862a.setText("");
        setIconified(false);
    }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (z) {
            ...
            UpdatableTouchDelegate updatableTouchDelegate2 = new UpdatableTouchDelegate(this.q, this.p, this.f1862a);
    ...
    public boolean requestFocus(int i2, Rect rect) {
        if (!this.J && isFocusable()) {
            ...
            boolean requestFocus = this.f1862a.requestFocus(i2, rect);
            if (requestFocus) {
                a(false);
            }
            return requestFocus;
    ...
    public void setSearchableInfo(SearchableInfo searchableInfo) {
        ...
        this.L = i2;
        if (i2) {
            this.f1862a.setPrivateImeOptions("nm");
        }
        a(isIconified());
    }
    ...
    public void setSuggestionsAdapter(CursorAdapter cursorAdapter) {
        ...
        this.f1862a.setAdapter(cursorAdapter);
    }
}
