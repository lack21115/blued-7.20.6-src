...
/* loaded from: source-2895416-dex2jar.jar:java/util/concurrent/locks/AbstractQueuedSynchronizer.class */
public abstract class AbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements Serializable {
    ...
    /* loaded from: source-2895416-dex2jar.jar:java/util/concurrent/locks/AbstractQueuedSynchronizer$ConditionObject.class */
    public class ConditionObject implements Condition, Serializable {
        ...
        public final void await() throws InterruptedException {
            ...
            int i2 = i;
            if (AbstractQueuedSynchronizer.this.acquireQueued(addConditionWaiter, fullyRelease)) {
                i2 = i;
                if (i != -1) {
                    i2 = 1;
                }
    ...
    /* loaded from: source-2895416-dex2jar.jar:java/util/concurrent/locks/AbstractQueuedSynchronizer$Node.class */
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void unparkSuccessor(java.util.concurrent.locks.AbstractQueuedSynchronizer.Node r5) {
        /*
            r4 = this;
            r0 = r5
        ...
        L5b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: java.util.concurrent.locks.AbstractQueuedSynchronizer.unparkSuccessor(java.util.concurrent.locks.AbstractQueuedSynchronizer$Node):void");
    }
