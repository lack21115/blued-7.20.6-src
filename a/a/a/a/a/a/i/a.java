...
public class a extends d {
    ...
    public void b(c.g gVar) {
        if (gVar.b == 1) {
            ...
            e eVar = e.f;
            eVar.b("PLAVMuxer", "VIDEO CONFIG LENGTH: " + this.p.length + ", pts:" + (gVar.f1202a.presentationTimeUs / 1000));
            ...
            e eVar2 = e.f;
            eVar2.b("PLAVMuxer", "AUDIO CONFIG LENGTH: " + this.q.length + ", pts:" + (gVar.f1202a.presentationTimeUs / 1000));
            PLDroidStreamingCore pLDroidStreamingCore2 = this.g;
            byte[] bArr2 = this.q;
            pLDroidStreamingCore2.writeAudioSeqHeader(bArr2, bArr2.length, gVar.f1202a.presentationTimeUs / 1000);
        }
