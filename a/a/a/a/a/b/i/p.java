...
public class p {
    ...
    public a.a.a.a.a.i.b.b f1287a;
    public FloatBuffer b;

    /* renamed from: c  reason: collision with root package name */
    public FloatBuffer f1288c;
    ...
    public void a() {
        a.a.a.a.a.i.b.b bVar = this.f1287a;
        if (bVar != null) {
            bVar.h();
            this.f1287a = null;
        }
    ...
    public void a(int i) {
        ...
        if (floatBuffer2 != null && (floatBuffer = this.f1288c) != null && (i2 = this.e) != 0) {
            this.f1287a.a(a.a.a.a.a.a.h.f.f1191c, floatBuffer2, 0, this.f, this.g, this.i, floatBuffer, i2, this.h);
        }
    ...
    public boolean a(int i, int i2, float f, float f2, float f3, float f4, WatermarkSetting watermarkSetting) {
        ...
        this.f1287a = new a.a.a.a.a.i.b.b(watermarkSetting.getAlpha());
    ...
    public final void c() {
        ...
        if (watermarkSetting == null) {
            a.a.a.a.a.e.e.f1313c.d("WatermarkSticker", "no settings for watermarkTexture");
            this.e = -1;
            return;
        }
        Bitmap watermarkBitmap = watermarkSetting.getWatermarkBitmap();
        if (watermarkBitmap == null) {
            a.a.a.a.a.e.e.f1313c.d("WatermarkSticker", "no resources for watermarkTexture");
            this.e = -1;
            return;
        }
        int[] iArr = new int[1];
