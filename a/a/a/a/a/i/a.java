...
public final class a implements SurfaceTextureCallback {
    ...
    public static final boolean f1335a = SharedLibraryNameHelper.getInstance().d();
    public InterfaceC0010a b;

    /* renamed from: c  reason: collision with root package name */
    public a.a.a.a.a.i.b.c.a f1336c;
    public Context d;
    ...
    public a(Context context, CameraStreamingSetting cameraStreamingSetting, boolean z, InterfaceC0010a interfaceC0010a) {
        ...
        if (SharedLibraryNameHelper.d(true) && cameraStreamingSetting.e()) {
            ...
            this.f1336c = new a.a.a.a.a.i.b.c.a();
        }
    ...
    public final void a(int i, int i2, long j, boolean z) {
        synchronized (this.m) {
            if (this.f1336c != null) {
                ...
                this.j.clear();
                boolean a2 = this.f1336c.a(this.j, this.l);
                if (this.b != null && a2) {
                    if (this.k == null) {
    ...
    public void a(CameraStreamingSetting.FaceBeautySetting faceBeautySetting) {
        ...
        this.f1336c.a(faceBeautySetting.beautyLevel);
        float f = faceBeautySetting.whiten;
        float f2 = f;
        if (f > 1.0f) {
            f2 = 1.0f;
        }
        this.f1336c.b(f2 / 2.0f);
        this.f1336c.c(faceBeautySetting.redden);
    }
    ...
    public void c() {
        a.a.a.a.a.i.b.c.a aVar = this.f1336c;
        if (aVar != null) {
            aVar.a();
            f();
        }
    ...
    public final void g() {
        ...
        if (aVar != null) {
            aVar.a();
            this.f1336c.a(this.d.getApplicationContext(), h.f(this.d), !this.g ? 1 : 0);
            this.f1336c.b(!h.c(this.d));
            a(this.e.getFaceBeautySetting());
        }
    }
