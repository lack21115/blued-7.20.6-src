...
public final class SequencesKt___SequencesKt$minus$3<T> implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        ...
        return a.isEmpty() ? this.b.iterator() : SequencesKt.b(this.b, new Function1<T, Boolean>() { // from class: kotlin.sequences.SequencesKt___SequencesKt$minus$3$iterator$1
